...
const LATEST_NEWS = [
  { source: "The Athletic", title: "Julian Ward emerges as Liverpool's leading internal candidate to replace Hughes as sporting director", time: "today", category: "major" },
  { source: "Football Fancast", title: "Edwards in the room: the man Ward once succeeded is back rebuilding the football-operations structure Gordon is now recruiting into", time: "today", category: "fan" },
  { source: "FourFourTwo", title: "Liverpool sort their Champions League right-back: Araujo's nine duels from ten point Iraola away from Frimpong", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Five games in 17 days: September is the first real test of Iraola's closed squad, Atletico first up Wednesday", time: "today", category: "major" },
  { source: "Caught Offside", title: "Liverpool consider move for Julian Ward with Woodfine and Marques also in the frame, Ayto and Mitchell the external names", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola's message to Frimpong: the winger's pace is still an answer, but Araujo has the shirt for now", time: "today", category: "fan" },
  { source: "AFP", title: "Wounded visitors: Atletico arrive at Anfield three days after a first defeat, 3-0 at Athletic Bilbao", time: "today", category: "major" },
  { source: "ESPN", title: "Arsenal host Chelsea at the Emirates, both a point above an idle Liverpool with the top of the table unfinished", time: "today", category: "major" },
  { source: "Get Spanish Football News", title: "Alvarez whistled by his own fans again, David a doubt: Atletico's troubles travel to Merseyside", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Gomez the nearest of five absentees, and the first squad call the next sporting director inherits", time: "today", category: "fan" },
  { source: "Opta Analyst", title: "Isak scores in a third straight game and Gakpo assists all three: the axis carrying a thin Liverpool attack", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Liverpool FC statement: Richard Hughes steps down as sporting director, the process to appoint a successor under way", time: "1d ago", category: "official" },
  { source: "Liverpool FC", title: "Alisson's 138th clean sheet moves him past Elisha Scott into fourth on the club's all-time list", time: "1d ago", category: "official" },
  { source: "Liverpool FC", title: "Injury update: Gomez to resume team training this week, no return date for Bradley or Ekitike", time: "2d ago", category: "official" },
  { source: "Sky Sports", title: "Ipswich 0-2 Liverpool: Isak strikes twice inside nine minutes as Iraola claims his first win and a first clean sheet", time: "2d ago", category: "major" },
];
