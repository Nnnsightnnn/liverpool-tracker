...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Australia 1-1 Egypt, 2-4 on penalties: Salah's Panenka caps the first knockout victory in Egypt's World Cup history", time: "today", category: "major" },
  { source: "ESPN", title: "'I decided last minute, I had to do it': Salah plays all 120 minutes in Arlington, then chips his shootout penalty down the middle", time: "today", category: "major" },
  { source: "World Soccer Talk", title: "Next up, Messi: Egypt's round-of-16 tie against Argentina is set for Tuesday, noon kickoff, in Atlanta", time: "today", category: "fan" },
  { source: "Football365", title: "Iraola 'requests' a £43m move for Leverkusen's Malik Tillman, the midfielder his USA World Cup keeps repricing", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Klopp closes on a return: the DFB confirms talks after Nagelsmann's resignation, the former Reds boss the favourite", time: "1d ago", category: "fan" },
  { source: "Football365", title: "Liverpool 'willing to pay £86m' for RB Leipzig winger Yan Diomande as the summer's biggest pursuit takes shape", time: "1d ago", category: "major" },
  { source: "The Athletic", title: "Ornstein: Diomande's preference is PSG, and Leipzig have publicly insisted the winger is going nowhere this year", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Fresh contact made with Barcola's camp as the PSG winger tops Liverpool's list of Diomande alternatives", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Van Dijk exit 'gains momentum': Turkish press claim a deal all but agreed; Liverpool insist nothing has changed", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "'Given me the go-ahead': Jacquet says his surgeon has cleared him for group training, promising 100% fitness", time: "3d ago", category: "fan" },
  { source: "This Is Anfield", title: "Roughly 19 players are expected at Iraola's first Kirkby session on July 13, World Cup runs permitting", time: "2d ago", category: "fan" },
  { source: "Liverpool FC", title: "Forever 20: the permanent memorial to Diogo Jota and André Silva now stands on 97 Avenue", time: "1d ago", category: "official" },
  { source: "This Is Anfield", title: "The tour ahead: Sunderland in Nashville on July 25, then Wrexham at Yankee Stadium five days later", time: "2d ago", category: "fan" },
];
