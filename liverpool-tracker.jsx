...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "doubtful", outSince: "2026-07-25", injuryNote: "Thu Aug 27 — the vice-captain is out, and the back line is down to two. Iraola set Gomez's muscle problem at around a month on Thursday, which rules him out of Saturday rather than leaving him a late call, after the knock taken inside minutes at Sunderland on 25 July that also cost him the Newcastle draw. The arithmetic behind him is stark: with Konate gone to Madrid, Leoni still on ACL rehab and Ndukwe barred from competitive football by a work permit, Van Dijk and Jacquet are the fit senior centre-backs and Araujo's loan is the cover. The longest-serving defender is a body to keep rather than sell, his Serie A links long since quiet", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  { id: 17, name: "Wataru Endo", number: 3, position: "MID", nationality: "🇯🇵 Japan", age: 33, appearances: 14, goals: 0, assists: 1, cleanSheets: null, xG: 0.3, tacklesPer90: 3.1, passCompletion: 87, progressiveCarries: 1.2, form: 6.2, status: "fit", injuryNote: "Thu Aug 27 — the exit that suddenly has a use again. Liverpool have made clubs aware Endo is available, Wolves, Fulham and West Ham the standing admirers, and at 33 he is among the up-to-eight departures FSG will sanction before Tuesday. But with Gomez ruled out a month, Ndukwe work-permit barred and the centre-back file down to Van Dijk and Jacquet, the makeshift-CB cover he provides is briefly worth more than the wages his sale would clear. The February foot trouble is long behind him; a manager who has never selected him may have to, at least on the bench", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p158983.png" },
  ...
  { id: 19, name: "Stefan Bajcetic", number: 43, position: "MID", nationality: "🇪🇸 Spain", age: 21, appearances: 0, goals: 0, assists: 0, cleanSheets: null, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "doubtful", injuryNote: "Thu Aug 27 — done bar the signature, and bound for Galicia. Romano now has Celta Vigo and Bajcetic aligned on personal terms, the clubs at an understanding built on bonuses and a sell-on cut Liverpool retain rather than a fee, a negotiated exit expected to unpick a contract that runs to 2027. He has not featured for Liverpool this calendar year, travelled to America in the rehab group rather than to play, and at 21 carries three seasons wrecked by hamstring trouble. The academy that raised him is where the rebuild starts again", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p535928.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 40, goals: 10, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 7.0, status: "fit", injuryNote: "Thu Aug 27 — a certainty at breakfast, a decision by evening. The morning framing had Gakpo days from Tottenham at around £72m, the sale funding the incomings; by Thursday night the club's stance had hardened the other way. Iraola said he cannot guarantee anything about the forward's future, but Liverpool are not chasing a sale, would move only for an offer they consider very attractive, and will not sanction one until a replacement is secured. Manchester City have joined Spurs, who are said to be readying an improved bid on an opening approach near €60m. He dragged Liverpool level at Newcastle in the 55th on the opening day and is contracted to 2030. Saturday's Forest visit may be his stage for a while yet", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 24, name: "Hugo Ekitike", number: 22, position: "FWD", nationality: "🇫🇷 France", age: 23, appearances: 41, goals: 18, assists: 5, cleanSheets: null, xG: 14.2, tacklesPer90: 0.4, passCompletion: 78, progressiveCarries: 2.1, form: 7.3, status: "injured", injuryNote: "Mon Aug 24 — 'still way off,' in the manager's own words. Iraola's first in-season bulletin offered no comfort on the striker Liverpool most miss: the Achilles ruptured against PSG in April keeps Ekitike sidelined, the coach 'talking about months and still a lot of time out' and conceding he may not feature again this calendar year. He continues his rehabilitation away from the group, took no part in pre-season, and is at best a hopeful festive-period return. The front line carries on without its most productive option from last term's 18 goals", image: "https://r2.thesportsdb.com/images/media/player/cutout/8za47v1757087851.png" },
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Thu Aug 27 — eighteen on matchday, with a contract waiting behind it. Ngumoha was a bench option at Newcastle as Gakpo held the right and scored. This Is Anfield report a new five-year deal with a significant pay rise is set to follow when he turns 18 on August 29, the day Forest visit, the delay only a rule capping under-18s at three-year terms. The flank around him got busier on Thursday rather than clearer: Barcola agreed in principle, a third bid weighed for Minteh, and Gakpo no longer certain to leave, which is three senior wingers where a fortnight ago there was a shortage. Twenty-nine appearances last term and a goal against Newcastle a year ago; the path is still there, just narrower than it looked at lunchtime", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  { id: 26, name: "Federico Chiesa", number: 14, position: "FWD", nationality: "🇮🇹 Italy", age: 28, appearances: 12, goals: 1, assists: 1, cleanSheets: null, xG: 1.5, tacklesPer90: 0.6, passCompletion: 80, progressiveCarries: 2.2, form: 6.0, status: "doubtful", injuryNote: "Thu Aug 27 — the briefing came and went without him in it. Iraola fielded questions on wingers, on Gakpo and on Carragher at his Thursday press conference and offered nothing fresh on Chiesa, which leaves the Italian genuinely touch and go for Saturday's home opener after the fitness issue that kept him out at Newcastle and off the training pitch earlier in the week. The silence complicates a summer spent weighing his future: he scored off the bench in Nashville and insisted his focus was Liverpool, yet he sits among the exits the club would sanction, and with two wingers being pursued the squad maths is moving against him", image: "https://r2.thesportsdb.com/images/media/player/cutout/idecla1757087689.png" },
...
const LATEST_NEWS = [
  { source: "CaughtOffside", title: "Here we go: Romano confirms Liverpool's agreement in principle for Bradley Barcola", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Brighton reject a new Liverpool bid for Minteh and set the price above \u00a370m", time: "today", category: "major" },
  { source: "ESPN", title: "Iraola on Gakpo's future: 'I cannot guarantee anything' as Man City join Spurs", time: "today", category: "major" },
  { source: "UEFA", title: "Champions League draw: Atletico, Porto, Villarreal and Lens to Anfield; Inter, Brugge, Fenerbahce, LASK away", time: "today", category: "official" },
  { source: "Sky Sports", title: "Barcola agreed at \u00a3120m with more than \u00a3100m guaranteed, medical and signing to follow", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Sky: Liverpool still want a right-sided winger and a back-up striker before Tuesday", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola on the winger hunt: 'We hope to have good news soon but we are still not there'", time: "today", category: "official" },
  { source: "Liverpool.com", title: "Iraola answers Carragher: 'Things to improve, but I have no doubt they are all top players'", time: "today", category: "major" },
  { source: "Sports Mole", title: "Third bid weighed: personal terms long agreed with Minteh despite August ankle surgery", time: "today", category: "major" },
  { source: "FootballFanCast", title: "Lille's \u20ac70m valuation cools Fernandez-Pardo for Liverpool, Newcastle and Man City alike", time: "today", category: "major" },
  { source: "Goal", title: "Preview: Glasner's pointless Forest at Anfield on Saturday, Yates and Savona out", time: "today", category: "major" },
  { source: "TeamTalk", title: "Besiktas agree personal terms with Tsimikas and lodge a \u20ac2m loan bid for Mamardashvili", time: "1d ago", category: "major" },
  { source: "Fabrizio Romano", title: "Bajcetic's Celta Vigo homecoming remains done bar the signature", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Two fit senior centre-backs: Konate gone, Leoni on ACL rehab, Gomez out around a month", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's 99th-minute penalty rescues Iraola's opener", time: "4d ago", category: "major" },
];
