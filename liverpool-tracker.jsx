...
const LATEST_NEWS = [
  { source: "TeamTalk", title: "Liverpool launch a £102.6m opening bid for Bradley Barcola after agreeing personal terms with the PSG winger", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Liverpool waiting on PSG's answer for Barcola after his terms are settled, with Paris holding out near £148m", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Akliouche informs Liverpool of his decision as he steers toward PSG, thinning the winger board behind Barcola", time: "today", category: "major" },
  { source: "Goal", title: "Besiktas finishing the paperwork on Salah as an announcement is expected within days", time: "today", category: "major" },
  { source: "FootballTransfers", title: "Adali confirms Salah agreement as an agent commission demand becomes the last snag", time: "today", category: "fan" },
  { source: "ESPN", title: "Preview: Liverpool meet Wrexham at Yankee Stadium, a homecoming ground for Andoni Iraola", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Team news: Gomez unlikely and Jacquet rested as Iraola fields another makeshift back line vs Wrexham", time: "today", category: "major" },
  { source: "Football Insider", title: "Trey Nyoni 'could be a real asset' as remarkable stats emerge from the 4-2 win over Sunderland", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Van Dijk set to make his pre-season bow in the Anfield friendly against Monaco on August 9", time: "today", category: "fan" },
  ...
  { source: "This Is Anfield", title: "Isak, Wirtz and Gravenberch to be eased in, 'fully with us' only in the second week of the tour", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Iraola makes winning start: Liverpool beat Sunderland 4-2 in Nashville with four scorers", time: "3d ago", category: "major" },
