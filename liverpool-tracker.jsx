...
const LATEST_NEWS = [
  { source: "TeamTalk", title: "Salah rules out Europe: deal in principle with the Saudi Pro League as Jeddah's two-hour flight to Cairo tips the decision", time: "today", category: "major" },
  { source: "ESPN", title: "Spain 2-1 Belgium: Merino's 88th-minute rebound sends Munoz into a World Cup semi-final against Konate's France", time: "today", category: "fan" },
  { source: "Football365", title: "PSG's Barcola floor drops to €135m (£116m) as Akliouche personal terms open the exit and Arsenal turn to Rogers", time: "today", category: "major" },
  { source: "GiveMeSport", title: "The Elliott sacrifice: Liverpool willing to send Harvey Elliott to Palace to cut £35-40m off the £70m Adam Wharton ask", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Confirmed: Andoni Iraola's first Liverpool press conference is 11am Monday, with testing from Tuesday", time: "today", category: "official" },
  { source: "Sky Sports", title: "Mac Allister and Argentina meet Switzerland in Kansas City tonight, the last Red still playing", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Four-man winger shortlist emerges: Minteh (now nearer £80m), Koln's Said El Mala and Lille's Matias Fernandez-Pardo", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Inter have had two bids for Curtis Jones rejected, the last around £21.7m, with Liverpool valuing him near £40m", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Chiesa digs in: 'I'll go on the tour, then talk to the club and Iraola' as Juventus circle again", time: "1d ago", category: "fan" },
  { source: "Anfield Watch", title: "Michael Edwards 'done waiting': Liverpool extremely keen on Monaco's Lamine Camara with Newcastle in the same room", time: "2d ago", category: "major" },
  { source: "DaveOCKOP", title: "Iraola includes a 15-year-old in early pre-season sessions and joins the U21s with Richard Hughes watching", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Three-stop US tour set: Sunderland in Nashville (Jul 25), Wrexham in New York (Jul 30), Leeds in Chicago (Aug 2)", time: "2d ago", category: "official" },
  { source: "Empire of the Kop", title: "Arsenal close on an 'agreement in principle' with Morgan Rogers, boosting Liverpool's chances of a Barcola swoop", time: "2d ago", category: "fan" },
  { source: "Football365", title: "Mainz hold their €50-60m line on Kaishu Sano as Liverpool stay ahead of United and Arsenal for the Japan No. 6", time: "3d ago", category: "major" },
  { source: "Goal", title: "Still no ink on Germany: Klopp's move waits only on his Red Bull release after Nagelsmann's exit", time: "4d ago", category: "major" },
];
