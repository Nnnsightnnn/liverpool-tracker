...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "FSG reach agreement with Bezos-led consortium: £4.4bn stake deal 'imminent'", time: "today", category: "major" },
  { source: "Sky Sports", title: "Jeff Bezos and Amit Bhatia close in on a strategic minority stake as FSG prepare an announcement", time: "today", category: "major" },
  { source: "Al Jazeera", title: "Bezos, Bhatia and Saverin near a one-third Liverpool stake in a 'path to control' deal", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Official: Ronald Araujo signs on loan, takes the No. 33 and eyes the title beside Van Dijk", time: "today", category: "official" },
  { source: "Sky Sports", title: "Barcola deal 'difficult' as PSG hold near €150m and Liverpool weigh alternatives", time: "today", category: "major" },
  { source: "TeamTalk", title: "Liverpool line up Bournemouth's Rayan as a £130m Barcola alternative", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool 'leading the race' for Ibrahim Mbaye as Mendes talks accelerate", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Inter reach a 'breakthrough' in Curtis Jones talks as a €35m offer nears Liverpool's valuation", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Iraola: Gomez to miss the Newcastle opener, in a race for Forest on August 29", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Leoni enters the final stage of his ACL rehab, back in team training within weeks", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Szoboszlai the favourite for the vice-captaincy after signing on to 2031", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Cody Gakpo not for sale: Liverpool shut the door on Tottenham's interest", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 2-3 Monaco: Reds throw away a two-goal lead on Iraola's Anfield bow", time: "2d ago", category: "major" },
  { source: "Liverpool FC", title: "Como close the pre-season at Anfield on August 16 before the Newcastle opener", time: "3d ago", category: "official" },
  { source: "Daily Sabah", title: "Salah settles at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "5d ago", category: "major" },
];
