...
const LATEST_NEWS = [
  { source: "Liverpool FC / Liverpool.com / This Is Anfield", title: "UNVEILED 9am BST: adidas 2026-27 home kit drops today, inspired by the iconic 1989-90 title-winning shirt — geometric pattern returns, deep-red shorts and socks, paired with a green 'LFC heritage' goalkeeper kit; available now in-store, online and via the LFC Store app (announcement Tue May 19 morning)", time: "today", category: "official" },
  { source: "Sky Sports / ESPN / GiveMeSport", title: "Bournemouth vs Man City TONIGHT (18:30 UK) is referendum night for Liverpool's top-five fate — if Pep's side win at Vitality, Bournemouth (61) drop further off the pace and Slot's Reds (65) all but seal Champions League BEFORE kicking off the Brentford finale Sunday", time: "today", category: "major" },
  { source: "SportBible / This Is Anfield", title: "Wayne Rooney tells Slot to DROP Mo Salah for the Anfield farewell — 'I'd be putting him on the bench' — the ex-Manchester United captain's startling Sunday line aired into Tuesday's news cycle as the rebellion-management storyline keeps churning", time: "today", category: "fan" },
  { source: "This Is Anfield / Caught Offside / Football FanCast", title: "Andoni Iraola firms up as Liverpool's leading external Slot-replacement candidate after the Alonso-to-Chelsea deal — Richard Hughes's Bournemouth-era ally tops every Tuesday-morning shortlist; his contract expires this summer", time: "today", category: "major" },
  { source: "Liverpool.com / Per Second News", title: "Slot under siege on TWO fronts as Tuesday morning's wires lead with 'crumbling Liverpool' — FSG still publicly silent in 96 hours, dressing room now 17-strong behind Salah's post per Caught Offside; Brentford has become referendum-night-the-sequel", time: "today", category: "major" },
  { source: "Liverpool FC / Liverpool.com", title: "Pre-Brentford fitness tracker (Tue): Alisson, Isak and Frimpong all stepping up training — Liverpool.com still has Slot 'hopeful' on all three for the Sun May 24 finale; team news doesn't firm up until Friday's presser, but the trio remain in light work as of this morning", time: "today", category: "official" },
  { source: "Al Jazeera / ITV / Euronews / Liverpool.com", title: "CONFIRMED Sunday: Chelsea appoint Xabi Alonso as new manager on a four-year deal starting July 1 — ex-Real Madrid boss snubs a 'wait for Liverpool' play, ends FSG's most-discussed Plan B and leaves the replacement market suddenly thin", time: "2d ago", category: "major" },
  { source: "Caught Offside / SI / beIN Sports", title: "17 past and present Liverpool players have now liked Salah's anti-Slot post — Konaté, Wirtz and Gakpo joined the original SportBible nine on Monday; SI labels it 'a brutal swipe' that pits players, fans and legends against each other", time: "1d ago", category: "fan" },
  { source: "TNT Sports / This Is Anfield / Tribuna", title: "Steven Gerrard's 'damning' verdict on Slot: 'Identity's gone' — the Liverpool icon's TNT Sports intervention is the line punditry coalesced around through Monday's back pages; consensus on Slot has narrowed sharply across 96 hours", time: "1d ago", category: "major" },
  { source: "Liverpool.com / Goal.com", title: "Salah takes 'another swipe' at Slot in second social-media post — beIN Sports' Sunday-night carry has the Egyptian doubling down on Saturday's bombshell; the manager-vs-talisman frame for Sunday's farewell is hardening by the hour", time: "1d ago", category: "major" },
  { source: "Sky Sports / NBC Sports / ESPN", title: "Aston Villa 4-2 Liverpool: Watkins brace, Rogers and McGinn fire Emery's side to Champions League as Slot's team ripped apart — Van Dijk's two headers (52', 90+) the lone reply on a night that dropped the Reds to 5th", time: "4d ago", category: "major" },
  { source: "Liverpool FC / NBC Sports / Yahoo", title: "Slot post-match Villa Park: 'damaging — three out of four from set pieces' — manager again insists 'I have every reason to believe I am the Liverpool manager next season,' a line that has not aged well over the weekend", time: "4d ago", category: "official" },
  ...
  { source: "Liverpool.com", title: "Ibrahima Konaté contract 'stalemate' with Liverpool — signing-on package and agent commissions the sticking points, Real Madrid still circling as the Frenchman is exposed by Villa's set-piece play on Friday", time: "6d ago", category: "major" },
  { source: "Liverpool FC", title: "Anfield mosaics confirmed for Sunday: Kop leads Salah tribute, lower Kenny Dalglish Stand honours Andy Robertson before kick-off vs Brentford — joint farewell for nine-year servants on what becomes a must-win for the Champions League", time: "1w ago", category: "official" },
];
