...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Five talking points: Wirtz and Isak shine but Monaco defeat lays Liverpool's depth bare", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 2-3 Monaco: Reds throw away a two-goal lead as Iraola is beaten on his Anfield bow", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Ifeanyi Ndukwe stars at centre-back, but a work permit keeps him out of competitive games until January", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola reaction: 'We have to manage the game better' after Monaco turn it late", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Liverpool lodge a first formal £98.5m bid for Barcola as PSG hold out near €150m", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Ibrahim Mbaye prioritises Anfield as Liverpool ready an official approach for the PSG teenager", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Cody Gakpo not for sale: Liverpool shut the door on Tottenham's interest", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Ronald Araujo completes his medical as the season-long loan from Barcelona is finalised", time: "1d ago", category: "major" },
  { source: "Football Insider", title: "Curtis Jones edges toward Inter as the Italians ready a fresh offer near £30m", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Injury latest: Gomez eyes September, Bradley to miss the opener, Leoni nears a return to training", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Hughes plots a Paris double as a combined Barcola-Mbaye package nears €200m", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Como close the pre-season at Anfield on August 16 before the Newcastle opener", time: "2d ago", category: "official" },
  { source: "Daily Sabah", title: "Salah settles at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "4d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool 2-4 Leeds: Iraola's side collapse from two up in the Chicago tour finale", time: "1w ago", category: "major" },
];
