...
const LATEST_NEWS = [
  { source: "Football Today / TeamTalk", title: "Konaté set to leave for nothing as contract talks collapse over trophy-bonus clauses — Real Madrid pull out over an 'alarming dip in form'", time: "today", category: "major" },
  { source: "TeamTalk / Liverpool World", title: "Hughes wants TWO centre-backs after the Konaté blow — Maxence Lacroix, Jan Paul van Hecke and Sporting's Ousmane Diomande the names on the board", time: "today", category: "major" },
  { source: "Sky Sports / The Hard Tackle", title: "Andoni Iraola 'interested' in Liverpool as AC Milan talks stall — the Bournemouth boss who just reached Europe keeps his name warm at Anfield", time: "today", category: "major" },
  { source: "Fabrizio Romano / Empire Of The Kop", title: "'Here we go': Andy Robertson agrees free transfer to De Zerbi's Tottenham — a late Juventus hijack attempt rebuffed after nine years at Anfield", time: "1d ago", category: "major" },
  { source: "This Is Anfield / Caught Offside", title: "Yan Diomande the priority to replace Salah — but an £86m clause, a reluctant Leipzig and a CAS agency dispute all stand in the way", time: "1d ago", category: "major" },
  { source: "AOL / Football Transfers", title: "If not Diomande: Bradley Barcola gettable only if the Ivorian arrives, with Newcastle's Anthony Gordon the homegrown fallback", time: "1d ago", category: "major" },
  { source: "The National / Goal", title: "Salah's next chapter: Al-Ittihad still lead, but MLS side San Diego FC hold family appeal and Fenerbahce linger at ~€13m a year", time: "1d ago", category: "fan" },
  { source: "Sky Germany / Fabrizio Romano", title: "Samuel Martinez a 'done deal' — 17-year-old Colombian flying in for a medical and a five-year contract, academy first", time: "2d ago", category: "official" },
  { source: "Liverpool.com / Sky Sports", title: "The Brexit wall holds: 16-year-old Kennet Eichhorn cannot officially sign until July 2027 — Liverpool may only agree a pre-contract this summer", time: "2d ago", category: "major" },
  { source: "Sky Sport Italia / Get Italian Football News", title: "Curtis Jones the live sale beneath it all — Inter keen around €20m, Liverpool value the Anfield-born midfielder at €30m", time: "2d ago", category: "major" },
  { source: "Sky Sports / Liverpool.com", title: "Alisson now expected to stay — Juventus's hand weakened by missing the Champions League; Mamardashvili likeliest to go out on loan", time: "2d ago", category: "fan" },
  ...
  { source: "This Is Anfield / Football365", title: "Mac Allister contract stand-off holds — no talks opened, Real Madrid live, Liverpool's internal valuation pitched at €120m if July passes", time: "3d ago", category: "major" },
  { source: "Sky Sports / ESPN", title: "Liverpool 1-1 Brentford: Curtis Jones turns in a Mohamed Salah cross before Kevin Schade levels — the Champions League place sealed amid the long farewell", time: "5d ago", category: "major" },
];
