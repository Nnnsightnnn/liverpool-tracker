...
const PLAYERS = [
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 33, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.1, status: "fit", injuryNote: "Sun May 24 — matchday: has shaken off the after-effects of the stomach infection that limited him at Villa Park and features in the matchday predicted XIs, tipped to start wide-left in Slot's 4-2-3-1 for the Brentford finale. An awkward, injury-disrupted first season at Liverpool ends with a run-out at Anfield", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p494595.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sun May 24 — matchday: in line for the Brentford matchday squad but tipped for the bench, with Isak's expected return pushing the 17-year-old toward a rotation role. Led the line at Villa Park and remains one of Slot's brightest young finds in a difficult season", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
  { id: 26, name: "Federico Chiesa", number: 14, position: "FWD", nationality: "🇮🇹 Italy", age: 28, appearances: 12, goals: 1, assists: 1, cleanSheets: null, xG: 1.5, tacklesPer90: 0.6, passCompletion: 80, progressiveCarries: 2.2, form: 6.0, status: "fit", injuryNote: "Sun May 24 — matchday: a rotation winger option only and likely among the substitutes for the Brentford finale, an unused sub in the 4-2 Villa Park defeat. Anfield Watch's summer clear-out list still has the Italian likely to exit; Sunday could be a last Anfield outing", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p230621.png" },

  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Sun May 24 — matchday: third-choice goalkeeper for the Brentford finale behind Mamardashvili, with Alisson back and tipped to start. Two Premier League starts this season (Crystal Palace and Old Trafford); serviceable cover only", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
];
