...
const LATEST_NEWS = [
  { source: "TNT Sports", title: "Szoboszlai to Gerrard: 'it has to change' - the intensity Liverpool missed, and why 'no one can stop us' if it returns", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Watch: Iraola's pre-Atletico Madrid press conference streams live at 1pm BST on Tuesday", time: "today", category: "official" },
  { source: "Yahoo Sports", title: "Barcola and Gravenberch to start: the predicted Liverpool 4-2-3-1 for Iraola's first Champions League night", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Atletico Madrid must be the night Anfield truly embraces Andoni Iraola", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Andoni Iraola 'officially under serious pressure' three games into Liverpool with Hughes gone", time: "today", category: "major" },
  { source: "El Gol Digital", title: "Alvarez scores a golazo in training and stays for extra running, two days from Anfield", time: "today", category: "major" },
  { source: "Football365", title: "Liverpool 8/11 to beat Atletico: prediction, team news, lineups and the 3-2 they won here last season", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Team news: Sorloth out injured and Ortiz suspended, Atletico travel two attackers short to Anfield", time: "today", category: "fan" },
  { source: "Rush The Kop", title: "Liverpool vs Atletico Madrid referee confirmed: UEFA appoint an Italian for the Anfield opener", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Iraola injury update: Ekitike 'will go later', Bradley in training after the break, Gomez a doubt for Wednesday", time: "today", category: "fan" },
  { source: "VAVEL", title: "Isak at 0.89 expected goals per 90, and one goal in 13 Champions League games: the striker's two records", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Grace Fisk scores twice as Liverpool Women beat Charlton 4-0 in the WSL opener; Sam Kerr starts", time: "3d ago", category: "official" },
  { source: "AFP", title: "Athletic Bilbao 3-0 Atletico Madrid: Williams, Navarro and Sancet undo Simeone's side before Anfield", time: "3d ago", category: "major" },
];
