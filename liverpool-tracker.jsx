...
const PLAYERS = [
  ...
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 37, goals: 2, assists: 0, cleanSheets: 9, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 7.0, status: "fit", injuryNote: "Started Old Trafford defeat (Sun May 3, L 3-2) alongside VVD — caught out by United's quick start (Cunha 6', Sesko 14'). Liverpool.com (Mon May 4) flagged him among players who took post-Palace family city-trips before the slow start; VVD pushed back on the criticism Tue May 5. Romano + ESPN (Apr 30): new Liverpool deal 'never been closer' — only length and bonuses outstanding", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 25, goals: 1, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 7.6, status: "fit", injuryNote: "Started at RB at Old Trafford (Sun May 3, L 3-2) — Goal.com 8/10, led the game in touches with over 100. Slot's Trent-redux RB experiment continues to thrive. Inter Milan still circling per Romano this week, 14 months left on deal", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 17, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.7, status: "injured", injuryNote: "Missed the 3-2 Old Trafford defeat (Sun May 3) with the groin strain picked up in Friday's training. Yahoo Sports (Sun): Slot confirmed pre-match the £130m forward 'wasn't ready' — even a minor groin tear is 1-2 weeks, putting Chelsea (May 9) on the doubt list and Aston Villa (A) May 17 the realistic comeback target", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "'We are not kids', 'It's a city trip': Virgil van Dijk rejects Liverpool 'days off' claim as captain defends Slot post-Old Trafford", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Virgil van Dijk defends Liverpool teammates amidst 'holiday' criticism following 3-2 United loss — calls season 'unacceptable' but backs manager", time: "today", category: "major" },
  { source: "This Is Anfield", title: "'It's on the manager': Jamie Carragher warns Liverpool's style is a choice, not a mistake — identity worry deepens after Old Trafford defeat", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "0 wins in 8 — Liverpool's damning away record against Premier League's top 10 (FotMob): 2 draws, 6 losses, 2.25 goals conceded per game", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Arne Slot 'confirms' Liverpool plans for new coaching staff in summer — Etienne Reijnen reunion 'beckons' as work-permit hurdle clears", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Marcos Senesi: Liverpool 'very interested' in free transfer — Slot eyes Feyenoord-era reunion ahead of Man Utd and Chelsea in CB race", time: "today", category: "fan" },
  { source: "Rousing The Kop", title: "What Liverpool staff now think about players going on holiday after Virgil van Dijk's 'city trip' comments — internal reaction reported", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool journalists question Arne Slot's 'mini breaks': 'Too much time off?' — beat writers query post-Palace travel ahead of slow Old Trafford start", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Arne Slot 'reviewing' Liverpool staff changes 'in the event of him staying' — wider reshuffle alongside Reijnen with FSG backing implicit", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Carragher worried for where Slot's Liverpool side are heading — Reds boss fumes at officiating decisions while pundit cites identity drift", time: "today", category: "major" },
  { source: "Sky Sports", title: "Man Utd 3-2 Liverpool recap: Mainoo's 77' winner ends Liverpool comeback — Cunha and Sesko's 14-minute opening still the key talking point", time: "2d ago", category: "major" },
  { source: "Goal.com", title: "Slot claims VAR has worked against Liverpool 'all season' after controversial Sesko goal in defeat at Manchester United — 'a recurring pattern'", time: "2d ago", category: "major" },
  { source: "TNT Sports", title: "Salah urges Liverpool to give Jordan Henderson 'the farewell he deserved' when Brentford visit Anfield May 24 — first return in red away kit since 2023", time: "3d ago", category: "fan" },
  { source: "TeamTalk", title: "Liverpool enter advanced talks for £70m Adam Wharton — Reds preempt Real Madrid as 22-year-old England midfielder eyes Champions League move", time: "3d ago", category: "major" },
  { source: "Liverpool.com", title: "Liverpool transfer news: Sam Beukema €28m bid lodged with Napoli, Daniel Svensson linked from Dortmund as defensive rebuild accelerates", time: "3d ago", category: "major" },
];
