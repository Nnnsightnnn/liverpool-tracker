...
const LATEST_NEWS = [
  { source: "FootballTransfers", title: "Arne Slot offers to resign as Liverpool manager — would step down on 'right terms'", time: "today", category: "major" },
  { source: "Football365", title: "Slot 'offers' to resign on one condition as FSG sack U-turn revealed after 'emergency summit'", time: "today", category: "major" },
  { source: "Sky Sports", title: "Van Dijk: Liverpool 'gave up' during 4-0 FA Cup defeat to Manchester City", time: "today", category: "major" },
  { source: "Anfield Index", title: "Arne Slot faces defining two weeks as pressure mounts at Liverpool", time: "today", category: "fan" },
  { source: "Liverpool FC Official", title: "Slot press conference: 'Reaction to Haaland's opener was not good enough'", time: "today", category: "official" },
  { source: "TeamTalk", title: "FSG bring forward Arne Slot 'review' as pressure hits all-time high after Etihad humiliation", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Jurgen Klopp 'waiting' for Liverpool return as pressure grows on Arne Slot", time: "1d ago", category: "fan" },
  { source: "Liverpool FC Official", title: "Away allocation increased to 2,376 for PSG quarter-final as Paris aligns with UEFA rules", time: "1d ago", category: "official" },
  { source: "UEFA.com", title: "Paris vs Liverpool Champions League preview: Where to watch, predicted line-ups, key men", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Alisson long-term injury confirmed: Out vs PSG, back 'towards end of season'", time: "3d ago", category: "fan" },
  { source: "This Is Anfield", title: "Frimpong injury nightmare: Subbed after 13 minutes for Netherlands vs Ecuador", time: "3d ago", category: "fan" },
  { source: "ESPN", title: "Transfer rumors: Liverpool eye Juventus winger Conceição as Salah replacement", time: "4d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool remain in contact with Yan Diomande's agents ahead of summer window", time: "4d ago", category: "major" },
