...
const PLAYERS = [
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 35, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.4, status: "fit", injuryNote: "Sat Aug 8 — expected to feature, and carrying the flank alone. Withdrawn against Leeds with what Iraola called overload rather than injury, Frimpong is set to play some part against Monaco, but the picture behind him has not improved: with Bradley still weeks from his knee and Gomez out into September, the Dutchman is effectively the only fit senior right-back before Newcastle, an academy full-back the sole cover. It is why Tottenham's Djed Spence has surfaced as an option around £35m. Fit, if managed, and badly short of competition", image: "https://r2.thesportsdb.com/images/media/player/cutout/ehf7fi1757088020.png" },
  ...
  { id: 28, name: "Victor Munoz", number: 21, position: "FWD", nationality: "🇪🇸 Spain", age: 22, appearances: 0, goals: 0, assists: 0, cleanSheets: null, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "fit", injuryNote: "Sat Aug 8 — home early, and in line to debut. The £34.7m winger and newly crowned World Cup champion with Spain cut short his post-tournament break to report to the AXA Centre this week, and is set for his first Liverpool minutes when Monaco visit Anfield on Sunday. The window's first and so far only signing, in since June on a six-year deal to 2032 after Liverpool met the €40m release clause at Osasuna, he gives Iraola an early look on a right flank left thin by Salah's exit. Seven goals and five assists in LaLiga last season at 22. The stats below are his Liverpool record, which is why they are empty", image: "https://img.a.transfermarkt.technology/portrait/big/935231-1747037145.jpg" },
];
...
const LATEST_NEWS = [
  { source: "Fabrizio Romano", title: "Here we go: Liverpool agree a season-long loan for Barcelona's Ronald Araujo, €55m option to buy", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Araujo travels for his medical as Liverpool agree a £47.1m buy clause on the Barcelona defender", time: "today", category: "official" },
  { source: "Anfield Index", title: "Reports: Liverpool and PSG close on the frame of a €128m Barcola deal, but Romano cools the 'done' talk", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola's first Anfield afternoon: Monaco visit Sunday with Victor Munoz in line to make his debut", time: "today", category: "official" },
  { source: "Football Insider", title: "Curtis Jones sets his sights on Inter as the Italians return with an offer near £30m", time: "today", category: "fan" },
  ...
  { source: "Liverpool.com", title: "Jeremy Jacquet a doubt on the eve of Monaco, still not training with a lingering shoulder issue", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Araujo's arrival cools Liverpool's long chase of Marc Guehi and the late Zabarnyi flirtation", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Joe Gomez to miss the Newcastle opener as the muscle injury runs into September", time: "1d ago", category: "fan" },
  { source: "ESPN", title: "Van Dijk, Alisson and Wirtz all in line for more minutes as Iraola's home stand begins", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 2-4 Leeds: Iraola's side collapse from two up as all four goals come from substitutes", time: "6d ago", category: "major" },
  { source: "Daily Sabah", title: "Salah settles at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "2d ago", category: "major" },
  ...
  { source: "This Is Anfield", title: "Como to follow Monaco on August 16 as Liverpool's final Anfield tune-up before the league begins", time: "2d ago", category: "fan" },
];
