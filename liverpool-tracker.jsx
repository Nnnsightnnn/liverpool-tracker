...
const PLAYERS = [
  ...
  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 35, appearances: 43, goals: 6, assists: 1, cleanSheets: 11, xG: 3.2, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Tue Aug 4 — the spine the rebuild is being built around, not sold from under. Back from his post-World Cup break and pointing to first minutes in the Anfield friendlies against Monaco on August 9 and Como on the 16th, Van Dijk is the fit senior the Chicago second half sorely missed. Milan's interest, driven by Ibrahimovic, keeps being knocked back with no bid received. With Gomez out for weeks and Iraola's non-negotiable centre-back now chased in Crystal Palace's Marc Guehi (per the BBC) with Milan's Tomori the cheaper alternative, the club are reinforcing a thin defence around him", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "injured", outSince: "2026-07-25", injuryNote: "Thu Aug 6 — a month, give or take, and the opener already gone. Iraola has put a rough timeline on the muscle injury Gomez took inside eight minutes at Sunderland, 'normally I always put myself as one month,' which reads as most of September lost and the August 23 trip to Newcastle missed. With Leoni still on his ACL and Van Dijk only now back from a World Cup break, losing the longest-serving defender into the campaign leaves Liverpool perilously light at centre-back, which is why they weigh a Zabarnyi offer alongside the long Guehi chase and Milan's Tomori in reserve. A genuine cover loss to absorb, not a sale to chase", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 35, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.4, status: "fit", injuryNote: "Thu Aug 6 — the lone fit right-back, carrying a flank alone. Withdrawn against Leeds with what Iraola called overload rather than injury, Frimpong is expected available for Monaco, but the picture behind him has not improved: with Bradley still weeks from his knee and Gomez now given about a month, the Dutchman is effectively the only fit senior right-back before Newcastle, an academy full-back the sole cover. It is why a Zabarnyi offer and a possible Kounde swing keep the defensive files live. Fit, if managed, and badly short of competition", image: "https://r2.thesportsdb.com/images/media/player/cutout/ehf7fi1757088020.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 33, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.1, status: "fit", injuryNote: "Mon Aug 3 — a goal in Chicago, and the role that fits. Wirtz scored in the 2-4 defeat to Leeds, curling home the second in a first half that showcased exactly why Iraola sees him behind the striker as a No. 10, the central berth Liverpool paid £115m for. He shared barely 117 minutes on the pitch with Isak and Ekitike across an injury-disrupted first year; a clean block of work, in his best position, is the reset, and this was its brightest evidence yet", image: "https://r2.thesportsdb.com/images/media/player/cutout/8t6bzo1757088899.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Tue Aug 4 — warming to an idea the club has not entertained. Gakpo and his camp are reported to have held positive talks with Tottenham and he is said to be open to the move, though Liverpool are yet to receive a bid and do not plan to sell a forward central to Iraola's front line. It would take a figure well beyond £60m to shift the stance, and with Salah's flank vacant the manager wants him tested on the left through the Anfield friendlies. Nine goals and six assists in 39 appearances last season. Only an offer the club consider unignorable changes it", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Mon Aug 3 — the wait over, the sharpness to come. Isak took his first pre-season minutes in the 2-4 loss to Leeds, lining up with Wirtz and Gravenberch for the first time after watching Nashville and the Bronx since reporting late from the World Cup. An injury-wrecked debut season limited him to a handful of starts, and a clean run under a new coach is the reset the whole front line needs; the first-half fluency was the argument, the second-half collapse someone else's", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
...
const LATEST_NEWS = [
  { source: "CBS Sports", title: "Salah passes Trabzonspor medical and is unveiled tonight on a two-year deal, ending nine years at Anfield", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Illia Zabarnyi offered to Liverpool as Iraola eyes a Bournemouth reunion and a possible double raid on PSG", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Barcola fee holds at PSG's £145m wall as Liverpool monitor PSG teenager Ibrahim Mbaye as a cheaper wide option", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "'About a month': Iraola puts a timeline on Joe Gomez's muscle injury as the right-back cupboard stays bare", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Manchester City reach full verbal agreement for Lille's Ayyoub Bouaddi as Liverpool step back", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Szoboszlai front-runner for the vacant vice-captaincy after the Wrexham armband flashpoint", time: "today", category: "fan" },
  { source: "Goal", title: "Inter come to £30m for Curtis Jones as Chivu is reported to picture him as a wide option", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Tottenham ready a fresh push for Cody Gakpo, but only a 'huge' fee north of £60m moves Liverpool", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Monaco visit Anfield on Sunday for Iraola's first home dugout, a 2.30pm kick-off 21 years on", time: "1d ago", category: "official" },
  { source: "Anfield Watch", title: "World Cup winner Victor Munoz to report early as Liverpool's senior spine reassembles", time: "1d ago", category: "major" },
  { source: "Newcastle United", title: "Newcastle away on August 23 opens the season, with tributes set for Kevin Keegan at St James' Park", time: "2d ago", category: "major" },
  { source: "GiveMeSport", title: "Liverpool hold Fikayo Tomori as the cheaper centre-back route behind Guehi after initial Milan contact", time: "2d ago", category: "fan" },
  { source: "TeamTalk", title: "Liverpool lead the race for Mainz's Kaishu Sano as the pricier Wharton pursuit cools", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Van Dijk and Alisson back in training as the senior spine reassembles for the Anfield friendlies", time: "3d ago", category: "official" },
];
