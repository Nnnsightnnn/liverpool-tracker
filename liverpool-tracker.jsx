...
const LATEST_NEWS = [
  { source: "Opta Analyst", title: "Anfield's first European night under Iraola: Liverpool have never lost a home Champions League opener, but the manager is winless in four against Simeone", time: "today", category: "fan" },
  { source: "SI", title: "Predicted Liverpool XI vs Atletico: Barcola in for a first start, Isak leading a Champions League line without Salah for the first time since 2014-15", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola before his first Champions League match: 'a special night', and a call for players who will run 55 minutes and be 'dead'", time: "today", category: "official" },
  { source: "Opta Analyst", title: "Supercomputer makes Liverpool 53% favourites for the opener; each of the last three home European openers has finished 3-2", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Simeone's Alvarez call splits the previews: the manager says the £81m striker will not start, SI's matchday XI recalls him beside Baena", time: "today", category: "major" },
  { source: "Anfield Watch", title: "Iraola 'under serious pressure' three games in, with Hughes gone to Al-Hilal and a new sporting director still to be convinced", time: "today", category: "fan" },
  { source: "Liverpool Echo", title: "Gakpo shifted to the right in the matchday previews after Tuesday's tightness, with Barcola set to start on the left", time: "today", category: "major" },
  { source: "Opta Analyst", title: "Marcos Llorente returns to Anfield, where he has four goals in two visits, more than at any ground bar the Metropolitano", time: "today", category: "fan" },
  { source: "Al Jazeera", title: "Atletico arrive off a 3-0 collapse at Bilbao, conceding twice inside three minutes of the second half for the first time in La Liga", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Endo and Chiesa left off the Champions League 25; Ekitike, Bradley and Leoni still out, Gomez back in full training", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Salah's Trabzonspor without a manager after the Tekke exit and chasing Richarlison before Friday's Turkish deadline", time: "1d ago", category: "fan" },
  { source: "Goal", title: "Turkish Airlines confirmed as Liverpool's shirt sponsor from 2027-28, closing out Standard Chartered's 17-year run", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Mac Allister plays on for a contract Liverpool have not offered, two years still to run on his 2023 deal", time: "1d ago", category: "major" },
  { source: "Rush The Kop", title: "One suspended, two ineligible, six injured: the full Liverpool and Atletico absentee list for the opener", time: "1d ago", category: "fan" },
];
