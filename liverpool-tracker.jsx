...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Liverpool complete £123m signing of Bradley Barcola from PSG: five-year deal, No. 29, announced Monday afternoon", time: "today", category: "official" },
  { source: "David Ornstein", title: "Gakpo saga over: Liverpool reject Manchester City's £75m plus £5m and call off the sale, the Dutchman stays", time: "today", category: "major" },
  { source: "TeamTalk", title: "Why the sale died: Crystal Palace never intended to sell Sarr, Brighton never came off £70m for Minteh", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "Here we go: Liverpool agree €5m deal for Saint-Etienne's Djylian N'Guessan, loaned back until summer 2027", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "Agreement and medical green light for Genk goalkeeper Lucca Brughmans, another 2027 arrival", time: "today", category: "major" },
  { source: "DaveOCKOP", title: "Celtic's Dara Jikiemi, 16, confirms his Liverpool move himself as the club announcement is prepared", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Harvey Elliott flies to Spain for Valencia medical: season-long loan with no option to buy before June", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Barcola's first interview: Anfield and Iraola made it easy, and the No. 29 came from playing FIFA as a boy", time: "today", category: "official" },
  { source: "TeamTalk", title: "Carragher tells FSG to move Endo on and responds to Van Dijk's public appeal over Gakpo", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Supporters back the decision to keep Gakpo while calling the window itself farcical", time: "today", category: "fan" },
  ...
  { source: "Rousing The Kop", title: "Mamardashvili's Anfield career looks over either way as Alisson stays and a loan exit is pursued", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Ipswich away on Friday: Gary O'Neil without Matusiwa, Taylor and Philogene-Bidace after a 5-2 at Old Trafford", time: "1d ago", category: "official" },
