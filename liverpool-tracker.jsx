...
const LATEST_NEWS = [
  { source: "Liverpool.com / Sportbible", title: "Brexit wall: Liverpool blocked from completing the Kennet Eichhorn deal this summer — the 16-year-old can only sign a pre-contract until he turns 18 in July 2027", time: "today", category: "major" },
  { source: "Fabrizio Romano / TEAMtalk", title: "'Here we go' — Liverpool reach full agreement for 17-year-old Colombian Samuel Martinez on a five-year deal from Atletico Nacional, with the move triggered when he turns 18", time: "today", category: "official" },
  { source: "Liverpool.com / Goal.com", title: "Alisson stays: Liverpool tell the goalkeeper 'we want you to stay, we want you to be our goalkeeper, we believe in you' as Comolli's €5m Juventus offer falls short of the €20m asking price", time: "today", category: "major" },
  { source: "TEAMtalk / Live4Liverpool", title: "Liverpool eye £73.5m move for Porto's Victor Froholdt — the Danish midfielder's release clause draws a transfer battle with Arsenal and Newcastle", time: "today", category: "major" },
  { source: "Liverpool.com / Football365", title: "Salah replacement domino: with Diomande coy at Leipzig, PSG's Bradley Barcola emerges as the alternative — Romano flags 'genuine interest' from Arsenal as well", time: "today", category: "major" },
  { source: "Anfield Index / Anfield Watch", title: "Edwards-Hughes split: FSG executives reported divided over Arne Slot's future as the end-of-season review formally opens, with Andoni Iraola still kept warm", time: "today", category: "fan" },
  { source: "Sky Sports / TEAMtalk", title: "Inter Milan in pole position for Curtis Jones — a £35m switch mooted, contract talks at Anfield shelved as the Anfield-born midfielder weighs Serie A", time: "1d ago", category: "major" },
  { source: "Anfield Watch / The Hard Tackle", title: "Juventus late move for Andy Robertson rebuffed: the Scotland captain's free transfer to Tottenham, under De Zerbi, stands — paperwork only now", time: "1d ago", category: "major" },
  { source: "Liverpool FC / SI", title: "Pre-season tour confirmed: Sunderland at Nashville's Geodis Park on July 25, Wrexham at Yankee Stadium on July 29, Leeds at Soldier Field on August 2", time: "1d ago", category: "official" },
  { source: "Goal / Liverpool.com", title: "Konaté drifts toward yes: the Frenchman wants the question settled before the World Cup, with Real Madrid having cooled their two-year pursuit", time: "1d ago", category: "major" },
  { source: "Liverpool FC / This Is Anfield", title: "Adidas 1989-90 throwback: Liverpool's new 2026-27 home kit, unveiled May 19, made its match debut at Anfield in Sunday's Brentford finale", time: "2d ago", category: "official" },
  { source: "Goal.com / beIN Sports", title: "Salah's parting speech to the dressing room surfaces from Sunday morning at Kirkby — the Egyptian's next club, with Al-Ittihad cast as favourite, expected within days", time: "2d ago", category: "major" },
  { source: "Sky Sports / ESPN", title: "Liverpool 1-1 Brentford: Curtis Jones turns in a Mohamed Salah cross before Kevin Schade levels — the Champions League place sealed amid the long farewell", time: "3d ago", category: "major" },
  { source: "This Is Anfield", title: "Etienne Reijnen, Slot's Feyenoord set-piece coach, to be confirmed shortly — UK work-permit issue now resolved, replacing Aaron Briggs in the backroom rebuild", time: "3d ago", category: "fan" },
  { source: "Anfield Index / The Anfield Wrap", title: "Post-mortem: a title defence finished 25 points adrift, a defence that conceded 1.4 goals a game, and a front three that shared only 117 minutes on the pitch", time: "4d ago", category: "fan" },
];
