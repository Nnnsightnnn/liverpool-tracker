...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Man Utd 3-2 Liverpool: Kobbie Mainoo's 77' winner secures Champions League qualification after Premier League epic at Old Trafford", time: "today", category: "major" },
  { source: "Goal.com", title: "Slot claims VAR has worked against Liverpool 'all season' after controversial Sesko goal in defeat at Manchester United — 'a recurring pattern'", time: "today", category: "major" },
  { source: "BBC Sport", title: "Sir Alex Ferguson 'fine' after being taken to hospital pre-match — 84-year-old felt unwell in directors' box ahead of Liverpool clash", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Man United 3-2 Liverpool: 19th defeat despite initial comeback — Szoboszlai 8.5/10 standout, Frimpong and Robertson among the flops", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Arne Slot's VAR rant after Manchester United defeat: Sesko handball, PSG penalty, the 'complete pattern' against Liverpool this season", time: "today", category: "major" },
  { source: "ESPN", title: "Kobbie Mainoo lifts Manchester United past Liverpool 3-2 — Cunha and Sesko sink Reds early before Szoboszlai/Gakpo level", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "'Not a surprise anymore' — Slot reacts to VAR call vs Man United as Liverpool's frustration with officiating boils over post-match", time: "today", category: "fan" },
  { source: "TNT Sports", title: "Salah urges Liverpool to give Jordan Henderson 'the farewell he deserved' when Brentford visit Anfield May 24 — first return in red away kit since 2023", time: "2d ago", category: "fan" },
  { source: "TeamTalk", title: "Liverpool enter advanced talks for £70m Adam Wharton — Reds preempt Real Madrid as 22-year-old midfielder eyes Champions League move", time: "2d ago", category: "major" },
  { source: "CaughtOffside", title: "Liverpool in advanced talks to land Adam Wharton ahead of Real Madrid hijack — Moretto reports Crystal Palace negotiations accelerating", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Liverpool transfer news: Borussia Dortmund's Daniel Svensson linked as Andy Robertson's free-agent exit confirms LB rebuild for Hughes", time: "2d ago", category: "major" },
  { source: "FootballTransfers", title: "Why Liverpool will not sack Arne Slot: manager retains FSG backing despite difficult campaign with third season already 'earned'", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool transfer ticker: Sam Beukema £24m offer to Napoli, Daniel Svensson linked as left-back competition for Kerkez intensifies", time: "2d ago", category: "major" },
  { source: "Liverpool FC", title: "Injury updates: Alisson Becker 'very close' to training, Milos Kerkez back from niggle — Salah out for Manchester United trip", time: "3d ago", category: "official" },
  { source: "The Athletic", title: "Virgil van Dijk expected to leave Liverpool at end of 2026/27 season — reporting confirms next phase of post-Salah-era squad rebuild under Hughes", time: "4d ago", category: "major" },
];
