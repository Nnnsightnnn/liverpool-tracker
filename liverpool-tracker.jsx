...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "injured", injuryNote: "Hamstring — still not training with team; Slot (Apr 19) targets Man Utd (A) on May 2 for return, NOT the Crystal Palace fixture", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  { id: 2, name: "Giorgi Mamardashvili", number: 25, position: "GK", nationality: "🇬🇪 Georgia", age: 25, appearances: 16, goals: 0, assists: 0, cleanSheets: 4, xG: 0, tacklesPer90: 0, passCompletion: 76, progressiveCarries: 0.1, form: 6.8, status: "injured", injuryNote: "Head/facial wound from Beto-Robertson collision (59' vs Everton, Apr 19) — stretchered off to hospital; Slot says 'fear the worst for next week' — likely misses Crystal Palace (Apr 25)", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p449027.png" },
  ...
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 35, goals: 2, assists: 0, cleanSheets: 9, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 7.1, status: "fit", injuryNote: null, image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 18, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 6.0, status: "injured", injuryNote: "Muscle injury from PSG cameo (Apr 14) — missed Merseyside Derby; still sidelined for Crystal Palace week", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
...
const LATEST_NEWS = [
  { source: "Caught Offside", title: "Journo confirms Liverpool may have to pay more than €100m to sign Yan Diomande — Leipzig holding firm on Salah-replacement valuation", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Alisson sets targeted Man Utd (A) comeback date as Liverpool learn extent of Mamardashvili's knee injury — 2-4 weeks out", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Ibrahima Konaté all but confirms new deal: 'For sure there is a big chance I'm here next season' — U-turn after months of Real Madrid rumours", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Giorgi Mamardashvili faces 3 weeks out with deep knee wound — Freddie Woodman next in line for PL debut start vs Crystal Palace", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Anthony Gordon transfer update: Bayern Munich stance emerges after Newcastle absence — 'concrete talks' with Liverpool still live", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Alonso priority to replace Slot & 21-man squad named — LFC News roundup as manager debate reignites", time: "today", category: "fan" },
  { source: "Caught Offside", title: "'Concrete talks are ongoing' — Sky Sports journalist drops exciting Liverpool Diomande update as FSG give green light to transfer", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Virgil van Dijk scores 100th-minute winner as Liverpool beat Everton 2-1 in Merseyside derby at Hill Dickinson Stadium", time: "2d ago", category: "official" },
  { source: "Liverpool FC", title: "Mohamed Salah equals Steven Gerrard's record for most Premier League Merseyside derby goals (9) in his final-ever clash with Everton", time: "2d ago", category: "official" },
  { source: "ESPN", title: "Van Dijk hands Liverpool a UCL boost and reason to believe after more late drama at the Hill Dickinson", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Everton 1-2 Liverpool PLAYER RATINGS — Jones (8.4) the inverted RB standout as Liverpool climb 7 clear of Chelsea", time: "2d ago", category: "fan" },
  { source: "Sports Mole", title: "Liverpool target Sunderland midfielder Enzo Le Fée — €25m valuation, 4 goals and 5 assists in debut PL season", time: "2d ago", category: "major" },
  { source: "TEAMtalk", title: "Tier-1 source confirms FSG eyeing sensational £85m move for Yan Diomande as top Salah replacement target", time: "4d ago", category: "major" },
  ...
  { source: "Sky Sports", title: "Andy Robertson to leave Liverpool at end of season — Scotland captain confirms exit after 9 years, Tottenham frontrunners", time: "1w ago", category: "official" },
];
