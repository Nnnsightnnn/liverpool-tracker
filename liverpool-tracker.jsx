...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Virgil van Dijk scores 100th-minute winner as Liverpool beat Everton 2-1 in Merseyside derby at Hill Dickinson Stadium", time: "1d ago", category: "official" },
  { source: "Liverpool FC", title: "Mohamed Salah equals Steven Gerrard's record for most Premier League Merseyside derby goals (9) in his final-ever clash with Everton", time: "1d ago", category: "official" },
  { source: "Liverpool.com", title: "Arne Slot issues troubling Giorgi Mamardashvili injury update after derby — 'a big wound, he went straight to hospital, we fear the worst for next week'", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Freddie Woodman to start vs Crystal Palace after Mamardashvili injury — Alisson targeting Man Utd (A) return, not this weekend", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Freddie Woodman opens up on unexpected heroics: 'Amazing to make my PL debut in a Merseyside derby and win it like that'", time: "1d ago", category: "major" },
  { source: "ESPN", title: "Van Dijk hands Liverpool a UCL boost and reason to believe after more late drama at the Hill Dickinson", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Everton 1-2 Liverpool PLAYER RATINGS — Jones (8.4) the inverted RB standout as Liverpool climb 7 clear of Chelsea", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "How Mamardashvili's game-ending injury sums up Liverpool's hapless 2025-26 season — sixth senior goalkeeper blow", time: "1d ago", category: "fan" },
  { source: "Anfield Index", title: "PSG open talks with Yan Diomande's representatives — hijack bid complicates Liverpool's long-standing pursuit", time: "2d ago", category: "fan" },
  { source: "Caught Offside", title: "Liverpool actively pursuing Anthony Gordon at £80m — Bayern's parallel push could push Reds back towards Diomande", time: "2d ago", category: "fan" },
  { source: "TEAMtalk", title: "Tier-1 source confirms FSG eyeing sensational £85m move for Yan Diomande as top Salah replacement target", time: "3d ago", category: "major" },
  { source: "Caught Offside", title: "'Tension' at Liverpool as key board figures remain split over Arne Slot's future despite FSG's public backing", time: "3d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool transfer chiefs Richard Hughes and Michael Edwards confirmed to remain in post through summer window", time: "3d ago", category: "major" },
  { source: "ESPN", title: "Hugo Ekitike ruptures Achilles — ruled out of World Cup with France in devastating 9-month blow for Liverpool", time: "6d ago", category: "major" },
