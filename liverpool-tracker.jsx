...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "doubtful", outSince: "2026-07-25", injuryNote: "Thu Aug 27 — a month, in the manager's framing, and no Forest. Iraola set Gomez's muscle problem at around a month on Thursday, the honest reading now a Saturday miss rather than a late gamble, after the knock taken inside minutes at Sunderland on 25 July that also cost him the Newcastle draw. Liverpool.com still floats an outside chance, but the vice-captain is not expected to be risked for the home opener. With Leoni only nearing a September ACL return and Bradley short after knee surgery, the absence bites a thin back line hardest. The longest-serving defender is a cover boost to keep, not a sale, his Serie A links long since gone quiet", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 40, goals: 10, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 7.0, status: "fit", injuryNote: "Thu Aug 27 — days from Tottenham, and the sale that pays for the summer. Fabrizio Romano reports Gakpo's move to Spurs could be only days away at a fee around £72m, personal terms agreed in principle, the deal reportedly hinging on Barcola arriving first so the money can fund the incomings. Manchester City linger as an alternate suitor but Tottenham stay a step ahead. He opened the Iraola era on the scoresheet, dragging Liverpool level at Newcastle in the 55th, and is contracted to 2030, so nothing forces this beyond the accounting. Saturday's Forest visit may still be his stage, but perhaps his last in red", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Thu Aug 27 — a birthday, a new deal, and a flank in flux. Ngumoha was a bench option at Newcastle as Gakpo held the right and scored. This Is Anfield report a new five-year deal with a significant pay rise is set to follow when he turns 18 on August 29, the day Forest visit, the delay only a rule capping under-18s at three-year terms. With Gakpo's £72m Tottenham exit now days away and Barcola a medical from signing, the teenager's path to real minutes is opening rather than closing. Twenty-nine appearances last term and a goal against Newcastle a year ago; experience starts ahead of him, but not by as much as it did", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  { id: 26, name: "Federico Chiesa", number: 14, position: "FWD", nationality: "🇮🇹 Italy", age: 28, appearances: 12, goals: 1, assists: 1, cleanSheets: null, xG: 1.5, tacklesPer90: 0.6, passCompletion: 80, progressiveCarries: 2.2, form: 6.0, status: "doubtful", injuryNote: "Thu Aug 27 — touch and go, and no word from the chair. Iraola offered no fresh Chiesa update at his Thursday briefing, leaving the Italian genuinely touch and go for Saturday's home opener after the fitness issue that kept him out at Newcastle and off the training pitch earlier in the week. It complicates a summer spent weighing his future: he scored off the bench in Nashville and insisted his focus was Liverpool, yet he sits among the exits the club would sanction, and the knock shadows both his selection and his sale", image: "https://r2.thesportsdb.com/images/media/player/cutout/idecla1757087689.png" },
...
const LATEST_NEWS = [
  { source: "Football365", title: "Romano: Barcola deal 'done' in both clubs' eyes, a medical from 'here we go'", time: "today", category: "major" },
  { source: "Anfield Watch", title: "Gakpo to Tottenham 'days away' at around \u00a372m, the sale that funds the incomings", time: "today", category: "major" },
  { source: "FootballFanCast", title: "Ben Jacobs: Newcastle's final Fernandez-Pardo bid rejected, door left ajar for Liverpool", time: "today", category: "major" },
  { source: "UEFA", title: "Champions League draw, Monaco 5pm: Pot 1 Liverpool eye a Bernabeu trip and a Trent reunion", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Thursday 1.30pm: Iraola faces the press before his first home match with Forest", time: "today", category: "official" },
  { source: "Yahoo Sports", title: "Injury latest: Gomez ruled out for a month, Chiesa touch and go for the Anfield opener", time: "today", category: "major" },
  { source: "Sky Sports", title: "Wingers first: Liverpool hopeful of late business with the window shut on Tuesday", time: "today", category: "major" },
  { source: "This Is Anfield", title: "The Kop wills the Barcola medical over the line as the final week opens", time: "today", category: "fan" },
  { source: "Fabrizio Romano", title: "Celta Vigo and Bajcetic aligned on personal terms: a homecoming done bar the signature", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Alex Scott named the defensive-midfield target at a \u00a390m price Liverpool cannot pay", time: "1d ago", category: "major" },
  { source: "CaughtOffside", title: "Liverpool delegation in Colombia as Matias Orozco's \u20ac6m release clause is met", time: "2d ago", category: "major" },
  { source: "Liverpool.com", title: "Ekitike still out until December as the Achilles rupture keeps the striker sidelined", time: "2d ago", category: "major" },
  { source: "BBC Sport", title: "Forest arrive at Anfield pointless after Anton Stach's free-kick won it for Leeds", time: "4d ago", category: "major" },
  ...
  { source: "Empire of the Kop", title: "The sequencing is blunt: Gakpo's exit hinges on Barcola landing first", time: "today", category: "fan" },
];
