...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Arne Slot pre-Merseyside derby press conference: Ekitike yet to undergo surgery, Isak still not ready for full 90 minutes", time: "today", category: "official" },
  { source: "Caught Offside", title: "'Tension' at Liverpool as key board figures split over Arne Slot's future despite public FSG backing", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Liverpool transfer chiefs Richard Hughes and Michael Edwards confirmed to remain in place for summer window", time: "today", category: "major" },
  { source: "Caught Offside", title: "Anthony Gordon pushes to join boyhood club Liverpool — 25-year-old 'desperate' to return after Ekitike blow", time: "today", category: "fan" },
  { source: "TEAMtalk", title: "Arne Slot facing six-game audition to save Liverpool job — top-5 finish required, FSG end-of-season review planned", time: "today", category: "major" },
  { source: "This Is Anfield", title: "FSG 'intend' to stick with Arne Slot even without Champions League — four summer signings planned", time: "1d ago", category: "fan" },
  { source: "ESPN", title: "Hugo Ekitike ruptures Achilles — ruled out of World Cup with France in devastating 9-month blow for Liverpool", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Hugo Ekitike injury: Liverpool striker suffers 'serious' Achilles rupture — misses rest of season and World Cup", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Anthony Gordon 'would jump' at chance to join Liverpool — England winger £80m price tag as Ekitike replacement search starts", time: "1d ago", category: "major" },
  { source: "TEAMtalk", title: "Liverpool plot big-money Anthony Gordon bid after Hugo Ekitike injury forces major summer rethink", time: "1d ago", category: "major" },
  { source: "Anfield Watch", title: "Liverpool transfer news: Reds have confirmed 'dream forward' Michael Olise in mind to replace Mo Salah", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool's '7-man shortlist' for wingers — Yan Diomande leads list alongside Minteh and Conceição", time: "2d ago", category: "fan" },
  { source: "BBC Sport", title: "Liverpool 0-2 PSG (0-4 agg): Dembélé double ends Reds' Champions League campaign at Anfield", time: "3d ago", category: "major" },
