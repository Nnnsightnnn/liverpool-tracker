...
const PLAYERS = [
  ...
  { id: 8, name: "Conor Bradley", number: 12, position: "DEF", nationality: "🇬🇧 N. Ireland", age: 22, appearances: 16, goals: 0, assists: 2, cleanSheets: 4, xG: 0.8, tacklesPer90: 2.6, passCompletion: 84, progressiveCarries: 5.1, form: 7.3, status: "injured", injuryNote: "Tue Jul 14 — pre-season starts without him, and the horizon has moved the wrong way. Iraola named Bradley among the three long-term absentees at Monday's press conference, calling the set of them a 'difficult situation,' and fresh reporting now suggests the knee that gave way at Arsenal in January is worse than first thought, with a return possibly not arriving until 2027. That is a full calendar year of a 22-year-old right back's career. Frimpong holds the slot alone, and the market is being asked to cover a position Liverpool thought they had solved", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p492777.png" },
  ...
  // ── Midfielders ───────────────────────────────────────────────────────────
  { id: 13, name: "Alexis Mac Allister", number: 10, position: "MID", nationality: "🇦🇷 Argentina", age: 27, appearances: 41, goals: 2, assists: 4, cleanSheets: null, xG: 1.9, tacklesPer90: 1.9, passCompletion: 90, progressiveCarries: 1.4, form: 6.7, status: "fit", injuryNote: "Tue Jul 14 — still the last Red playing, and still nowhere near Kirkby. Argentina, the holders, meet England in Atlanta tomorrow, the midfielder having headed Messi's corner past Switzerland to put them there. Pre-season opened this morning without him. Should Argentina reach Sunday's final in New Jersey he will not report to Iraola until the American tour is well under way, which is a peculiar way to begin with a manager rebuilding a midfield around whoever is actually available", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243016.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 34, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Tue Jul 14 — signed, and waiting on a press release. The reporting has hardened from a deal in principle to a deal agreed: a Saudi Pro League destination is settled, the announcement is all that remains, and Europe is gone for good. Al-Ittihad and Al-Ahli in Jeddah remain the likeliest names, with Neom an outsider; Sporting Kansas City and San Diego kept an MLS bid alive to the end and lost it. A free agent since June 30, having chosen to leave a year early. Ten goals and ten assists in his final season, and no statue yet", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  ...
  { id: 24, name: "Hugo Ekitike", number: 22, position: "FWD", nationality: "🇫🇷 France", age: 23, appearances: 41, goals: 18, assists: 5, cleanSheets: null, xG: 14.2, tacklesPer90: 0.4, passCompletion: 78, progressiveCarries: 2.1, form: 7.3, status: "injured", injuryNote: "Tue Jul 14 — the club and the striker are no longer telling the same story. Ekitike has set his own sights on Boxing Day at Hull, and has been rehabbing in the United States without crutches, juggling and passing; Liverpool have now been warned his recovery from the Achilles ruptured against PSG in April could take 'longer than people expect,' and Iraola named him first among the three long-term absentees, a 'difficult situation' the squad has to be built around. He came back to the AXA this week for an assessment. April's scan said nine to twelve months. He is arguing with it", image: "https://r2.thesportsdb.com/images/media/player/cutout/8za47v1757087851.png" },
...
const LATEST_NEWS = [
  { source: "Read Liverpool FC", title: "'Difficult situation': Iraola confirms Ekitike, Bradley and Leoni are all long-term absentees as pre-season opens", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Pre-season begins at the AXA: Iraola takes his first session with six academy names drafted in to fill the gaps", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool reject Inter Milan's improved €35m bid for Curtis Jones as Iraola says he wants to keep him", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Two words stood out in Iraola's first press conference: the low block is dead at Anfield", time: "today", category: "fan" },
  { source: "Football365", title: "Liverpool make contact for Wolves' Joao Gomes after Jorge Mendes blows up his agreed Atletico move", time: "today", category: "major" },
  { source: "FIFA", title: "World Cup semi-final today: Konate's France meet Munoz's Spain in Dallas, 3pm Eastern, for a place in Sunday's final", time: "today", category: "major" },
  { source: "Sky Sports", title: "Iraola tells FSG the job is not done: 'It is impossible to deal with this kind of season with 15 players'", time: "1d ago", category: "major" },
  { source: "Anfield Watch", title: "Deal signed: Mo Salah's next club announcement is coming, with the Saudi Pro League destination settled", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Liverpool accelerate for Egypt winger Hassan and are 'confident' of a £10.2m deal with Real Oviedo", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Hugo Ekitike recovery could take 'longer than expected', expert warns, as the striker eyes Boxing Day", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Giovanni Leoni delay hint as Iraola names his three 'long-term solutions' who cannot yet be picked", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Every word from Andoni Iraola's first Liverpool press conference as he opens up on transfer plans", time: "1d ago", category: "official" },
  { source: "GiveMeSport", title: "Gilberto Mora and the £20m release clause: Liverpool among the clubs watching the World Cup's breakout teenager", time: "2d ago", category: "major" },
  { source: "ESPN", title: "Mac Allister's Argentina face England in Atlanta on Wednesday after he headed Messi's corner past Switzerland", time: "2d ago", category: "major" },
  { source: "Rousing The Kop", title: "Five takeaways from Iraola's first press conference: an Ekitike update and new signings incoming", time: "2d ago", category: "fan" },
];
