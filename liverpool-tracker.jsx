...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Gakpo's stoppage-time volley denies Klopp's Germany a winning debut: Netherlands 1-1", time: "today", category: "major" },
  { source: "SportBible", title: "Van Dijk calls Germany's goal a 'disgrace'; Klopp hits back with 'no guilty conscience'", time: "today", category: "major" },
  { source: "Anfield Index", title: "Andoni Iraola nominated for Premier League Manager of the Month for September", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Jurgen Klopp keeps Florian Wirtz out of Germany's opening games, a boost for Iraola", time: "today", category: "fan" },
  { source: "VAVEL", title: "Ruben van Bommel debut cross sets up Gakpo's dramatic Nations League leveller", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Iraola to work a skeleton squad at the AXA through the international break", time: "1d ago", category: "fan" },
  { source: "Sports Mole", title: "Leoni back in group training a year on from his ACL; Chiesa due before month's end", time: "1d ago", category: "major" },
  { source: "The Athletic", title: "Julian Ward reappointment still reported but unconfirmed as Ornstein and Joyce align", time: "1d ago", category: "major" },
  { source: "Goal", title: "Mac Allister's stalled renewal remains the first file for a returning sporting director", time: "1d ago", category: "fan" },
  { source: "Read Man City", title: "Opta's model still rates City's perfect start 5.8 points too kind before the Anfield trip", time: "2d ago", category: "fan" },
  { source: "Liverpool FC", title: "Turkish Airlines to become Liverpool's main club partner from June 2027", time: "2d ago", category: "official" },
  { source: "Opta Analyst", title: "Liverpool's expected goals against third-best in the division after five games", time: "2d ago", category: "fan" },
  { source: "BBC Sport", title: "Bournemouth 0-1 Liverpool: Isak's winner sent Iraola into the break unbeaten", time: "5d ago", category: "major" },
];
