...
const PLAYERS = [
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Fri Aug 14 — the exit saga finally moves. Liverpool.com report a 'breakthrough' in Inter's pursuit, the Serie A club growing in belief he will now push to join after three approaches, the last an informal €35m, fell short of a €40m ask. Jones, into his final year and thought unlikely to extend, has stayed quiet in public while the machinery turns; Inter's move was tangled in a Frattesi domino all summer. Fit and available for Sunday's Como friendly, still needed in a midfield only just getting Mac Allister back, but a boyhood Red now edges towards the door", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
...
const LATEST_NEWS = [
  { source: "Empire of the Kop", title: "Man City put Mac Allister on a midfield shortlist as they brace for Rodri's Barcelona exit", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Mac Allister's agent rules out a City move: 'Alexis will stay at Liverpool'", time: "today", category: "fan" },
  { source: "Fabrizio Romano", title: "Mbaye deal cools as Liverpool focus on Barcola for a double winger swoop", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Barcola gap holds at £120m to £145m as Arsenal weigh a hijack", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Curtis Jones 'breakthrough' reached in Inter exit talks", time: "today", category: "fan" },
  { source: "Football365", title: "Liverpool to sanction a double exit on two conditions as Iraola rules on Elliott", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Como kick-off times confirmed for Sunday's Anfield double-header", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Wharton 'ready to wait' for Liverpool despite a rival's interest", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Iraola: Gomez chasing an end-of-August return for the Forest opener at Anfield", time: "1d ago", category: "fan" },
  { source: "Goal", title: "Ekitike eyes a festive comeback as Leoni edges back into team training", time: "2d ago", category: "fan" },
  { source: "Football Insider", title: "Endo made available to Wolves, Fulham and West Ham as the desk turns seller", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool 2-3 Monaco: Reds throw away a two-goal lead on Iraola's Anfield bow", time: "5d ago", category: "major" },
