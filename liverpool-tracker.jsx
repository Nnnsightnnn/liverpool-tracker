...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Iraola cannot guarantee Gakpo as adductor doubt clouds Bournemouth team news", time: "today", category: "major" },
  { source: "Sports Illustrated", title: "Bournemouth vs Liverpool: rested seniors return as Iraola goes back to Dorset", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola: 'Everyone is ready to go', no fresh injuries out of the cup tie", time: "today", category: "official" },
  { source: "The Hard Tackle", title: "Predicted XI: Isak, Barcola and Wirtz return; Alisson back in goal at the Vitality", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Andoni Iraola 'officially under serious pressure' on the eve of his homecoming", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "U21s 5-1 Brighton: Will Wright scores twice, Mabaya off injured inside five minutes", time: "1d ago", category: "official" },
  { source: "ESPN", title: "Liverpool slip to tenth without playing as five Saturday results reshape the round", time: "1d ago", category: "major" },
  { source: "Opta Analyst", title: "Brighton 3-0 Arsenal: champions stunned, and Anfield hosts the Seagulls in October", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Chelsea at Anfield on 28 October in the Carabao Cup; LASK away on the 14th", time: "1d ago", category: "official" },
  { source: "This Is Anfield", title: "Ngumoha reports to England after Bournemouth, new long-term deal still unsigned", time: "2d ago", category: "fan" },
  ...
  { source: "Liverpool.com", title: "'I like his spirit': Iraola on six games of Ronald Araujo, and the English lessons", time: "2d ago", category: "major" },
  { source: "BBC Sport", title: "Isak on the record move: 'No, never. I would never think like that'", time: "3d ago", category: "major" },
];
