...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "injured", outSince: "2026-07-25", injuryNote: "Sun Aug 16 — the summer closed with him still watching. Gomez took no part in the Como win, the muscle injury from the opening minutes at Sunderland ruling him out of the August 23 trip to Newcastle, with Iraola targeting the first home game against Nottingham Forest on August 29. With Leoni still on his ACL, the back line leans on Araujo's loan and a returning Jacquet. The longest-serving defender is a cover loss to absorb rather than a sale to chase. Weeks, not months, and every day counts toward that Forest date", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Tue Aug 18 — now the player is pushing too. Jones, whose personal terms with Inter have been settled for months, is described as 'doing everything he can' to force the move before deadline day, intermediaries telling Italian outlets the deal is 'almost there'. The block stays the fee: Liverpool hold firm at €40m and Inter, needing to sell first, have yet to reach it. Fit and available, he trained through the Como week but has made his wish plain. Into his final year and unlikely to extend, the only Scouser left in the first team edges toward a door he is now leaning on. Iraola wanted him to stay; the club will not gift him away", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Tue Aug 18 — the forward asks to leave. Gakpo has told Liverpool he wants to join Tottenham and agreed personal terms in principle on a deal to 2031, his camp now speaking directly with the hierarchy. Spurs' opening bid of a little over £60m was rejected on Monday, Liverpool holding nearer £72m and expecting an improved offer to follow. He scored against Como on Sunday and signed fresh Anfield terms only last year, but is said to see no long-term future under Iraola. Nine goals and six assists in 39 appearances last term, now the summer's likeliest big sale and the funding line the Barcola pursuit has been waiting on", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Tue Aug 18 — the shirt is his until Paris lets go, and the door has cracked. Ngumoha keeps the post-Salah right-sided slot by default heading into Newcastle. PSG president Al-Khelaifi has now confirmed 'negotiations' over Barcola, Liverpool near £98m against an ask up to £145m, the funds waiting on the sales of Gakpo and Jones that have finally started to move. With Minteh injured the alternative board is down to Rayan's dormant clause and Everton's Ndiaye. The 17-year-old, youngest goalscorer in the club's history, is reported to have no intention of leaving. Until a senior winger signs, the berth stays his", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  ...
  { id: 28, name: "Victor Munoz", number: 21, position: "FWD", nationality: "🇪🇸 Spain", age: 22, appearances: 0, goals: 0, assists: 0, cleanSheets: null, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "fit", injuryNote: "Sun Aug 16 — through the pre-season, and building. The £34.7m winger and World Cup champion with Spain logged early minutes across the friendlies, his first Liverpool run-outs on a right flank left thin by Salah's exit, and came through the Como finale. In since June on a six-year deal to 2032 after Liverpool met the €40m release clause at Osasuna, he is fully fit and pushing for a place at Newcastle. Seven goals and five assists in LaLiga last season at 22. The stats below are his Liverpool record, which is why they are empty", image: "https://img.a.transfermarkt.technology/portrait/big/935231-1747037145.jpg" },
];
...
const LATEST_NEWS = [
  { source: "TeamTalk", title: "Gakpo tells Liverpool he wants Tottenham with personal terms agreed and £60m bid rejected", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Curtis Jones 'doing everything he can' to force Inter move as terms are settled", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Al-Khelaifi confirms 'negotiations' with Liverpool over Bradley Barcola", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Liverpool reject Tottenham's £60m opening bid for Gakpo, hold out near £72m", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola on rotation before Newcastle: 'we have to recover players'", time: "today", category: "official" },
  { source: "CaughtOffside", title: "Hector Fort: Barcelona right-back emerges as a depth option with Bradley short", time: "1d ago", category: "fan" },
  { source: "Sports Mole", title: "Gomez ruled out of the opener as Liverpool's back line travels to Tyneside light", time: "1d ago", category: "fan" },
  { source: "The Hard Tackle", title: "Jones deal to Inter 'almost there', intermediaries say, but fee still short of €40m", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Calum Scanlon rejoins Cardiff on loan after signing new long-term Liverpool deal", time: "1d ago", category: "official" },
  { source: "This Is Anfield", title: "Everton hold near £75m for Ndiaye as the winger board stays thin behind Barcola", time: "2d ago", category: "fan" },
  { source: "FotMob", title: "Harvey Elliott 'needs to review' his future with a World Cup place in mind", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "FSG's minority-stake sale to the Bezos-Bhatia consortium settles into context", time: "4d ago", category: "official" },
  { source: "Daily Sabah", title: "Salah settles at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "1w ago", category: "major" },
];
