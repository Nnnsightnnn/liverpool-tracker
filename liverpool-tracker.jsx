...
// ─── Player Data (2025-26 Season · Updated Apr 18, 2026) ────────────────────
// Statuses: "fit" | "injured" | "doubtful" | "recovering"
// injuryNote: short description shown on card when not fit
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "injured", injuryNote: "Hamstring back — Man Utd (A, May 3) the return target, NOT Palace. BUT today (Apr 23) Romano: 'Alisson likes the idea' of a Juventus return; Bianconeri verbal offer made", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  { id: 2, name: "Giorgi Mamardashvili", number: 25, position: "GK", nationality: "🇬🇪 Georgia", age: 25, appearances: 16, goals: 0, assists: 0, cleanSheets: 4, xG: 0, tacklesPer90: 0, passCompletion: 76, progressiveCarries: 0.1, form: 6.8, status: "injured", injuryNote: "Deep open wound below left knee from Beto collision (59' vs Everton, Apr 19); Slot told reporters Apr 22 'not expected to be long-term' but still 2-4 wks per The Athletic — out for Palace and Man Utd (May 3)", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p449027.png" },

  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 34, appearances: 38, goals: 4, assists: 1, cleanSheets: 10, xG: 2.8, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Scored 100th-minute winner vs Everton (Apr 19) in first Hill Dickinson derby — captain's heroics lifted Liverpool 7 points clear of 6th", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 35, goals: 2, assists: 0, cleanSheets: 9, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 7.1, status: "fit", injuryNote: "Romano (Apr 20): new Liverpool deal 'nears completion' — only contract length & bonus structure left. Konaté to BBC: 'we are close to an agreement'", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 18, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 6.0, status: "injured", injuryNote: "Muscle injury from 22-min PSG cameo (Apr 14) — still a doubt for Crystal Palace (Apr 25); named on Slot's 9-man injury list per Liverpool.com (Apr 22)", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  { id: 6, name: "Andy Robertson", number: 26, position: "DEF", nationality: "🏴󠁧󠁢󠁳󠁣󠁴󠁿 Scotland", age: 32, appearances: 25, goals: 0, assists: 3, cleanSheets: 7, xG: 0.5, tacklesPer90: 2.3, passCompletion: 83, progressiveCarries: 4.2, form: 6.7, status: "fit", injuryNote: "Started at LB vs Everton (Apr 19) in first derby win at Hill Dickinson — recalled with Kerkez on the bench", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p122798.png" },
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 32, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.9, status: "fit", injuryNote: "Benched vs Everton (Apr 19) as Slot used Jones in an inverted RB role — managed hamstring, available for Crystal Palace", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
  ...
  // ── Midfielders ───────────────────────────────────────────────────────────
  { id: 13, name: "Alexis Mac Allister", number: 10, position: "MID", nationality: "🇦🇷 Argentina", age: 27, appearances: 36, goals: 2, assists: 3, cleanSheets: null, xG: 1.8, tacklesPer90: 1.9, passCompletion: 90, progressiveCarries: 1.4, form: 7.0, status: "fit", injuryNote: "On bench for derby (Apr 19); Slot went with Gravenberch-Szoboszlai double pivot in a 4-2-3-1", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243016.png" },
  ...
  { id: 15, name: "Dominik Szoboszlai", number: 8, position: "MID", nationality: "🇭🇺 Hungary", age: 25, appearances: 43, goals: 11, assists: 8, cleanSheets: null, xG: 6.2, tacklesPer90: 2.1, passCompletion: 86, progressiveCarries: 2.8, form: 7.6, status: "fit", injuryNote: "Delivered the 100th-minute corner Van Dijk headed home vs Everton (Apr 19) — 93% pass completion on derby day", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p424876.png" },
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 22, goals: 1, assists: 2, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.8, form: 7.2, status: "fit", injuryNote: "Started as an inverted RB vs Everton (Apr 19) — 8.4 match rating, Liverpool's highest on the day; fitness back", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 29, goals: 5, assists: 6, cleanSheets: null, xG: 4.5, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.0, status: "fit", injuryNote: null, image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p494595.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 36, goals: 10, assists: 9, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Scored 29' vs Everton (Apr 19) to equal Steven Gerrard's all-time PL Merseyside derby record (9 goals) — his final-ever derby as LFC player", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 34, goals: 8, assists: 5, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 7.3, status: "fit", injuryNote: "Delivered pinpoint assist for Salah's derby opener (Apr 19); 7.9 match rating", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  { id: 23, name: "Alexander Isak", number: 14, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 16, goals: 8, assists: 2, cleanSheets: null, xG: 9.2, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.4, status: "recovering", injuryNote: "Started Merseyside Derby (Apr 19) but subbed around HT as planned — minutes still being managed; on track to start again vs Crystal Palace (Apr 25)", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Liverpool and Chelsea declare interest in James Trafford — Man City keeper among five PL clubs eyeing summer move after losing No.1 spot to Donnarumma", time: "today", category: "official" },
  { source: "Empire of the Kop", title: "'Alisson likes the idea…' — Fabrizio Romano shares Liverpool transfer update fans won't enjoy as Juventus push for Brazilian return to Italy", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Marcos Senesi: Liverpool 'most likely' destination for Bournemouth CB on free transfer — left-footed Slot reunion from Feyenoord days", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool need 6 signings to get back on top — a summer to sculpt the squad: GK, LCB, RB, midfielder, two wide forwards", time: "today", category: "fan" },
  { source: "Goal.com", title: "Exclusive: Liverpool & Chelsea lead chase for James Trafford as keeper seeks regular football — Tottenham, Newcastle and Aston Villa also in five-club race", time: "today", category: "major" },
  { source: "FourFourTwo", title: "Alisson reaches verbal agreement with Juventus in Anfield exit — Reds triggered one-year extension to 2027 but Brazilian open to Italy switch", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Yan Diomande to Liverpool transfer latest as new threat to £87m move emerges — PSG enter the race after Roc Nation talks", time: "1d ago", category: "official" },
  { source: "Sky Sports", title: "Arne Slot expected to stay at Anfield next season as Liverpool close in on UCL qualification — 7-point cushion seals Dutchman's position", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Transfer insider claims Liverpool have set a target date for completion of Yan Diomande swoop — pre-World Cup deal sought", time: "1d ago", category: "fan" },
  { source: "Tribuna", title: "Romano: Ibrahima Konaté's Liverpool deal nears completion — contract length and bonus structure all that's left to finalise", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Wharton fit for Liverpool 'Anfield Audition' with Palace — Glasner confirms midfielder back for Saturday's clash", time: "2d ago", category: "fan" },
  { source: "World Soccer Talk", title: "Hugo Ekitiké's replacement decided — Liverpool chase Randal Kolo Muani from PSG with at least €35m required for permanent deal", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Newcastle sets Anthony Gordon transfer fee at $100M — Bayern Munich made winger their No.1 target as Liverpool weigh competition", time: "3d ago", category: "major" },
  { source: "Liverpool FC", title: "Van Dijk scores 100th-minute winner as Liverpool beat Everton 2-1 in first Merseyside derby at Hill Dickinson Stadium", time: "4d ago", category: "official" },
  { source: "ESPN", title: "Mohamed Salah equals Steven Gerrard's record for most Premier League Merseyside derby goals (9) in his final-ever clash with Everton", time: "4d ago", category: "major" },
  { source: "ESPN", title: "Hugo Ekitike ruptures Achilles — ruled out of World Cup with France in devastating 9-month blow for Liverpool", time: "1w ago", category: "major" },
];
