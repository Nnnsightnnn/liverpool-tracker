...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Liverpool told to pay a British-record £128m for Barcola as PSG set a €150m price and the winger's camp give the green light", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Bid 'ready': Liverpool line up a concrete offer for Brighton's Yankuba Minteh as the deliverable long-term Salah successor", time: "today", category: "major" },
  { source: "Yahoo Sport", title: "France 2-0 Morocco: Konate reaches the World Cup semi-finals, the first Red into the last four", time: "today", category: "fan" },
  { source: "Goal", title: "Atletico Madrid make Salah their top target as Griezmann's heir, with Roma and Juventus also investigating the free agent", time: "today", category: "major" },
  { source: "Sky Sports", title: "Argentina meet Switzerland on Saturday and Spain face Belgium as Mac Allister and Munoz chase the semis", time: "today", category: "fan" },
  { source: "Football365", title: "Yan Diomande set to choose PSG over Liverpool, hardening the Reds' winger pivot to Barcola and Minteh", time: "1d ago", category: "major" },
  { source: "GiveMeSport", title: "Liverpool join Chelsea and Man United in the race for West Ham's relegation-freed Crysencio Summerville", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "John Barnes: keep Van Dijk beyond his contract as Anfield knocks back Milan's interest in the 35-year-old again", time: "1d ago", category: "fan" },
  { source: "Anfield Watch", title: "Scouts sent for Georgian teenager Andria Bartishvili as Liverpool and Arsenal table identical contracts", time: "1d ago", category: "fan" },
  { source: "Football365", title: "Sano latest: Mainz hold their €50-60m line as Liverpool stay ahead of United and Arsenal for the Japan No. 6", time: "2d ago", category: "major" },
  { source: "Liverpool.com", title: "Nineteen report Tuesday: Iraola's pre-season proper begins July 14 with the World Cup men still to trickle back", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Galatasaray join Inter in the race for Curtis Jones as the midfielder enters the final year of his deal", time: "2d ago", category: "major" },
  { source: "ESPN", title: "Konate to Real Madrid confirmed: France defender left on a free after extension talks collapsed", time: "3d ago", category: "major" },
  { source: "Goal", title: "Still no ink on Germany: Klopp's move waits only on his Red Bull release after Nagelsmann's exit", time: "3d ago", category: "major" },
  { source: "Empire of the Kop", title: "Chiesa's U-turn holds: the Italian wants to stay and fight for a starting role under Iraola", time: "4d ago", category: "fan" },
];
