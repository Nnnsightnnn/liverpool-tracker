...
const LATEST_NEWS = [
  { source: "Paul Joyce / The Times", title: "Liverpool reject Inter's second bid for Curtis Jones, a ~£21m offer that falls 'considerably short' of their ~£40m valuation; the Reds want no further talks and now hope he signs a new deal", time: "today", category: "major" },
  { source: "Liverpool.com / Get French Football News", title: "Yan Diomandé drops a Premier League hint, 'I am an RB Leipzig player, but why not?', as Leipzig counter Liverpool's rejected €100m bid with a new contract carrying a 2027 release clause", time: "today", category: "major" },
  { source: "Yahoo Sports / FIFA", title: "Mohamed Salah scores and assists in Egypt's 3-1 World Cup win over New Zealand, moving within one of his country's all-time scoring record", time: "1d ago", category: "fan" },
  { source: "TeamTalk / ESPN", title: "New name: Liverpool join a 'very realistic' hunt for Borussia Dortmund's £52m Felix Nmecha, with Manchester United, Real Madrid and Barcelona also circling", time: "today", category: "major" },
  { source: "Liverpool.com / Magenta TV", title: "Klopp, on punditry duty, on unlocking Wirtz: 'Give him the ball, because that's when the lad feels completely at home'", time: "today", category: "fan" },
  { source: "Get French Football News / OneFootball", title: "Leipzig set Diomandé's price between €120m and €130m as Romano flags a 'big proposal coming'; PSG yet to bid but expected to join the race", time: "1d ago", category: "fan" },
  { source: "Football365 / TeamTalk", title: "Salah to Fenerbahce hardens: re-elected president Yıldırım frames a three-year deal worth a reported €90m (£77m) total as Liverpool confirm a free-agent exit", time: "1d ago", category: "major" },
  { source: "Sky Sports / This Is Anfield", title: "Centre-back search grinds on: Inácio the clean ~£52m fit, Ordóñez the value play, with free-agent-in-waiting Marc Guéhi kept warm for the longer game", time: "2d ago", category: "fan" },
  ...
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season map: a US tour through Wrexham, Sunderland (Nashville, July 25) and Leeds before the August 23 opener at Newcastle", time: "3d ago", category: "official" },
  { source: "This Is Anfield / Anfield Watch", title: "Mac Allister exit talk refuses to die, the camp batting it away as Liverpool stay quietly open near €120m to fund the midfield reshape", time: "4d ago", category: "fan" },
  { source: "Empire of the Kop / Sky Sports", title: "Ekitike's long road back: still early in Achilles rehab, a festive-period return the optimistic case, the absence that keeps the striker-search file open", time: "5d ago", category: "fan" },
