...
const LATEST_NEWS = [
  ...
  { source: "Anfield Index", title: "Everton shut down Liverpool's Branthwaite enquiry before a fee was even mentioned, per the Daily Mail", time: "1d ago", category: "fan" },
  { source: "Football365", title: "Chiesa performs an exit U-turn: the Italian now wants to stay and fight for a starting spot under Iraola", time: "1d ago", category: "major" },
  { source: "live4liverpool", title: "Endo, Leoni and Bajcetic hand Iraola an early boost, reporting to Kirkby a week before the bell", time: "1d ago", category: "fan" },
  { source: "Football365", title: "Romano sets the Barcola timeline: no movement until France leave the World Cup, possibly the July 19 final", time: "1d ago", category: "major" },
  { source: "Goal", title: "Klopp's Germany unveiling waits only on the Red Bull release as the DFB finalises contract details", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Mora release-clause details emerge as Bellingham shares a touching moment with the Liverpool target", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Pre-season tour and two friendlies: Iraola's era begins this month, Nashville first on July 25", time: "2d ago", category: "fan" },
];
