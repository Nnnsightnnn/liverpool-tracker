...
const PLAYERS = [
  ...
  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 35, appearances: 43, goals: 6, assists: 1, cleanSheets: 11, xG: 3.2, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Wed Jul 8 — thirty-five today, and Milan want him: Zlatan Ibrahimović has made the captain AC Milan's 'dream' signing for Ruben Amorim's rebuild, with Fenerbahce also interested. Anfield dismisses it 'categorically,' with Van Dijk, out of the World Cup with the Netherlands and contracted to 2027, firmly in Iraola's plans. No bid has arrived and none is expected to shift him", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  ...
  { id: 10, name: "Giovanni Leoni", number: 33, position: "DEF", nationality: "🇮🇹 Italy", age: 18, appearances: 1, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "injured", injuryNote: "Tue Jul 7 — back in the building: reported to Kirkby early on Monday with Endo and Bajcetic, the last mile of the ACL rehab that began in September now running ahead of the group. A 2026-27 return stays the target", image: "https://r2.thesportsdb.com/images/media/player/cutout/8aws9t1766829004.png" }, /* Leoni - TheSportsDB cutout */
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 34, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Wed Jul 8 — the tournament is over: Egypt led Argentina 2-0 in Atlanta and lost 3-2, Messi's late double and Enzo Fernández's 92nd-minute winner ending a run that had carried the feel of a farewell. A free agent since ending his Liverpool deal, his destination call now unparks in earnest, with Al-Ahli leading a Saudi race and MLS watching", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Argentina 3-2 Egypt: Salah's World Cup ends in Atlanta as Enzo Fernandez wins a classic in stoppage time", time: "today", category: "major" },
  { source: "ESPN", title: "Two up and out: Messi's late double and a VAR storm break Egyptian hearts at Mercedes-Benz Stadium", time: "today", category: "major" },
  { source: "ESPN", title: "'An injustice': Hossam Hassan slams FIFA and the officials after Egypt's round-of-16 exit", time: "today", category: "major" },
  { source: "Goal", title: "Ibrahimovic makes Van Dijk his 'dream' signing as Milan test Liverpool on the captain's 35th birthday", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Barcola blow: PSG winger 'favours Arsenal' with Paris holding out for €135m once France are done", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Eight in at the AXA: Jacquet, Elliott and McConnell train as Bradley, Ekitike and Leoni step up rehab", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Jeremy Jacquet links up at Kirkby, the 20-year-old defender settling in after his move from Rennes", time: "1d ago", category: "fan" },
  { source: "Goal US", title: "Three conditions for Salah's next club as Al-Ahli lead a Saudi race that will now accelerate", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Wharton interest 'cools' as Iraola signals the England midfielder is not a priority this window", time: "1d ago", category: "major" },
  { source: "Football Italia", title: "Van Dijk 'dream' will not come true: sources at Anfield dismiss Milan and Fenerbahce, he stays", time: "1d ago", category: "fan" },
  { source: "TeamTalk", title: "Liverpool 'make contact' over Gilberto Mora, barred from a move abroad until October and priced past £34m", time: "2d ago", category: "major" },
  { source: "Goal", title: "Here we go: Klopp's Germany move waits only on his Red Bull release after Nagelsmann's Paraguay exit", time: "2d ago", category: "major" },
  { source: "Empire of the Kop", title: "Romano confirms it: Celtic's U16 captain Dara Jikiemi signs a five-year Liverpool path at sixteen", time: "2d ago", category: "fan" },
  { source: "Football365", title: "Chiesa's exit U-turn: the Italian now wants to stay and fight for a starting role under Iraola", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Pre-season begins July 14 at Kirkby, Sunderland in Nashville on July 25 the first date of the Iraola era", time: "2d ago", category: "fan" },
];
