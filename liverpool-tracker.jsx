...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "injured", outSince: "2026-07-25", injuryNote: "Mon Aug 24 — the opener passed him by, and Forest is the target now. Gomez sat out Sunday's 2-2 at Newcastle with the muscle injury taken in the opening minutes at Sunderland, and Iraola confirms the vice-captain is 'some weeks off,' adding it 'shouldn't be a lot more' than that. With Leoni edging back from his ACL and Bradley still months from a knee return, the defence that drew at St James' leaned on Araujo's loan debut beside Van Dijk. The longest-serving defender is a cover loss to absorb, not a sale to chase, and Friday's home game against Forest may still come a little too soon", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Mon Aug 24 — a rotation role, and a new deal on the horizon. Ngumoha was a bench option at Newcastle as Gakpo held the right and scored, the teenager's minutes coming late in a young matchday squad. This Is Anfield still report a new five-year deal with a significant pay rise once he turns 18 on August 29, the delay only a rule capping under-18s at three-year terms. Above it the marquee search has cooled, PSG holding Barcola near £145m while Minteh's personal terms are agreed. Twenty-nine appearances last term and a goal against Newcastle a year ago; his minutes will come, but experience starts ahead of him for now", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's stoppage-time penalty rescues a point on Iraola's debut", time: "today", category: "major" },
  { source: "BBC Sport", title: "Iraola sidesteps the penalty question as Szoboszlai, not Isak, converts the 99th-minute leveller", time: "today", category: "major" },
  { source: "Caught Offside", title: "Romano: Liverpool agree personal terms with Yankuba Minteh as £60m Brighton bid is lodged", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Isak endures a difficult, hostile return to St James' as Gakpo's finish keeps Liverpool alive", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Barcola talks drag on: PSG hold firm near £145m with Liverpool valuing the winger around £120m", time: "today", category: "major" },
  { source: "Rousing the Kop", title: "Steve Nicol slams Iraola's 'nonsense' line on the late penalty as Neville faults a Liverpool man", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Injury latest: Ekitike 'still way off' with his Achilles, Gomez targeting a return within weeks", time: "today", category: "official" },
  { source: "Goal", title: "New era at Anfield: Forest visit on Friday as Iraola chases a first competitive win", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "'He dreams of joining': Minteh wants Anfield despite a leg injury that keeps him out for months", time: "1d ago", category: "fan" },
  { source: "TeamTalk", title: "Iraola ready to approve exits: Chiesa weighs his options as the final week opens", time: "1d ago", category: "fan" },
  { source: "UEFA", title: "Champions League league-phase draw set for August 27 in Monaco with Liverpool a fifth seed", time: "today", category: "official" },
  { source: "ESPN", title: "Curtis Jones settles at Inter as the last Scouser's €35m San Siro move is signed off", time: "2d ago", category: "major" },
  { source: "Sports Mole", title: "Newcastle held despite Elanga and Willock strikes as Bruno's men rue late VAR drama", time: "1d ago", category: "fan" },
  { source: "Daily Sabah", title: "Salah begins life at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "3w ago", category: "major" },
];
