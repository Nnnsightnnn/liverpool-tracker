...
const PLAYERS = [
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Sun Jun 28 — the strain is confirmed, the tie a question: Egypt have acknowledged Salah carries a muscle strain after his 57th-minute withdrawal against Iran, leaving his place for the World Cup last-32 meeting with Australia in Arlington on July 4 genuinely uncertain. The Pharaohs reached the knockouts for the first time but finished second in Group G after Belgium beat New Zealand 5-1. Off the pitch the destination still leans Saudi Arabia over a framed Fenerbahce offer; a free agent on June 30, the Anfield chapter closed, the final word waits on the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "Football365 / Liverpool.com", title: "Diomandé deal wobbles: reports say the teenager favours Real Madrid as Leipzig demand up to €148m and Liverpool draw up alternatives", time: "today", category: "major" },
  { source: "Liverpool.com / Ben Jacobs", title: "Reds 'actively working' on Diomandé alternatives Fernandez-Pardo, El Mala and Minteh to keep leverage and avoid an overpay", time: "today", category: "major" },
  { source: "football360 / Sky Sports", title: "Salah confirmed with a muscle strain: doubt over his Egypt place for the World Cup last-32 tie with Australia in Arlington on July 4", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Harvey Elliott boost: Iraola 'willing to give him a chance' as the midfielder returns from his Aston Villa loan", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Goal", title: "Jones expected to stay: Liverpool reject a second Inter bid (~£21.7m) and halt talks, Hughes 'unimpressed' against a £35m valuation", time: "1d ago", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season tour confirmed: Sunderland in Nashville (Jul 25), Wrexham at Yankee Stadium (Jul 29), Leeds at Soldier Field (Aug 2)", time: "2d ago", category: "official" },
  { source: "GiveMeSport / CaughtOffside", title: "Inácio still leads the centre-back board: the left-footed Sporting man's £52m clause heads a list with Beukema, Murillo and Vuskovic", time: "2d ago", category: "fan" },
  { source: "Anfield Watch / This Is Anfield", title: "Right-back search live: Inter's Denzel Dumfries (release clause) and Leipzig's Geertruida floated as Bradley's rehab drags", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "Olise a long-shot wide option: Bayern move to tie the France winger to a new deal amid Real Madrid and Liverpool interest", time: "2d ago", category: "fan" },
  ...
  { source: "Al Jazeera / ESPN", title: "Konaté gone: Real Madrid confirm the centre-back to 2030, reuniting him with Trent Alexander-Arnold at the Bernabéu", time: "3d ago", category: "official" },
  ...
  { source: "Liverpool FC / Sky Sports", title: "Iraola's calendar set: a daunting Newcastle opener (Aug 23), Forest first at Anfield, and a final-day Bournemouth reunion", time: "1w ago", category: "official" },
];
