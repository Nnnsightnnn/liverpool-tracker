...
const LATEST_NEWS = [
  { source: "Football365", title: "FSG-Bezos stake sale 'announcement imminent' as fans seek clarity on what it changes", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Arsenal move to hijack Barcola as Liverpool are reported to weigh walking away", time: "today", category: "major" },
  { source: "Sky Sports", title: "PSG hold Barcola near £145m and name him in their Super Cup squad", time: "today", category: "major" },
  { source: "Goal", title: "Iraola confirms Jeremy Jacquet set for his pre-season debut against Como", time: "today", category: "fan" },
  { source: "Fabrizio Romano", title: "Curtis Jones to Inter 'far from complete' as talks stall on the fee", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool still lead the race for Mbaye as the Barcola chase turns contested", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Iraola: 'We are going to recover players' before the Newcastle opener", time: "1d ago", category: "official" },
  { source: "Sky Sports", title: "Gomez racing to be fit for Forest on August 29 as Leoni nears team training", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Araujo settles in ahead of his Como bow, available from Sunday in the No. 33", time: "2d ago", category: "official" },
  ...
  { source: "Sky Sports", title: "Liverpool 2-3 Monaco: Reds throw away a two-goal lead on Iraola's Anfield bow", time: "3d ago", category: "major" },
