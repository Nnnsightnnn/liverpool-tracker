...
const PLAYERS = [
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 25, goals: 1, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 7.6, status: "fit", injuryNote: "Headline Wed May 6: Romano via Tribuna confirmed Tue May 5 Jones has given his 'full approval' to Inter Milan ahead of a summer move — Liverpool valuation the only obstacle. EOTK/Sky (May 1): contract talks 'stalled' with one year left. Aston Villa, Newcastle, Inter all in. Still locking down RB on the pitch — Goal.com 8/10 at MUN with 100+ touches. Sports Mole Wed: Liverpool 'preparing £34m bid' for the Wharton replacement", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
...
const LATEST_NEWS = [
  { source: "Tribuna / Romano", title: "Curtis Jones gives 'full approval' to Inter Milan switch — Liverpool valuation now the only obstacle as contract extension talks stall", time: "today", category: "major" },
  { source: "This Is Anfield", title: "FSG respond to Red Sox & Liverpool fan unrest: 'Don't settle for mediocrity, you have to win' — John Henry breaks rare silence", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Liverpool 2026/27 home kit already 'on sale' in stores after latest leak — Adidas Candy 1989-91 throwback shows up at Foot Locker before official launch", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool facing Curtis Jones transfer 'problem it cannot ignore' — Aston Villa, Newcastle and Inter all circling 25-year-old Scouser this summer", time: "today", category: "major" },
  { source: "Sports Mole", title: "Liverpool preparing £34m bid for 'unbelievable' Curtis Jones replacement after worrying contract update — Wharton chase accelerates", time: "today", category: "major" },
  { source: "Liverpool Rumours", title: "Liverpool 'working' to sign U23 Asian Cup MVP Ryunosuke Sato from FC Tokyo before the 2026 World Cup — early Hughes scouting move", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "'We are not kids', 'It's a city trip': Virgil van Dijk rejects Liverpool 'days off' claim as captain defends Slot post-Old Trafford", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "'It's on the manager': Jamie Carragher warns Liverpool's style is a choice, not a mistake — identity worry deepens after Old Trafford", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "0 wins in 8 — Liverpool's damning away record against Premier League's top 10 (FotMob): 2 draws, 6 losses, 2.25 goals conceded per game", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Arne Slot 'confirms' Liverpool plans for new coaching staff in summer — Etienne Reijnen reunion 'beckons' as work-permit hurdle clears", time: "1d ago", category: "fan" },
  { source: "Goal.com", title: "Marcos Senesi: Liverpool 'leads' free-transfer race over Man Utd & Chelsea — but Tottenham now have 'agreement in principle' to complicate", time: "1d ago", category: "major" },
  { source: "FootballTransfers", title: "Liverpool transfer news: Reds in 'advanced' Adam Wharton talks at £80m as Crystal Palace dig in over fee — Real Madrid preempted", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Slot's 'a recurring pattern' VAR rant continues to dominate post-Man Utd narrative — Carragher worried about identity drift on MNF", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Man Utd 3-2 Liverpool recap: Mainoo's 77' winner ends Liverpool comeback — Cunha and Sesko's 14-minute opening still the key talking point", time: "3d ago", category: "major" },
  { source: "TNT Sports", title: "Salah urges Liverpool to give Jordan Henderson 'the farewell he deserved' when Brentford visit Anfield May 24 — first return in red away kit since 2023", time: "4d ago", category: "fan" },
];
