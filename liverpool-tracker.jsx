...
const PLAYERS = [
  ...
  { id: 8, name: "Conor Bradley", number: 12, position: "DEF", nationality: "🇬🇧 N. Ireland", age: 22, appearances: 16, goals: 0, assists: 2, cleanSheets: 4, xG: 0.8, tacklesPer90: 2.6, passCompletion: 84, progressiveCarries: 5.1, form: 7.3, status: "injured", injuryNote: "Thu May 28 — a pre-season doubt now: four and a half months after the knee gave way at Arsenal, he is back on load-bearing gym work at the AXA centre, but Slot has called the case 'complicated' and there is 'no timeline.' Northern Ireland's Michael O'Neill says he is 'doing well' while keeping the detail confidential", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p492777.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Mon Jun 8 — still untouchable: Fabrizio Romano restates the 17-year-old has 'no chance' of leaving as Bayern keep him on their list after missing Anthony Gordon, with no formal contact made — Liverpool's position unmoved. With Gakpo now asking to leave, the left flank the youngest goalscorer in the club's history would inherit looks more his than ever", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
...
const LATEST_NEWS = [
  { source: "Managing Madrid / Real Madrid", title: "Pérez re-elected in a Bernabéu landslide — Konaté's free transfer to Real Madrid now sealed, the agreed four-year deal freed to be announced within days", time: "today", category: "major" },
  { source: "GiveMeSport / Rousing The Kop", title: "Gakpo hands in a transfer request: the Dutch forward 'doesn't see a future' without Slot — Liverpool open near €45m, Tottenham, Newcastle and Bayern circling", time: "today", category: "major" },
  { source: "Sportingpedia / Anfield Watch", title: "Mac Allister caught in a Madrid tug — both Real Madrid and Atlético now circling the contract rebel as no new deal materialises at Anfield", time: "today", category: "major" },
  { source: "Fabrizio Romano / Football365", title: "Romano: Iraola's approved first signing 'set for next week' as Liverpool move before the June 15 window opens — Diomandé gives his 'preference'", time: "today", category: "major" },
  { source: "This Is Anfield / Sports Mole", title: "Winger chase flickers back: Liverpool in 'strongest position' for Diomandé, who wants his future settled before the World Cup; Trincão stays the calmer plan", time: "today", category: "major" },
  { source: "Al Jazeera / beIN Sports", title: "Salah named Egypt captain for the World Cup — his Anfield decision held until the tournament ends, Turkey now ahead of Saudi and MLS in the betting", time: "1d ago", category: "fan" },
  { source: "Sky Sports / Premier League", title: "Confirmed: Andy Robertson joins Tottenham on a free — nine years and nine major trophies close as the title-winning core thins, Kerkez inheriting the left", time: "3d ago", category: "official" },
  { source: "Football365 / Sky Sports", title: "A £40m Ordóñez bid anchors the defensive rebuild now Konaté is gone — one half of an 'approved' £170m double, with Chelsea and City watching", time: "1d ago", category: "major" },
  { source: "Liverpool.com / Fabrizio Romano", title: "Ngumoha stays untouchable — Romano says 'no chance' the 17-year-old leaves as Bayern keep him on their list with no formal contact made", time: "1d ago", category: "fan" },
  { source: "Football365 / Liverpool.com", title: "Alisson stays, Mamardashvili the keeper likelier to go: the £29m heir now looks loan-bound for game time after the Brazilian digs in", time: "2d ago", category: "fan" },
  { source: "Football365 / Sky Sport Italia", title: "The clear-out frames the reset — Jones (Inter's €20m rejected), Elliott, Gomez, Endo and Chiesa on the list as the window nears its June 15 open", time: "2d ago", category: "major" },
  { source: "Liverpool FC", title: "Iraola sets his pre-season blueprint: ~8 first-teamers report late from the World Cup, opening the US tour to the academy and returning loanees", time: "2d ago", category: "official" },
  { source: "Empire of the Kop", title: "Full pre-season set: Sunderland in Nashville (Jul 25), Wrexham at Yankee Stadium (Jul 29), Leeds at Soldier Field (Aug 2), then Monaco and Como at Anfield", time: "4d ago", category: "official" },
];
