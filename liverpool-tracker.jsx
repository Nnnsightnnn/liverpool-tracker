...
const LATEST_NEWS = [
  { source: "Empire of the Kop / Anfield Watch", title: "Liverpool agree personal terms with Yan Diomandé as PSG step back, handing the Reds a clear run; an 'aggressive' second bid above €100m loads this week", time: "today", category: "major" },
  { source: "TeamTalk / Sports Mole", title: "Leipzig hold for nearer £104m after rejecting Liverpool's €100m Diomandé opener (£69m + £17.3m add-ons); Romano expects a fast, very aggressive return", time: "today", category: "major" },
  { source: "Fabrizio Romano / Liverpool.com", title: "Second hijack? Liverpool make contact for West Ham's £85m Mateus Fernandes, threatening a midfield deal Man Utd and Tottenham have chased", time: "today", category: "major" },
  { source: "Liverpool.com / TeamTalk", title: "Barcola kept warm: Liverpool and the PSG forward at 'completely different stages' to Diomandé, but he is discussed internally 'every single week'", time: "today", category: "fan" },
  { source: "GiveMeSport", title: "Diomandé the World Cup reason: player of the match vs Ecuador and 'impossible to stop' before Ivory Coast went out to Germany, the form stiffening Leipzig's price", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Sky Sports", title: "Jones stand-off holds: Liverpool reject Inter's second bid of ~£21.7m, but the midfielder is reported still 'totally open' to an exit", time: "1d ago", category: "major" },
  { source: "This Is Anfield / Managing Madrid", title: "Konaté's Real Madrid unveiling imminent as Liverpool's free-agent exits firm up before the June 30 contract cliff", time: "1d ago", category: "official" },
  { source: "Al Jazeera / Sky Sports", title: "Salah scores and assists as Egypt beat New Zealand 3-1 to top Group G; Iran await on Friday in Seattle", time: "3d ago", category: "fan" },
  { source: "Liverpool.com", title: "Isak and Wirtz give Iraola a World Cup boost as the squad's non-internationals begin warm-weather pre-season work", time: "2d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Gakpo exit now 'highly improbable': the Dutchman has not asked to leave and stays firmly in Iraola's plans", time: "2d ago", category: "fan" },
  { source: "Liverpool.com / Sportingpedia", title: "Mac Allister and Real Madrid: no extension talks open as Liverpool would listen near €120m if the books need balancing", time: "3d ago", category: "fan" },
  { source: "Fabrizio Romano / This Is Anfield", title: "Munoz settled: the €40m (£34.7m) Osasuna winger, the window's first arrival, signed for six years after Liverpool hijacked a near-done Newcastle move", time: "1w ago", category: "official" },
  { source: "Empire of the Kop / Sky Sports", title: "Ekitike's long road back: still early in Achilles rehab, the absence that keeps the striker-search file open", time: "1w ago", category: "fan" },
];
