...
const PLAYERS = [
  ...
  { id: 8, name: "Conor Bradley", number: 12, position: "DEF", nationality: "🇬🇧 N. Ireland", age: 22, appearances: 16, goals: 0, assists: 2, cleanSheets: 4, xG: 0.8, tacklesPer90: 2.6, passCompletion: 84, progressiveCarries: 5.1, form: 7.3, status: "injured", injuryNote: "Mon Jul 20 — the timeline hardens the wrong way again. Last week the briefing was a return shortly after the season opens; the reporting over this weekend suggests the knee he hurt against Arsenal in January is worse than first thought and that he may not feature until 2027. The club have committed to no date in either direction, which is usually its own answer. Iraola grouped him with Ekitike and Leoni as long-term absences and he takes no part in the American tour. Frimpong is the only fit senior right-back on the plane", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p492777.png" },
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 35, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.4, status: "fit", injuryNote: "Mon Jul 20 — he boards today carrying the whole right side. With Bradley now credibly reported as a 2027 problem rather than an autumn one, Frimpong is the only fit senior right-back travelling to Chicago, and the three American fixtures give Iraola no realistic way to rest him beyond handing minutes to an academy full-back. A first pre-season under a coach whose Bournemouth sides asked their wing-backs to run the touchline for ninety minutes should suit him better than the last twelve months did. Fit, available, and short of competition", image: "https://r2.thesportsdb.com/images/media/player/cutout/ehf7fi1757088020.png" },
...
const LATEST_NEWS = [
  { source: "FIFA", title: "Spain win the World Cup: Ferran Torres settles it in extra time as Victor Munoz becomes a champion three weeks into his Liverpool career", time: "today", category: "major" },
  { source: "NBC News", title: "Enzo Fernandez sent off in the 93rd minute as Argentina play the whole of extra time a man down in the final", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Besiktas president says Salah's camp raised their commission demand to 35 per cent and calls the figure 'astronomical'", time: "today", category: "major" },
  { source: "ESPN", title: "Emi Martinez makes a World Cup final record eleven saves in defeat as Mac Allister ends the tournament a runner-up", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool fly into 'unhealthy' Chicago air as Canadian wildfire smoke triggers an air quality alert across the city", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Career path, Spain impact and history-maker: the club marks Victor Munoz's World Cup medal", time: "today", category: "official" },
  { source: "TeamTalk", title: "FSG plan a concrete bid for Yankuba Minteh at around £70m after learning Arsenal lead the race for Bradley Barcola", time: "today", category: "major" },
  { source: "Football365", title: "Chelsea named as Mohamed Salah's 'first choice' should he decide to stay in the Premier League", time: "1d ago", category: "major" },
  { source: "Anfield Watch", title: "Said El Mala decision made: Koln intend to keep the £43m forward through 2026-27 with any move waiting on 2027", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Conor Bradley's knee may keep him out until 2027 as the reporting on his return date hardens", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Trey Nyoni: 'Pre-season tour is an opportunity, I want to show what I can do'", time: "1d ago", category: "official" },
  { source: "Chicago Sun-Times", title: "'Hazardous' Canadian wildfire smoke prompts air quality warning across the Chicago area as 800 fires burn", time: "2d ago", category: "major" },
  { source: "El Gol Digital", title: "Liverpool confident of a fee below Haissem Hassan's €12m clause at a relegated Real Oviedo, with Celtic circling", time: "2d ago", category: "fan" },
  { source: "Liverpool FC", title: "Wirtz, Van Dijk, Gravenberch, Gakpo and Isak to join the tour in week one, Alisson in week two", time: "3d ago", category: "official" },
];
