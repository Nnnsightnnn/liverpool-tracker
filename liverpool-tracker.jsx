...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Fri Sep 11, afternoon — 'the way it roars, I've never heard anything like it,' he told the club on Thursday night of his first European start, in which he worked Llorente out over time and went outside him in the build-up to the winner per Rousing The Kop, before cramping on the hour. Ngumoha says Iraola 'drives the fight within us' and asks him to defend as well as attack. Whether he starts against Fulham on Saturday depends on Gakpo's Friday afternoon test; if the Dutchman waits for Tuesday, Ngumoha or Munoz takes the left, and 3 Added Minutes' predicted XI has the teenager", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "BBC Sport", title: "Noon presser: Gakpo 'will try today', the Fulham call waits on Friday's session; Barcola has 'no injury' and should be available", time: "today", category: "major" },
  { source: "Sports Mole", title: "Arbeloa reports no fresh Fulham injuries and answers unrest reports: Kevin's 'no speak, no hear, no see', Iwobi and Smith Rowe wipe their feeds", time: "today", category: "major" },
  { source: "TEAMtalk", title: "Warnock: Araujo's switch to right-back is permanent, with Jacquet inside beside Van Dijk; the loan carries a €55m option and he is happy to stay", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Match officials: Tom Bramall referees Liverpool v Fulham, Tony Harrington on VAR; Sports Mole notes three straight league draws at Anfield", time: "today", category: "official" },
  { source: "3 Added Minutes", title: "Predicted XI: Ngumoha on the left with Gakpo not yet back in a full session, Gomez in line for a first bench of the season", time: "today", category: "fan" },
  { source: "Opta Analyst", title: "Isak's xG per shot up from 0.16 to 0.25 and three league goals already equal all of last season; one more on Saturday passes it", time: "today", category: "fan" },
  { source: "Liverpool Echo", title: "Alisson fined £8,000 by the FA for the numbers board after the Forest draw; charge accepted, no ban", time: "1d ago", category: "major" },
  { source: "Goal", title: "Ancelotti leaves Alisson out of Brazil's squad for the break: 'right now we have to prioritise the younger ones'", time: "1d ago", category: "major" },
  { source: "Sports Mole", title: "Why Iraola has dropped Gravenberch three games running for Mac Allister and Szoboszlai, and the six-year deal that complicates it", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Ngumoha on his first European start: 'The way it roars, I've never heard anything like it'; Iraola 'drives the fight within us'", time: "1d ago", category: "official" },
  { source: "Football365", title: "Van Dijk 'tempted to quit' next summer with Saudi interest, says Football Insider's Mick Brown; staying 'not out of the question'", time: "1d ago", category: "fan" },
  { source: "AnfieldWatch", title: "Murray-Holme, an England youth midfielder likened to Wharton, agrees his first professional contract at Liverpool", time: "1d ago", category: "fan" },
  ...
  { source: "Empire of the Kop", title: "Romano's 'here we go': Manchester United complete a deal for 16-year-old Isaac Konde, the first direct move between the clubs since 1964", time: "4d ago", category: "fan" },
];
