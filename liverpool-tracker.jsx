...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sat Jun 6 — declared untouchable: Bayern Munich's approach for the 17-year-old — calls, meetings, even a reported verbal agreement with his camp — collapsed within hours against Liverpool's flat refusal to name a price. Romano reports 'zero intention' of a sale; the youngest goalscorer in the club's history is a crucial part of the project, not a chip to cash", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
...
const LATEST_NEWS = [
  { source: "Goal / Fox Sports / TribalFootball", title: "Diomandé tilts to PSG: the 19-year-old reported to have given Paris a verbal yes pending a fee, with Leipzig minded to keep him and BILD touting up to €150m", time: "today", category: "major" },
  { source: "Football365", title: "Iraola greenlights Plan B after the Diomandé blow — Sporting's Francisco Trincão, a ~€60m clause, the calmer route to a wide forward", time: "today", category: "major" },
  { source: "Fabrizio Romano / Sky Germany", title: "Bayern's move for 17-year-old Rio Ngumoha collapses within hours — Liverpool 'untouchable' stance, 'zero intention' of selling, no price even discussed", time: "today", category: "major" },
  { source: "Football365 / Liverpool.com", title: "Iraola eyes as many as eight exits in his first act — Jones, Elliott, Gomez, Mac Allister, Endo and Chiesa among those who could go", time: "today", category: "major" },
  { source: "Football365 / Liverpool.com", title: "Alisson snubs Juventus to stay at Anfield another season — and Mamardashvili now looks the goalkeeper likelier to leave, on loan", time: "today", category: "major" },
  { source: "This Is Anfield / TeamTalk", title: "Iraola a 'huge fan' of Rayan: the £130m Bournemouth winger named a 'first-three' target, but the clause only opens in January 2027", time: "today", category: "fan" },
  { source: "Football365 / Yahoo Sports", title: "Alex Scott a £40m first-signing option for Iraola — but Manchester United and Tottenham are credited with interest in the Bournemouth midfielder", time: "today", category: "major" },
  { source: "Goal / Football365", title: "First two Iraola signings could cost £170m as the Ordóñez–winger double is 'approved' — Chelsea and City still circle the Brugge defender", time: "1d ago", category: "major" },
  { source: "This Is Anfield / ESPN", title: "Salah holds the line: 'I'm going to the World Cup and then everything will become clear' — no regrets, but the goodbye stays sealed", time: "today", category: "fan" },
  { source: "This Is Anfield / Premier League", title: "Iraola's 'frantic football', by the numbers: fewer passes, more chaos, a relentless press — the Klopp comparisons explained", time: "1d ago", category: "fan" },
  { source: "Liverpool.com / Empire of the Kop", title: "Iraola's pre-season blueprint: ~8 first-teamers report late from the World Cup, opening the US tour to an academy audition", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / beIN Sports", title: "Konaté's free move to Real Madrid waits on Sunday's contested Bernabéu election — a Pérez win expected to trigger the announcement", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Full pre-season set: Sunderland (Nashville), Wrexham (Yankee Stadium), Leeds (Soldier Field), then Monaco and Como at Anfield", time: "2d ago", category: "official" },
  { source: "Liverpool FC", title: "Thirteen LFC Women called up for June internationals as European qualification for the 2027 World Cup reaches its crescendo", time: "2d ago", category: "official" },
];
