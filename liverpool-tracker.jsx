...
const PLAYERS = [
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Sat Aug 22 — kept, and in line to start the opener. Liverpool still do not expect Gakpo to leave for Tottenham before the deadline, the hierarchy won over by a pre-season under Iraola in which he scored against Como. Spurs opened a little over £60m and were sent away, Liverpool nearer £72m, and with Jones' sale to Inter now confirmed and funding the window the pressure to bank him has gone. He signed fresh Anfield terms only last year, and the manager wants width and goals he can trust. Nine goals and six assists in 39 appearances last term, and he is tipped to start on the right at Newcastle with Ngumoha pushing", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
...
const LATEST_NEWS = [
  { source: "ESPN", title: "Official: Inter Milan complete €35m signing of Curtis Jones as the last Scouser leaves", time: "today", category: "major" },
  { source: "Football365", title: "Liverpool put £115m to PSG for Barcola as Paris drop their ask toward £125m", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola confirms Van Dijk captaincy and names Alisson, Gomez and Szoboszlai vice-captains", time: "today", category: "official" },
  { source: "Sky Sports", title: "Iraola on his opener: 'this week smells different' and 'we don't have enough wingers'", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Predicted XI: Araujo set for competitive debut and Jacquet in line for a Premier League bow", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Isak braced for a hostile Newcastle return in red as both clubs remember Keegan", time: "1d ago", category: "major" },
  { source: "Sports Mole", title: "Newcastle without Joelinton and sweating on Schar and Livramento for the opener", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Gomez misses Tyneside and targets the August 29 Forest home opener as the defence travels light", time: "2d ago", category: "fan" },
  { source: "Football Insider", title: "Endo edges toward the exit as Wolves, Fulham and West Ham circle a trimming midfield", time: "2d ago", category: "fan" },
  { source: "Football Italia", title: "Jones becomes the third England international to join Inter this window after Stones and Spence", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Mbaye double-raid thread stays open as Liverpool pour everything into the Barcola move", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Ekitike pictured leaning on a cane with a festive-period comeback the notional target", time: "3d ago", category: "fan" },
  { source: "UEFA", title: "Champions League league-phase draw set for August 27 with Liverpool a fifth seed", time: "today", category: "official" },
  { source: "Daily Sabah", title: "Salah settles at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "2w ago", category: "major" },
];
