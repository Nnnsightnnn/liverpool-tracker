...
const LATEST_NEWS = [
  { source: "El Desmarque", title: "Simeone weighs a back three at Anfield after Bilbao: Romero in, Grimaldo to wing-back or the bench, Llorente right", time: "today", category: "major" },
  { source: "Caught Offside", title: "Liverpool linked with free agent Dani Carvajal, signable with the window shut, after Lescott's 'there's talk of Liverpool' on TNT", time: "today", category: "fan" },
  { source: "ESPN", title: "Arsenal 2-1 Chelsea: Havertz and Odegaard put the champions level with City on nine, Chelsea drop to fourth a point above Liverpool", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Kerkez: 'Now games come every three days', Atletico, Fulham and Tottenham at Anfield inside a week", time: "today", category: "official" },
  { source: "El Gol Digital", title: "Simeone returns to Anfield without a win there since March 2020, Sorloth carrying a contracture and Alvarez unsettled", time: "today", category: "fan" },
  { source: "NBC Sports", title: "Everton 2-2 Manchester United: Maitland-Niles levels in the 96th minute on debut, five sides now on five points with Liverpool", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Ward, Woodfine and Marques the three names 'likely to be considered', a fourth sporting director in as many years", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Carvajal to Liverpool theory raised as Reds look ahead to January window", time: "today", category: "fan" },
  { source: "DaveOCKOP", title: "Eight players could miss Liverpool v Atletico: six Reds absentees, Sorloth doubtful and Ortiz suspended for the visitors", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Loan watch: Morrison forces an own goal and sets up the winner as Sheffield Wednesday beat Peterborough", time: "1d ago", category: "official" },
  { source: "Liverpool.com", title: "Iraola decided to let Jacquet 'suffer' through a second-half doubt rather than substitute him at Ipswich", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "'He owes me a few now': Gakpo on three assists for Isak's three goals and 'beautiful things ahead'", time: "1d ago", category: "major" },
  ...
  { source: "AFP", title: "Athletic Bilbao 3-0 Atletico Madrid: Williams, Navarro and Sancet, Simeone's side undone in five second-half minutes before Anfield", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Ipswich 0-2 Liverpool: Isak's quickfire double and Alisson's 138th clean sheet give Iraola a first win", time: "2d ago", category: "official" },
];
