...
const PLAYERS = [
  ...
  { id: 24, name: "Hugo Ekitike", number: 22, position: "FWD", nationality: "🇫🇷 France", age: 23, appearances: 41, goals: 18, assists: 5, cleanSheets: null, xG: 14.2, tacklesPer90: 0.4, passCompletion: 78, progressiveCarries: 2.1, form: 7.3, status: "injured", injuryNote: "Fri Jul 24 — filed by the manager under way off. Iraola grouped Ekitike with Bradley as the two furthest from fitness, the Achilles ruptured against PSG in April still tracking toward the festive period, close enough to the Boxing Day target he set himself to stop it being an argument and short of the twelve-month end of April's nine-to-twelve-month scan. He has flown to the United States to rehabilitate under the medical staff, taking no part in the three friendlies, and remains hopeful of playing again before the end of 2026", image: "https://r2.thesportsdb.com/images/media/player/cutout/8za47v1757087851.png" },
...
const LATEST_NEWS = [
  { source: "CaughtOffside", title: "Liverpool confident of beating Arsenal and Bayern to a £100m deal for PSG winger Bradley Barcola as club-to-club talks progress", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "£85m opening bid rejected but mood flips: Liverpool now leading the race for Barcola despite PSG's £128m valuation", time: "today", category: "major" },
  { source: "beIN Sports", title: "Iraola confirms Ekitike and Bradley are 'way off' as Liverpool carry a triple long-term injury blow onto the US tour", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Vice-captaincy narrows to Szoboszlai or Chiesa as Iraola prepares to name Van Dijk's deputy in the coming weeks", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Szoboszlai on the armband: 'If it's me, I'm ready to do it' after signing a new five-year deal", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Akliouche approach still stands but slides behind Barcola as Liverpool's deliverable winger fallback", time: "1d ago", category: "major" },
  { source: "Yahoo Sports", title: "Josh Abe among 11 academy players on tour, the 16-year-old framed as the next Rio Ngumoha", time: "1d ago", category: "fan" },
  { source: "Al Jazeera", title: "Salah-Besiktas saga stays a standoff of agreed terms and public denials as agent Ramy Abbas muddies the picture", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Iraola's plea made plain: Liverpool 'definitely need to sign a winger' and a centre-back before August 23", time: "1d ago", category: "major" },
  { source: "ESPN", title: "Leoni running outdoors and furthest advanced of the injured trio as the ACL recovery reaches ten months", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Curtis Jones staying as Inter's money falls short and Liverpool weigh fresh terms", time: "2d ago", category: "major" },
