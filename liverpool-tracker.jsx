...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Tue Sep 15, matchday - the left wing is his tonight. Rousing The Kop expect Ngumoha to start wide on Tuesday with Munoz on the opposite flank, arrived at largely by elimination: Barcola cannot start, Isak will not, Gakpo is only just back. Saturday's cameo, on for Barcola at 72, was poor enough to draw a 4, an overhit cross and a counter conceded, so this is a chance to answer that rather than repeat it.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Tue Sep 15, matchday - a bench place at most behind the confirmed starter. With Mamardashvili confirmed as Tuesday's starter, the third goalkeeper's involvement is a place among the substitutes rather than anything more; he was not on Saturday's nine-man bench, which carried Mamardashvili alone. A settled and quiet role behind two senior goalkeepers, and one that will not be tested until a cup round somewhere further on.", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Matchday: Liverpool host Tottenham tonight at 8pm in the Carabao Cup third round, Iraola's first domestic cup tie", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Predicted XI: Koumas through the middle, Gakpo restored to lead the line, Ngumoha and Munoz wide in a rotated side", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Homecoming: Andy Robertson set to start at Anfield for Spurs on his first return since leaving in the summer", time: "today", category: "major" },
  { source: "To The Lane And Back", title: "'I will not strip my side down': De Zerbi rotates but hands Kudus a first start as Spurs chase a first league goal", time: "today", category: "major" },
  { source: "Liverpool Echo", title: "Gomez available after seven weeks out, but Iraola says the length of his outing is still to be decided", time: "today", category: "major" },
  { source: "SI", title: "The boy he would not sell: Koumas handed his chance through the middle, the man Iraola was 'so desperate to keep'", time: "today", category: "fan" },
  { source: "EFL", title: "Ten titles and counting: Liverpool enter the round as the competition's most decorated club, unbeaten since 2025", time: "today", category: "major" },
  { source: "ESPN", title: "No VAR, no extra time: a level ninety at Anfield goes straight to penalties in round three", time: "today", category: "major" },
  { source: "TEAMtalk", title: "January whispers: Liverpool 'prepared to break their transfer record again' for Vasco winger Rayan", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Arsenal said to be monitoring a Liverpool winger, with Bayern and Real circling a £43m midfield target", time: "today", category: "fan" },
  { source: "Rousing The Kop", title: "Ngumoha handed the left as the rotation reaches the flanks and a young team assembles around him", time: "today", category: "fan" },
  { source: "ESPN", title: "Eighth and idle: Liverpool watch the table settle before Sunday's trip to a winless Bournemouth", time: "1d ago", category: "major" },
  { source: "Sports Mole", title: "Injury latest: Chiesa targets mid-October, with Ekitike, Bradley and Leoni all longer-term absentees", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Mamardashvili confirmed to start in goal, a first appearance of the season for the Georgian", time: "1d ago", category: "official" },
];
