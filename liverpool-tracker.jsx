...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sat May 16 — led the line in last night's 4-2 Villa Park defeat at 17 after Isak's late withdrawal; one of the few bright spots in a wretched team display per Goal.com's player ratings ('despite the best efforts of teenager Rio Ngumoha'). Couldn't conjure a goal but ran channels and drew fouls. The teen remains Slot's bright young find — start expected at Brentford May 24 with Isak's fitness uncertain", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Sat May 16 — third-choice back-up to Mamardashvili at Villa Park last night (4-2 defeat); Alisson left out of the squad for an 11th straight game. Two PL starts this season (Crystal Palace and Old Trafford); serviceable cover for the Brentford finale May 24 if Alisson still isn't ready", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
];
...
const LATEST_NEWS = [
  { source: "Al Jazeera / ITV / Euronews / Liverpool.com", title: "CONFIRMED: Chelsea appoint Xabi Alonso as new manager on a four-year deal starting July 1 — ex-Real Madrid boss snubs a 'wait for Liverpool' play, ends FSG's most-discussed Plan B and leaves Slot's replacement market suddenly thin (announcement carried by Stamford Bridge late Sun, headlines lead Monday papers)", time: "today", category: "major" },
  { source: "Liverpool.com / This Is Anfield", title: "Why Xabi Alonso 'turned down' Liverpool — Sunday-into-Monday read: Alonso's camp made clear weeks ago he wanted certainty NOW, FSG would not move on Slot in-season, and Chelsea's BlueCo offered four years and full footballing control. The Stamford Bridge appointment lands a body blow to Anfield's contingency plans", time: "today", category: "major" },
  { source: "This Is Anfield / Caught Offside / Football FanCast", title: "Andoni Iraola back in the frame as Liverpool's top external candidate — with Alonso gone to Chelsea, Richard Hughes's Bournemouth-era ally is now the headline name in any FSG conversation about a Slot successor (Monday-morning briefing cycle)", time: "today", category: "major" },
  { source: "Caught Offside / SI / beIN Sports", title: "17 past and present Liverpool players have now liked Salah's anti-Slot post — Caught Offside's Monday tally adds Konaté, Wirtz and Gakpo to the original SportBible nine; SI labels it 'a brutal swipe' that pits players, fans and legends against each other", time: "today", category: "fan" },
  { source: "TNT Sports / This Is Anfield / Tribuna", title: "Steven Gerrard's 'damning' verdict on Slot: 'Identity's gone' — the Liverpool icon doubles down on Saturday's intervention, telling TNT Sports Salah's post is 'quite damning to the manager.' Picked up across Monday's back pages as the punditry consensus hardens", time: "today", category: "major" },
  { source: "beIN Sports / Liverpool.com", title: "Salah takes 'another swipe' at Slot amid Liverpool crisis — beIN's Sunday-night carry has the Egyptian doubling down with a second social post; manager and talisman now openly briefing through their platforms with six days until the Brentford farewell", time: "today", category: "major" },
  { source: "Liverpool.com / Per Second News", title: "Slot under siege on TWO fronts as Monday papers lead with 'crumbling Liverpool' — FSG above (no public backing in 48 hours), dressing room beside (now 17 players publicly aligned with Salah). The Brentford finale becomes referendum night", time: "today", category: "major" },
  { source: "Liverpool.com / ESPN / Sky Sports", title: "Champions League maths heading into MW38: Liverpool 5th on 65 pts need a Brentford win OR Bournemouth (61, host Man City Tue) and Chelsea (61) to drop points. A Bournemouth defeat tomorrow night essentially seals top-five before kickoff Sun May 24", time: "today", category: "major" },
  { source: "Liverpool.com / Liverpool FC", title: "Pre-Brentford fitness watch: Slot 'hopeful' on Alisson, Isak AND Frimpong for the home finale — all three were absent at Villa Park, all three reported in light training Monday morning; team news firms up at Friday's presser", time: "today", category: "official" },
  { source: "Sky Sports / NBC Sports / ESPN", title: "Aston Villa 4-2 Liverpool: Watkins brace, Rogers and McGinn fire Emery's side to Champions League as Slot's team ripped apart — Van Dijk's two headers (52', 90+) the lone reply on a night that dropped the Reds to 5th", time: "3d ago", category: "major" },
  { source: "Liverpool FC / NBC Sports / Yahoo", title: "Slot post-match Villa Park: 'damaging — three out of four from set pieces' — manager again insists 'I have every reason to believe I am the Liverpool manager next season,' a line that has not aged well over the weekend", time: "3d ago", category: "official" },
  { source: "Goal.com / Sports Illustrated", title: "Liverpool player ratings vs Aston Villa: 'Wretched Reds routed by Watkins & Co. despite best efforts of teenager Rio Ngumoha' — Van Dijk's 8/10 the lone bright spot in a 4-2 defeat that knocks Liverpool out of the top four", time: "3d ago", category: "major" },
  { source: "ESPN / Sports Mole / Sky Sports", title: "Alexander Isak ruled out of Villa Park with 'minor injury' — Slot at kickoff: 'Indeed, Alex is out — minor injury,' citing missed pre-season and the broken-leg recovery; Liverpool 'hopeful' for the Brentford finale May 24", time: "3d ago", category: "major" },
  { source: "Anfield Watch / FootballTransfers", title: "Alisson Becker 'agrees €15m deal' to leave Liverpool — Nicolò Schira pegs the personal terms at €5m a year on a Juventus contract as the Brazilian's Anfield exit firms up after an 11th straight game absent", time: "5d ago", category: "fan" },
  { source: "Liverpool.com", title: "Ibrahima Konaté contract 'stalemate' with Liverpool — signing-on package and agent commissions the sticking points, Real Madrid still circling as the Frenchman is exposed by Villa's set-piece play on Friday", time: "5d ago", category: "major" },
];
