...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Barcola deal 'difficult to complete' after talks as Liverpool weigh the £145m gap", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Ian Doyle warns Liverpool not to pay an 'extortionate' fee for Bradley Barcola", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Mbaye given priority by Liverpool, but Borussia Dortmund enter the race", time: "today", category: "fan" },
  { source: "Fabrizio Romano", title: "'Going to be movement' on Curtis Jones as Inter wait on Frattesi's exit", time: "today", category: "major" },
  { source: "The Kopite View", title: "Liverpool make direct contact with Crystal Palace over Adam Wharton", time: "today", category: "fan" },
  { source: "Football Insider", title: "Liverpool make Wataru Endo available as Wolves, Fulham and West Ham circle", time: "1d ago", category: "major" },
  { source: "Football365", title: "FSG-Bezos stake sale still awaits its announcement as the Kop seeks clarity", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Como close the pre-season in an Anfield double-header on Sunday", time: "1d ago", category: "official" },
  { source: "Liverpool.com", title: "Ekitike targeting a festive-period return as Leoni nears team training", time: "1d ago", category: "fan" },
  { source: "Goal", title: "Jacquet set for his pre-season bow against Como as Araujo is available", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Gakpo stays a condition, not a sale, as Tottenham's interest is priced above £70m", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 2-3 Monaco: Reds throw away a two-goal lead on Iraola's Anfield bow", time: "4d ago", category: "major" },
