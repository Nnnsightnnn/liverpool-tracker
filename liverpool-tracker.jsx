...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "injured", injuryNote: "Sat May 9 (matchday) — Slot confirmed in Friday's presser: 'Salah and Alisson won't play on Saturday.' Eight consecutive PL matches missed with the hamstring; has not yet resumed team sessions per Liverpool FC's official injury list. Off the pitch, Liverpool.com (Schira) and FootballTransfers report Alisson has 'agreed personal terms with Juventus' on a €5m-a-year deal; €15m fee mooted. Reds drawing up a five-keeper shortlist headed by Chevalier (PSG) — Aston Villa (A) Fri May 15 the more realistic return", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  { id: 2, name: "Giorgi Mamardashvili", number: 25, position: "GK", nationality: "🇬🇪 Georgia", age: 25, appearances: 17, goals: 0, assists: 0, cleanSheets: 5, xG: 0, tacklesPer90: 0, passCompletion: 76, progressiveCarries: 0.1, form: 6.8, status: "fit", injuryNote: "Sat May 9 (matchday) — surprise early return: Slot confirmed in Friday's presser the Georgia keeper is back a week ahead of schedule, with Romano (EOTK) reporting Liverpool 'confident' he STARTS vs Chelsea today. Beto's Apr 19 boot-stud knee wound finally healed, displacing Woodman from the XI. Liverpool.com lead: 'Mamardashvili surprise.' Could be the first-choice for the Aston Villa trip Fri May 15 too with Alisson still hamstrung", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p449027.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 17, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.7, status: "doubtful", injuryNote: "Sat May 9 (matchday) — Slot confirmed Friday Isak rejoined training Thursday for the first time since the Apr 25 Crystal Palace groin strain. Set to return to the matchday squad vs Chelsea but a bench role 'the best possible outcome' (Goal.com). Some predicted XIs (Last Word) still pencil him in to start; Liverpool.com expects bench. Sat May 9 12:30 BST kick-off the firm call", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Drops back to the bench for Chelsea (H) May 9 — Mamardashvili surprisingly fit again a week ahead of schedule per Slot's Friday presser, replacing Woodman in the XI. Two PL starts this season (Crystal Palace and Old Trafford) ratings 6-7; serviceable cover for the run-in", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
];
...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Liverpool v Chelsea team news — TODAY 12:30 BST kick-off at Anfield: Mamardashvili and Isak return to training as Reds chase Champions League seal", time: "today", category: "official" },
  { source: "Empire of the Kop", title: "Romano hints at Liverpool team news boost before Chelsea clash — confident Mamardashvili returns to start vs Chelsea, replacing Woodman", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool vs Chelsea: Injury News, Predicted XI & How to Watch — Mamardashvili back, Wirtz fit, Salah and Alisson OUT for 12:30 BST kick-off", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Why Wirtz and Konate missed Liverpool training as Slot issues pre-Chelsea update — Wirtz had minor illness, Konaté absent for 'personal reason'", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Florian Wirtz and Ibrahima Konate update as Arne Slot confirms two huge Liverpool boosts — both expected to start vs Chelsea, Salah ruled out", time: "1d ago", category: "major" },
  { source: "Goal.com", title: "Arne Slot calms Konaté and Wirtz injury fears as Liverpool boss provides hopeful Alexander Isak update — Mamardashvili surprise return to training", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Arne Slot shares Liverpool injury update on Isak, Salah and Alisson before Chelsea — six-player update as Reds chase top-five lock-in", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Mamardashvili surprise, latest on Isak, Salah & 3 more: full Liverpool injury update — Georgia keeper back a week ahead of schedule", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Mac Allister Agent: Why We Have Declined Liverpool Transfer Talks — Carlos Mac Allister: 'No talks during the season, the fans deserve commitment'", time: "1d ago", category: "fan" },
