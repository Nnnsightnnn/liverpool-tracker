...
const PLAYERS = [
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 40, goals: 10, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 7.0, status: "fit", injuryNote: "Fri Aug 28 — the sale the manager would rather not make. Iraola called Gakpo very influential and said he hopes he stays, softening a week that began with the Dutchman framed as the funding sale at around £72m. Manchester City and Tottenham are both interested, but Liverpool will not sanction an exit without a replacement secured, and none is in the building. He dragged Liverpool level at Newcastle on the opening day and is contracted to 2030. Saturday's Forest visit may be his stage a while longer", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Fri Aug 28 — eighteen tomorrow, with a contract waiting behind it. Ngumoha turns 18 on Saturday, the day Forest visit, and This Is Anfield report a new five-year deal with a significant rise set to follow, the delay only a rule capping under-18s at three-year terms. He was a bench option at Newcastle. The flank around him is no clearer: Barcola a medical away, Sarr chased at Palace, Gakpo no longer a certain sale, which is a crowd where a fortnight ago there was a shortage. The path is still there, just narrower than it looked at lunchtime", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "TeamTalk", title: "Barcola cleared to fly: PSG green light expected, medical next, five-year deal to 2031", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Palace stand firm on Sarr after \u00a350m rejected: 'no intention of selling'", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Still hunting a centre-back: Upamecano and Tomori on Liverpool's deadline shortlist", time: "today", category: "major" },
  { source: "Sky Sports", title: "Barcola \u00a3120m breakdown: \u00a3100m guaranteed plus \u00a320m add-ons, debut earmarked after the window", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Mick Brown: Crystal Palace have no intention of selling Ismaila Sarr as the window narrows", time: "today", category: "fan" },
  { source: "ESPN", title: "Iraola on Gakpo: 'very influential, I hope he stays' with City and Spurs circling", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola on Forest: 'Glasner's shape is clear straight away, they don't concede many chances'", time: "today", category: "official" },
  { source: "AOL", title: "Iraola talks Gannon-Doak, international call-ups and the goals a young side must find", time: "today", category: "major" },
  { source: "FootballTransfers", title: "Iraola's promise: Liverpool will 'definitely' add at least one more before Tuesday", time: "today", category: "major" },
  { source: "Goal", title: "Preview: pointless Forest visit Anfield, where they have won their last two", time: "today", category: "major" },
  ...
  { source: "UEFA", title: "Champions League draw: Atletico, Porto, Villarreal and Lens to Anfield; Inter, Brugge, Fenerbahce, LASK away", time: "1d ago", category: "official" },
  ...
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's stoppage-time penalty rescues Iraola's opener", time: "5d ago", category: "major" },
];
