...
const LATEST_NEWS = [
  { source: "This Is Anfield / Al Jazeera", title: "Salah's Liverpool era formally ends: the contract lapses today and the Egyptian is a free agent, his next club not yet chosen as Saudi leads", time: "today", category: "major" },
  { source: "Liverpool.com / Yahoo Sports", title: "Barcola talks move to the player's camp: Liverpool open dialogue as their Gestifute ties offer hope on the Salah heir", time: "today", category: "major" },
  { source: "This Is Anfield / Sky Sports", title: "Liverpool sound out Bruno Guimarães but leave it at an enquiry, with Arsenal readying an £80m approach for the Newcastle captain", time: "today", category: "fan" },
  { source: "Football365 / Rousing The Kop", title: "A clause on the clock: Schlotterbeck's €50-60m release window, open to just three clubs, sharpens Liverpool's centre-back hunt before mid-July", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Bouaddi's camp meets Liverpool: the No. 6 file stirs again as the Lille teenager's reps hold talks, though Lille want €70m", time: "1d ago", category: "fan" },
  { source: "ESPN / Sky Sports", title: "Two more walk for nothing: Konaté (Real Madrid) and Robertson (Tottenham) free transfers take effect as their deals lapse today", time: "today", category: "official" },
  { source: "OneFootball / Talksport", title: "Forest's £116m Anderson windfall funds a £40m move for Curtis Jones as Inter's bids stall and Arsenal watch", time: "1d ago", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season takes shape: squad reports July 13, with home friendlies vs Monaco (Aug 9) and Como (Aug 16) added to the US tour", time: "2d ago", category: "official" },
  { source: "Liverpool FC", title: "New shirt lands: Liverpool release the 2026-27 home kit, the first of the post-Salah era under Andoni Iraola", time: "4d ago", category: "official" },
  { source: "Goal / Fox Sports", title: "Salah hamstring doubt for Friday: Egypt sweat on their captain for the World Cup last-32 tie with Australia in Arlington", time: "1d ago", category: "major" },
  ...
  { source: "Anfield Watch / This Is Anfield", title: "Right-back search runs on: Inter's Denzel Dumfries and Leipzig's Geertruida floated as Conor Bradley's knee rehab drags", time: "3d ago", category: "fan" },
