...
const PLAYERS = [
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Fri Aug 15 — filmed in training, even as Inter circle. Jones, over a minor hip complaint, was among those pictured back in training before Sunday's Como double-header, available if Iraola wants him. Off the grass the exit inches: the reported Inter 'breakthrough' holds, talks now down to the figures after an informal €35m fell short of a €40m ask, his file long tangled in a Frattesi domino. Into his final year and thought unlikely to extend, a boyhood Red edges nearer the door even while he trains for the shirt", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Fri Aug 15 — the summer's live sale. Tottenham have stepped up, talks between the clubs now described as underway and Dutch outlets claiming an agreement in principle with the player plus a £60m-plus bid, though sources close to Gakpo deny anything is settled. De Zerbi wants two wide men and rates him highly; Liverpool's position is a price rather than a refusal, willing to sell above roughly £70m and only once the wingers they want have landed. Said to be unsettled since Slot's exit, nine goals and six assists in 39 appearances last term, a forward Iraola would rather reshape around than cash in, now suddenly the exit closest to happening", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sun Aug 16 — the shirt is his until Paris lets go. Ngumoha keeps the post-Salah right-sided slot by default, but the wait is shortening: PSG spent the weekend buying Barcola's replacements in Torres and Godts and are now willing to lower his price, and with Minteh injured the alternative board is down to Rayan's dormant clause and Everton's Ndiaye. The 17-year-old, youngest goalscorer in the club's history, held the spotlight through the Sunderland and Wrexham wins and could feature again in today's Como double-header. He is reported to have no intention of leaving. Until a senior winger signs, the berth stays his", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Barcola boost: PSG sign Ferran Torres and agree Godts, clearing his exit path", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "PSG 'willing to lower' Barcola price after buying his replacements", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Como close the pre-season at Anfield today: Araujo set for his bow", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Winger 'target' Yankuba Minteh ruled out up to three months with a leg injury", time: "today", category: "fan" },
  { source: "Football365", title: "Reds hold 'genuine interest' in Everton's Iliman Ndiaye as £75m ask looms", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool drop Curtis Jones asking price as blocked Frattesi sale snags Inter", time: "today", category: "fan" },
  { source: "FourFourTwo", title: "Tottenham reach agreement in principle for Cody Gakpo at around £60m", time: "today", category: "major" },
  { source: "BeSoccer", title: "Iraola without Gomez, Leoni, Bradley, Ekitike and now Danns for Como", time: "1d ago", category: "fan" },
  { source: "Football Insider", title: "RB Leipzig stay favourites for Harvey Elliott as the clear-out continues", time: "1d ago", category: "fan" },
  ...
  { source: "Liverpool.com", title: "Iraola: Gomez racing the Forest opener after missing Newcastle away", time: "2d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Mac Allister's camp shut down the City link, insisting the Argentine stays", time: "2d ago", category: "fan" },
