...
const LATEST_NEWS = [
  { source: "Fabrizio Romano", title: "Gakpo agrees personal terms with Manchester City and green-lights a five-year deal, £85m package, clubs in contact over the fee", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool's condition holds: no Gakpo sale until a second winger arrives, and Barcola alone does not count", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Liverpool make contact with Pedro Neto's representatives over a late move from Chelsea", time: "today", category: "major" },
  { source: "TeamTalk", title: "Contact made with Bournemouth over Rayan, the Brazilian Iraola coached, with a £130m release clause in the way", time: "today", category: "major" },
  { source: "Football365", title: "Brighton talks reopened over Yankuba Minteh after the £80m quote had closed the file", time: "today", category: "major" },
  { source: "TeamTalk", title: "Third time asking: Liverpool prepare a new proposal for Ismaila Sarr after two Palace rejections", time: "today", category: "major" },
  { source: "Sky Sports", title: "Barcola's medical complete but the announcement slips to Monday, with Ligue 1 shutting first", time: "today", category: "major" },
  { source: "ESPN", title: "Liverpool 13th after two weekends, a place and a point below Friday's hosts Ipswich Town", time: "today", category: "major" },
  { source: "Goal", title: "Harvey Elliott agrees personal terms with Valencia, choosing Mestalla over Napoli and Lazio", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "'I cannot guarantee anything': Iraola declines to promise Gakpo will still be here on Wednesday", time: "2d ago", category: "fan" },
  { source: "The Independent", title: "Alex Scott named Liverpool's top defensive-midfield target, with a reported £90m the complication", time: "3d ago", category: "major" },
  { source: "Liverpool FC", title: "Gomez trains fully and targets Portman Road, leaving four out: Ekitike, Bradley, Leoni and Chiesa", time: "1d ago", category: "official" },
  ...
  { source: "Empire of the Kop", title: "Bajcetic's Celta homecoming runs through a mutual termination as Besiktas circle Tsimikas and Mamardashvili", time: "2d ago", category: "fan" },
  { source: "ESPN", title: "Newcastle 2-2 Liverpool: Szoboszlai's stoppage-time penalty rescues Iraola's opener", time: "1w ago", category: "major" },
];
