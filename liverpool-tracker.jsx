...
const PLAYERS = [
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Sat Jun 13 — 'one step away,' per Anfield Watch: having said yes to Inter and rebuffed Aston Villa, Newcastle and Forest, the Scouser is now framed a single meeting from a ~€25m move, a sell-on clause forming as Hughes and Ausilio close the last of the gap to Liverpool's ask. The only Merseyside-born player in the squad looks the window's likeliest first exit; the reluctance has become paperwork", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Sat Jun 13 — the last act reaches the pitch: Salah captains Egypt at the World Cup as his release stays official and his Liverpool contract lapses June 30, a free agent between group games. Turkey still heads the reported queue for his next address, ahead of Saudi Arabia and MLS; for now the stage is his, and it is enormous", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Sat Jun 13 — caught between two wings: with Barcola's PSG door now open beside the still-unanswered Diomandé bid, the Dutchman's mooted makeweight role reads as live arithmetic against an asking price near €140m, while Tottenham's interest in a straight sale near €45m holds. He joins the Netherlands' World Cup camp regardless, having asked to leave rather than fight Ngumoha for the left wing", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
...
const LATEST_NEWS = [
  { source: "Empire of the Kop / L'Équipe", title: "PSG open the door on Bradley Barcola: Romano's overnight 'fire and eyes' hint as L'Équipe report the French side 'not completely opposed' to a £86m sale, Liverpool and Arsenal both ready", time: "today", category: "major" },
  { source: "Liverpool FC / ESPN", title: "The World Cup reaches the Reds: Alisson starts for Brazil against Morocco this afternoon, the first current Liverpool player on the pitch, with Robertson's Scotland to follow", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Iraola's first words to the squad: 'For me, you're all new signings' as the new boss sketches a US pre-season the World Cup internationals will largely miss", time: "today", category: "fan" },
  { source: "Anfield Watch", title: "Curtis Jones 'one step away' from a €25m Inter Milan move after rejecting Villa, Newcastle and Forest; a sell-on clause forms and a closing meeting is set", time: "1d ago", category: "major" },
  { source: "Sky Sports / GiveMeSport", title: "Diomandé bid still unanswered two days on: Liverpool's 'important money' offer weighed against Leipzig's ~€130m valuation, PSG and Man City lurking", time: "1d ago", category: "major" },
  { source: "GiveMeSport / Managing Madrid", title: "Konaté's Real Madrid unveiling turns imminent: a reported €230k a week and a €20m signing-on bonus, terms Anfield declined to match", time: "1d ago", category: "major" },
  { source: "Fabrizio Romano / Sportskeeda", title: "Romano files Mac Allister's summer under 'interesting' as Real Madrid lead the pull, no extension talks open with two years left", time: "1d ago", category: "fan" },
  { source: "Football365 / Anfield Watch", title: "First-signing chatter widens: 'noise' around Alex Scott near £80m, Trincão's clause waits on the World Cup, and Iraola asks about Real Madrid's Dean Huijsen", time: "1d ago", category: "fan" },
  { source: "Liverpool.com / TeamTalk", title: "Liverpool show 'little interest' in a free Darwin Núñez as Chelsea and Barcelona circle the soon-to-be Al-Hilal free agent", time: "2d ago", category: "fan" },
  { source: "This Is Anfield / Liverpool FC", title: "Academy ledger: new deals offered to eight youngsters including Cisse and Figueroa, with Cannonier and Balagizi among the releases", time: "2d ago", category: "official" },
  ...
  { source: "Liverpool.com", title: "Premier League confirm the summer window opens Monday June 15 and closes at 11pm on Tuesday September 1", time: "2d ago", category: "official" },
  { source: "GB News / OneFootball", title: "Klopp's World Cup job: a pundit's chair at MagentaTV alongside Thomas Müller, after a video teasing a return to management", time: "3d ago", category: "fan" },
