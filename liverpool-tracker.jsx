...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "doubtful", injuryNote: "Missed Palace 3-1 (Apr 25) as expected — Woodman starred. On Slot's Apr 24 timeline Alisson is targeting Old Trafford (May 3) for his return. Slot has dismissed Juventus links saying he is 'only focused on recovery'", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 33, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 7.0, status: "fit", injuryNote: "Recalled at RB for Palace 3-1 (Apr 25) and came on for the injured Salah on the hour — Slot's pre-match plan validated. Locks in the right-back spot for Old Trafford May 3", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
  ...
  // ── Midfielders ───────────────────────────────────────────────────────────
  { id: 13, name: "Alexis Mac Allister", number: 10, position: "MID", nationality: "🇦🇷 Argentina", age: 27, appearances: 37, goals: 2, assists: 4, cleanSheets: null, xG: 1.9, tacklesPer90: 1.9, passCompletion: 90, progressiveCarries: 1.4, form: 7.1, status: "fit", injuryNote: "Recalled for Palace 3-1 (Apr 25); his skewed long shot was the lay-off Isak controlled and finished for the opener. Back in the midfield three after the derby benching", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243016.png" },
  { id: 14, name: "Ryan Gravenberch", number: 38, position: "MID", nationality: "🇳🇱 Netherlands", age: 23, appearances: 37, goals: 5, assists: 5, cleanSheets: null, xG: 3.1, tacklesPer90: 2.8, passCompletion: 91, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Anchored the midfield in Palace 3-1 (Apr 25); ball-winning gave Liverpool control after Munoz halved the deficit. Form rating among the league's best since New Year", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p441266.png" },
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 23, goals: 1, assists: 3, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 7.3, status: "fit", injuryNote: "Started Palace 3-1 (Apr 25) and assisted Robertson with a slick counter-attack release for the second goal — Liverpool.com had him among the winners. Exit talk persists: Aston Villa still leading Tottenham/Inter for summer move", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 37, goals: 10, assists: 9, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.2, status: "injured", injuryNote: "Hamstring tear vs Palace (Apr 25, 60') — limped off applauding Anfield. Egypt FA director Ibrahim Hassan (Apr 26) confirms 4-week absence: 'has played his last game for Liverpool.' Will be fit for World Cup. Free-agent exit was already confirmed Mar 24", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Mohamed Salah injury: Liverpool legend may have played final game for club after hamstring strain in Crystal Palace win", time: "today", category: "major" },
  { source: "Al Jazeera", title: "Injured Salah has played his last game for Liverpool, says Egypt FA director — 4 weeks out, fit for World Cup", time: "today", category: "major" },
  { source: "The National", title: "Mohamed Salah out for four weeks and has played last game for Liverpool, claims Egypt official", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Egyptian reports suggest Salah may never play for Liverpool again — 33-year-old hugged Slot before walking down the tunnel", time: "today", category: "fan" },
  { source: "Rousing The Kop", title: "When Mohamed Salah is expected to be fit again and what it means for Liverpool's season run-in", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Arne Slot admits worry over Mo Salah injury: 'For Mo to leave the pitch…' — confirms own concern post-match", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Isak, Robertson and Wirtz score as Liverpool beat Crystal Palace 3-1 — Reds climb to fourth", time: "1d ago", category: "official" },
  { source: "This Is Anfield", title: "Liverpool 3-1 Crystal Palace: Up to 4th as Isak scores first goal after injury — Salah forced off with hamstring", time: "1d ago", category: "fan" },
  { source: "Goal.com", title: "Liverpool player ratings vs Crystal Palace: Woodman 8/10 instant Anfield hero, Salah's farewell tour cruelly cut short", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Liverpool player ratings vs Crystal Palace: Jones and Woodman impress as Reds edge closer to UCL spot", time: "1d ago", category: "major" },
  { source: "NBC Sports", title: "Liverpool 3-1 Crystal Palace: Reds edge closer to Champions League qualification — six points needed from four games", time: "1d ago", category: "major" },
  { source: "Sportsdunia", title: "Liverpool vs Crystal Palace player ratings: Andrew Robertson 8.0/10 seals crucial win before Wirtz late strike", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Diomande to Liverpool: Concrete Talks for €100m Salah Successor — Reds 'hold clear lead' over PSG, Arsenal", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "Arne Slot future: Liverpool boss expected to stay at Anfield next season — FSG 'intend to stick' through summer rebuild", time: "2d ago", category: "major" },
  { source: "Tribuna", title: "Ibrahima Konate's Liverpool deal nears completion — only contract duration and bonus structure left, says Romano", time: "5d ago", category: "fan" },
];
