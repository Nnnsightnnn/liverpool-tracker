...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Tue Sep 22, morning - away with England, and still the youngest unresolved contract at the club. Ngumoha is the only Liverpool player in Thomas Tuchel's senior squad and in line for a first competitive cap after a friendly debut in June. He was an unused substitute at Bournemouth once Gakpo passed his warm-up. David Ornstein reported the club wants his new deal signed inside the month, which on tonight's evidence of how Liverpool handle contracts is not a formality.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  ...
  { source: "Liverpool Echo", title: "Wirtz breaks silence after Carragher criticism: 'Into the international break with a win'", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Iraola praises Klopp's 'very smart' decision to split Germany squad and rest Wirtz", time: "today", category: "fan" },
  ...
  { source: "TeamTalk", title: "Liverpool looking into Feyenoord's Givairo Read to solve glaring right-back issue", time: "today", category: "major" },
  { source: "TeamTalk", title: "Wirtz linked with Bayern return as Reds' stance on a sale emerges", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Fans 'impatient' as Iraola warned of growing pressure despite unbeaten start", time: "1d ago", category: "fan" },
  ...
  { source: "This Is Anfield", title: "Gomez, Leoni and Chiesa: the injury return dates as the break begins its work", time: "2d ago", category: "fan" },
  ...
  { source: "CaughtOffside", title: "Talks held: Liverpool meet Brentford's Lee Dykes over replacing Richard Hughes", time: "4d ago", category: "fan" },
