...
const LATEST_NEWS = [
  { source: "Empire of the Kop / GiveMeSport", title: "Liverpool submit their first bid for Yan Diomandé as the big summer officially kicks off, Leipzig's price reported hardening toward €140m", time: "today", category: "major" },
  { source: "Football365 / CaughtOffside", title: "Reds 'very keen' on Leipzig right-back Lutsharel Geertruida as a second signing, talks held with his camp after a late World Cup call-up", time: "today", category: "major" },
  { source: "Read Liverpool / MSN", title: "Curtis Jones nears a €25m Inter agreement with a sell-on clause attached: the Scouser has 'said yes' and a fresh meeting is set to close it", time: "today", category: "major" },
  { source: "Liverpool FC", title: "World Cup opening day: the club's preview counts eight current Reds at the tournament, with Alisson set to be the first on the pitch for Brazil", time: "today", category: "official" },
  { source: "Liverpool.com / Yahoo Sport", title: "Quansah buy-back details: personal terms already agreed on an Anfield return, but Germany expects the cheaper £52m clause in 2027, not this summer", time: "today", category: "fan" },
  { source: "TeamTalk / Goal", title: "Núñez formally offered back to Liverpool as eight clubs circle the soon-to-be free agent; Chelsea, Spurs, Newcastle and Villa all alerted", time: "today", category: "major" },
  { source: "GB News / OneFootball", title: "Klopp lands his World Cup job: a pundit's chair at MagentaTV alongside Thomas Müller, after a video teasing a return to management", time: "1d ago", category: "fan" },
  { source: "Sports Mole / Record", title: "Sporting will not discuss Trincão until the World Cup ends; Liverpool stay 'closest' to the €60m clause but the deal now lands in July", time: "1d ago", category: "fan" },
  { source: "Yahoo Sport / CaughtOffside", title: "Heskey warns Iraola the step up is 'immense' and the dressing room must be won over; inside accounts say the appointment has gone down well", time: "1d ago", category: "fan" },
  { source: "Sky Sports / Football365", title: "The second wave forms: Stiller's €40m Stuttgart clause monitored, Murillo scouting increased, and 'noise grows' around Alex Scott as a first signing", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Bradley's rehab remains indoors with pre-season in doubt; the next step is still described as 'far away' after 24 matches missed", time: "2d ago", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Retained list aftermath: twelve releases now official as Salah, Konaté and Robertson begin their goodbyes at the World Cup", time: "2d ago", category: "official" },
  { source: "Football365 / Football Italia", title: "Chiesa's future is parked until the pre-season tour, the Italian expected to sit down with Iraola as Inter's wider raid takes shape", time: "2d ago", category: "fan" },
  { source: "Managing Madrid / This Is Anfield", title: "Konaté's four-year Real Madrid deal awaits its unveiling while he reports to France's World Cup camp", time: "3d ago", category: "major" },
];
