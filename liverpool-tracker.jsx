...
const LATEST_NEWS = [
  { source: "Yahoo Sports", title: "Liverpool raise Barcola offer to around £100m as PSG reject the bid but talks stay live", time: "today", category: "major" },
  { source: "Football365", title: "Djed Spence emerges as a Liverpool right-back option with Tottenham open to a sale near £35m", time: "today", category: "fan" },
  { source: "Sky Sports", title: "'No': McAdam says Liverpool do not plan to sign a new defender this summer as Zabarnyi talk cools", time: "today", category: "major" },
  { source: "Daily Sabah", title: "'I am here to win': Salah unveiled at Trabzonspor under a laser show on a two-year deal", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "World Cup winner Victor Munoz cuts his holiday short to report early to Iraola's pre-season", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Liverpool will accept around £70m for Cody Gakpo as Tottenham's pursuit enters key stages", time: "today", category: "fan" },
  { source: "Football Insider", title: "Inter hold at about £35m for Curtis Jones as Iraola makes a public case for him to stay", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Jeremy Jacquet a doubt for Monaco, yet to train four days out with a lingering shoulder issue", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Monaco visit Anfield on Sunday for Iraola's first home dugout, Isak and Wirtz in line for more", time: "1d ago", category: "official" },
  { source: "ESPN", title: "Van Dijk, Alisson and Gravenberch back in the group after the World Cup for the Anfield friendlies", time: "1d ago", category: "fan" },
  ...
  { source: "GiveMeSport", title: "Marc Guehi stays the centre-back non-negotiable with Milan's Tomori the cheaper route behind him", time: "2d ago", category: "fan" },
