...
const LATEST_NEWS = [
  { source: "Fabrizio Romano", title: "Here we go: Liverpool agree a fee around £70m with Brighton for Yankuba Minteh, deal set to complete", time: "today", category: "major" },
  { source: "Sky Sports", title: "Liverpool and PSG hold decisive Barcola talks as the fee alone stands between the winger and Anfield", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Barcola told to train only until his future clears, with Liverpool closing on a sub-€150m compromise", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Exits accelerate: Endo pushed toward a Premier League move as Mamardashvili's loan is shopped to Serie A", time: "today", category: "fan" },
  { source: "UEFA", title: "On the eve of Monaco: Liverpool learn their eight Champions League opponents on Thursday from Pot 1", time: "today", category: "official" },
  { source: "Liverpool.com", title: "Chiesa returns to light training but stays a doubt for Saturday's Forest opener", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Gomez trains fully with the group and pushes his case to feature against Forest", time: "today", category: "official" },
  { source: "Goal", title: "Iraola's pre-Forest work: shaping his first Anfield XI as continuity from Newcastle points the way", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Isak hunts his first Liverpool goal at Anfield after the cold Newcastle homecoming", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Ngumoha turns 18 on Saturday with a new five-year deal cleared to follow", time: "1d ago", category: "fan" },
  { source: "BBC Sport", title: "Forest arrive at Anfield beaten by Leeds as Glasner searches for his first Forest win", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's stoppage-time penalty rescued Iraola's opening day", time: "3d ago", category: "major" },
  { source: "ESPN", title: "Curtis Jones settles at Inter as the last Scouser's €35m San Siro move beds in", time: "5d ago", category: "major" },
