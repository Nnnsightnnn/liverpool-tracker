...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "injured", outSince: "2026-07-25", injuryNote: "Tue Aug 4 — out of the opener, and the reason the defence is being reinforced. Iraola has ruled Gomez out for weeks with the muscle injury taken inside eight minutes at Sunderland, missing the August 23 trip to Newcastle after both American games passed him by. With Leoni still on his ACL and Van Dijk only now back from a World Cup break, losing the longest-serving defender into the campaign leaves Liverpool perilously light at centre-back, which is why they are stepping up for Crystal Palace's Marc Guehi and holding Milan's Fikayo Tomori in reserve. A genuine cover loss to absorb, not a sale to chase", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
...
const LATEST_NEWS = [
  { source: "FootballTransfers", title: "Salah agrees two-year Trabzonspor deal worth around €23m a year, one clause from an official exit", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Iraola plays down Frimpong injury after Leeds scare, but Liverpool's right-back department is down to one fit senior", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Barcola talks stall as PSG hold at £145m and Liverpool draw up Rayan and Minteh as Plan B", time: "today", category: "major" },
  { source: "BBC Sport", title: "Liverpool keep Marc Guehi as the marquee centre-back target with Milan's Tomori the value alternative", time: "today", category: "major" },
  { source: "Goal", title: "Inter sense a breakthrough on Curtis Jones as the £30m-£40m valuation gap narrows", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Jeremy Jacquet 'feeling discomfort' as Liverpool take a cautious approach with their lone senior centre-back", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "'I hate August': Andoni Iraola on the uncertainty of an unsettled transfer window", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Gakpo open to Tottenham after positive talks as Liverpool insist he is not for sale cheaply", time: "1d ago", category: "fan" },
  ...
  { source: "Sky Sports", title: "Newcastle away on Sunday August 23 confirmed as the opener, a 4.30pm kick-off at St James' Park", time: "3d ago", category: "major" },
