...
const PLAYERS = [
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Sat Jun 27 — through, but withdrawn: Salah was taken off after 57 minutes of Friday's 1-1 with Iran, his left hamstring strapped, as Egypt drew into a World Cup last-32 tie with Australia, the first knockout round in their history. The camp call it precautionary and expect him fit. Off the pitch the destination still leans Saudi Arabia over a framed Fenerbahce offer; a free agent on June 30, the Anfield chapter closed, the final word waits on the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "Al Jazeera / Sky Sports", title: "Egypt reach the World Cup last 32 for the first time in their history after a 1-1 draw with Iran; Salah subbed at 57' with his hamstring strapped", time: "today", category: "major" },
  { source: "World Soccer Talk / Fox Sports", title: "Salah injury scare a 'precaution': Egypt expect their captain fit for the round-of-32 tie with Australia in Dallas", time: "today", category: "fan" },
  { source: "Football365 / TeamTalk", title: "Diomandé saga hardens into a fee fight: Leipzig dig in near £112m as the teenager leans on his club and PSG hover", time: "today", category: "major" },
  { source: "Anfield Watch / This Is Anfield", title: "Right-back search finally moves: Inter's Denzel Dumfries (release clause) and Leipzig's Geertruida floated as Bradley's rehab drags", time: "today", category: "major" },
  { source: "Liverpool.com / GiveMeSport", title: "Bouaddi on the midfield longlist: Liverpool and Arsenal track the Lille teenager, though the player's preference tilts to PSG", time: "1d ago", category: "fan" },
  { source: "ESPN / Anfield Watch", title: "Camavinga available but unconvinced: Madrid willing to sell near £52m, the France international reported reluctant to leave", time: "1d ago", category: "fan" },
  { source: "ESPN / Liverpool.com", title: "Centre-back board opens with Konaté gone: Sporting's Inácio leads ahead of Ordóñez and Murillo on Hughes's shortlist", time: "2d ago", category: "fan" },
  { source: "The Telegraph / Sky Sports", title: "Jones set to stay: Liverpool rebuff a second Inter bid worth ~€25m against a £35m valuation and signal no interest in dealing", time: "2d ago", category: "major" },
  ...
  { source: "Liverpool.com / Empire of the Kop", title: "Gakpo exit 'improbable' despite De Zerbi's Tottenham interest; the nine-goal Dutchman stays firmly in Iraola's plans", time: "3d ago", category: "fan" },
