...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "'We need one more winger': Iraola confirms the hunt goes on after Yan Diomande chooses PSG over Liverpool", time: "today", category: "major" },
  { source: "ESPN", title: "France 0-2 Spain: Victor Munoz reaches the World Cup final as Ibrahima Konate watches his tournament end from the bench", time: "today", category: "major" },
  { source: "TeamTalk", title: "Contact made: FSG eye an £85m double hijack of Man Utd for Wolves' Joao Gomes and Roma's Manu Kone", time: "today", category: "major" },
  { source: "England Football", title: "World Cup semi-final today in Atlanta: Mac Allister's Argentina meet England, 3pm Eastern, the last Red still standing", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola to hold talks with Curtis Jones and is hopeful he stays as Inter are rebuffed again", time: "today", category: "fan" },
  { source: "GiveMeSport", title: "'Will explode under Iraola': Said El Mala emerges as the cheaper winger alternative to Barcola and Minteh", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Iraola gets the ball out early: front-foot first sessions as Tsimikas, Elliott and Jacquet report for testing", time: "1d ago", category: "fan" },
  { source: "TeamTalk", title: "Joao Gomes price drops toward £30m after Wolves' relegation as Liverpool weigh a move for the 'ideal' target", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "PSG signal no sale even if they land Diomande, keeping Barcola a £100m-plus dream rather than a plan", time: "1d ago", category: "fan" },
  { source: "Anfield Watch", title: "Deal signed: Mo Salah's next-club announcement is coming, the Saudi Pro League destination settled", time: "1d ago", category: "major" },
  { source: "Read Liverpool FC", title: "Ekitike targets a Boxing Day return as Bradley and Leoni stay long-term absentees under Iraola", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Full list: the 15 Liverpool first-teamers back for day one of the Iraola era", time: "2d ago", category: "official" },
  { source: "RTE Sport", title: "Michael Edwards' FSG exit leaves Mike Gordon on day-to-day duties as Richard Hughes eyes Al-Hilal", time: "2d ago", category: "major" },
  { source: "Football365", title: "Liverpool 'ready to bid' for £80m Minteh, the Diomande alternative Iraola is said to love", time: "2d ago", category: "major" },
  { source: "Rousing The Kop", title: "Iraola names three players he already loves at Liverpool in his first week of work", time: "2d ago", category: "fan" },
];
