...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Van Dijk's Netherlands host Klopp's Germany tonight: 'I want to spoil his debut'", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Van Dijk rejects retirement, vows to play on for Netherlands until 'at least' 37 after Xavi's Merseyside visit", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Jeremy Frimpong recalled to the Netherlands squad after time in the cold", time: "today", category: "fan" },
  { source: "The Times", title: "Paul Joyce joins Ornstein: Julian Ward set to be reappointed Liverpool sporting director", time: "today", category: "major" },
  { source: "Sport Witness", title: "Bayern Munich have no plans to move for Florian Wirtz in January, German insider says", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Turkish Airlines to become Liverpool's main club partner from June 2027", time: "today", category: "official" },
  { source: "Read Man City", title: "Opta's expected-points model still rates City's perfect start 5.8 points too kind", time: "1d ago", category: "fan" },
  { source: "Sports Mole", title: "A year and a day on: Giovanni Leoni due back in group training over the break", time: "1d ago", category: "major" },
  { source: "Goal", title: "Mac Allister's stalled renewal becomes Ward's first file as Stankovic is tracked", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Rio Ngumoha in Tuchel's England squad and in line for a first competitive cap", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Fixture updates: five straight Sundays for Liverpool across October and November", time: "2d ago", category: "official" },
  { source: "BBC Sport", title: "Bournemouth 0-1 Liverpool: Isak's winner sends Iraola into the break unbeaten", time: "4d ago", category: "major" },
];
