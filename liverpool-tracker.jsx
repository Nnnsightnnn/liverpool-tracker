...
// ─── Player Data (2025-26 Season · Updated May 20, 2026) ──────────────────
// Statuses: "fit" | "injured" | "doubtful" | "recovering"
// injuryNote: short description shown on card when not fit
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "doubtful", injuryNote: "Thu May 21 — back in full training at Kirkby and in line for an Anfield send-off against Brentford on Sun May 24 after roughly three months out (last played mid-March). Slot: 'Alisson trains with us again, let's see where he is tomorrow.' Schira's line that the Brazilian has 'agreed a €15m deal' to join Juventus on €5m-a-year personal terms still holds — Sunday could be his Liverpool farewell", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 35, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.4, status: "doubtful", injuryNote: "Thu May 21 — back in training after the 'minor injury' that kept him out at Villa Park; in line to return for the Sun May 24 Brentford finale. Liked Salah's anti-Slot Instagram post — among the squad members flagged in Caught Offside's tally of endorsers", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool.com / Heavy Sport", title: "FINAL-DAY MATH: Opta now gives Liverpool a 99.65% chance of Champions League football — after Bournemouth's draw, a point at home to Brentford on Sunday guarantees the top-five finish; only a defeat plus a heavy Bournemouth win could force a play-off", time: "today", category: "major" },
  { source: "Football365 / Liverpool.com / Anfield Watch", title: "'World-class boss lined up' to replace Slot as talks loom — Wed-into-Thu wires have FSG ready to 'pounce', with Luis Enrique installed as the bookies' favourite ahead of Iraola and Hoeness; Hughes and Edwards have 'serious thinking' to do after the finale", time: "today", category: "major" },
  { source: "Liverpool.com / Yahoo Sports", title: "Antonio Conte enters the Slot-replacement frame after his abrupt Napoli exit — but Liverpool.com flags the catch: Conte's trademark back three doesn't fit the squad, and the vacant Italy job (open from June 22) is also calling", time: "today", category: "major" },
  { source: "Liverpool FC / Liverpool.com", title: "Club confirms Salah and Robertson farewell tributes for Sunday — and in a fresh statement Salah vows to 'give everything' to secure Champions League qualification, calling it 'the bare minimum' on his Anfield send-off", time: "today", category: "official" },
  { source: "Liverpool FC / Liverpool.com", title: "Fitness latest: Alisson back in full training and in line for an Anfield send-off vs Brentford after three months out; Slot says Isak 'definitely has a chance' but can give no guarantees as the Swede trains through the week", time: "today", category: "official" },
  { source: "ESPN / Read Liverpool FC", title: "Steve Nicol furious with Salah's statement: 'He doesn't have the class' — the ex-Red blasts the timing of the Egyptian's outburst days before his farewell, splitting pundit opinion on the Anfield icon", time: "today", category: "fan" },
  { source: "Caught Offside / Empire of the Kop", title: "'No time to lose': Liverpool urged to move fast for Andoni Iraola as a 'golden opportunity' emerges — the Bournemouth boss leaves the Vitality this summer and is undecided on his next move", time: "1d ago", category: "fan" },
  { source: "Liverpool.com / Sky Sports", title: "Liverpool 'red-hot' on Bradley Barcola — the PSG winger is 'strongly tempted' by a move to Anfield after slipping down the pecking order behind Kvaratskhelia and Doué in Paris", time: "1d ago", category: "major" },
  { source: "Liverpool.com / This Is Anfield", title: "Yan Diomande confirms he plans to stay at RB Leipzig next season — cooling Liverpool's pursuit of the winger unless a summer offer big enough to make Leipzig cash in arrives", time: "1d ago", category: "major" },
  { source: "ESPN / Sky Sports / VAVEL", title: "Bournemouth 1-1 Man City (Vitality): Junior Kroupi 39', Haaland 90+5' — the draw crowned Arsenal champions and left Liverpool three points clear of the Cherries with one game to play", time: "2d ago", category: "major" },
  { source: "Liverpool FC / This Is Anfield", title: "adidas 2026-27 home kit unveiled — an explicit homage to the 1989-90 title-winning strip, geometric pattern restored, deep-red shorts and socks, paired with a green 'heritage' goalkeeper kit; on sale via the LFC Store", time: "2d ago", category: "official" },
  { source: "This Is Anfield / Sky Sports", title: "Mohamed Salah 'open to joining Fenerbahce' when he leaves Liverpool this summer — the Egyptian departs as a free agent after Sunday's farewell, with the Istanbul club among the destinations in the frame", time: "3d ago", category: "fan" },
  { source: "TNT Sports / Liverpool.com / This Is Anfield", title: "Gerrard's 'damning' verdict on Salah's statement — 'the identity's gone' — as the Liverpool icon, himself now linked with the vacant Burnley job, questions whether Salah speaks for the whole dressing room", time: "4d ago", category: "major" },
  { source: "Al Jazeera / ITV News / Liverpool.com", title: "Chelsea confirm Xabi Alonso as manager on a four-year deal from July 1 — ending FSG's most-discussed 'Plan B' and leaving the Slot-replacement market suddenly thin", time: "4d ago", category: "major" },
  { source: "Sky Sports / NBC Sports / ESPN", title: "Aston Villa 4-2 Liverpool: Watkins brace plus Rogers and McGinn punish a set-piece collapse — Van Dijk's two headers (52', 90+) the lone reply on a night that dropped the Reds to 5th", time: "6d ago", category: "major" },
];
