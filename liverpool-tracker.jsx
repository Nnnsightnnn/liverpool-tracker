...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "fit", injuryNote: "Sun Jun 7 — the line has hardened into a decision: per Brazilian sources, Alisson has snubbed Juventus's approach to stay at Anfield at least another season, his extension already triggered. Heading to a World Cup as Brazil's No. 1, he returns as the unarguable starter — and the knock-on falls on Mamardashvili, now the likelier to leave", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  { id: 2, name: "Giorgi Mamardashvili", number: 25, position: "GK", nationality: "🇬🇪 Georgia", age: 25, appearances: 19, goals: 0, assists: 0, cleanSheets: 5, xG: 0, tacklesPer90: 0, passCompletion: 76, progressiveCarries: 0.1, form: 6.2, status: "fit", injuryNote: "Sun Jun 7 — collateral of Alisson's stay: with the Brazilian snubbing Juventus to remain, a loan looks the likeliest 2026-27 route for the £29m Valencia signing rather than a second year of understudy minutes. The club's longer-term thinking still circles Porto's Diogo Costa and his €60m release clause", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p449027.png" },
  ...
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 40, goals: 2, assists: 0, cleanSheets: 10, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 6.4, status: "fit", injuryNote: "Sun Jun 7 — election day, and the last formality: the four-year free transfer to Real Madrid — reported at ~€24m gross a season, to 2030 — completes once today's contested Bernabéu vote returns Pérez, who built the centre-back into his campaign. CaughtOffside calls the package the bill for Liverpool's delay; at Anfield the right-sided vacancy he leaves is the one the £40m Ordóñez bid is built to fill", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
  ...
  // ── Midfielders ───────────────────────────────────────────────────────────
  { id: 13, name: "Alexis Mac Allister", number: 10, position: "MID", nationality: "🇦🇷 Argentina", age: 27, appearances: 41, goals: 2, assists: 4, cleanSheets: null, xG: 1.9, tacklesPer90: 1.9, passCompletion: 90, progressiveCarries: 1.4, form: 6.7, status: "fit", injuryNote: "Sun Jun 7 — now openly framed as sellable: a top Liverpool source says the Argentine 'could be moved on' this summer, no new-contract talks underway as he enters the final two years of his deal — in pointed contrast to Gravenberch's fresh extension. Real Madrid's interest stays live (the player's father has dismissed specifics as 'untrue'); Football365 puts the internal sale valuation near €120m", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243016.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Sun Jun 7 — the timeline holds: a decision on his future comes after the World Cup, not before, and the departing forward declines to advance it whatever Iraola's arrival changes around him. The contract lapses June 30; Turkey, Saudi and MLS wait on a verdict he will not give until the tournament is done. A nine-year story keeps its final line in pencil", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sun Jun 7 — still not for sale: Bayern Munich are reported to have made the 17-year-old their main target for the left flank after missing Anthony Gordon, yet are yet even to make formal contact — Liverpool's position unmoved. The youngest goalscorer in the club's history remains the one asset in a summer of departures carrying no price at all", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
...
const LATEST_NEWS = [
  { source: "CaughtOffside / This Is Anfield", title: "Konaté's Madrid move reaches its ballot box: the agreed four-year free transfer turns only on today's contested Bernabéu election, his ~€24m-a-year package 'the price Liverpool paid for delay'", time: "today", category: "major" },
  { source: "Sky Sports / Premier League", title: "Confirmed: Andy Robertson joins Tottenham on a free — nine years and nine major trophies close as the title-winning core thins, Kerkez inheriting the left", time: "1d ago", category: "official" },
  { source: "This Is Anfield / Anfield Watch", title: "Mac Allister 'could be moved on': top Liverpool source says no new-contract talks underway, Real Madrid hovering as Gravenberch signs on and Szoboszlai prepares to", time: "today", category: "major" },
  { source: "DaveOCKOP / Empire of the Kop", title: "Diomandé chase cools — no Liverpool offer made, Leipzig wanting €100m, the teenager focused on the World Cup; Sporting's Trincão now 'top of the list'", time: "today", category: "major" },
  { source: "Yahoo Sports / Liverpool.com", title: "Ngumoha stays 'not for sale' as Bayern make the 17-year-old a main target after missing Anthony Gordon — no formal contact yet made", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola sets his pre-season blueprint: ~8 first-teamers report late from the World Cup, opening the US tour to the academy — 'a chance to work especially with the young players'", time: "1d ago", category: "official" },
  { source: "Liverpool.com / Fox Sports", title: "Iraola settles in: personality concerns dismissed a week into the job, the Hughes reunion framed as continuity by design on a two-year deal", time: "1d ago", category: "fan" },
  { source: "Football365 / Sky Sports", title: "A £40m Ordóñez bid anchors the defensive rebuild now Konaté is leaving — one half of an 'approved' £170m double, with Chelsea and City watching", time: "today", category: "major" },
  { source: "Football365 / Liverpool.com", title: "Alisson stays, Mamardashvili the keeper likelier to go: the £29m heir now looks loan-bound for game time after the Brazilian digs in", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / ESPN", title: "Salah's goodbye still waits on the tournament — decision after the World Cup, suitors in Turkey, Saudi and MLS left to wait, contract lapsing June 30", time: "1d ago", category: "fan" },
  { source: "Football365 / Sky Sport Italia", title: "Eight exits frame the reset — Jones (Inter's €20m rejected), Elliott, Gomez, Endo and Chiesa on the list as the window nears its June 15 open", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Liverpool announce two more Anfield friendlies — Monaco (Aug 9) and Fàbregas's Champions League-bound Como (Aug 16) close the pre-season", time: "2d ago", category: "official" },
  { source: "Empire of the Kop", title: "Full pre-season set: Sunderland in Nashville (Jul 25), Wrexham at Yankee Stadium (Jul 29), Leeds at Soldier Field (Aug 2), then Monaco and Como at Anfield", time: "3d ago", category: "official" },
  { source: "Liverpool FC", title: "Andoni Iraola Q&A: leadership style, his read on the inherited squad, and the pre-season plan as the new head coach settles in at the AXA", time: "3d ago", category: "official" },
];
