...
const PLAYERS = [
  ...
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 38, goals: 2, assists: 0, cleanSheets: 10, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 7.0, status: "doubtful", injuryNote: "Fri May 8 — fresh fitness scare: Sky Sports/Tribuna and This Is Anfield report Konaté trained AWAY from the main group on Wednesday after being substituted late at Old Trafford (Sun May 3, L 3-2); 'severity still unclear.' Liverpool.com headline: 'Five Liverpool stars miss training as Slot faces injury worry.' Slot's Friday 1:15pm presser will give the firm call. Contract still '50/50' per Crook — Real Madrid in chase, Liverpool tracking Bremer/Bastoni/Schlotterbeck shortlist", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
