...
const LATEST_NEWS = [
  { source: "Liverpool FC / ESPN", title: "OFFICIAL: Andoni Iraola appointed Liverpool head coach on a two-year deal — 'You don't need a lot of things to get attracted by Liverpool. Liverpool is Liverpool'", time: "today", category: "official" },
  { source: "Sky Sports / GiveMeSport", title: "Liverpool open formal talks with Leipzig for Yan Diomandé — Ornstein has the Reds more advanced than PSG, with the Germans holding out for £112m", time: "today", category: "major" },
  { source: "Football365 / TeamTalk", title: "Salah calls a meeting with his agent over a spectacular U-turn: the regime change he wanted has happened, and one hurdle remains to him staying", time: "today", category: "major" },
  { source: "This Is Anfield / beIN Sports", title: "Pérez 'announces' Konaté — and unveils Mourinho — from the campaign trail, two days before Madrid's presidential election. The actual unveiling waits on Sunday's vote", time: "today", category: "major" },
  { source: "Football365 / Goal", title: "The Diomandé twist: Ornstein puts Liverpool in pole position, but the teenager admits PSG are 'a team I've loved since I was a child'", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Two more friendlies confirmed: Monaco at Anfield on August 9, Como on August 16 — the full pre-season now runs five matches from Nashville to L4", time: "today", category: "official" },
  { source: "Liverpool.com / ESPN", title: "Inter's opening €20m for Curtis Jones rejected as insufficient — Liverpool hold out for £30m-plus for the academy graduate", time: "1d ago", category: "major" },
  { source: "TeamTalk / Sky Sports", title: "Liverpool prepare a £40m bid for Joël Ordóñez as the Konaté replacement — Chelsea and Manchester City monitor the Ecuadorian, who grew up a Liverpool fan", time: "1d ago", category: "major" },
  { source: "Football365 / Fabrizio Romano", title: "Romano: the first 'approved' Iraola signing could land next week — Diomandé wants his future settled before the World Cup opens on June 11", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Bournemouth dig in on Kroupi: the Cherries are 'determined to keep' Iraola's £100m-rated striker despite the Anfield reunion talk", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "New name on the list: relegated West Ham's Crysencio Summerville linked as a wide-forward option for the Iraola rebuild", time: "1d ago", category: "fan" },
  { source: "Liverpool.com / The Athletic", title: "Elphick, Cooper and fitness coach Pablo de la Torre expected to follow Iraola from Bournemouth as the backroom team takes shape", time: "1d ago", category: "fan" },
  { source: "SportBible", title: "Arne Slot emerges as the 'ideal candidate' for the Netherlands job if Koeman steps down after the World Cup — five days after his Anfield sacking", time: "2d ago", category: "fan" },
  { source: "Liverpool FC", title: "Thirteen LFC Women called up for June internationals as European qualification for the 2027 World Cup reaches its crescendo", time: "today", category: "official" },
];
