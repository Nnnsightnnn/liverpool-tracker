...
const LATEST_NEWS = [
  { source: "Mundo Deportivo", title: "Sorloth out and Ortiz suspended for Anfield: Atletico travel without two attackers for the Champions League opener", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Ortiz banned for Liverpool trip over a 2024 red card for Slask Wroclaw, a one-match UEFA suspension unserved for two years", time: "today", category: "fan" },
  { source: "El Desmarque", title: "Alvarez placed in Simeone's trial eleven and stays behind for extra running; Jonathan David back in the group", time: "today", category: "major" },
  { source: "Sports Mole", title: "Predicted Liverpool XI vs Atletico: Barcola for a first start on the right, Gravenberch restored to the pivot", time: "today", category: "fan" },
  { source: "Rousing The Kop", title: "Barcola should start at Anfield: ease the two-time Champions League winner in on Wednesday, not against Fulham", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Isak has scored once in 13 Champions League appearances; Sports Mole tips Liverpool 2-1 on Wednesday", time: "today", category: "fan" },
  { source: "VAVEL", title: "Isak at 0.89 expected goals per 90 and Gakpo's expected assists doubled to 0.45: the numbers behind three in three", time: "today", category: "fan" },
  { source: "Sports Mole", title: "'Like a boss': Brughmans named player of the match for Genk in his first game since the £30m Liverpool move", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola's pre-Atletico press conference streams live at 1pm BST on Tuesday", time: "today", category: "official" },
  { source: "The Hard Tackle", title: "Isak against Hancko and Wirtz against Hjulmand: the duels that decide whether Liverpool control Wednesday", time: "today", category: "fan" },
  { source: "Football365", title: "Camara told he is 'high in Liverpool's thinking' for 2027 as Chelsea and Monaco fall out over the collapsed £47m move", time: "today", category: "major" },
  { source: "Sports Mole", title: "Gomez still a doubt, Ekitike, Bradley and Leoni out, Chiesa and Endo ineligible: Liverpool's team news for Atletico", time: "today", category: "fan" },
  { source: "ESPN", title: "Atletico slip to sixth in La Liga after the Sunday round; Liverpool's table untouched in a Champions League week", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Grace Fisk scores twice as Liverpool Women beat Charlton 4-0 in the WSL opener; Sam Kerr starts", time: "1d ago", category: "official" },
  { source: "AFP", title: "Athletic Bilbao 3-0 Atletico Madrid: Williams, Navarro and Sancet undo Simeone's side before Anfield", time: "2d ago", category: "major" },
];
