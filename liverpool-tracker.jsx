...
const PLAYERS = [
  ...
  { id: 8, name: "Conor Bradley", number: 12, position: "DEF", nationality: "🇬🇧 N. Ireland", age: 22, appearances: 16, goals: 0, assists: 2, cleanSheets: 4, xG: 0.8, tacklesPer90: 2.6, passCompletion: 84, progressiveCarries: 5.1, form: 7.3, status: "injured", injuryNote: "Sat Jul 25 — a spectator at the opener he cannot play in. As Iraola's side faces Sunderland tonight, Bradley is in Nashville only to rehabilitate the knee he suffered against Arsenal in January, still months from a return with a lot of time out yet and taking no part in any of the three friendlies. The club commit to no date. Frimpong remains the only fit senior right-back travelling", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p492777.png" },
  ...
  { id: 15, name: "Dominik Szoboszlai", number: 8, position: "MID", nationality: "🇭🇺 Hungary", age: 25, appearances: 48, goals: 12, assists: 9, cleanSheets: null, xG: 6.2, tacklesPer90: 2.1, passCompletion: 86, progressiveCarries: 2.8, form: 7.3, status: "fit", injuryNote: "Sat Jul 25 — first name on tonight's teamsheet. With Mac Allister and Munoz absent all tour, Szoboszlai anchors the midfield against Sunderland by process of elimination, and he is also in the frame for the vacant armband, Iraola's search for a Van Dijk deputy narrowed to him and Chiesa per Paul Joyce. Fresh from an extension to 2031 and voted supporters' player of the season, he starts the new era as its most senior available midfielder. Fit, and central to it", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p424876.png" },
...
const LATEST_NEWS = [
  { source: "Sports Mole", title: "The Iraola era begins tonight: young Liverpool open the US tour against Sunderland at Nashville's Geodis Park", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Jeff Bezos approached to join £1.35bn consortium eyeing a 30% Liverpool stake as FSG insist they have 'no intention' of selling", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Chelsea's £85.6m bid for Alex Scott rejected as Iraola plots a Bournemouth reunion and Liverpool monitor the midfielder", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Predicted XI: Mamardashvili starts, Jacquet handed his debut and Harvey Elliott given an attacking audition against Sunderland", time: "today", category: "fan" },
  { source: "Goal", title: "Salah-Besiktas breakthrough: agent Ramy Abbas softens his €7.5m commission demand as a fresh meeting is set to finalise terms", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Isak, Wirtz and Gravenberch miss the Sunderland opener after early World Cup exits but are in the frame for Wrexham and Leeds", time: "1d ago", category: "major" },
  { source: "ESPN", title: "Iraola wants a winger with 'different skills' to Salah as the squad flies to America a body short on both flanks", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Mac Allister and Munoz not due back until mid-August after reaching the World Cup final in New Jersey", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Harvey Elliott's future unresolved as he returns from an underwhelming Villa loan into the final year of his deal", time: "1d ago", category: "major" },
  { source: "CaughtOffside", title: "Barcola pursuit stays warm: Liverpool confident of a deal near £100m with Akliouche the deliverable fallback", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Freddie Woodman signs a contract extension as Mamardashvili leads the goalkeeping group through the tour", time: "2d ago", category: "official" },
  { source: "beIN Sports", title: "Leoni furthest advanced of the injured trio as Ekitike and Bradley remain 'months' from a return", time: "2d ago", category: "major" },
  { source: "Liverpool.com", title: "Confirmed: Liverpool complete the £750k signing of 17-year-old Colombian Samuel Martinez, to join in 2027", time: "3d ago", category: "official" },
  { source: "DaveOCKOP", title: "Bajcetic and Endo among the group building fitness on tour rather than featuring in Nashville", time: "3d ago", category: "fan" },
  { source: "Liverpool.com", title: "Van Dijk, Alisson and Gakpo to begin at the AXA Centre with minutes saved for the Anfield friendlies", time: "3d ago", category: "major" },
];
