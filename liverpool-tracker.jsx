...
const LATEST_NEWS = [
  ...
  { source: "Empire of the Kop", title: "Iraola's homecoming: the manager returns to the club he took into Europe on Sunday", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Predicted XI: Araujo back at right-back, Isak restored, Gomez on the bench at the Vitality", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Bournemouth have led all four league games and won none, the record that defines Rose's start", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Ben Jacobs: Liverpool to sanction Wataru Endo sale in January as Iraola makes his call", time: "today", category: "major" },
  { source: "The Athletic", title: "Ornstein: no Ngumoha agreement yet as Liverpool push to tie down the 18-year-old inside a month", time: "today", category: "major" },
  ...
  { source: "Daily Mail", title: "Steele: Chiesa, Leoni and Bradley all take a step forward, but none has a return date yet", time: "today", category: "major" },
  { source: "Squawka", title: "The alternative table: Liverpool concede the fewest expected goals per game in the Premier League", time: "today", category: "fan" },
  { source: "beIN Sports", title: "Klopp calls up 44 players across two Germany squads, with Florian Wirtz among the midfielders", time: "1d ago", category: "major" },
  { source: "NBC Sports", title: "Bournemouth team news: Araujo out to late November, Kroupi to early November, Milosavljevic first back", time: "1d ago", category: "major" },
  { source: "LiveScore", title: "Iraola 'under pressure' a fortnight in? One win in four, but Liverpool remain unbeaten", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Genk sporting director on the £30m teenage goalkeeper Liverpool signed: 'Never saw that coming'", time: "2d ago", category: "major" },
  { source: "Empire of the Kop", title: "Szoboszlai names two Liverpool youngsters who 'deserve to play' after the Tottenham win", time: "2d ago", category: "fan" },
];
