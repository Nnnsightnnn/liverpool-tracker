...
const PLAYERS = [
  ...
  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 34, appearances: 43, goals: 6, assists: 1, cleanSheets: 11, xG: 3.2, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Sun Jun 21 — the captain wants to stay, and made his Group F statement: pushing for a fresh deal beyond his 2027 expiry, he marshalled the Netherlands' 5-1 rout of Isak's Sweden in Houston to take top spot in Group F. At 34 he remains the fixed point Hughes is buying a partner for, not a problem to solve", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Mon Jun 29 — a domestic suitor enters: with Liverpool having rejected a second Inter bid worth around €25m against a £35m valuation, Nottingham Forest are now reported to be readying a move near £40m for the midfielder, per Talksport. The catch is football, Forest carry no European competition next season where Inter and Liverpool both have the Champions League, and the 25-year-old is said to be wary of a step down. A year left, talks stalled, and an exit that looked closed a week ago suddenly has options", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Mon Jun 29 — a hamstring, and a race against the clock: Egypt's team doctor has confirmed Salah strained a hamstring when he was withdrawn after 57 minutes against Iran, and the federation says he has begun rehab with no guarantee he features in Friday's World Cup last-32 tie with Australia at AT&T Stadium in Arlington. Coach Hossam Hassan struck an optimistic note, relaying that Salah told him 'it's not a serious injury.' A free agent at Anfield from Tuesday, the Anfield chapter closed, his destination still leaning Saudi Arabia over a framed Fenerbahce offer, the final word left for after the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "The Athletic / Romano", title: "Diomandé picks PSG over Liverpool: the Reds lose their Salah heir as Paris agree a five-year deal and Leipzig haggle the fee", time: "today", category: "major" },
  { source: "This Is Anfield / Le10 Sport", title: "Barcola becomes the plan: PSG forward has asked to leave and is 'thrilled' by an Anfield move, favouring Liverpool over Arsenal", time: "today", category: "major" },
  { source: "TeamTalk / Foot Mercato", title: "Akliouche shuts a second door: Monaco man tells Liverpool and Man Utd his priority is to join PSG this summer", time: "today", category: "major" },
  { source: "Talksport / BBC Sport", title: "Curtis Jones drawing Nottingham Forest interest near £40m as Inter linger, though he may baulk at a step down from the Champions League", time: "today", category: "fan" },
  { source: "Goal / The Tribune", title: "Salah hamstring strain confirmed: Egypt sweat on their captain for Friday's World Cup last-32 tie with Australia in Arlington", time: "1d ago", category: "major" },
  { source: "This Is Anfield / BBC", title: "Quansah starts for England at the World Cup before injury: Liverpool hold an €80m buy-back (€60m in 2027) on the sold defender", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Marca", title: "Munoz setback: Liverpool's first signing picks up a muscular injury and misses Spain's group game, return tied to the knockouts", time: "2d ago", category: "fan" },
  { source: "GiveMeSport / Anfield Watch", title: "Inácio still leads the centre-back board: the left-footed Sporting man's £52m clause heads a list with Beukema, Murillo and Vuskovic", time: "2d ago", category: "fan" },
  { source: "Anfield Watch / This Is Anfield", title: "Right-back search runs on: Inter's Denzel Dumfries (release clause) and Leipzig's Geertruida floated as Bradley's rehab drags", time: "2d ago", category: "fan" },
  ...
  { source: "Al Jazeera / ESPN", title: "Konaté gone: Real Madrid confirm the centre-back to 2030, reuniting him with Trent Alexander-Arnold at the Bernabéu", time: "4d ago", category: "official" },
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season tour set: Sunderland in Nashville (Jul 25), Wrexham at Yankee Stadium (Jul 29), Leeds at Soldier Field (Aug 2)", time: "5d ago", category: "official" },
  { source: "Football Italia / Romano", title: "Chiesa exit 'on': Inter open near €20m against Liverpool's €30m-plus ask, the Italian to settle his future on the pre-season tour", time: "6d ago", category: "fan" },
];
