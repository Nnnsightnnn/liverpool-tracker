...
const LATEST_NEWS = [
  { source: "Empire of the Kop", title: "Romano: Curtis Jones could try to copy McTominay's Napoli playbook if he leaves Liverpool — Inter Milan named as suitor for the No.17", time: "today", category: "fan" },
  { source: "Rousing The Kop", title: "Liverpool transfer round-up: Curtis Jones latest, PSG winger Barcola eyed and more — door creaks open as Diomande race tilts to Paris", time: "today", category: "fan" },
  { source: "TEAMtalk", title: "Liverpool transfer news: €100m PSG ace Bradley Barcola becomes TOP priority after cruel Diomande twist — PSG join race for Leipzig forward", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Slot 'expected to continue' as Liverpool head coach — FSG support locked in heading into 2026-27 with UCL spot now realistic", time: "today", category: "fan" },
  { source: "CaughtOffside", title: "Liverpool feel they have advantage in race for Yan Diomande — Reds' relationship with RB Leipzig the edge over PSG, Arsenal", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Slot explains Robertson Liverpool exit: 'As a result, he's leaving' — left-back lost first-choice spot to Kerkez, Juve & Atletico join Spurs in summer chase", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Paul Joyce: three stats show why Liverpool must fight to keep Curtis Jones — Times man backs No.17 to stay despite Slot's pecking order", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Aston Villa v Liverpool kick-off time announced — Sun May 17 12:30pm BST, but fixture moves to Friday May 15 (8pm) if Villa reach Europa League final", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Liverpool sent clear Michael Olise transfer message by Bayern chief — Rummenigge: 'no price tag would make us cringe', Eberl confirms he stays", time: "1d ago", category: "official" },
  { source: "Empire of the Kop", title: "Romano drops double Liverpool contract & transfer bombshell — Konaté deal nears completion as Curtis Jones future opens up to Serie A interest", time: "1d ago", category: "fan" },
  { source: "ESPN", title: "Transfer rumors: Liverpool eye Adam Wharton amid Manchester United, Real Madrid interest — £80m Palace midfielder top of summer No.6 shortlist", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Slot praises Curtis Jones at RB: 'comfort on the ball, like Trent' — back-to-back 8/10s vs Everton & Palace earn the Old Trafford starting nod", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Mohamed Salah injury: Liverpool legend may have played final game for club after hamstring strain in Crystal Palace win — 4 weeks out", time: "3d ago", category: "major" },
  { source: "Al Jazeera", title: "Injured Salah has played his last game for Liverpool, says Egypt FA director — fit for World Cup, ruled out of Man Utd, Chelsea, Villa", time: "3d ago", category: "major" },
  { source: "Liverpool FC", title: "Isak, Robertson and Wirtz score as Liverpool beat Crystal Palace 3-1 — Reds climb to fourth, 97.9% UCL chance per Opta", time: "4d ago", category: "official" },
];
