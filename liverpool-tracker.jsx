...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "doubtful", outSince: "2026-07-25", injuryNote: "Fri Aug 28 — a month out, and the number the maths cannot spare. Iraola set Gomez's muscle problem at around a month, ruling him out of Saturday's home opener rather than leaving it a late call, after the knock taken inside minutes at Sunderland on 25 July that also cost him Newcastle. The arithmetic behind him is stark: with Konate gone to Madrid, Leoni on ACL rehab and Ndukwe barred by a work permit until January, Van Dijk and Jacquet are the only fit senior centre-backs and Araujo's loan is the cover, which is why Upamecano and Tomori are suddenly names again. The longest-serving defender is a body to keep, not sell", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  { id: 19, name: "Stefan Bajcetic", number: 43, position: "MID", nationality: "🇪🇸 Spain", age: 21, appearances: 0, goals: 0, assists: 0, cleanSheets: null, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "doubtful", injuryNote: "Fri Aug 28 — closing on Celta, on a termination rather than a fee. Romano has Celta Vigo closing on personal terms with Bajcetic, the framework a mutual end to a contract that runs to 2027 with Liverpool keeping a sell-on, not a conventional transfer. He has not featured for Liverpool this calendar year, travelled to America in the rehab group rather than to play, and at 21 carries three seasons wrecked by injury. The academy that raised him is where the rebuild begins, and the deal should complete inside the final week", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p535928.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 40, goals: 10, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 7.0, status: "fit", injuryNote: "Sat Aug 29 — starting the opener, not leaving it. On matchday Gakpo is named to start the Anfield home game against Forest, the clearest answer to a week that began with the Dutchman framed as the funding sale at around £72m. Manchester City and Tottenham keep an interest, but Liverpool will not sanction an exit without a replacement secured, and none is in the building. He took the equaliser at Newcastle on the opening day and is contracted to 2030. With three days left and no wide reinforcement beyond Barcola, Anfield is his stage a while longer", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Fri Aug 28 — a first home crowd, and a first goal still owed. Isak walked back into St James' in red on the opening weekend, a year after the £100m move he forced off Tyneside, and was met by jeers he could not answer: no goal, a hard afternoon, the late penalty handed to Szoboszlai rather than him. Paired with Wirtz and Gravenberch, the Sweden striker is fit and central, but a first goal of the Iraola era, ideally at Anfield on Saturday, would quiet a loud few days", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sat Aug 29 — eighteen today, and starting. Ngumoha turns 18 on the day Forest visit, and This Is Anfield report a new five-year deal with a significant rise waiting to be signed, the delay only a rule capping under-18s at three-year terms, a formality now clearing on his birthday. A bench option at Newcastle, he is in line to start the home opener on the flank. The path that looked narrow a fortnight ago is his to take: Barcola arrives as competition rather than a wall, and Gakpo, no longer a certain sale, is a partner beside him. A birthday, a contract, and a first Anfield start of the season, in one afternoon", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  { id: 26, name: "Federico Chiesa", number: 14, position: "FWD", nationality: "🇮🇹 Italy", age: 28, appearances: 12, goals: 1, assists: 1, cleanSheets: null, xG: 1.5, tacklesPer90: 0.6, passCompletion: 80, progressiveCarries: 2.2, form: 6.0, status: "doubtful", injuryNote: "Fri Aug 28 — still a doubt for the home opener. The Italian remains touch and go for Saturday after the fitness issue that kept him out at Newcastle and off the training pitch earlier in the week, with nothing fresh offered on his return. It complicates a summer spent weighing his future: he scored off the bench in Nashville and insists his focus is Liverpool, yet he sits among the exits the club would sanction, and with a winger still being chased the squad maths keeps moving against him", image: "https://r2.thesportsdb.com/images/media/player/cutout/idecla1757087689.png" },
...
const LATEST_NEWS = [
  { source: "The Athletic", title: "Ornstein: Barcola undergoing Liverpool medical, \u00a3106m plus \u00a317m add-ons, second-biggest signing in club history", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola's first Anfield: Forest at 12.30, Ngumoha handed a start on his 18th birthday", time: "today", category: "official" },
  { source: "Empire of the Kop", title: "Midfield now the front: Monaco's Camara offered at \u20ac50m, Roma's Kone priced near \u00a351m after Jones exit", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Barcola debut earmarked for Ipswich, not Forest: winger to be unveiled within a day", time: "today", category: "major" },
  { source: "Redmen TV", title: "Iraola on Barcola: 'I hope we have good news soon' as first home match nears", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Upamecano handed Bayern contract deadline: Madrid and PSG ahead of Liverpool if he moves", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Ngumoha turns 18: new five-year deal with a significant rise set to follow", time: "today", category: "fan" },
  { source: "Football365", title: "Preview: pointless Forest visit Anfield, where they have won their last two", time: "today", category: "major" },
  { source: "Sky Sports", title: "Palace value Sarr well above \u00a350m and stay unmoved as the window narrows", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Romano: Bajcetic closing on Celta Vigo as contract-termination route firms up", time: "1d ago", category: "major" },
  { source: "Goal", title: "Milan's Tomori still floated as Liverpool's value centre-back option with Gomez out a month", time: "1d ago", category: "major" },
  { source: "UEFA", title: "Champions League draw: Atletico, Porto, Villarreal and Lens to Anfield; Inter, Brugge, Fenerbahce, LASK away", time: "2d ago", category: "official" },
  { source: "TeamTalk", title: "Besiktas agree personal terms with Tsimikas and lodge a \u20ac2m loan bid for Mamardashvili", time: "2d ago", category: "major" },
  { source: "ESPN", title: "Jones sealed to Inter for \u20ac35m, thinning Iraola's midfield as the deadline nears", time: "3d ago", category: "major" },
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's stoppage-time penalty rescues Iraola's opener", time: "6d ago", category: "major" },
];
