...
const PLAYERS = [
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Sun Aug 16 — trains on, even as Inter circle. Jones, over a minor hip complaint, was among those back in training through the Como double-header, available if Iraola wanted him. Off the grass the exit is stuck on price: Inter remain his likeliest destination but have not moved to Liverpool's €40m valuation, an informal approach nearer €35m falling short. Into his final year and thought unlikely to extend, a boyhood Red keeps preparing for a shirt he may leave, edging toward the door without yet reaching it", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Sun Aug 16 — a goal, with the exit still open. Gakpo opened the scoring in Sunday's 2-0 win over Como even as Tottenham circle: talks between the clubs are described as underway and the Dutchman said to be open to the move if a fee can be agreed, reported near £60m against a valuation closer to £70m, though sources close to him deny anything is settled. De Zerbi wants two wide men and rates him highly; Liverpool's stance is a price rather than a refusal, likely settled only once the winger they want has landed. Nine goals and six assists in 39 appearances last term, a forward Iraola might reshape around or cash in, and for one night the reason to keep him", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sun Aug 16 — the shirt is his until Paris lets go, and the summer just closed. Ngumoha keeps the post-Salah right-sided slot by default through the Como win that ended the pre-season. The wait is shortening but stuck: PSG will now take around £125m for Barcola, yet Sky call the deal difficult, and with Minteh injured the alternative board is down to Rayan's dormant clause and Everton's Ndiaye. The 17-year-old, youngest goalscorer in the club's history, held the spotlight through the summer and is reported to have no intention of leaving. Until a senior winger signs, the berth stays his into Newcastle", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Pre-season done: Liverpool 2-0 Como at Anfield, Gakpo and Jacquet on the mark", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Araujo makes his Anfield bow as the summer closes and Newcastle looms", time: "today", category: "official" },
  { source: "Sky Sports", title: "Isak's St James' Park return headlines the opener as both clubs start under new coaches", time: "today", category: "major" },
  { source: "Football365", title: "PSG 'would accept £125m' for Barcola after buying Ferran Torres cover", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Barcola deal 'difficult to complete' after latest talks, sources say", time: "today", category: "major" },
  { source: "TeamTalk", title: "Iraola 'ready to approve eight exits' as an overstocked squad must sell to buy", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Gomez to miss Newcastle and possibly Forest, Iraola confirms return window", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Curtis Jones: Inter still short of the €40m ask as the Scouser trains on", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Gakpo scores against Como with a Tottenham move still open at the talks stage", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Everton hold near £75m for Ndiaye as the winger board thins behind Barcola", time: "2d ago", category: "fan" },
  { source: "FotMob", title: "Harvey Elliott 'needs to review' his future with a World Cup place in mind", time: "2d ago", category: "fan" },
  { source: "Sky Sports", title: "FSG's minority-stake sale to the Bezos-Bhatia consortium settles into context", time: "2d ago", category: "official" },
