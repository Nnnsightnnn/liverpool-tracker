...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Mon Sep 21, evening - away with England, and still the youngest unresolved contract at the club. Ngumoha is the only Liverpool player in Thomas Tuchel's senior squad and in line for a first competitive cap after a friendly debut in June. He was an unused substitute at Bournemouth once Gakpo passed his warm-up. David Ornstein reported the club wants his new deal signed inside the month, which on tonight's evidence of how Liverpool handle contracts is not a formality.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "beIN Sports", title: "Mac Allister says 'no firm decision' over Liverpool future amid contract stand-off", time: "today", category: "major" },
  { source: "beIN Sports", title: "Carragher: Wirtz 'the poorest I've ever seen him in a Liverpool shirt', drop him for City", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Alisson on the shutout run: 'It wasn't the cleanest performance, but it brings confidence'", time: "today", category: "official" },
  { source: "Rousing The Kop", title: "The two Iraola calls that rebuilt Liverpool's spine: Araujo in, Frimpong and Gravenberch out", time: "today", category: "fan" },
  { source: "Anfield Index", title: "Reds handed glowing reports on Real Sociedad's Aramburu and his £50m release clause", time: "today", category: "fan" },
  { source: "Express & Star", title: "Semenyo surprised by City plan to use him as Haaland's back-up: 'I've no problem doing that'", time: "today", category: "major" },
  { source: "This Is Anfield", title: "'We are reaching tipping point': Andoni Iraola's first month at Liverpool assessed", time: "today", category: "fan" },
  ...
  { source: "L'Equipe", title: "Jeremy Jacquet called up to the France senior squad for the first time", time: "2d ago", category: "fan" },
  { source: "CaughtOffside", title: "Talks held: Liverpool meet Brentford's Lee Dykes over replacing Richard Hughes", time: "3d ago", category: "fan" },
  { source: "This Is Anfield", title: "Wirtz to report late for Klopp's split Germany squad, in line to face Serbia and Greece", time: "4d ago", category: "fan" },
  { source: "Liverpool FC", title: "Chelsea at Anfield in the Carabao Cup fourth round, Wednesday 28 October, 8pm", time: "4d ago", category: "official" },
  { source: "Sky Sports", title: "Mac Allister 'very sad' over no new contract and admits he could have left in summer", time: "2w ago", category: "major" },
  { source: "Liverpool FC", title: "Turkish Airlines confirmed as main club partner from the 2027-28 season", time: "2w ago", category: "official" },
];
