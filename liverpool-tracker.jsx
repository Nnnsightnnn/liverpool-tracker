...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Iraola's Anfield bow this afternoon: Liverpool host Monaco at 2.30pm to begin the home stand", time: "today", category: "official" },
  { source: "ESPN", title: "Victor Munoz declares himself fit to debut against Monaco as Van Dijk stands as the lone senior centre-back", time: "today", category: "major" },
  { source: "Sky Sports", title: "Not just Barcola: Liverpool lead the race for PSG's 18-year-old Ibrahim Mbaye ahead of Leverkusen", time: "today", category: "major" },
  { source: "Goal", title: "Mbaye gives Liverpool the green light as PSG set a €40-50m price on the teenage winger", time: "today", category: "fan" },
  { source: "Football365", title: "Barcola deal called 'difficult to complete' as PSG hold near €145m against Liverpool's €128m", time: "today", category: "fan" },
  ...
  { source: "Daily Sabah", title: "Salah settles at Trabzonspor after his Black Sea unveiling on a two-year deal", time: "3d ago", category: "major" },
  { source: "Newcastle United", title: "Newcastle away on August 23 opens the season, with tributes set for Kevin Keegan at St James' Park", time: "3d ago", category: "major" },
  { source: "This Is Anfield", title: "Como to follow Monaco on August 16 as Liverpool's final Anfield tune-up before the league begins", time: "3d ago", category: "fan" },
];
