...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sun Sep 13, morning - rested to the bench and on for Barcola at 72, a cameo Rousing The Kop called poor, a 4: an overhit cross, a counter conceded, a shot fired wide from Frimpong's late ball across the box. The special day against the side he scored against last April did not come. Still a left-sided starting option for Tuesday if Barcola and Gakpo are managed", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Sun Sep 13, morning - third keeper, not on Saturday's bench, which carried Mamardashvili alone. With the deputy likelier to start Tuesday's cup tie, Woodman's next involvement is a bench place there at most", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
...
const LATEST_NEWS = [
  { source: "AnfieldWatch", title: "Iraola 'officially under serious pressure' at Liverpool: one win in four, and the sporting director who hired him is gone", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola's fuller reflection: 'what was lacking was quite clear' on a first afternoon his side could not create", time: "today", category: "official" },
  { source: "LFC Live", title: "Liverpool make initial contact for Atletico's Pablo Barrios after his Anfield display; Chelsea also weighing a move", time: "today", category: "major" },
  { source: "Yahoo Sport", title: "Who will be Liverpool's next sporting director? FSG's Mike Gordon leads a fifth search since 2022", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Iraola 'confident' the Richard Hughes exit to Al-Hilal will not affect the squad's day-to-day", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Carabao Cup: Iraola set to rotate against Tottenham, with Mamardashvili and Gomez in line for minutes", time: "today", category: "fan" },
  { source: "SI", title: "'My fights with him are more about other stuff': Iraola defends Isak after a 16-touch afternoon", time: "today", category: "major" },
  { source: "CBS Sports", title: "Tottenham bring a four-game league goal drought to Anfield, a club first, for Tuesday's cup tie", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Andy Robertson returns to Anfield in white for the first time since his summer move to Spurs", time: "today", category: "fan" },
  { source: "ESPN", title: "Manchester derby at Old Trafford this afternoon: City chase Arsenal with a game in hand", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Mac Allister 'undroppable' after the pivot buckled without him, his contract still unrenewed for 2027", time: "1d ago", category: "fan" },
  { source: "The Independent", title: "Richard Jolly: a 670m-pound squad drawn by pointless Fulham, and a first rotation that failed inside an hour", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Injury latest: Leoni and Chiesa both due back in group training over the September international break", time: "1d ago", category: "official" },
  { source: "Football Insider", title: "Van Dijk 'tempted' by Saudi interest: report stays unconfirmed as the captain plays on at 35", time: "1d ago", category: "fan" },
];
