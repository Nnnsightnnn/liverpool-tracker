...
const LATEST_NEWS = [
  { source: "Sky Sports / Empire Of The Kop", title: "Arne Slot, at his Thursday media briefing: 'I don't think I am deciding that alone by myself, but I have every reason to believe I am the Liverpool manager next season'", time: "today", category: "major" },
  { source: "Sky Sport Italia / Football Italia", title: "Inter table €20m offer for Curtis Jones, Liverpool hold out for €30m — Hughes and Ausilio held preliminary talks in Monte Conte earlier this week", time: "today", category: "major" },
  { source: "Liverpool.com / OneFootball", title: "'Sell to buy': Slot braces the support for as many as 10 departures this summer to fund the second phase of the rebuild around Wirtz and Isak", time: "today", category: "major" },
  { source: "Liverpool.com / Yahoo Sports", title: "Quansah buy-back held over to 2027 — Liverpool will let the €80m clause drop to €65m next summer rather than trigger it now, saving roughly $23m", time: "today", category: "major" },
  { source: "Sky Sports / This Is Anfield", title: "Etienne Reijnen 'closing on' Liverpool move — Slot's Feyenoord set-piece coach has told colleagues he is joining once the Dutch season ends", time: "today", category: "official" },
  { source: "Sky Sports / Liverpool.com", title: "Alisson Becker now framed as 'set to stay' despite agreed personal terms with Juventus — Liverpool's direct stance against the €5m offer holds", time: "today", category: "major" },
  { source: "Sky Sports / DaveOCKOP", title: "Edwards and Hughes confirmed in post for the summer window — Saudi interest in Hughes rebuffed; the FSG review continues, the chairs do not move", time: "today", category: "official" },
  { source: "This Is Anfield / Sports Mole", title: "Mac Allister's agent (and father) publicly declines opening contract talks 'out of respect' for Liverpool supporters — Real Madrid interest live, €120m sale price floated", time: "1d ago", category: "fan" },
  { source: "Liverpool FC / NBC Sports", title: "Pre-season opens at Nashville's Geodis Park against Sunderland on July 25, Wrexham at Yankee Stadium July 29, Leeds at Soldier Field August 2", time: "1d ago", category: "official" },
  { source: "Liverpool.com / Goal", title: "Salah replacement domino: Diomande coy at Leipzig, PSG's Barcola moves to the front of the queue, Anthony Gordon ruled out of Liverpool's plans", time: "1d ago", category: "major" },
  { source: "Fabrizio Romano / TEAMtalk", title: "Liverpool's first signing on paper: 17-year-old Colombian Samuel Martinez (Atletico Nacional), a 5-year deal that triggers when he turns 18 in 2027", time: "2d ago", category: "official" },
  { source: "Liverpool.com / Sportbible", title: "The Brexit wall holds: 16-year-old Kennet Eichhorn cannot officially sign for Liverpool until July 2027 — the club may only agree a pre-contract this summer", time: "2d ago", category: "major" },
  { source: "Anfield Watch / The Hard Tackle", title: "Robertson to Tottenham confirmed under De Zerbi — Juventus late intervention rebuffed; Salah's next club, Al-Ittihad cast as favourite, still pending", time: "2d ago", category: "major" },
  { source: "RTE / Rousing The Kop", title: "Robertson, on his way out, backs Wirtz and Isak to have 'unbelievable' Liverpool careers — Slot insists the £241m pair's integration will 'only continue'", time: "3d ago", category: "fan" },
  { source: "Sky Sports / ESPN", title: "Liverpool 1-1 Brentford: Curtis Jones turns in a Mohamed Salah cross before Kevin Schade levels — the Champions League place sealed amid the long farewell", time: "4d ago", category: "major" },
];
