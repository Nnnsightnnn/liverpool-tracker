...
const PLAYERS = [
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Wed Sep 16, morning - third of three, and the order is unchanged. Woodman was not required for the cup tie that went to Mamardashvili, and with both senior goalkeepers fit his season remains a bench one at most. Nothing in Tuesday's night or Sunday's preview changes it.", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
...
const LATEST_NEWS = [
  { source: "Yahoo Sports", title: "Iraola returns to Bournemouth on Sunday 'under serious pressure', unbeaten but with the man who hired him gone", time: "today", category: "major" },
  { source: "Liverpool Echo", title: "Carabao Cup fourth-round draw made tonight after Man Utd vs Brighton, live on Sky, ties in the week of 26 October", time: "today", category: "major" },
  { source: "Goal", title: "Gomez came through 90 minutes and the armband on Tuesday and is now a genuine option for Sunday", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Iraola calls Szoboszlai 'a great finisher' after the thirty-yard volley that beat Spurs", time: "today", category: "official" },
  { source: "Sports Mole", title: "Chiesa and Leoni both due back in training over the international break, mid-October availability targets", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Sunday at the Vitality is Liverpool's last fixture before the extended international break", time: "today", category: "fan" },
  { source: "Squawka", title: "Isak the likeliest scorer at the Vitality as he returns after a rare rest", time: "today", category: "fan" },
  { source: "Sports Mole", title: "The right-back question for Sunday: Araujo, Frimpong or Gomez, with Bradley out until November", time: "today", category: "major" },
  ...
  { source: "Goal", title: "Bournemouth's unwanted record: first side to lead in all four openers and win none", time: "1d ago", category: "major" },
  { source: "EPL Index", title: "Liverpool 3-1 Tottenham: ten changes and a Szoboszlai stunner send Iraola's side into round four", time: "1d ago", category: "major" },
  { source: "Goal", title: "All four stands rise for Robertson on his Anfield return in a Tottenham shirt", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Spurs leave Merseyside seventeenth and out, with one goal to show for five games", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Richard Hughes leaves Liverpool for Al-Hilal as the search for a sporting director goes on", time: "1w ago", category: "major" },
];
