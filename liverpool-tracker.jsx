...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "injured", injuryNote: "Hamstring fully healed per Slot (Apr 22) — back in team training this week, but NOT rushed for Palace; Man Utd (A, May 3) is the return target", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  ...
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 35, goals: 2, assists: 0, cleanSheets: 9, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 7.1, status: "fit", injuryNote: "All but confirmed new Liverpool contract: 'For sure there is a big chance I'm here next season' — U-turn on Real Madrid speculation (still lead transfer story Apr 22)", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
...
const LATEST_NEWS = [
  { source: "ESPN", title: "Liverpool's Freddie Woodman eyes 'unreal' first PL start vs boyhood club Crystal Palace — 'grew up a Palace fan, was a ball-boy there'", time: "today", category: "major" },
  { source: "Tribuna", title: "'He has been unbelievable' — Andy Robertson publicly backs Freddie Woodman ahead of full Liverpool debut vs Palace", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Watch: Arne Slot's pre-Crystal Palace press conference LIVE from the AXA Training Centre — Alisson, Mamardashvili, Gomez updates", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Alonso 'future lies at Anfield' claim Spanish reports: 'No doubts' — Diario AS editor reignites Liverpool manager saga", time: "today", category: "fan" },
  { source: "World Soccer Talk", title: "Hugo Ekitiké's replacement decided — Liverpool chase Randal Kolo Muani arrival with PSG demanding at least €35m", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Liverpool injury latest as 9 players now on Arne Slot's growing list — Wirtz back issue, Gomez muscle, Mama knee all up in the air", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Alisson Return Date & Woodman Debut Confirmed — hamstring fully healed, Brazilian targets Man Utd (A, May 3)", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Ibrahima Konaté all but confirms new deal: 'For sure there is a big chance I'm here next season' — U-turn after months of Real Madrid rumours", time: "1d ago", category: "major" },
  { source: "FootballTransfers.com", title: "Reds forced to pay over €100m for Mohamed Salah replacement — Leipzig holding firm on Yan Diomande valuation", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Ornstein: Alonso not on Liverpool's agenda, even if Slot is sacked — FSG still intend to stick with Slot", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Van Dijk scores 100th-minute winner as Liverpool beat Everton 2-1 in first Merseyside derby at Hill Dickinson Stadium", time: "3d ago", category: "official" },
  { source: "Liverpool FC", title: "Mohamed Salah equals Steven Gerrard's record for most Premier League Merseyside derby goals (9) in his final-ever clash with Everton", time: "3d ago", category: "official" },
  { source: "This Is Anfield", title: "Everton 1-2 Liverpool PLAYER RATINGS — Jones (8.4) the inverted RB standout as Liverpool climb 7 clear of Chelsea", time: "3d ago", category: "fan" },
  { source: "Sports Mole", title: "Liverpool target Sunderland midfielder Enzo Le Fée — €25m valuation, 4 goals and 5 assists in debut PL season", time: "3d ago", category: "major" },
