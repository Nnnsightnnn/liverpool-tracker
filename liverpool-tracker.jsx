...
const PLAYERS = [
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 32, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.3, status: "doubtful", injuryNote: "Mon May 11 — ruled out of Sat's 1-1 Chelsea Anfield draw with a stomach infection (AP/Washington Post/Yahoo Sports). Slot: 'He tried everything to be in it ... in the end things got worse and he wasn't able to train.' Reds will 'wait and see how he feels' Mon-Wed. Slot 'hopeful' Wirtz returns at Villa Park Fri May 15", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p494595.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Mon May 11 — came off the bench in the second half of Sat's 1-1 Chelsea Anfield draw, his first minutes since the Apr 25 Crystal Palace muscle issue. Couldn't find the winner, but confidence-builder ahead of Villa Park Fri May 15 where he's expected to start with Gakpo dropping back to the wing", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 12, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.4, status: "fit", injuryNote: "Mon May 11 — STARTED Sat's 1-1 Chelsea Anfield draw and supplied the assist for Gravenberch's 6' opener. Liverpool.com headline: 'Rio Ngumoha stars.' Hooked at 75' with cramp; the substitution drew loud boos from the Anfield crowd. Slot post-match: 'He said it was enough.' Gomez (today, Liverpool.com): 'Rio's young ... physically he was tired.' Pushes for another start at Villa Park Fri May 15 if Salah isn't ready", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Mon May 11 — back-up to Mamardashvili in Sat's 1-1 Chelsea draw; unused. Two PL starts this season (Crystal Palace and Old Trafford), ratings 6-7. Serviceable cover for the run-in with Alisson still not in full training ahead of Villa Park Fri May 15", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
];
...
const LATEST_NEWS = [
  { source: "Liverpool.com", title: "Joe Gomez reveals Liverpool dressing-room feelings on Anfield boos: 'For us older boys who have experienced so many good times here, it does hurt' — but accepts fans 'entitled' to show frustration", time: "today", category: "major" },
  { source: "ESPN", title: "Joe Gomez understands frustration as Liverpool fans boo Chelsea draw: 'We get it' — defender defends Slot's Ngumoha cramp substitution", time: "today", category: "major" },
  { source: "This Is Anfield", title: "'Hurt' Joe Gomez accepts Anfield boos for football 'no one wants to see' as Liverpool's race for the top five wobbles into Villa Park", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Liverpool gets referee verdict on Virgil van Dijk incident during Chelsea draw as captain limps off with cramp — Slot 'has to wait and see how he feels' before Villa", time: "today", category: "major" },
  { source: "FootballTransfers", title: "Liverpool news: Arne Slot set to stay after rejecting move to European giants — Telegraph confirms FSG faith and reports Reds have NOT contacted Alonso or his agents in May", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool's final fixtures compared to Aston Villa and Bournemouth — exactly how many points Slot's side need to confirm Champions League with two to play", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool transfer news LIVE: Juventus advances on Alisson on €5m-a-year terms, €15m fee mooted — Reds drawing up Chevalier-led five-keeper shortlist", time: "today", category: "major" },
  { source: "Sky Sports", title: "Liverpool 1-1 Chelsea: Boos for Arne Slot at Anfield as Blues end six-game Premier League losing streak — Gravenberch 6', Enzo Fernandez 35'", time: "2d ago", category: "major" },
  { source: "Liverpool FC", title: "Liverpool 1-1 Chelsea: Every word from Arne Slot's post-match press conference — boss says Reds 'shouldn't be happy' and Champions League wait goes on", time: "2d ago", category: "official" },
  { source: "Sky Sports", title: "Arne Slot admits he won't win Liverpool fans back this season after Anfield boos but expects change after transfer window — 'I'm 100% convinced next season we will be a different team'", time: "2d ago", category: "major" },
  { source: "Washington Post (AP)", title: "Wirtz misses Liverpool's game against Chelsea because of stomach infection — Slot: 'He tried everything to be in it', will be reassessed for Villa Park", time: "2d ago", category: "major" },
  { source: "Empire of the Kop", title: "Liverpool hit unwanted Premier League record as Slot's set-piece problem exposed — Opta: Reds' non-penalty set-piece difference of -9 is worst in Europe's top five leagues", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Diomande to Liverpool: Concrete talks for €100m Salah successor as Reds' top transfer target — 22 goal contributions for Leipzig, Roc Nation agency contacted", time: "3d ago", category: "fan" },
  { source: "Liverpool.com", title: "Anthony Gordon contact made amid £73m boost as Newcastle winger 'opens transfer talks' — but Bayern Munich now seen as in pole position", time: "3d ago", category: "major" },
  { source: "This Is Anfield", title: "Andoni Iraola 'among candidates' to replace Arne Slot at Liverpool — Bournemouth boss to leave Cherries this summer as contract expires", time: "1w ago", category: "fan" },
  { source: "GiveMeSport", title: "Liverpool in 'advanced talks' to sign Adam Wharton — Crystal Palace's £80m midfielder reportedly favours Anfield move over Real Madrid and United", time: "1w ago", category: "major" },
];
