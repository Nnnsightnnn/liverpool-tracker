...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "recovering", injuryNote: "Wed May 13 — Liverpool.com's Wed injury read 'Liverpool could be without EIGHT players against Aston Villa' confirms Alisson STILL not in full team training Wednesday morning, 48 hours from Villa Park kickoff. Slot's pre-Villa wording stands — 'doesn't train with the team yet.' Brentford home finale May 24 looks the realistic earliest return. Off the pitch the Juventus story has hardened on Wed — €15m fee mooted with €5m-a-year personal terms (Schira), Mamardashvili anointed next season's No. 1", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 32, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.3, status: "doubtful", injuryNote: "Wed May 13 — Liverpool.com's Wed '8 out vs Villa' rundown lists Wirtz among the doubts: still being managed back from the stomach infection that forced him out of Sat's 1-1 Chelsea draw. AP/Washington Post quote stands: 'He tried everything to be in it ... in the end things got worse and he wasn't able to train.' Late call for Aston Villa (A) Fri May 15", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p494595.png" },
...
const LATEST_NEWS = [
  { source: "ESPN / Anfield Index", title: "'Anything can happen … we'll see' — Joe Gomez breaks silence on his Liverpool future, admits he doesn't know if he'll still be at Anfield next season as he enters the final year of his deal", time: "today", category: "major" },
  { source: "Caught Offside", title: "Liverpool tipped to replace Arne Slot with Xabi Alonso — Danny Murphy says Slot's time is 'surely up' with the ex-Real Madrid boss the 'obvious' candidate after Chelsea boos", time: "today", category: "fan" },
  { source: "Yahoo Sports / OneFootball", title: "'The fans have disconnected from the manager' — David Bentley claims Liverpool supporters are emotionally detaching from Slot in latest pundit broadside", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool could be WITHOUT EIGHT PLAYERS at Villa Park as Slot faces more decisions — Salah, Alisson, Ekitike, Bradley, Endo, Leoni, Bajcetic and Wirtz (doubtful) on the casualty list", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Ibrahima Konaté contract 'stalemate' with Liverpool — sticking points over signing-on package and agent commissions, Real Madrid still circling", time: "today", category: "major" },
  { source: "Sky Sports", title: "Howard Webb says Benjamin Šeško DID handle the ball before scoring vs Liverpool at Old Trafford on May 3 — VAR could not disallow due to lack of conclusive evidence", time: "today", category: "major" },
  { source: "L'Équipe / Football365", title: "Akliouche 'almost certain' to leave Monaco this summer per L'Équipe — Liverpool prepping €50m bid as FSG green-lights potential Gakpo sale to fund the wide rebuild", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Jürgen Klopp could be set for another Anfield return on the last day of the season — Brentford's May 24 visit to double as Salah farewell and a Klopp reunion in the Brentford suite", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "'The farewell he deserved': Mohamed Salah asks Liverpool to give Jordan Henderson a proper send-off too — old captain back at Anfield in Brentford colours on May 24", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop / The Athletic", title: "Pearce hints Liverpool could need at least FIVE summer signings to be competitive next term — Anfield Watch names the eight-man clear-out Hughes will sanction", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Arne Slot's pre-Aston Villa press conference: 'I see it as 13 games to be played and the next game to be the most important one, starting with Villa away'", time: "1d ago", category: "official" },
  { source: "Caught Offside / Football365", title: "Liverpool take 'concrete steps' for Sporting's Francisco Trincão — €60m release-clause winger linked with Salah successor role, Chelsea and Arsenal also keen", time: "1d ago", category: "fan" },
  { source: "Tribuna", title: "'Arne Slot Out' petition surges past 1.2 million signatures — viral campaign caveated by Anfield Index / Telegraph note: hierarchy 'absolutely' continuing with Slot", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Konaté trains without restriction Tuesday and Van Dijk's Saturday cramp cleared — CB pair restored for Villa Park as Wirtz still managed back from stomach infection", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Joe Gomez reveals Liverpool dressing-room feelings on Anfield boos: 'For us older boys who have experienced so many good times here, it does hurt' — accepts fans 'entitled' to show frustration", time: "2d ago", category: "major" },
  { source: "FootballTransfers", title: "Liverpool transfer news: Reds in 'advanced' Adam Wharton talks as summer planning goes into overdrive — Palace ask £80m, Wharton said to favour Anfield", time: "2d ago", category: "major" },
  { source: "Liverpool.com", title: "Liverpool transfer news LIVE: Juventus advances on Alisson on €5m-a-year terms, €15m fee mooted — Mamardashvili anointed as next season's No. 1", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool 1-1 Chelsea: Boos for Arne Slot at Anfield as Blues end six-game Premier League losing streak — Gravenberch 6', Enzo Fernandez 35'", time: "4d ago", category: "major" },
];
