...
const LATEST_NEWS = [
  { source: "TeamTalk", title: "Romano delivers the 'here we go': Klopp agrees to become Germany head coach, two years after leaving Liverpool", time: "today", category: "major" },
  { source: "Goal", title: "Klopp is back: Germany job accepted after Nagelsmann's resignation, with the announcement awaiting his Red Bull release", time: "today", category: "major" },
  { source: "Anfield Watch", title: "Van Dijk 'green-lights' the Galatasaray move in Turkish reports, with an official offer now said to be days away", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Barcola 'evasive' on his future: 'Right now, I'm really focused on the World Cup', says the man atop Liverpool's list", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Nineteen due at Kirkby a week today: Iraola's first-session squad takes shape, minus the Dutch trio, Wirtz and Isak", time: "today", category: "fan" },
  { source: "Sky Sports", title: "The Diomande file closes: Liverpool decline to meet Leipzig's valuation as PSG negotiate the teenager's transfer", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Germany and Red Bull set for further talks over the one issue standing between Klopp and the touchline", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Curtis Jones 'reluctant' to join Forest, who have parted with Pereira and are set to appoint Glasner", time: "today", category: "fan" },
  { source: "ESPN", title: "Argentina vs Egypt: noon on Tuesday in Atlanta, with Messi and Salah meeting in a World Cup for the first time", time: "today", category: "major" },
  { source: "Atlanta News First", title: "Egypt touch down in Atlanta ahead of the round-of-16 meeting with the champions", time: "1d ago", category: "fan" },
  { source: "Anfield Watch", title: "Iraola intervenes on Tillman as World Cup form pushes Leverkusen's price toward £43m and beyond", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool 'made contact' with Bruno Guimaraes's agents, though the enquiry is not being actively worked, per Jacobs", time: "1d ago", category: "fan" },
  { source: "Opta Analyst", title: "The supercomputer gives Argentina 70.4% on Tuesday; Egypt have conceded twice all tournament", time: "today", category: "fan" },
];
