...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "recovering", injuryNote: "Missed past 8 PL matches with hamstring complaint — has not featured since March 18. Slot's pre-Man Utd presser (Fri May 1): 'very close to' training but yet to do so; Liverpool.com's Sat May 3 update keeps him sidelined — Woodman retains the gloves at Old Trafford. Earliest realistic return is the Chelsea home tie May 9", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 33, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 7.0, status: "fit", injuryNote: "Came off bench in 59' for the injured Salah vs Palace 3-1 (Apr 25) — Slot kept Curtis Jones at RB. Leading candidate to fill Salah's RW vacancy at Old Trafford May 3; with today's 'minor' Salah update (Apr 30) Frimpong's run-in workload may ease later in May", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 14, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 17, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.7, status: "injured", injuryNote: "BREAKING (Sat May 3) — Sky Sports/Daily Mail/Goal: Suspected groin strain picked up in Friday's training, Liverpool fly to Old Trafford WITHOUT a fit recognised senior No.9. Scan this weekend will set the timeline; even a minor groin tear is a 1-2 week absence that could threaten Chelsea (May 9) and the Aston Villa trip (May 17). Gakpo set to deputise as a false 9 with Ngumoha or Wirtz the alternative", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "BREAKING — Alexander Isak ruled out of Man Utd trip with groin strain picked up in training; Liverpool head to Old Trafford without a fit senior striker", time: "today", category: "major" },
  { source: "Daily Mail", title: "Isak suffers groin injury in training — major doubt for Old Trafford, scan to determine if Chelsea (May 9) and Aston Villa (May 17) also at risk", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Liverpool have two options to replace Isak vs Man United as injury curse continues — Gakpo false 9 or Wirtz pushed central", time: "today", category: "fan" },
  { source: "Goal.com", title: "Alexander Isak injured and set to miss Liverpool's clash vs Man Utd — £130m forward joins Salah, Alisson, Mama on absentee list", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Isak injury claim: Fans furious at source of story on Man United absence as Liverpool's striker shortage deepens hours before kick-off", time: "today", category: "fan" },
  { source: "Sports Mole", title: "How Liverpool could line up against Man United as Slot considers two Isak replacements: Gakpo false 9 with Ngumoha drafted in wide", time: "today", category: "major" },
  { source: "Read Liverpool", title: "Man Utd vs Liverpool: Salah & Alisson ruled out amid fresh defensive injury concern as Kerkez doubt added to matchday-1 list", time: "today", category: "fan" },
  { source: "FotMob", title: "Man United vs Liverpool match centre — predicted lineups, H2H stats and live preview ahead of Sunday's 14:30 Old Trafford clash", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Liverpool in advanced talks to land Adam Wharton — Moretto reports £70m deal accelerated to preempt Real Madrid hijack", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Why Man Utd vs Liverpool kick-off was moved as Reds eye Champions League boost — Sunday 14:30 slot brings Sky Super Sunday spotlight", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Liverpool make £24m 'offer' for Napoli's Sam Beukema — Slot reportedly told Hughes to sign the Dutch defender as cover", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Arne Slot future: Liverpool boss expected to stay at Anfield next season as FSG firmly back third campaign with UCL qualification 96.92% likely", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Arne Slot 'confirms' Liverpool plans for new coaching staff — Etienne Reijnen set-piece reunion 'beckons' from Feyenoord", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Mohamed Salah injury update — club confirm 'minor' muscle issue, expect Egyptian back before end of season for Anfield farewell", time: "2d ago", category: "official" },
  { source: "Empire of the Kop", title: "Romano: Curtis Jones could copy McTominay's Napoli playbook if he leaves Liverpool — Inter Milan circling, 14 months left on deal", time: "4d ago", category: "fan" },
];
