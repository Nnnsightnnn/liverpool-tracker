...
const LATEST_NEWS = [
  { source: "Fabrizio Romano / Caught Offside", title: "Here we go: Ibrahima Konaté reaches verbal agreement to join Real Madrid on a free — a four-year deal, following Trent Alexander-Arnold to the Bernabéu", time: "today", category: "major" },
  { source: "TeamTalk / This Is Anfield", title: "Andoni Iraola gives FSG an official 'yes' — Liverpool hope to confirm him by the weekend, building a lean backroom around Bournemouth's Elphick and Cooper", time: "today", category: "official" },
  { source: "FourFourTwo / Yahoo Sports", title: "Alexander Isak admits he felt 'disconnected' from Liverpool after Slot's sacking, speaking on Sweden duty — the £125m striker's candid verdict", time: "today", category: "fan" },
  { source: "FootballTransfers / Get French Football News", title: "Konaté to become a Real Madrid free signing — wage-and-bonus impasse at Anfield never bridged, only formalities now outstanding", time: "today", category: "major" },
  { source: "Goal / Liverpool.com", title: "Salah expected to name his next club 'in a few days' — Juventus join the free-transfer race, a move to Turkey still the bookmakers' favourite", time: "1d ago", category: "major" },
  { source: "This Is Anfield / La Nación", title: "Alan Varela on the Liverpool links: 'I'm calm and 100% focused here in Porto' — the €75m clause and the queue both still in place", time: "1d ago", category: "fan" },
  { source: "Rousing The Kop / This Is Anfield", title: "Liverpool to move early when the window opens June 15 — but hold fire on 'dream' target Adam Wharton to let Iraola pick his own midfielder", time: "1d ago", category: "major" },
  { source: "Football365 / This Is Anfield", title: "Winger shortlist widens: Leipzig want €120m for Diomandé as Yildiz, Olise, Rodrygo, Barcola and Bowen fill out a seven-man list", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Iraola expected to bring a set-piece specialist and a former Liverpool player onto his coaching staff as the new structure takes shape", time: "1d ago", category: "fan" },
  { source: "Liverpool.com / OneFootball", title: "Centre-back hunt turns urgent with Konaté gone: a Quansah buy-back leads, Koulierakis, Schlotterbeck and Lacroix all in the frame", time: "2d ago", category: "major" },
  { source: "Sky Sports / Sky Sport Italia", title: "Andy Robertson's free transfer to De Zerbi's Tottenham is done; Inter Milan keen on Curtis Jones around €20m", time: "2d ago", category: "major" },
  { source: "Liverpool FC / ESPN", title: "'Forever Bound': Liverpool's new Carrara-marble Heysel memorial stands by the Anfield Road Stand on the disaster's 41st anniversary, Juventus present", time: "4d ago", category: "official" },
