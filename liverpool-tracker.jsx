...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Fri Sep 18, evening - an England international by Friday lunchtime, and still unsigned by Friday night. Thomas Tuchel named Ngumoha, eighteen, in his squad for four Nations League fixtures, the only Liverpool player selected, which would bring his first competitive caps after a friendly debut in June. Iraola said he absolutely deserves it and described the attitude behind it: he does not say where he would prefer to play, he asks what the team needs. The club still wants a long-term deal agreed inside a month, and Ornstein still reports that nothing is agreed.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Rio Ngumoha receives England call-up for four Nations League fixtures under Tuchel", time: "today", category: "official" },
  { source: "BBC Sport", title: "Iraola on the call-up: Ngumoha and Alex Scott 'absolutely deserve' their England places", time: "today", category: "major" },
  { source: "Liverpool FC", title: "'Have to be ruthless': Iraola on going back to the club he took into Europe", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Team news: 'No, everyone is ready to go' as the injury list holds at four", time: "today", category: "official" },
  { source: "Sky Sports", title: "Real Sociedad 1-2 Bournemouth: Kluivert and Rayan hand the Cherries a first European win", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola claims a rest advantage: 'most of the time it has been the opposite'", time: "today", category: "official" },
  { source: "Sports Illustrated", title: "Predicted XI: Kerkez back in at left-back, Mac Allister and Szoboszlai the pivot, Isak leads", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola is pushing Ronald Araujo to learn English so the back four can use his experience", time: "today", category: "major" },
  { source: "beIN Sports", title: "Brentford 3-0 Chelsea: Anthony, Thiago and Carvalho send the Bees third", time: "today", category: "major" },
  { source: "Sports Mole", title: "Bournemouth XI: Rose faces a Tyler Adams call after the midfielder came off on the hour in Spain", time: "today", category: "major" },
  { source: "BBC Sport", title: "Isak on the record move: 'No, never. I would never think like that'", time: "1d ago", category: "major" },
  { source: "Yahoo Sports", title: "Iraola on four wingers for two flanks: 'we will need them all, it's a luxury'", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "No new injuries as a 25-man squad trains at the AXA, with Van Dijk, Wirtz and Tsimikas back in", time: "1d ago", category: "fan" },
  { source: "CaughtOffside", title: "Ben Jacobs: Liverpool to sanction Wataru Endo sale in January as Iraola makes his call", time: "2d ago", category: "major" },
];
