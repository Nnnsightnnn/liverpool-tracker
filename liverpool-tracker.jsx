...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "doubtful", injuryNote: "Mon Jul 27 — the scare eases. Two days after he limped off inside eight minutes of the Sunderland win with a muscle problem, Iraola offered a calmer read: the defender has trained very well, no risks will be taken, and the manager expects him back for the final match of the American tour. A back line down to Jacquet, with Van Dijk not yet on the trip, needed exactly this kind of reprieve, even if the search for a senior centre-back goes on regardless", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
...
const LATEST_NEWS = [
  { source: "Goal", title: "Salah on the brink of Besiktas: agent accepts final condition and 'deal done' is briefed, though the club deny one report", time: "today", category: "major" },
  { source: "Turkiye Today", title: "Besiktas president Serdal Adali confirms a final offer submitted to Salah with a quick answer requested", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Barcola ends his PSG contract talks as Paris set a price near €170m, handing suitors the initiative", time: "today", category: "major" },
  { source: "beIN Sports", title: "Gomez injury not as feared: Iraola says the defender has trained well and should feature in the final tour game", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Isak, Wirtz and Gravenberch land in the States and get straight to work in Sunday's session", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Jeff Bezos among those approached to join a consortium's £1.35bn minority-stake bid for Liverpool", time: "1d ago", category: "major" },
  { source: "Football365", title: "Midfield board shifts: Liverpool weigh a late Diomande hijack as Bouaddi drifts toward Manchester City", time: "today", category: "major" },
  { source: "ESPN", title: "Preview: Iraola set for another makeshift back line as Liverpool meet Wrexham at Yankee Stadium on Wednesday", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Watch: Gravenberch, Isak and Wirtz get to work in Liverpool's Sunday session on the US tour", time: "1d ago", category: "official" },
  { source: "TEAMtalk", title: "Alex Scott stays in view as Bournemouth hold the line after rejecting Chelsea's £85.6m", time: "1d ago", category: "major" },
  { source: "Football Italia", title: "Chiesa answers his own question with a goal off the bench in Nashville as he fights to stay", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Iraola makes winning start: Liverpool beat Sunderland 4-2 in Nashville with four scorers", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Amara Nallo joins HJK Helsinki on loan as the young defender chases senior minutes", time: "2d ago", category: "official" },
  { source: "Liverpool FC", title: "Confirmed: Liverpool complete the £750k signing of 17-year-old Colombian Samuel Martinez, to join in 2027", time: "3d ago", category: "official" },
  { source: "MLB.com", title: "Tour ahead: Wrexham at Yankee Stadium on Wednesday, then Leeds at Soldier Field on August 2", time: "1d ago", category: "fan" },
];
