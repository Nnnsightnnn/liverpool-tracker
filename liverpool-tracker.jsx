...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Tue Sep 22, evening - away with England, and still the youngest unresolved contract at the club. Ngumoha is the only Liverpool player in Thomas Tuchel's senior squad and in line for a first competitive cap after a friendly debut in June. He was an unused substitute at Bournemouth once Gakpo passed his warm-up. David Ornstein reported the club wants his new deal signed inside the month, which on the week's evidence of how Liverpool handle contracts is not a formality.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "The Athletic", title: "Liverpool to appoint Julian Ward as sporting director for the second time", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Will Wright wondergoal as 10-man Liverpool U21s win on penalties after dramatic comeback at Rochdale", time: "today", category: "fan" },
  { source: "Read Man City", title: "Man City barely have enough players left behind for a five-a-side team", time: "today", category: "fan" },
  { source: "TEAMtalk", title: "Key star details 'plenty' of exit options and maps out 'perfect' scenario", time: "today", category: "major" },
  { source: "ESPN", title: "Van Dijk: Xavi key in 'massive decision' over Netherlands stay", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Matty Wright signs full professional contract at LFC", time: "today", category: "official" },
  { source: "Sports Mole", title: "Andoni Iraola 'attempted' to sign Inter star after Jones sale", time: "today", category: "fan" },
  { source: "AnfieldWatch", title: "Monaco's start could delay Liverpool moves for Lamine Camara and Paris Brunner", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Iraola claps back at Carragher over Wirtz: 'Much happier with his second half than his first'", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Liverpool discover €50m asking price for Benfica right-back Daniel Banjaqui", time: "today", category: "fan" },
  { source: "ESPN", title: "Mac Allister on his contract: 'no firm decision yet' with two years left and no talks", time: "1d ago", category: "major" },
  { source: "BBC Sport", title: "Bournemouth 0-1 Liverpool: Isak's winner sends Iraola into the break unbeaten", time: "2d ago", category: "major" },
  ...
  { source: "L'Equipe", title: "Jeremy Jacquet called up to the France senior squad for the first time", time: "3d ago", category: "fan" },
  { source: "Liverpool FC", title: "Chelsea at Anfield in the Carabao Cup fourth round, Wednesday 28 October, 8pm", time: "5d ago", category: "official" },
];
