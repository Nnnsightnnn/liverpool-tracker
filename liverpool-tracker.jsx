...
const PLAYERS = [
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Wed Jun 10 — the negotiation has numbers and a date: Inter tabled €20m against Liverpool's €30m ask, talks set for next week with €25m the reported landing zone, Ausilio confirming the interest on the record. Pearce reports the club would sell the only Scouser in the first team reluctantly, seeking a resale percentage; Jones is ready to refuse Aston Villa and wait", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Wed Jun 10 — the goodbye is now club record: Tuesday's retained list confirmed his release, and he leads Egypt into a World Cup that opens tomorrow as the contract runs down to June 30, a free agent between group games. Turkey is reported ahead of Saudi Arabia and MLS in the queue for the next address; where, not whether, remains the only open question", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Wed Jun 10 — the leverage went live: with Liverpool's approach to Leipzig lodged, the Dutchman, admired in Saxony, is floated as the makeweight bridging a €130m ask for Diomandé, while Tottenham stay keen on a straight sale near €45m. Having asked to leave rather than fight Ngumoha for the left wing, he is priced into the deal built to replace him", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports / Fabrizio Romano", title: "Diomandé chase flips back on: Liverpool make an approach to Leipzig for the 19-year-old, Romano says the Reds are 'really pushing' and ahead of PSG", time: "today", category: "major" },
  { source: "Football365 / TeamTalk", title: "A £164m double winger swoop accelerates: Diomandé the project, Trincão the finished article, with Liverpool 'closest' to the Sporting man's ~€60m clause", time: "today", category: "major" },
  { source: "Liverpool FC / This Is Anfield", title: "Retained list confirmed: twelve players released, with Salah, Konaté, Robertson and Rhys Williams leaving the senior squad and eight academy deals offered", time: "1d ago", category: "official" },
  { source: "The Hard Tackle / This Is Anfield", title: "Inter table €20m for Curtis Jones against a €30m ask, talks set for next week; Pearce says Liverpool are reluctant to lose the only Scouser in the squad", time: "today", category: "major" },
  { source: "ESPN / This Is Anfield", title: "The World Cup opens tomorrow at the Azteca with eleven Reds inside it, Salah leading Egypt as his contract runs quietly down to June 30", time: "today", category: "fan" },
  { source: "Empire of the Kop / Liverpool.com", title: "Oakley Cannonier, the ballboy behind the corner-taken-quickly against Barcelona, leaves Liverpool without ever making a senior appearance", time: "1d ago", category: "fan" },
  { source: "TeamTalk / ESPN", title: "Núñez moves to tear up his Al-Hilal contract and 'would like' an Anfield return: 'I would be lying if I told you I don't miss the Liverpool supporters'", time: "1d ago", category: "fan" },
  { source: "Anfield Watch / TeamTalk", title: "Liverpool step up the Inácio chase, aiming to beat Manchester United to the £52m clause as Chelsea, Real Madrid and Barcelona circle the same profile", time: "today", category: "major" },
  { source: "TeamTalk", title: "Hughes plots a raid on Manchester City's academy for Xavier Parker, the 15-year-old midfielder City cannot tie to professional terms until 2027", time: "today", category: "fan" },
  { source: "Liverpool.com / Football365", title: "Iraola's house rules land at the AXA: immediate changes, players 'excited,' a managed reintegration plan for World Cup returners, seven signings backed", time: "1d ago", category: "fan" },
  { source: "Football365 / Football Italia", title: "Chiesa deal stays live per Romano, the Italian expected to settle his future with Iraola on tour as Inter open near €20m against a €30m-plus ask", time: "1d ago", category: "fan" },
  ...
  { source: "Sky Sports / Premier League", title: "Andy Robertson's free move to Tottenham confirmed — nine years and nine major trophies close, Kerkez inheriting the left", time: "5d ago", category: "official" },
  { source: "Empire of the Kop", title: "Pre-season set: Sunderland in Nashville (Jul 25), Wrexham at Yankee Stadium (Jul 29), Leeds at Soldier Field (Aug 2), then Monaco and Como at Anfield", time: "6d ago", category: "official" },
];
