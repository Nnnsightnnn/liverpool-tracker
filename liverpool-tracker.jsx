...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Live at 11am BST: Andoni Iraola takes his first Liverpool press conference at the AXA as the summer break formally ends", time: "today", category: "official" },
  { source: "This Is Anfield", title: "The 15 players back for day one: Elliott returns from Villa, Tsimikas back from loan, five ruled out injured", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Salah rules out Europe: deal in principle in place in Saudi Pro League, with only MLS still in the argument", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Curtis Jones answers the 'agreed' Forest deal with a raised-eyebrow emoji as he prepares to report back", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Iraola's first big call: the vice-captaincy is vacant with Salah, Konate and Robertson all gone in one window", time: "today", category: "fan" },
  { source: "Football365", title: "Liverpool want Almeria's Sergio Arribas: 26 goals in the second tier, and a £21m price with Real Madrid taking half", time: "today", category: "major" },
  { source: "ESPN", title: "World Cup semi-finals set: Konate's France meet Munoz's Spain in Dallas tomorrow, England v Argentina in Atlanta Wednesday", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Ekitike targets a Boxing Day return at Hull, seen at Wimbledon walking with a cane rather than crutches", time: "1d ago", category: "fan" },
  { source: "Football365", title: "Barcola blow: Arsenal reported top of the race as PSG hold firm at a British-record £128m valuation", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Jacquet cleared by his surgeon and back in group training: 'I will be 100 per cent fit' for the new season", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Michael Edwards resigns as FSG's chief executive of football and will not be replaced; Mike Gordon retakes football operations", time: "1d ago", category: "major" },
  { source: "The Athletic", title: "Ornstein: sporting director Richard Hughes expected to join Al-Hilal once the transfer window closes", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Wataru Endo reports back to the AXA early after missing Japan's World Cup, with a summer sale still to negotiate", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Palace offer Adam Wharton to Real Madrid at £103m as an Anfield move is called 'extremely unlikely'", time: "2d ago", category: "major" },
  { source: "ESPN", title: "Mac Allister heads Messi's corner as Argentina beat Switzerland 3-1 after extra time to reach the semi-finals", time: "2d ago", category: "fan" },
];
