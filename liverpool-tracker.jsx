...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "doubtful", injuryNote: "Sun Jul 26 — a muscle scare, and the worst sort of luck. Forced off inside eight minutes of the Sunderland win, the defender pulled up with a suspected muscle injury that Iraola called 'the worst news' after the game, though the extent is still being assessed and no risks will be taken. He walked off unaided, so hopes are it is minor, but in a back line already down to Jacquet it is the one absence Iraola could least afford", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Iraola makes winning start: Liverpool beat Sunderland 4-2 in Nashville, Szoboszlai screamer and four scorers set the tone", time: "today", category: "major" },
  { source: "Sports Mole", title: "Iraola's 'worst news': Joe Gomez forced off with a muscle injury inside eight minutes of the Sunderland win", time: "today", category: "major" },
  { source: "Rousing the Kop", title: "Youngsters shine and a new centre-back needed: five things learned from Liverpool 4-2 Sunderland", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Jeremy Jacquet held out of the opener as a precaution, sharpening fears over a back line down to the bone", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Player ratings: Szoboszlai and Chiesa impress as Calvin Ramsay presses his claim for the vacant right-back role", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Supporters vent at a quiet window even as the Iraola era opens with a win over Sunderland", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Amara Nallo joins HJK Helsinki on loan as the young defender goes in search of senior minutes", time: "today", category: "official" },
  { source: "Football365", title: "Liverpool 'will sign' Barcola 'as a minimum' with FSG braced to 'spend big' after confirming Samuel Martinez", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Barcola pursuit holds firm: Reds reported confident near £100m and leading Arsenal and Bayern for the PSG winger", time: "1d ago", category: "major" },
  { source: "TEAMtalk", title: "Iraola keen on an Alex Scott reunion after Bournemouth reject Chelsea's £85.6m bid and refuse a valuation", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Confirmed: Liverpool complete the £750k signing of 17-year-old Colombian Samuel Martinez, to join in 2027", time: "2d ago", category: "official" },
  { source: "Empire of the Kop", title: "Isak, Wirtz and Gravenberch to join the tour in the coming days after early World Cup exits", time: "2d ago", category: "major" },
  { source: "Goal", title: "Salah-Besiktas edges forward as agent Ramy Abbas softens his commission demand toward the club's figure", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Freddie Woodman signs a new deal to 2029 as Mamardashvili leads the goalkeeping group through the tour", time: "3d ago", category: "official" },
  { source: "MLB.com", title: "Next up: Liverpool face Wrexham at Yankee Stadium on Wednesday before Leeds at Soldier Field on August 2", time: "1d ago", category: "fan" },
];
