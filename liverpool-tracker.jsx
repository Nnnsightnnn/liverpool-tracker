...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Barcola in for his medical this weekend, £123m deal to be announced within a day, debut earmarked for Ipswich", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Why Barcola will wear 29, not Salah's 11: the FIFA career-mode number he calls non-negotiable", time: "today", category: "fan" },
  { source: "SportBible", title: "Liverpool move to hijack Newcastle again, making contact over Lille's Matias Fernandez-Pardo as a second winger", time: "today", category: "major" },
  { source: "Sky Sports", title: "Endo made available: Liverpool tell clubs the 33-year-old can leave before Tuesday, Wolves and Fulham alerted", time: "today", category: "major" },
  { source: "TeamTalk", title: "Besiktas close on the double: Tsimikas terms agreed, €2m Mamardashvili loan on the table", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Kone stays the one Liverpool want as Camara drifts to Chelsea, Roma still refusing to sell", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Sarr file flickers on: Palace hold firm above the rejected £50m with the flank still one body short", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Gomez trains fully and pushes for a September 4 return at Portman Road after a month out", time: "today", category: "official" },
