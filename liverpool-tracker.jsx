...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "doubtful", outSince: "2026-07-25", injuryNote: "Wed Aug 26 — with the group, and still not cleared. Gomez has trained with the group again without being passed fit, some Forest previews still listing him among the unavailable and Liverpool.com keeping Saturday as a possible return date, so the honest reading is a doubt rather than an option after the muscle injury taken inside minutes at Sunderland that cost him the Newcastle draw, though Iraola may still protect a vice-captain only lately back. With Leoni closing on a September return from his ACL and Bradley still short after knee surgery, any reinforcement for a thin back line eases the manager's first home selection. The longest-serving defender is a cover boost to chase, not a sale, his Serie A links long since gone quiet", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
  ...
  { id: 19, name: "Stefan Bajcetic", number: 43, position: "MID", nationality: "🇪🇸 Spain", age: 21, appearances: 0, goals: 0, assists: 0, cleanSheets: null, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "doubtful", injuryNote: "Wed Aug 26 — going home to Vigo, most likely for good. Fabrizio Romano reports Celta Vigo closing in on personal terms with Bajcetic, the clubs already at an understanding built on bonuses and a sell-on percentage Liverpool retain rather than a fee, with some form of negotiated exit expected to unpick a contract that runs to 2027. He has not featured for Liverpool this calendar year, travelled to America in the rehab group rather than to play, and at 21 has three seasons wrecked by hamstring trouble behind him. The academy that raised him is where the rebuild starts again", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p535928.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 40, goals: 10, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 7.0, status: "fit", injuryNote: "Wed Aug 26 — the exit that had gone quiet came back, with a second bidder. The forward Tottenham chased all summer opened the Iraola era on the scoresheet, dragging Liverpool level at Newcastle in the 55th before Szoboszlai's late penalty rescued the 2-2. By Wednesday, though, Tottenham were reported a step away with personal terms agreed in principle, and Manchester City had entered the race, Liverpool holding out past £60m for a forward valued nearer £70m and contracted to 2030. The Dutch reporting is blunt on sequencing: while Barcola is not an Anfield player, a Spurs deal is close to nil. With Minteh withdrawn from and Sarr refused, selling a starting forward six days from the deadline is a harder argument than it was on Sunday, and Saturday's Forest visit is still his stage", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Wed Aug 26 — a birthday deal, and a flank that just emptied around him. Ngumoha was a bench option at Newcastle as Gakpo held the right and scored, the teenager's minutes coming late in a young matchday squad. This Is Anfield report a new five-year deal with a significant pay rise is set to follow when he turns 18 on August 29, the day Forest visit, the delay only a rule capping under-18s at three-year terms. Above him the wing rebuild came apart in a day, Liverpool withdrawing from Minteh at £80m and being turned away over Sarr, which makes a teenager's minutes rather more likely than they looked on Tuesday. Twenty-nine appearances last term and a goal against Newcastle a year ago; his minutes will come, but experience starts ahead of him for now", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  { id: 26, name: "Federico Chiesa", number: 14, position: "FWD", nationality: "🇮🇹 Italy", age: 28, appearances: 12, goals: 1, assists: 1, cleanSheets: null, xG: 1.5, tacklesPer90: 0.6, passCompletion: 80, progressiveCarries: 2.2, form: 6.0, status: "doubtful", injuryNote: "Wed Aug 26 — light work done, and no clearance yet from a manager who speaks tomorrow. Chiesa returned to light work on Wednesday after the fitness problem that sat him out at Newcastle, but he stays a doubt for Saturday's home opener against Forest. It complicates a summer already spent weighing his future: he scored off the bench in Nashville and insisted his focus was Liverpool, but he sits among the up-to-eight exits Iraola is reported willing to sanction, and the knock still shadows both his selection and his sale", image: "https://r2.thesportsdb.com/images/media/player/cutout/idecla1757087689.png" },
...
const LATEST_NEWS = [
  { source: "TeamTalk", title: "Liverpool walk away from Yankuba Minteh as Brighton set their price at \u00a380m", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "Minteh talks 'gone cold' inside 24 hours as Liverpool turn to 'different options'", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Crystal Palace reject a \u00a350m approach for Ismaila Sarr within hours of it emerging", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Liverpool call Lille over Matias Fernandez-Pardo as a second Newcastle hijack looms", time: "today", category: "fan" },
  { source: "Football365", title: "Barcola unmoved: the \u00a3110m-plus PSG agreement still waits on a medical green light", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Romano: Celta Vigo closing on personal terms to take Stefan Bajcetic home", time: "today", category: "major" },
  { source: "This Is Anfield", title: "'Amateurish' and 'desperate': supporters turn on FSG's handling of the window", time: "today", category: "fan" },
  { source: "ESPN", title: "Gakpo exit reopens as Spurs move a step closer and Manchester City join the race", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Alex Scott named Liverpool's top defensive-midfield target, at a \u00a390m price they cannot pay", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Thursday 1.30pm: Iraola faces the press before his first home match as Liverpool head coach", time: "today", category: "official" },
  { source: "UEFA", title: "Champions League league-phase draw, Monaco, Thursday 6pm CET: Liverpool seeded in Pot 1", time: "today", category: "official" },
  { source: "Liverpool.com", title: "Injury latest: Chiesa back in light work but doubtful, Gomez still short of a clearance for Forest", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Liverpool delegation flies to Colombia as Matias Orozco's \u20ac6m release clause is met", time: "1d ago", category: "major" },
  { source: "BBC Sport", title: "Forest arrive at Anfield pointless after Anton Stach's free-kick won it for Leeds", time: "2d ago", category: "major" },
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's 99th-minute penalty rescues Iraola's opening day", time: "3d ago", category: "major" },
];
