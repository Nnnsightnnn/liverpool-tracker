...
const LATEST_NEWS = [
  { source: "Opta Analyst", title: "Liverpool 0-0 Fulham: a fourth straight Anfield league draw, the first such run since November 2011, and a first blank under Iraola", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola: 'There is a lack of freshness, definitely, we cannot hide it' after the 60-hour turnaround from Atletico", time: "today", category: "official" },
  { source: "Sky Sports", title: "Alisson: unbeaten with three draws 'is not something to celebrate too much with this shirt'", time: "today", category: "major" },
  { source: "The Independent", title: "Rotation backfires: Tsimikas off at half-time, Gravenberch and Munoz by the hour, and a squad 'simply not strong enough'", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Player ratings: Jacquet an 8 for the goal-line clearance; Tsimikas, Gravenberch and Szoboszlai a 3 apiece", time: "today", category: "fan" },
  { source: "SI", title: "FotMob numbers: 1.13 xG to 0.71, three shots on target to four, four big chances; Jacquet 8.1 tops the card", time: "today", category: "fan" },
  { source: "BBC Sport", title: "Isak's 16 touches the second fewest for a Liverpool outfielder on record; is it too early to worry?", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Mac Allister has become undroppable after the pivot lost its balance without him", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Confirmed: Gakpo back on the bench and on at 60; Gomez not in the nine-man squad", time: "today", category: "official" },
  { source: "Sky Sports", title: "Arbeloa: 'Happy with the point and more happy with the performance' as Affengruber debuts and Fulham take a first point", time: "today", category: "major" },
  { source: "CBS Sports", title: "Tuesday's cup opponents Tottenham draw 0-0 with Everton: four league games without a goal, a club first", time: "today", category: "major" },
  { source: "ESPN", title: "Table: Liverpool sixth on six, level with Everton and Ipswich; Arsenal perfect on twelve", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola on Endo: 'for sure he will have his moments', but three pivots sit ahead of him", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Liverpool v Tottenham, Carabao Cup third round, Tuesday 8pm at Anfield: Robertson's first return, ITV and Sky", time: "today", category: "fan" },
