...
const PLAYERS = [
  ...
  { id: 14, name: "Ryan Gravenberch", number: 38, position: "MID", nationality: "🇳🇱 Netherlands", age: 23, appearances: 41, goals: 6, assists: 5, cleanSheets: null, xG: 3.1, tacklesPer90: 2.8, passCompletion: 91, progressiveCarries: 3.2, form: 7.2, status: "fit", injuryNote: "Thu Jul 23 — due in Chicago within days. One of the returning trio with Isak and Wirtz, he sits out Sunderland after his World Cup summer but is in the frame for Wrexham and Leeds. Liverpool's most consistent player across a turbulent 2025-26 is the fixed point at the base of whatever the manager builds. Everything around him is a question; he is not one of them", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p441266.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 33, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.1, status: "fit", injuryNote: "Thu Jul 23 — flying in with the returning trio. The £115m playmaker joins the tour in the coming days alongside Isak and Gravenberch, missing Sunderland but in line for Wrexham and Leeds, and Iraola finally gets an extended block of work with him. He shared barely 117 minutes on the pitch with Isak and Ekitike across an injury-disrupted first year; a clean summer, for once, is the reset", image: "https://r2.thesportsdb.com/images/media/player/cutout/8t6bzo1757088899.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Thu Jul 23 — back within days, and eased in carefully. One of the returning trio, Isak is in line for a few minutes against Wrexham on July 29 before a fuller role versus Leeds, having come home early from the World Cup. An injury-wrecked debut season limited the £100m striker to a handful of starts; a full pre-season under a new coach is the reset the whole front line needs", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Liverpool make initial approach to Monaco for winger Maghnes Akliouche as the search for a Salah heir gathers pace", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Akliouche available at £42.6m as Liverpool move to hijack PSG, whose bids around £34m have been rejected by Monaco", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Jurgen Klopp accepts the Germany job, replacing Nagelsmann two years after Anfield following the World Cup exit to Paraguay", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola tells Mac Allister he is central to his plans as Liverpool resist summer interest in the midfielder", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Joao Gomes books an Aston Villa medical as Liverpool miss out on the £38m Wolves midfielder they declined", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Curtis Jones staying as Inter's offer falls short of Liverpool's valuation and the club weigh fresh terms", time: "1d ago", category: "major" },
  { source: "L'Equipe", title: "PSG hold firm on £127.5m Barcola valuation as Ornstein reports the champions do not want to sell", time: "1d ago", category: "major" },
  { source: "Al Jazeera", title: "Salah-Besiktas move stalls as agent will not confirm any agreement and reports of a verbal deal are waved away", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Liverpool player offers himself to Real Madrid in a move that could help fund a Barcola bid", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Isak, Wirtz and Gravenberch to sit out Sunderland but eye Wrexham minutes as Iraola phases in his World Cup men", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Confirmed: £750,000 deal for 17-year-old Colombian Samuel Martinez, a signing for 2027", time: "2d ago", category: "official" },
  { source: "Liverpool.com", title: "Van Dijk and Alisson to begin at the AXA Centre with minutes saved for the Como and Monaco friendlies", time: "2d ago", category: "major" },
  { source: "Nashville SC", title: "Geodis Park set for Liverpool vs Sunderland on Saturday to open the three-game US tour", time: "2d ago", category: "major" },
  { source: "Liverpool FC", title: "Reds settled at their Chicago base with 31 players, eleven of them from the academy", time: "3d ago", category: "official" },
  { source: "DaveOCKOP", title: "Endo and Bajcetic among five seniors building fitness on tour rather than featuring", time: "3d ago", category: "fan" },
];
