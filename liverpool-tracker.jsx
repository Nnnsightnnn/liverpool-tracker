...
const PLAYERS = [
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 35, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.4, status: "doubtful", injuryNote: "Sat May 23 — a DOUBT for the Sun May 24 Brentford finale: back in training after the suspected muscular injury that kept him out at Villa Park, but facing a late fitness test. If he isn't cleared, Joe Gomez is the cover at right-back — Sports Illustrated's predicted XI already picks Gomez to handle Brentford's Kevin Schade", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "doubtful", injuryNote: "Sat May 23 — trained on Friday and 'likely to start up front' for the Brentford finale per Yahoo Sports's team news, after the minor groin/hip issue that ruled him out at Villa Park. Slot is managing the Swede carefully and a late fitness test is expected; if he isn't cleared, 17-year-old Rio Ngumoha leads the line again", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sat May 23 — led the line at 17 in the 4-2 Villa Park defeat and is in line for the Brentford matchday squad, though Isak's expected return pushes the teenager toward the bench or a wide rotation role. One of Slot's bright young finds in a difficult season — This Is Anfield's predicted XI has him among the substitutes", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool FC / This Is Anfield", title: "Matchday eve: Anfield mosaics for Salah and Robertson go up Saturday — the Kop for the Egyptian, the lower Sir Kenny Dalglish Stand for the Scot — with the 'Salah: Farewell to the King' tribute film now released", time: "today", category: "official" },
  { source: "Sports Mole / Football365", title: "Liverpool predicted XI for Brentford: pundit lineups split as Arne Slot still won't commit to starting Mohamed Salah in his Anfield farewell after the forward's social-media outburst", time: "today", category: "major" },
  { source: "Yahoo Sports / The 4th Official", title: "'Robertson, Salah and Alisson to start' — most predicted XIs tip all three to begin the 4-2-3-1 finale, though Sports Illustrated keeps Mamardashvili and Joe Gomez in the side", time: "today", category: "major" },
  { source: "Liverpool.com / Sports Mole", title: "Team news: Florian Wirtz a doubt for the finale with the after-effects of illness — Liverpool 'could be without seven players' against Brentford, Endo, Ekitike, Bradley and Leoni long-term out", time: "today", category: "major" },
  { source: "Liverpool.com / Opta Analyst", title: "Champions League math: a point at home to Brentford on Sunday seals a top-five finish — Liverpool sit 5th on 59 points, three clear of Bournemouth, with Opta rating qualification a near-certainty", time: "today", category: "major" },
  { source: "Irish Times / This Is Anfield", title: "Liverpool closing in on appointing Etienne Reijnen — Slot's former Feyenoord set-piece specialist — to the coaching staff, in what is read as a 'strong show of support' for the manager", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Slot reiterates he has 'every reason to believe' he will be Liverpool manager next season; reliable reporter Lewis Steel now rates the Dutchman '96%' likely to stay", time: "1d ago", category: "major" },
  { source: "Football365 / TeamTalk", title: "Unverified sack saga rumbles on: reports claim FSG have 'decided' to move on from Slot with Andoni Iraola 'demanding' the job — but no tier-one outlet has stood the story up", time: "1d ago", category: "major" },
  { source: "Liverpool FC / Liverpool.com", title: "Fitness latest: Alisson, Alexander Isak and Jeremie Frimpong all trained Friday and are in contention for the Brentford finale, with late fitness tests expected", time: "1d ago", category: "official" },
  { source: "The Washington Post", title: "Slot declines to commit to starting Mohamed Salah in his Anfield farewell, days after the Egyptian's post calling for a return to 'heavy metal' attacking football", time: "1d ago", category: "major" },
  { source: "Sky Sports / Caught Offside", title: "Transfer: Curtis Jones 'very likely' to leave Liverpool this summer — Inter Milan keen since January and new-contract talks stalled for months; Sunday could be his final Reds game", time: "2d ago", category: "major" },
  { source: "CrunchSports / Anfield Watch", title: "Transfer: Liverpool eye West Ham captain Jarrod Bowen as a Salah replacement, reportedly in a three-way battle with Newcastle and Everton, with Diomande, Barcola and Olise also shortlisted", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Transfer: Eduardo Camavinga commits his future to Real Madrid, cooling a long-running Liverpool midfield link; Bournemouth's Marcos Senesi weighed as a free-transfer defensive option", time: "3d ago", category: "major" },
  { source: "This Is Anfield / Sky Sports", title: "Transfer: AS Monaco prepared to accept around £40m for midfielder Lamine Camara, with Liverpool credited with interest as Richard Hughes prioritises the engine room", time: "3d ago", category: "fan" },
  { source: "Sky Sports / NBC Sports / ESPN", title: "Aston Villa 4-2 Liverpool: Watkins brace plus Rogers and McGinn punish a set-piece collapse — Van Dijk's two headers the lone reply on a night that dropped the Reds to 5th", time: "1w ago", category: "major" },
];
