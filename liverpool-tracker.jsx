...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "recovering", injuryNote: "Thu May 7 — Liverpool.com: Italian journalist Nicolo Schira reports the Brazilian has 'agreed personal terms with Juventus' on a €5m-a-year deal; Liverpool still need to be convinced to sell and Alisson isn't agitating. On the pitch he remains 'very close' to training per Slot's Read Liverpool/Anfield Index update — Chelsea (May 9) still the realistic return target after the eight-week hamstring layoff. Watched the 3-2 Old Trafford defeat (Sun May 3) from the bench", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
  { id: 2, name: "Giorgi Mamardashvili", number: 25, position: "GK", nationality: "🇬🇪 Georgia", age: 25, appearances: 17, goals: 0, assists: 0, cleanSheets: 5, xG: 0, tacklesPer90: 0, passCompletion: 76, progressiveCarries: 0.1, form: 6.8, status: "injured", injuryNote: "Two weeks into the ~3-week stitched-knee layoff (Beto collision Apr 19) — Aston Villa trip May 17 still the earliest realistic return per LFC's run-in injury rundown. Alisson now ahead of him in the queue for Chelsea (May 9)", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p449027.png" },
  ...
  { id: 4, name: "Ibrahima Konaté", number: 5, position: "DEF", nationality: "🇫🇷 France", age: 27, appearances: 37, goals: 2, assists: 0, cleanSheets: 9, xG: 1.5, tacklesPer90: 1.8, passCompletion: 88, progressiveCarries: 0.5, form: 7.0, status: "fit", injuryNote: "Started Old Trafford defeat (Sun May 3, L 3-2) alongside VVD. Wed May 6 frame more cautious: Apr 21 Konaté himself said 'we are close to an agreement' but Apr 25 Alex Crook reported insiders see it as '50/50' — could still leave on a free. Contract expires 30 June 2026; decision expected before the World Cup. Liverpool.com (Mon May 4) flagged him among the city-trip group; VVD's Tue May 5 'we are not kids' rebuttal applied", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p204716.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 31, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.3, status: "fit", injuryNote: "Started Old Trafford (Sun May 3, L 3-2) on the right of the front three — couldn't repeat his Palace winner but linked play around the comeback. Liverpool.com (Mon May 4) named him among the city-trip group; VVD took the Tue May 5 lead defending the breaks. Central No.10 role expected vs Chelsea (H) May 9", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p494595.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool.com", title: "Alisson 'agrees personal terms with Juventus' as Liverpool transfer headache grows — Schira reports €5m-a-year deal pending Reds approval", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Curtis Jones contract talks with Liverpool have 'effectively ceased' — Inter Milan exit 'now seems likely' as Anfield resists Romano-confirmed approach", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Explained: How Liverpool can clinch Champions League place on Saturday vs Chelsea — even without winning if Bournemouth slip at Fulham", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Liverpool has 3 players who could be sold this summer as scale of rebuild emerges — Slot, Jones and Mac Allister face the door alongside Salah & Robertson", time: "today", category: "major" },
  { source: "Read Liverpool", title: "Arne Slot delivers Alexander Isak and Alisson Becker update ahead of Liverpool v Chelsea — 'small margins' but pair targeting Anfield return", time: "today", category: "major" },
  { source: "Liverpool.com", title: "16 players face missing Liverpool vs Chelsea as Alisson and Alexander Isak updates loom — Reds carry season-long absentee list into the run-in", time: "today", category: "major" },
  { source: "Tribuna / Romano", title: "Curtis Jones gives 'full approval' to Inter Milan switch — Liverpool valuation now the only obstacle as Wharton chase accelerates", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "FSG respond to Red Sox & Liverpool fan unrest: 'Don't settle for mediocrity, you have to win' — John Henry breaks rare silence", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Liverpool 2026/27 home kit already 'on sale' in stores after latest leak — Adidas Candy 1989-91 throwback shows up at Foot Locker before launch", time: "1d ago", category: "major" },
  { source: "Sports Mole", title: "Liverpool preparing £34m bid for 'unbelievable' Curtis Jones replacement after worrying contract update — Wharton chase accelerates", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "'We are not kids', 'It's a city trip': Virgil van Dijk rejects Liverpool 'days off' claim as captain defends Slot post-Old Trafford", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "'It's on the manager': Jamie Carragher warns Liverpool's style is a choice, not a mistake — identity worry deepens after Old Trafford", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Arne Slot 'confirms' Liverpool plans for new coaching staff in summer — Etienne Reijnen reunion 'beckons' as work-permit hurdle clears", time: "2d ago", category: "fan" },
  { source: "FootballTransfers", title: "Liverpool transfer news: Reds in 'advanced' Adam Wharton talks at £80m as Crystal Palace dig in over fee — Real Madrid preempted", time: "3d ago", category: "major" },
  { source: "Sky Sports", title: "Man Utd 3-2 Liverpool recap: Mainoo's 77' winner ends Liverpool comeback — Cunha and Sesko's 14-minute opening still the key talking point", time: "4d ago", category: "major" },
  { source: "TNT Sports", title: "Salah urges Liverpool to give Jordan Henderson 'the farewell he deserved' when Brentford visit Anfield May 24 — first return in red away kit since 2023", time: "5d ago", category: "fan" },
];
