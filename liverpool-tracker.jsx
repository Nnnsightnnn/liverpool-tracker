...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Iraola's fitness update: Barcola and Kerkez 'just tired' and expected to be fit, Gakpo a doubt for Fulham with niggles in both adductors", time: "today", category: "official" },
  { source: "Sports Illustrated", title: "Kerkez on the cramps: pressing the way Liverpool now do 'is a bit tough to do it for all the 90 minutes'", time: "today", category: "fan" },
  { source: "Football365", title: "Liverpool in January talks with Manchester City over £31m Rayan Ait-Nouri; long-standing admiration for Palace's Adam Wharton", time: "today", category: "major" },
  { source: "Football365", title: "Club officials 'not happy' with Mac Allister airing public doubt over a new deal, two days after his winner", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Iraola 'under serious pressure' with Hughes gone to Al-Hilal and no sporting director to protect him", time: "today", category: "major" },
