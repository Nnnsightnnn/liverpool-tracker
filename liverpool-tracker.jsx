...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Iraola: 'a reasonable chance' Ekitike helps in the last two Champions League league-phase games, 'a hope and a realistic chance' he is back in January", time: "today", category: "official" },
  { source: "Evening Standard", title: "Arbeloa: 'Tomorrow is where we have to send a message for us'; deadline signing Affengruber fit to start at Anfield", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola's full Q&A: Fulham 'have lost their three games by one goal' and would have 'four, five points' on the eye test; 'we are not starting the games too well'", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Isak, 332 minutes into the season: 'It's just about keeping this rhythm'; Barcola 'a big signing for us'", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Opta pre-match: exactly two goals in each of the first four league games would be a club first; Jacquet has won 18 of 25 duels", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Ekitike's January target: Inter at Anfield on 19 January and Lens on the 27th are the two games Iraola means", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Team news: Gakpo, Barcola and Kerkez all listed doubtful; Sports Mole's XI rests Kerkez and Barcola for Tsimikas and Munoz", time: "today", category: "fan" },
  { source: "3 Added Minutes", title: "Eight out or doubtful for Fulham; predicted XI starts Barcola, Wirtz and Ngumoha behind Isak with Gomez in line for the bench", time: "today", category: "fan" },
  { source: "BBC Sport", title: "Arbeloa on Tete, 'so important' despite no league minutes, and the week's work: 'we need to control the transition'", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Koumas was always staying: 'The first week I was here, I already told the club he was staying all the season', says Iraola", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Iraola on Araujo: the language was the biggest challenge, the move 'has helped him a lot' mentally, right-back 'probably is not his main position'", time: "today", category: "official" },
  { source: "Rousing The Kop", title: "Ekitike back in January: how an Ekitike, Isak and Barcola front three might fit, with the Frenchman from the left", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Anfield travel update: Walton Breck Road closure on Saturday; Liverpool v Fulham not televised in the UK", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Festive fixtures moved: Hull away on Boxing Day at 5.30pm, Villa away 30 December, Sunderland away 5 January, all on Sky", time: "1d ago", category: "fan" },
  { source: "Opta Analyst", title: "Liverpool 2-1 Atletico in numbers: 1.68 xG to 0.81, Iraola's first win over Simeone at the fifth attempt, Mac Allister from twenty yards", time: "2d ago", category: "fan" },
];
