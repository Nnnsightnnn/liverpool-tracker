...
const LATEST_NEWS = [
  { source: "This Is Anfield / Goal", title: "Diomandé bid knocked back: Liverpool's club-record £87m (€100m) offer rejected by Leipzig, who want north of €120m and signal they'd keep the teenager another year as PSG lurk", time: "today", category: "major" },
  { source: "Premier League / Liverpool FC", title: "Fixtures morning: the 2026-27 schedule drops at 10am, and Andoni Iraola finally learns the opening assignment of his Liverpool reign; season begins the weekend of August 22", time: "today", category: "official" },
  { source: "Football365 / TeamTalk", title: "Fenerbahce 'will sign' Salah: the Turkish club's newly elected president goes public on a deal worth a reported £77m package, a three-year offer waiting on the Egyptian's World Cup", time: "today", category: "major" },
  { source: "Sports Mole / This Is Anfield", title: "Iraola's first competitive opponent in the balance: a winger deal stalled, a captain choosing from afar, and a calendar that fills in this morning at last", time: "today", category: "fan" },
  { source: "Liverpool.com / TeamTalk", title: "Jones to Inter: the Italians prepare a fresh €25m bid with a sell-on clause against Liverpool's ~€30m ask, the Scouser's decision to leave described as 'final'", time: "today", category: "major" },
  { source: "ESPN / This Is Anfield", title: "Group F on Saturday: Van Dijk's Netherlands, third after a 2-2 with Japan, meet Isak's Sweden, top after thumping Tunisia 5-1 with Isak and Gyökeres scoring, in Houston", time: "today", category: "fan" },
  { source: "Liverpool.com / GiveMeSport", title: "Gakpo exit 'highly improbable' per club sources: the Dutchman is still floated in a Leipzig swap, but Liverpool insist they want to add attackers, not subtract them", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Anfield Watch", title: "Van Dijk pushes for a fresh deal beyond his 2027 expiry, the 34-year-old captain the fixed point Hughes is building a new centre-back partnership around", time: "1d ago", category: "fan" },
  { source: "ClutchPoints / Anfield Watch", title: "Inácio still the cleanest centre-back route on a ~£52m clause; Brugge's Ordóñez the cost-effective alternative as Hughes works a four-man board", time: "1d ago", category: "fan" },
  { source: "SI / Liverpool.com", title: "Thirteen names to watch: Iraola's recruitment team scout a World Cup full of defensive and midfield targets while the inherited spine plays on in other colours", time: "2d ago", category: "fan" },
  { source: "This Is Anfield / Anfield Watch", title: "Mac Allister's camp again pushes back on exit talk, even as Liverpool stay quietly open to a sale near €120m to fund the midfield reshape", time: "2d ago", category: "fan" },
  { source: "Empire of the Kop / Liverpool FC", title: "Ekitike's long road back: a ruptured Achilles points to a festive-period return at best, the absence that keeps the striker-search file open", time: "2d ago", category: "fan" },
