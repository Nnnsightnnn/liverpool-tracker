...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Liverpool's September: five games in 17 days as Iraola's favourable-looking test begins at Ipswich", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola cools Joe Gomez return talk: a muscle injury he normally puts at about a month", time: "today", category: "major" },
  { source: "Goal", title: "Ipswich Town vs Liverpool preview: Reds continue to leak goals before Friday's Portman Road trip", time: "today", category: "major" },
  { source: "Sports Mole", title: "Joe Gomez back in full training and in contention to feature at Ipswich after his July muscle injury", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Gary O'Neil's homecoming: former Liverpool academy coach hosts the Reds at Portman Road", time: "today", category: "fan" },
  { source: "Squawka", title: "Ipswich Town vs Liverpool: predicted XIs and match preview for the 4 September fixture", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Bournemouth v Liverpool confirmed for Sunday 20 September, 2pm kick-off live on Sky", time: "today", category: "official" },
  { source: "Sky Sports", title: "Barcola registered and in line for a debut at Portman Road on Friday", time: "today", category: "official" },
  ...
  { source: "Rousing The Kop", title: "Every incoming and outgoing deal Liverpool completed on an extremely quiet transfer deadline day", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Cody Gakpo holds air-clearing talks with the owners and stays at Anfield", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Official: Liverpool sign Lucca Brughmans, the 18-year-old Genk goalkeeper, and loan him straight back until 2027", time: "1d ago", category: "official" },
  { source: "Yahoo Sports", title: "Liverpool fail in late deadline-day loan bid for Chelsea defender Malo Gusto", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool 2-2 Nottingham Forest: Munoz's debut strike rescues a second straight draw at Anfield", time: "4d ago", category: "major" },
