...
const LATEST_NEWS = [
  { source: "Sky Sports / Caught Offside", title: "Signing day: Andoni Iraola travels to Merseyside to put pen to paper on a two-year deal to June 2028 — Romano says the official announcement is 'soon'", time: "today", category: "official" },
  { source: "Football365 / Fabrizio Romano", title: "Romano reveals FSG had 'second thoughts' over sacking Slot before committing to Iraola — and why the Basque never signs more than two years", time: "today", category: "major" },
  { source: "Foot Mercato / Sky Germany", title: "Diomandé says yes to BOTH Liverpool and PSG — the winger will join whichever club strikes a deal with Leipzig, and wants it settled before the World Cup", time: "today", category: "major" },
  { source: "Football365 / Sky Sports", title: "First two Iraola signings 'approved' at a combined £170m: Diomandé plus Club Brugge centre-back Joël Ordóñez to fill the Konaté vacancy", time: "today", category: "major" },
  { source: "TeamTalk / GiveMeSport", title: "Romano drops a £100m striker hint: a Kroupi reunion with Iraola — but Bournemouth's deterrent valuation is set at £80m-£100m", time: "1d ago", category: "major" },
  { source: "TeamTalk / SportBible", title: "Josh Abe, 15, rejects £50k-a-week offers from Chelsea, Man Utd and Man City to sign scholarship terms at Kirkby — a three-year pro deal from 2027 agreed", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Managing Madrid", title: "Konaté's Liverpool exit formally confirmed; Madrid close the four-year deal but park the unveiling until after Sunday's presidential election", time: "1d ago", category: "major" },
  { source: "This Is Anfield / Liverpool.com", title: "Curtis Jones 'prioritising' Inter after Hughes-Ausilio talks in Monte Carlo — £17m offered against a £35m ask, Dumfries floated as a makeweight", time: "1d ago", category: "major" },
  { source: "This Is Anfield / Africa Soccer", title: "Salah's agent Ramy Abbas pushes back on the countdown: 'no one knows' where the Egyptian plays next — decision parked until after the World Cup", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool's World Cup ledger: 11 called up, 16 left home — Endo wins his fitness race to captain Japan, Frimpong axed by Koeman", time: "2d ago", category: "official" },
  { source: "This Is Anfield", title: "Vítězslav Jaroš left out of the Czech World Cup squad after a serious knee injury — the loan goalkeeper's cruellest week", time: "2d ago", category: "fan" },
  { source: "Sky Sports / Sky Sport Italia", title: "Andy Robertson's free transfer to De Zerbi's Tottenham is done bar the unveiling — nine years at Anfield close", time: "4d ago", category: "major" },
