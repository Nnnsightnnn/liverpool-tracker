...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Mon Sep 21, morning - the only Liverpool player in Thomas Tuchel's senior England squad, and away for the international window. Ngumoha was an unused substitute at Bournemouth once Gakpo passed his warm-up, and is in line for a first competitive cap after a friendly debut in June. The contract David Ornstein reported the club wants signed inside the month is, as far as the reporting goes, still unsigned.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Mon Sep 21, morning - third of three, and the three-week break removes club football entirely. Woodman was not in the Bournemouth squad, where Mamardashvili took the bench behind Alisson. A bench season at most; the cup tie with Chelsea on 28 October is the only realistic opening.", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Iraola confirms hands-on plan for the international break: Reds to work at the AXA", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Leoni to rejoin group training during the break, a year on from his ACL rupture", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Chiesa targeting Liverpool training return by the end of the month", time: "today", category: "fan" },
  { source: "Opta Analyst", title: "Isak turns 26 with four league goals in five, already past all of last season", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Injury news: Iraola provides update on Gomez, Leoni, Chiesa, Bradley and Ekitike", time: "1d ago", category: "fan" },
  { source: "L'Equipe", title: "Jeremy Jacquet called up to the France senior squad for the first time", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Ngumoha the only Liverpool player in Tuchel's senior England squad", time: "1d ago", category: "fan" },
