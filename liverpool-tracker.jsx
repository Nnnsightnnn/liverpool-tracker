...
const PLAYERS = [
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 35, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.4, status: "doubtful", injuryNote: "Fri May 15 — RULED OUT of the Villa Park squad with a 'minor injury' picked up since Sat (This Is Anfield / RotoWire / DaveOCKOP kickoff cycle). Joe Gomez moves into the RB slot; Slot hopeful Frimpong recovers in time for the Brentford home finale May 24. Adds to a Liverpool match-day inventory already light on attacking width with Salah only a sub", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 32, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.3, status: "doubtful", injuryNote: "Fri May 15 — CONFIRMED on the BENCH at Villa Park tonight (Liverpool FC official teamsheet). Slot's Thursday presser had him 'on antibiotics' for the stomach infection that ruled him out of the Chelsea draw, but the German playmaker recovered enough to be a sub option. Available for a cameo if the game is settled, but not deemed fit enough to start", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p494595.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 37, goals: 10, assists: 9, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.2, status: "doubtful", injuryNote: "Fri May 15 — CONFIRMED on the BENCH at Villa Park tonight (Liverpool FC official teamsheet); Slot at the Thursday presser: 'Mo will be available tomorrow for only a few minutes.' First squad inclusion since the Apr 25 Crystal Palace muscle issue, cameo expected. The Brentford home finale May 24 stays the projected Anfield farewell with Henderson back in Brentford kit and Klopp tipped as a guest", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 12, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.4, status: "fit", injuryNote: "Fri May 15 — CONFIRMED XI: the 17-year-old PROMOTED to the No. 9 role at Villa Park tonight after Isak was ruled out with a minor injury (This Is Anfield: 'Rio Ngumoha starts again, NO Isak'). Started last Sat's Chelsea draw and assisted Gravenberch's 6' opener; now asked to lead the line in a Champions-League-shaping fixture. The teen's substitution drew loud boos last week — Slot leaning into the fans' favourite", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
  { id: 26, name: "Federico Chiesa", number: 14, position: "FWD", nationality: "🇮🇹 Italy", age: 28, appearances: 12, goals: 1, assists: 1, cleanSheets: null, xG: 1.5, tacklesPer90: 0.6, passCompletion: 80, progressiveCarries: 2.2, form: 6.0, status: "fit", injuryNote: "Fri May 15 — bench role at Villa Park tonight after Slot turned to Isak and Kerkez first off the pine in last Sat's 1-1 Chelsea Anfield draw. Rotation winger option only; Anfield Watch's 8-man summer clear-out list still has the Italian likely to exit", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p230621.png" },

  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Fri May 15 — back-up to Mamardashvili at Villa Park tonight with Alisson only back in training Thursday and Slot warning he 'may have to wait one more week.' Two PL starts this season (Crystal Palace and Old Trafford), ratings 6-7. Serviceable cover for the run-in", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
];
...
const LATEST_NEWS = [
  { source: "Liverpool FC / Liverpool.com", title: "CONFIRMED Liverpool XI vs Aston Villa: Mamardashvili; Gomez, Konate, Van Dijk, Kerkez; Gravenberch, Mac Allister; Jones, Szoboszlai, Gakpo; Ngumoha — Slot rolls out a 4-2-3-1 with Gomez at RB and the 17-year-old Ngumoha leading the line", time: "today", category: "official" },
  { source: "ESPN / Sports Mole / SI", title: "Alexander Isak RULED OUT of Villa Park with a 'minor injury' — Slot at kickoff: 'Indeed, Alex is out — minor injury,' Liverpool 'hopeful' for the Brentford home finale May 24 as Ngumoha takes the No. 9 role", time: "today", category: "major" },
  { source: "This Is Anfield / RotoWire / DaveOCKOP", title: "Jeremie Frimpong added to the injury list overnight — Liverpool right-back joins Isak in missing the Villa Park squad with a 'minor issue,' Joe Gomez steps in at RB for his most consequential 90 of the season", time: "today", category: "major" },
  { source: "This Is Anfield", title: "'Liverpool confirmed XI vs. Aston Villa: Rio Ngumoha starts again, NO Isak' — the 17-year-old promoted from impact-sub option to the No. 9 role in a Champions-League-shaping fixture", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Confirmed Liverpool line-up v Aston Villa — Salah, Wirtz and Chiesa all on the bench as Slot leans into the youth-and-vets mix; Mamardashvili keeps the gloves with Alisson out", time: "today", category: "official" },
  { source: "Sky Sports", title: "Aston Villa vs Liverpool, 8pm BST tonight at Villa Park — Liverpool 4th on 65 pts, Villa 5th on 62 with both in the top-five chase, a win or a Chelsea slip seals Champions League qualification before the Brentford finale May 24", time: "today", category: "major" },
  { source: "FOX Sports / Goal.com", title: "Slot confirms Mohamed Salah's limited Villa Park return — Liverpool boss told Thursday presser the winger 'will be available tomorrow for only a few minutes, but hopefully can come in' before next weekend's Anfield farewell", time: "today", category: "major" },
  { source: "Per Second News / This Is Anfield", title: "'I have every reason to believe I'm the Liverpool manager next season' — Slot fronted up at the AXA on Thursday and explicitly ruled himself in for 2026-27 hours before the team-coach left for Birmingham", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Alisson Becker still not in the matchday squad — Brazilian back in training but Slot at the Thursday presser warned he may have to 'wait one more week,' Mamardashvili makes a third straight start", time: "today", category: "major" },
  { source: "beIN Sports / GiveMeSport", title: "Arne Slot feels secure at Liverpool despite his disastrous season — Dutchman cites contract status and ongoing FSG talks as the club is reported to have 'no plans to complete a summer review'", time: "today", category: "major" },
