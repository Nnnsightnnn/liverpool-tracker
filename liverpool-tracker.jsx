...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Watch: Andoni Iraola's press conference ahead of Ipswich vs Liverpool, streamed 10am Thursday", time: "today", category: "official" },
  { source: "Sports Mole", title: "Barcola to make Reds debut? Predicted Liverpool XI vs Ipswich as £123m signing pushes to start", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Cody Gakpo holds clear-the-air talks with FSG after £80m Man City move collapses on deadline day", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Federico Chiesa injury latest: Italian in line to feature at Ipswich as back problem eases", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Gravenberch to start, Mac Allister on the bench: 4-2-3-1 Liverpool predicted lineup vs Ipswich", time: "today", category: "fan" },
  { source: "Racing Post", title: "Ipswich vs Liverpool preview: Emersonn doubtful, Flemming could lead the line; Reds 11-20 favourites", time: "today", category: "major" },
  { source: "Football365", title: "Wantaway no more: Gakpo refocuses on Friday as Carragher rates a disappointing Liverpool window", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Champions League opener confirmed: Liverpool host Atletico Madrid on Wednesday 9 September", time: "today", category: "official" },
  { source: "Telegraph", title: "Ranked 14th of 20: why the Telegraph rates Liverpool's transfer window among the summer's weakest", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool the biggest net spender in the league at £218.4m, Sky's post-window figures show", time: "1d ago", category: "fan" },
  ...
  { source: "Liverpool.com", title: "Liverpool fans turn on departing Richard Hughes with Al-Hilal move still expected", time: "1d ago", category: "fan" },
  { source: "Evening Standard", title: "Joe Gomez ruled out of Ipswich; Fulham on 12 September the defender's next target", time: "1d ago", category: "major" },
  { source: "Opta Analyst", title: "One clean sheet in 13: the transition problem behind Liverpool's two opening draws", time: "2d ago", category: "fan" },
