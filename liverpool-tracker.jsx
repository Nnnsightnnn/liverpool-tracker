...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Sat Aug 29 — eighteen, and on the bench after all. The previews had Ngumoha starting on his birthday; Iraola gave the right flank to Victor Munoz instead, and the substitute watched the Spaniard hit the equaliser that saved the afternoon. The new five-year deal with a significant rise is still there to sign, delayed only by the rule capping under-18s at three-year terms, a formality that clears now he has turned eighteen. Nothing about a competitive selection call at a club with a £123m winger arriving says the path has closed. It says the queue is long, which it always was", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Liverpool 2-2 Nottingham Forest: Victor Munoz's debut rocket rescues a point in Iraola's first Anfield match", time: "today", category: "major" },
  { source: "ESPN", title: "Isak off the mark at last, tapping in Gakpo's cross, but Liverpool still have not led all season", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola after the draw: 'The first half has been poor from our side'", time: "today", category: "official" },
  { source: "The Independent", title: "Fast and flawed: only Sunderland have conceded more Premier League counter-attack goals since last August", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Confirmed XI: Munoz handed a full debut on the right, Ngumoha and Gravenberch drop to the bench", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "'They have left Iraola incredibly short': fans demand a DM, a right winger and a backup striker before Tuesday", time: "today", category: "fan" },
  { source: "David Ornstein", title: "Barcola medical completed on Merseyside, announcement expected within a day, Ipswich debut earmarked", time: "today", category: "major" },
  { source: "TeamTalk", title: "Kone is Liverpool's preferred midfielder, which is why little has moved on Camara, and Roma will not sell", time: "today", category: "major" },
  { source: "Sky Sports", title: "Pierre Sage repeats that Sarr is not for sale as Palace hold firm above the rejected £50m", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Chiesa ruled out with a small muscle injury, five senior players unavailable against Forest", time: "1d ago", category: "official" },
  { source: "TeamTalk", title: "Besiktas double: full agreement with Tsimikas, €2m loan bid lodged for Mamardashvili", time: "1d ago", category: "major" },
  { source: "Fabrizio Romano", title: "Bajcetic agrees terms with Celta Vigo, exit to run through a mutual contract termination", time: "2d ago", category: "major" },
  ...
  { source: "ESPN", title: "Jones sealed to Inter for €35m, thinning Iraola's midfield as the deadline nears", time: "1w ago", category: "major" },
