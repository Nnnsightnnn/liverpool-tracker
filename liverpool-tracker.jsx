...
const LATEST_NEWS = [
  { source: "Empire of the Kop", title: "'Makes a lot of sense': The Athletic's James Pearce backs Julian Ward's expected return as sporting director", time: "today", category: "fan" },
  { source: "Read Man City", title: "Opta numbers reveal concern behind Man City's perfect Maresca start", time: "today", category: "fan" },
  { source: "BBC Sport", title: "Contagious, confident: the rise of Lewis Koumas, from three loans to Liverpool's only cover for Isak", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Giovanni Leoni edges closer to a Liverpool return, a year to the day after his ACL", time: "today", category: "major" },
  { source: "Read Man City", title: "Haaland leads the first Man City players into international action on Thursday", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "'I nearly left': Robertson reveals Everton once bid less than £1m for him", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Will Wright's phenomenal goal on a night of high drama for Liverpool U21s", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Robertson leaps to the defence of 'really special' Florian Wirtz after Carragher's jibe", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "'We didn't care about football': Robertson on the impact of Diogo Jota's death", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 'seriously considering' Ward, with Brentford's Lee Dykes discussed as a possible partner", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Mbappe explains why he defied his mother's wishes by turning down Liverpool", time: "1d ago", category: "fan" },
  { source: "Sports Mole", title: "Liverpool keeping 'close eye' on in-form Feyenoord right-back Givairo Read", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Fixture updates: three Premier League changes for Liverpool in November", time: "2d ago", category: "official" },
  { source: "BBC Sport", title: "Bournemouth 0-1 Liverpool: Isak's winner sends Iraola into the break unbeaten", time: "3d ago", category: "major" },
];
