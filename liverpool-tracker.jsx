...
const PLAYERS = [
  ...
  // ── Late additions ────────────────────────────────────────────────────────
  { id: 27, name: "Freddie Woodman", number: 28, position: "GK", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 29, appearances: 2, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 78, progressiveCarries: 0.1, form: 7.4, status: "fit", injuryNote: "Wed Sep 9, evening — named on the European bench as third keeper, with Mamardashvili, and unused as Alisson kept Liverpool in it. Woodman's inclusion in the Champions League squad is depth rather than intent; the Carabao Cup tie against Tottenham on Tuesday is the one fixture this month that might use either deputy", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p155503.png" },
...
const LATEST_NEWS = [
  { source: "Opta Analyst", title: "Liverpool 2-1 Atletico Madrid: Mac Allister's twenty-yard drive completes the comeback on Iraola's Champions League bow, 1.68 xG to 0.81", time: "today", category: "fan" },
  { source: "Hayters TV", title: "Iraola: 'They played a five, a 5-3-2, I have to take the blame from the beginning', and Barcola's exit was 'just cramps'", time: "today", category: "major" },
  { source: "The Independent", title: "Mac Allister winner answers the contract question a day after 'very, very sad', but Liverpool concede first for the third time in four", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Player ratings: Mac Allister 8 and man of the match, Araujo 8 for the backheel assist, Kerkez 3 for losing Llorente", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Barcola substitution explained: cramp, not injury, on a first start the manager admits the club is rushing", time: "today", category: "fan" },
  { source: "WhoScored", title: "Confirmed teams: Ngumoha and Barcola start wide, Gakpo out of the squad as a precaution; Simeone starts Alvarez after saying he would not", time: "today", category: "major" },
  { source: "Opta Analyst", title: "Llorente's fifth at Anfield in three visits: the only player with 10+ Champions League goals to score half of them against one opponent", time: "today", category: "fan" },
  { source: "The 4th Official", title: "Szoboszlai 8.5, Mac Allister 7.5: the pivot scores both as Liverpool win the opener", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Premier League panel: the Forest penalty against Alisson should not have been given, but the VAR was right not to intervene", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Ornstein hints at a change of ownership at Liverpool 'in the next year or two' as 1892 Holdings hold an option on control", time: "today", category: "fan" },
  { source: "Live Football On TV", title: "Fulham on Saturday is a 3pm and not televised in the UK; Tottenham in the Carabao Cup on Tuesday is on ITV4 and Sky at 8pm", time: "today", category: "official" },
  ...
  { source: "Sky Sports", title: "Fulham next: booed off after throwing away two leads against Palace, three defeats from three under Arbeloa, at Anfield at 3pm on Saturday", time: "4d ago", category: "major" },
  { source: "Squawka", title: "Arbeloa's Fulham: Gonzalo Garcia for a record-equalling £34m, Palacios and Charles in, a 4-2-3-1 built to counter-press", time: "1w ago", category: "fan" },
];
