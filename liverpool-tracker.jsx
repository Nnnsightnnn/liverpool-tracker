...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Carabao Cup fourth-round draw: Liverpool to host Chelsea as Arsenal are sent to League Two Fleetwood", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Xabi Alonso back at Anfield a third autumn running with a third club, with 28 October the likeliest date", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola on the Gomez substitution: 'the plan was not a lot more than 45'", time: "today", category: "official" },
  { source: "Daily Mail", title: "Chiesa aiming to resume training this month as Bradley begins ball work and Leoni steps up recovery", time: "today", category: "major" },
  { source: "This Is Anfield", title: "The cup-tie numbers land: Tottenham out-created Liverpool 2.30 to 1.53 and still lost 3-1", time: "today", category: "fan" },
