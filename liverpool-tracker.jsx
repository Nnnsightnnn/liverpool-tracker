...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 18, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Wed Sep 23, morning - away with England, and still the youngest unresolved contract at the club. Ngumoha is the only Liverpool player in Thomas Tuchel's senior squad and in line for a first competitive cap after a friendly debut in June. He was an unused substitute at Bournemouth once Gakpo passed his warm-up. David Ornstein reported the club wants his new deal signed inside the month, which on the week's evidence of how Liverpool handle contracts is not a formality.", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "When is Giovanni Leoni back? Defender set to rejoin group training during the break, a year on from his ACL", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Iraola tells Liverpool to 'get used to not being able to train' as the break becomes his one real coaching window", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool sporting director plan emerges: Julian Ward AND a new external hire?", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool's next five fixtures after the break as Andoni Iraola faces his biggest test", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool's original 'This Is Anfield' sign goes up for auction, 46 years after it came down", time: "today", category: "fan" },
  { source: "Read Man City", title: "Foden's ban runs out at Anfield as Doku returns from a calf that cost him five games", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Andy Robertson backed to make 'sensational' Liverpool return after 'strange' summer exit", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "The nine Liverpool players NOT on international duty, and the games they could still play", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Liverpool launch 2026/27 home kit inspired by the 1989/90 title-winning strip", time: "1d ago", category: "official" },
  { source: "ESPN", title: "Van Dijk: Xavi key in 'massive decision' over Netherlands stay to Euro 2028", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Matty Wright signs first professional contract at LFC", time: "1d ago", category: "official" },
  { source: "TEAMtalk", title: "Mac Allister maps out 'perfect' scenario with two years left and no new deal on the table", time: "2d ago", category: "major" },
  ...
  { source: "Sky Sports", title: "Man City 5-3 Sunderland: Maresca's leaders await Liverpool at Anfield", time: "3d ago", category: "major" },
];
