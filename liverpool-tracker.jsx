...
const LATEST_NEWS = [
  ...
  { source: "Liverpool FC / NBC Sports", title: "Slot post-match: 'damaging — three out of four from set pieces' as the manager calls the defeat 'damaging' and again insists 'I have every reason to believe I am the Liverpool manager next season'", time: "today", category: "official" },
  { source: "Al Jazeera / Sky Sports", title: "Aston Villa thrash Liverpool 4-2 to seal Champions League place — Emery's side leapfrog the Reds into 4th as Villa Park enters frenzy ahead of Wednesday's Europa League final", time: "today", category: "major" },
  { source: "FOX Sports / Goal.com / Liverpool FC", title: "Mohamed Salah cameos off the Liverpool bench at Villa Park — first action since the April 25 Crystal Palace muscle issue; Anfield farewell vs Brentford May 24 now BOTH a tribute night AND a must-win", time: "today", category: "major" },
  { source: "Football365 / Sky Sports", title: "Carragher: Slot 'showing signs of a man buckling'; Murphy on television: 'his time is up' — punditry pressure ramps up as Anfield mood darkens after the Villa Park defeat", time: "today", category: "fan" },
  { source: "ESPN / Sports Mole / SI", title: "Alexander Isak ruled out of Villa Park with a 'minor injury' — Slot at kickoff: 'Indeed, Alex is out — minor injury,' Liverpool 'hopeful' for the Brentford home finale May 24", time: "1d ago", category: "major" },
  { source: "This Is Anfield / RotoWire", title: "Jeremie Frimpong added to the injury list — Joe Gomez stepped in at RB for the Villa Park defeat as Slot's match-day inventory thinned further", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Confirmed Liverpool line-up v Aston Villa — Mamardashvili; Gomez, Konate, Van Dijk, Kerkez; Gravenberch, Mac Allister; Jones, Szoboszlai, Gakpo; Ngumoha as Slot rolled out a 4-2-3-1 with the 17-year-old leading the line", time: "1d ago", category: "official" },
  { source: "Sky Sports / Inside World Football", title: "Xabi Alonso 'frontrunner' for Chelsea manager job — talks 'progress positively' as the ex-Bayer boss weighs the Stamford Bridge offer against waiting for Liverpool, FSG decision to stick with Slot puts him on the spot", time: "2d ago", category: "major" },
  { source: "This Is Anfield / Caught Offside", title: "Andoni Iraola 'among candidates' to replace Arne Slot — Bournemouth boss linked at Liverpool with pre-existing Richard Hughes relationship, Chelsea also holding in-person talks with the Spaniard", time: "2d ago", category: "fan" },
  { source: "Anfield Watch / FootballTransfers", title: "Alisson Becker 'agrees €15m deal' to leave Liverpool — Nicolò Schira pegs the personal terms at €5m a year on a Juventus contract as the Brazilian's Anfield exit firms up", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Virgil van Dijk transfer to Galatasaray RULED OUT as new rule could prevent Liverpool exit — captain set to see out his current deal as Bastoni / Schlotterbeck / van Hecke are tracked as long-term succession candidates", time: "2d ago", category: "major" },
  { source: "ESPN / Anfield Index / Yahoo / RTÉ", title: "'Anything can happen … we'll see' — Joe Gomez breaks silence on his Liverpool future, admits he doesn't know if he'll still be at Anfield next season as he enters the final year of his deal", time: "3d ago", category: "major" },
  { source: "Liverpool.com", title: "Ibrahima Konaté contract 'stalemate' with Liverpool — sticking points over signing-on package and agent commissions, Real Madrid still circling as the Frenchman starts at Villa Park", time: "3d ago", category: "major" },
  { source: "Sky Sports", title: "Howard Webb says Benjamin Šeško DID handle the ball before scoring vs Liverpool at Old Trafford on May 3 — VAR could not disallow due to lack of conclusive evidence", time: "3d ago", category: "major" },
