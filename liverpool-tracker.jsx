...
const LATEST_NEWS = [
  { source: "ESPN", title: "Final day at MetLife: Mac Allister expected to start in Argentina's midfield three as Spain go for the double", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Sporting Kansas City table a two-year offer for Mohamed Salah as MLS interest turns concrete", time: "today", category: "major" },
  { source: "Sports Illustrated", title: "Messi, Alvarez and Simeone in Scaloni's front three as Argentina name an unchanged spine for the final", time: "today", category: "major" },
  { source: "Football365", title: "Liverpool 'accelerate' for Haissem Hassan and are confident of a fee below the Egypt winger's £10.4m release clause", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Samuel Martinez flies in with family and agent for a medical as Liverpool agree a $1m deal with Atletico Nacional", time: "today", category: "fan" },
  { source: "Besiktas / beIN Sports", title: "Besiktas call reports of a Salah agreement 'entirely fabricated' as Ramy Abbas says a decision is close", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Joe Bradshaw scores as Liverpool's U21s draw 1-1 with Vauxhall Motors in a friendly nobody announced", time: "1d ago", category: "fan" },
  { source: "TeamTalk", title: "Khephren Thuram set to commit to Juventus as Wharton's £100m price leaves Kaishu Sano the realistic midfield move", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Jarrod Bowen agrees restructured West Ham terms, closing off the longest-running Salah-replacement link of the summer", time: "1d ago", category: "fan" },
  { source: "Football365", title: "Liverpool restate they do not plan to sell Cody Gakpo after a Spanish report described his exit as settled", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Squad flies to Chicago on Monday: Sunderland in Nashville, Wrexham at Yankee Stadium, Leeds at Soldier Field", time: "2d ago", category: "official" },
  { source: "Read Liverpool FC", title: "Robbie Fowler hosts Chicago Bears pair at the Royal Albert Dock as the club builds out its American footprint", time: "2d ago", category: "fan" },
  { source: "GiveMeSport", title: "Talks held over Kaishu Sano with Liverpool ready to go to €60m for the Mainz and Japan midfielder", time: "2d ago", category: "major" },
  { source: "Read Liverpool FC", title: "Iraola calls Ekitike, Bradley and Leoni 'long-term solutions' with none of the three taking part in pre-season", time: "3d ago", category: "major" },
];
