...
const LATEST_NEWS = [
  { source: "FOX Sports", title: "Barcola agrees personal terms with Liverpool to 2032 as the Reds table a record-class opening bid", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Iraola confirms Isak, Wirtz, Gravenberch and Jacquet will get their first minutes against Leeds on Sunday", time: "today", category: "major" },
  { source: "Sports Illustrated", title: "Salah's agent: 'We still do not know where Mohamed will play, but we may know very soon'", time: "today", category: "major" },
  { source: "TeamTalk", title: "Liverpool's opening Barcola bid worth around £103m as PSG hold out near €180m", time: "today", category: "major" },
  { source: "Football Insider", title: "Wharton pursuit cools: Chelsea firm in the market as an ankle problem keeps him from Palace's Como trip", time: "today", category: "fan" },
  { source: "GiveMeSport", title: "Liverpool open talks for Lille's Ayyoub Bouaddi, moving ahead of Manchester City", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola plots Florian Wirtz as a No. 10, working 'behind the striker'", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Joe Gomez set to miss the start of the season after his Sunderland muscle injury", time: "today", category: "fan" },
  { source: "Choose Chicago", title: "Tens of thousands set for Soldier Field as the tour reaches its close against Leeds", time: "today", category: "fan" },
  ...
  { source: "Liverpool.com", title: "Van Dijk due his pre-season bow at Anfield against Monaco on August 9 and Como on the 16th", time: "2d ago", category: "fan" },
  ...
  { source: "Liverpool.com", title: "Jordan Henderson closing on a Chelsea move from Brentford as the 2020 spine scatters further", time: "3d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 1-0 Wrexham: Ngumoha's switch to the right sealed back-to-back Iraola wins in the Bronx", time: "2d ago", category: "major" },
];
