...
const LATEST_NEWS = [
  { source: "Football365 / The National", title: "Salah gives the green light: next move tilts to Turkey with Fenerbahce firm as favourites, a former board member claiming positive meetings and broad agreement", time: "today", category: "major" },
  { source: "Sky Sports / TeamTalk", title: "Diomandé chase stalls on a fee: Leipzig hold near £87m against Liverpool's approved £75m, Bayern Munich enter beside PSG, and one outlet warns of an £80m Plan B", time: "today", category: "major" },
  { source: "This Is Anfield / OneFootball", title: "Núñez camp cools the homecoming: sources call a free return 'not true' with 'nothing ongoing', and Liverpool.com warns the club off the 'short-term fix'", time: "today", category: "major" },
  { source: "Premier League / Liverpool FC", title: "Fixtures tomorrow: Iraola learns his first Liverpool assignment when the 2026-27 schedule drops at 10am on Friday June 19, season starts Aug 22-23", time: "today", category: "official" },
  { source: "This Is Anfield / OneFootball", title: "Group F decider Saturday: Van Dijk's Netherlands meet Isak's Sweden for top spot; Isak banks a goal, two assists and POTM in Sweden's 5-1 rout of Tunisia", time: "today", category: "fan" },
  { source: "Anfield Watch / This Is Anfield", title: "Jones to Inter still a haggle: Liverpool want ~€35m, Inter open near €20m as Ausilio talks up the Scouser, the likeliest first exit of the window", time: "1d ago", category: "major" },
  { source: "Empire of the Kop / Liverpool FC", title: "Ekitike injury timeline: striker working through 'immense pain' on a ruptured Achilles, a festive-period return at best and concerns over his level", time: "1d ago", category: "fan" },
  { source: "TeamTalk / Liverpool.com", title: "Gakpo wants a Premier League exit with Villa and Spurs alert, floated as a player-plus-cash makeweight to bridge the Diomandé valuation gap", time: "1d ago", category: "fan" },
  { source: "ClutchPoints / Anfield Watch", title: "Inácio stays the cleanest centre-back route: a ~£52m Sporting clause Liverpool are reported willing to meet, ahead of United, Madrid and Chelsea", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Anfield Watch", title: "Mac Allister's camp again denies exit talk, insisting no approaches were turned down, even as Liverpool stay quietly open to a sale near €120m", time: "2d ago", category: "fan" },
  { source: "SI / Liverpool.com", title: "Iraola's World Cup scouting mission: the new manager studies the spine he inherited, Van Dijk, Isak and Wirtz above all, before pre-season", time: "2d ago", category: "fan" },
  ...
  { source: "Sky Sports / OneFootball", title: "Endo forced out of the World Cup through injury, Japan losing the midfielder before Group F's decisive round", time: "2d ago", category: "fan" },
