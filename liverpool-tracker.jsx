...
const PLAYERS = [
  ...
  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 34, appearances: 43, goals: 6, assists: 1, cleanSheets: 11, xG: 3.2, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Tue Jun 23 — the captain wants to stay, and made his Group F statement: pushing for a fresh deal beyond his 2027 expiry, he marshalled the Netherlands' 5-1 rout of Isak's Sweden in Houston to take top spot in the pool. At 34 he remains the fixed point Hughes is buying a partner for, not a problem to solve", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  ...
  { id: 10, name: "Giovanni Leoni", number: 33, position: "DEF", nationality: "🇮🇹 Italy", age: 18, appearances: 1, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "injured", injuryNote: "Mon May 25 — torn ACL last September; the long rehabilitation continues, with a return targeted for the 2026-27 season", image: "https://r2.thesportsdb.com/images/media/player/cutout/8aws9t1766829004.png" }, /* Leoni - TheSportsDB cutout */
  ...
  { id: 16, name: "Curtis Jones", number: 17, position: "MID", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 25, appearances: 28, goals: 2, assists: 4, cleanSheets: null, xG: 1.8, tacklesPer90: 1.5, passCompletion: 86, progressiveCarries: 3.9, form: 6.9, status: "fit", injuryNote: "Tue Jun 23 — talks have soured: Liverpool, irritated by Inter's approach, rejected a second bid worth around £21.7m (€25m), well short of their ~£35-40m valuation (sell-on attached), and want no further negotiation. Pricing a market in which City offered £100m-plus for Elliot Anderson, the Reds would now happily keep their only Merseyside-born player, even hoping he signs a new deal. The exit is no longer a formality", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p206915.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Tue Jun 23 — top of the group, and stacking up records: Egypt lead Group G after the 3-1 of New Zealand and the 1-1 with Belgium, the captain now the oldest African to score and assist at a World Cup and his country's leading finals scorer, one short of Hossam Hassan's overall 69, with Iran to come Friday in Seattle. Off the pitch the Fenerbahce framework holds, a ~£77m three-year deal ahead of Saudi and MLS interest. A free agent on June 30, the Anfield chapter is closed; the final word waits on the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "This Is Anfield / ESPN", title: "Bradley Barcola asks to leave PSG, putting Liverpool and Arsenal on alert for a ~€100m France winger thrilled by the prospect of Anfield", time: "today", category: "major" },
  { source: "Anfield Watch / Yahoo Sports", title: "Hughes sets a deadline on Yan Diomandé and is ready to break the British record again, a fee near £128m topping both Wirtz (£116m) and Isak (£126m), rather than let it drift into August", time: "today", category: "major" },
  { source: "ESPN / Manchester City", title: "Game over for Liverpool's long game: Marc Guéhi signs for Manchester City in a £20m deal, the free agent the Reds had hoped to collect in 2027", time: "today", category: "major" },
  { source: "Football365", title: "The transfer trick: Liverpool bank just over £1m through a 17.5% sell-on clause as Bobby Clark joins Derby for £6m, a small top-up toward the winger fund", time: "today", category: "fan" },
  { source: "Sky Sports / Washington Post", title: "Salah tops Group G and faces Iran on Friday: now the oldest African to score and assist at a World Cup and Egypt's leading finals scorer, one short of his country's overall record", time: "1d ago", category: "fan" },
  { source: "Liverpool.com / Sky Sports", title: "Jones stand-off holds: Liverpool, 'irritated' by Inter's approach, reject a second bid of around £21.7m as well short of their ~£35-40m valuation", time: "1d ago", category: "major" },
  { source: "Sky Sports / NewsNow", title: "Camavinga enters the frame: Liverpool and Manchester United among possible destinations for the Real Madrid midfielder", time: "today", category: "fan" },
  { source: "Liverpool.com / Yahoo Sports", title: "Iraola pre-season: Harvey Elliott back from his Aston Villa loan as the squad flies to the US on July 20; the manager tells the group he sees everyone as a new signing", time: "2d ago", category: "official" },
  { source: "Liverpool.com / GiveMeSport", title: "Lille set Ayyoub Bouaddi at £60m as the 18-year-old leans toward PSG, leaving Liverpool and Arsenal in a three-way scramble", time: "2d ago", category: "fan" },
  { source: "Football365 / TeamTalk", title: "Salah to Fenerbahce framework holds: a three-year deal worth a reported €90m (£77m) total as Liverpool confirm a free-agent exit on June 30", time: "3d ago", category: "fan" },
  { source: "Fabrizio Romano / This Is Anfield", title: "Munoz settles in: the €40m (£34.7m) Osasuna winger, the window's first arrival, signed for six years after Liverpool hijacked a near-done Newcastle move", time: "3d ago", category: "official" },
