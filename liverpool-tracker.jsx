...
const PLAYERS = [
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Wed Jun 17 — ruled out of a Premier League return: with his Anfield chapter closed, Salah will weigh Turkey, the Saudi money and an MLS reunion only once Egypt's World Cup run ends. The Pharaohs' captain sits two goals short of his country's all-time scoring record of 69, held by head coach Hossam Hassan, the kind of farewell footnote that writes itself. A free agent on June 30, his next club still parked until after the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "Football365 / Liverpool.com", title: "Liverpool 'closing in' on Yan Diomandé: daily talks with the 19-year-old's camp, a significant bid due this week, and the winger hinting he's 'about to sign'", time: "today", category: "major" },
  { source: "TeamTalk / Goal", title: "'Darwin Núñez returns to Liverpool': a Uruguayan journalist calls the free move a 'done deal' to be announced once Uruguay exit the World Cup, Jorge Mendes involved", time: "today", category: "major" },
  { source: "Liverpool.com / GiveMeSport", title: "Bouaddi's preference now said to tilt to PSG: Liverpool and Arsenal still in a three-way race for the £70m-rated Lille teenager", time: "today", category: "fan" },
  { source: "This Is Anfield / Anfield Watch", title: "Jones to Inter hinges on the gap: Liverpool want ~€35m, Inter open near €20m as Ausilio goes public and the Scouser stays 'totally open' to leaving", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Mac Allister's father slaps down 'false' exit talk, insisting no approaches were declined, even as Liverpool stay open to a sale if funds are needed", time: "today", category: "fan" },
  { source: "Football365 / OneFootball", title: "PSG must sell before they can match Liverpool's Diomandé push, needing to offload one of Barcola, Ramos or Lee first", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports / Olympics.com", title: "Salah ruled out of a Premier League return as he weighs his next club, and sits two goals shy of Egypt's all-time scoring record", time: "1d ago", category: "fan" },
  { source: "This Is Anfield / Liverpool.com", title: "Group F decider Saturday: Van Dijk's Netherlands meet Isak's Sweden for top spot, with Endo's Japan also live in the same pool", time: "1d ago", category: "major" },
  { source: "Premier League / Liverpool FC", title: "Fixtures Friday: Iraola learns his first Liverpool assignment when the 2026-27 schedule drops at 10am on June 19, season starts Aug 22-23", time: "1d ago", category: "official" },
  { source: "ClutchPoints / Anfield Watch", title: "Inácio holds as the cleanest of the centre-back four: a ~€60m Sporting clause Liverpool are reported willing to pay, ahead of United, Madrid and Chelsea", time: "1d ago", category: "fan" },
  { source: "SI / Liverpool.com", title: "Iraola's World Cup scouting mission: the new manager studies the spine he inherited, Wirtz, Isak and Van Dijk above all, before pre-season", time: "2d ago", category: "fan" },
  { source: "Anfield Watch / Football365", title: "Camara and Scott the midfield names waiting on a sale: neither accelerates until Jones, and perhaps Mac Allister, clears the wage bill", time: "2d ago", category: "fan" },
  { source: "TeamTalk / Liverpool.com", title: "Gakpo wants a Premier League exit with Villa and Spurs alert, floated as a player-plus-cash makeweight to bridge the Diomandé valuation gap", time: "2d ago", category: "fan" },
  { source: "GiveMeSport / Managing Madrid", title: "Konaté's Real Madrid switch confirmed on a free after Pérez's re-election, the centre-back vacancy still the spine of Hughes's search", time: "5d ago", category: "major" },
];
