...
const PLAYERS = [
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Fri May 15 — expected to start at Villa Park tonight per the Sportsmole / SI predicted XI after last Sat's bench cameo in the 1-1 Chelsea draw (his first minutes since the Apr 25 Crystal Palace muscle issue). With Salah only a brief sub and Ekitike out for the season, Isak is the only natural No. 9 fit; Gakpo drops back to LW", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 12, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.4, status: "fit", injuryNote: "Fri May 15 — bench / impact-sub option at Villa Park tonight per the Sportsmole / SI predicted XI as Gakpo slides to LW alongside Isak up top. The teen STARTED last Sat's 1-1 Chelsea Anfield draw and supplied the assist for Gravenberch's 6' opener (Liverpool.com: 'Rio Ngumoha stars'). His 75' substitution drew loud boos and remains a flashpoint of the fan-Slot disconnect this week", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p611922.png" },
