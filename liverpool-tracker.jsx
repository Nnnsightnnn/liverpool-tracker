...
const LATEST_NEWS = [
  { source: "Fabrizio Romano / This Is Anfield", title: "Here we go: Liverpool complete the €40m (£34.7m) signing of Spain winger Victor Munoz, triggering his Osasuna release clause to hijack Newcastle; six-year deal signed, medical passed", time: "today", category: "official" },
  { source: "ESPN / Sports Mole", title: "Fixtures out: Iraola handed a daunting opener away at Newcastle on Sunday August 23, Liverpool's first season since 2017-18 without Salah and Robertson", time: "today", category: "official" },
  { source: "Football365 / GiveMeSport", title: "Diomandé take two: Romano names 'two reasons' for the rejection and says a fresh bid near the €120m mark is coming 'quickly', the deal floated to close during the World Cup", time: "today", category: "major" },
  { source: "Football365 / TeamTalk", title: "Romano: a second winger still wanted after Munoz, with Diomandé the priority and PSG's Barcola plus Cologne's Said El Mala on the board", time: "today", category: "major" },
  { source: "ESPN / Sports Mole", title: "Group F decider today: Van Dijk's Netherlands, third after a 2-2 with Japan, face Isak's Sweden, top after a 5-1 of Tunisia, at NRG Stadium in Houston", time: "today", category: "fan" },
  { source: "TeamTalk / Football365", title: "Salah's farewell tilts to Istanbul: Fenerbahce firm up a reported £77m package, though the free agent keeps the call for after Egypt's World Cup", time: "1d ago", category: "major" },
  { source: "Liverpool.com / TeamTalk", title: "Jones to Inter edges closer: the Italians ready a €25m bid with a sell-on clause against Liverpool's ~€30m ask, Bournemouth's Alex Scott lined up to replace him", time: "1d ago", category: "fan" },
  { source: "ClutchPoints / OneFootball", title: "Inácio stays the cleanest centre-back route on a ~£52m clause; Brugge's Ordóñez the value alternative as Hughes works a four-man board", time: "1d ago", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season map: Iraola's first look begins with newly promoted Sunderland at Geodis Park, Nashville, on July 25 before the US tour", time: "2d ago", category: "fan" },
  { source: "Liverpool.com / GiveMeSport", title: "Gakpo stays in demand but the club resist a sale, the Dutchman lingering as a possible Leipzig swap chip even as Liverpool insist they want to add up front", time: "2d ago", category: "fan" },
  { source: "Empire of the Kop / Liverpool FC", title: "Ekitike's long road back: a ruptured Achilles points to a festive-period return at best, the absence that keeps the striker-search file open", time: "3d ago", category: "fan" },
  { source: "Sky Sports / OneFootball", title: "Endo home from the World Cup injured, Japan losing the midfielder before the group's decisive round as a summer sale looms at Anfield", time: "3d ago", category: "fan" },
  { source: "This Is Anfield / Anfield Watch", title: "Mac Allister's camp again push back on exit talk, even as Liverpool stay quietly open to a sale near €120m to fund the midfield reshape", time: "4d ago", category: "fan" },
