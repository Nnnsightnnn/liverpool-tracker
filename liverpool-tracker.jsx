...
const PLAYERS = [
  ...
  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 35, appearances: 43, goals: 6, assists: 1, cleanSheets: 11, xG: 3.2, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Wed Jul 22 — held back for the Anfield friendlies. Iraola confirmed in his first pre-season briefing that the captain stays in Europe with Alisson and Gakpo and links up later in the trip, the bulk of his minutes reserved for the Como and Monaco games at Anfield in mid-August. Milan's interest, driven by Ibrahimovic, keeps being knocked back with no bid received and none expected to move him. Jacquet is the lone senior centre-back until he arrives", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  ...
  { id: 8, name: "Conor Bradley", number: 12, position: "DEF", nationality: "🇬🇧 N. Ireland", age: 22, appearances: 16, goals: 0, assists: 2, cleanSheets: 4, xG: 0.8, tacklesPer90: 2.6, passCompletion: 84, progressiveCarries: 5.1, form: 7.3, status: "injured", injuryNote: "Tue Jul 21 — he is on the plane, but only to work. Bradley is one of three injured players flown to the United States specifically to continue a specialist rehabilitation programme under the club's medical staff, and is not expected to take any part in the three friendlies. Today's reporting pulls back from the weekend's 2027 framing and returns to the earlier line, that he is targeting availability around the start of the campaign proper, though the club still commit to no date. The knee dates to the Arsenal match in January. Frimpong remains the only fit senior right-back travelling", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p492777.png" },
  ...
  { id: 14, name: "Ryan Gravenberch", number: 38, position: "MID", nationality: "🇳🇱 Netherlands", age: 23, appearances: 41, goals: 6, assists: 5, cleanSheets: null, xG: 3.1, tacklesPer90: 2.8, passCompletion: 91, progressiveCarries: 3.2, form: 7.2, status: "fit", injuryNote: "Wed Jul 22 — confirmed among the returning trio. Iraola named him with Isak and Wirtz as rejoining the tour in the coming days after their World Cup summers, missing Sunderland but in the frame for Wrexham and Leeds. Liverpool's most consistent player across a turbulent 2025-26 is the fixed point at the base of whatever the manager builds. Everything around him is a question; he is not one of them", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p441266.png" },
  ...
  { id: 18, name: "Florian Wirtz", number: 7, position: "MID", nationality: "🇩🇪 Germany", age: 23, appearances: 33, goals: 6, assists: 6, cleanSheets: null, xG: 4.9, tacklesPer90: 1.0, passCompletion: 87, progressiveCarries: 4.1, form: 7.1, status: "fit", injuryNote: "Wed Jul 22 — one of the three Iraola confirmed are coming. The £115m playmaker rejoins the tour in the coming days with Isak and Gravenberch, missing Sunderland but in line for Wrexham and Leeds, and the manager finally gets an extended block of work with him. He shared barely 117 minutes on the pitch with Isak and Ekitike across an injury-disrupted first year; a clean summer, for once, is the reset", image: "https://r2.thesportsdb.com/images/media/player/cutout/8t6bzo1757088899.png" },
  ...
  { id: 23, name: "Alexander Isak", number: 9, position: "FWD", nationality: "🇸🇪 Sweden", age: 26, appearances: 18, goals: 9, assists: 2, cleanSheets: null, xG: 9.6, tacklesPer90: 0.4, passCompletion: 76, progressiveCarries: 3.2, form: 7.5, status: "fit", injuryNote: "Wed Jul 22 — confirmed back, and eased in carefully. Iraola named Isak among the returning trio, in line for a few minutes against Wrexham on July 29 before a fuller role versus Leeds, having come home early from the World Cup. An injury-wrecked debut season limited the £100m striker to a handful of starts; a full pre-season under a new coach is the reset the whole front line needs", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p219168.png" },
  { id: 24, name: "Hugo Ekitike", number: 22, position: "FWD", nationality: "🇫🇷 France", age: 23, appearances: 41, goals: 18, assists: 5, cleanSheets: null, xG: 14.2, tacklesPer90: 0.4, passCompletion: 78, progressiveCarries: 2.1, form: 7.3, status: "injured", injuryNote: "Tue Jul 21 — the two stories have quietly converged on Christmas. Ekitike has flown to the United States with Bradley and Leoni to continue specialist rehabilitation under the medical staff, taking no part in any of the three friendlies, and the reporting now puts the Achilles ruptured against PSG in April as keeping him out until around the festive period. That is close enough to the Boxing Day target he set himself to stop it being an argument, and short of the twelve-month end of April's nine-to-twelve-month scan. He remains hopeful of playing again before the end of 2026", image: "https://r2.thesportsdb.com/images/media/player/cutout/8za47v1757087851.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool.com", title: "Iraola confirms triple pre-season boost: Isak, Wirtz and Gravenberch to rejoin the tour in the coming days", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool confirm £750,000 signing of 17-year-old Colombian playmaker Samuel Martinez from Atletico Nacional", time: "today", category: "official" },
  { source: "L'Equipe", title: "PSG set £127.5m price on Bradley Barcola as Ornstein reports the champions remain convinced they will not sell", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Isak in line for Wrexham minutes as Van Dijk's game time is reserved for the Anfield friendlies", time: "today", category: "major" },
  { source: "FootballTransfers", title: "Liverpool ask about Yan Diomande as Harvey Elliott is floated as a makeweight in a Leipzig deal", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Iraola confirms five senior stars will miss the USA tour, with Mac Allister and Munoz back for Como on August 16", time: "today", category: "major" },
  { source: "DaveOCKOP", title: "Endo and Bajcetic join Ekitike, Bradley and Leoni in the rehab group on the American trip", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Samuel Martinez signing a 'steal' at £750,000 as Liverpool see off Bayern, Dortmund and Barcelona", time: "today", category: "fan" },
  { source: "Nashville SC", title: "Geodis Park to host Liverpool vs Sunderland on Saturday as the Reds open their three-game US tour", time: "1d ago", category: "major" },
  { source: "Al Jazeera", title: "Salah to Besiktas the centre of the post-World Cup market as president calls agent demands 'astronomical'", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Curtis Jones stays in the plans as Liverpool draw up fresh terms after Inter's third bid is rejected", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Giovanni Leoni back running outdoors and furthest advanced of the long-term absentees on tour", time: "1d ago", category: "fan" },
  { source: "TeamTalk", title: "Minteh at around £70m and Hassan under a €12m clause hold as the deliverable winger alternatives", time: "2d ago", category: "major" },
  { source: "Anfield Watch", title: "Said El Mala to stay at Koln for 2026-27 with any Liverpool move waiting on 2027", time: "2d ago", category: "fan" },
  { source: "Liverpool FC", title: "Liverpool settled at their Chicago base with 31 players, eleven of them from the academy", time: "2d ago", category: "official" },
];
