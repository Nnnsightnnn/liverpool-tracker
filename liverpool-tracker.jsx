...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Jérémy Jacquet officially completes his £55m move from Rennes (rising to £60m): five-year deal, second most expensive defender in the club's history", time: "2d ago", category: "official" },
  { source: "Liverpool FC", title: "'Forever 20': club unveils permanent memorial to Diogo Jota and André Silva on 97 Avenue, on the eve of the first anniversary", time: "1d ago", category: "official" },
  { source: "ESPN", title: "Salah passed fit for Egypt's last-32 tie with Australia tonight, but Hassan won't promise a start: 'I am not going to run any risk'", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Portugal's entire squad pay tribute to Jota after the dramatic World Cup win over Croatia, Ronaldo leading it", time: "today", category: "fan" },
  { source: "Football365", title: "Van Dijk 'very close' to Galatasaray after 'positive' talks, with an official offer said to be days away", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "The counter-report: a Turkish foreign-player quota could rule the Van Dijk deal out entirely while Icardi stays", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Liverpool confirm Iraola's backroom staff: Elphick, Cooper, De la Torre and Webber arrive from Bournemouth", time: "1d ago", category: "official" },
  { source: "This Is Anfield", title: "Curtis Jones 'reluctant' to join Nottingham Forest, a club without Europe that could yet lose its manager", time: "1d ago", category: "fan" },
  { source: "CaughtOffside", title: "Barcola leaves the door open: 'Focus on World Cup now. After that, my future… I don't know'", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Liverpool made contact with Bruno Guimarães' agent, but Arsenal are ahead and the age gives the desk pause", time: "2d ago", category: "major" },
  { source: "TeamTalk", title: "Manchester United 'determined' to sign Mateus Fernandes as Liverpool drift out of the West Ham race", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Jacquet is a blessing, argues the analysis, but Liverpool are gambling on going into pre-season with four fit senior defenders", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "The July map: players report on the 13th, Sunderland in Nashville on the 25th, then Wrexham at Yankee Stadium", time: "2d ago", category: "fan" },
];
