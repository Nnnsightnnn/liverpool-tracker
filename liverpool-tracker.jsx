...
const LATEST_NEWS = [
  { source: "Fabrizio Romano", title: "Here we go: Liverpool and PSG agree a deal up to €150m for Bradley Barcola, medical next", time: "today", category: "major" },
  { source: "David Ornstein", title: "Barcola to Liverpool 'done' by all parties as the France winger travels to England for his medical", time: "today", category: "major" },
  { source: "This Is Anfield", title: "And a second winger: Liverpool agree around £70m with Brighton for Yankuba Minteh, deal set to complete", time: "today", category: "major" },
