...
const LATEST_NEWS = [
  { source: "Liverpool.com", title: "Simeone takes the blame for Atletico's 3-0 at Bilbao before Anfield: 'we lost the match in five minutes'", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Iraola on a first Champions League night as Liverpool manager: 'special... an honour for me and my staff'", time: "today", category: "official" },
  { source: "DaveOCKOP", title: "Simeone leaves Julian Alvarez a question two days out, the striker whistled again by his own supporters", time: "today", category: "fan" },
  { source: "El Desmarque", title: "Simeone still weighing a back three for Anfield: Romero in, Grimaldo to wing-back or the bench", time: "today", category: "major" },
  { source: "FourFourTwo", title: "Araujo reads as Iraola's Champions League right-back after a 7.7 and nine duels from ten at Ipswich", time: "today", category: "fan" },
  { source: "ESPN", title: "Table on hold in a European week: City and Arsenal perfect on nine, five sides on five, Liverpool sixth", time: "today", category: "major" },
  { source: "DaveOCKOP", title: "Eight could miss Liverpool v Atletico: Gomez a doubt for the Reds, Sorloth out and Ortiz suspended for the visitors", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Isak reaches a first Anfield European night with three league goals in three", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Gomez back in team training but a doubt for Atletico; Fulham on the 12th the realistic return", time: "today", category: "fan" },
  { source: "Sports Mole", title: "Gakpo's four goal involvements in three bettered only by Salah among Liverpool players this century, per Opta", time: "1d ago", category: "fan" },
  { source: "The Athletic", title: "Ward, Woodfine and Marques the internal names to replace Hughes, a fourth sporting director in four years", time: "1d ago", category: "major" },
  ...
  { source: "Liverpool FC", title: "Ipswich 0-2 Liverpool: Isak's quickfire double and Alisson's 138th clean sheet give Iraola a first win", time: "3d ago", category: "official" },
  { source: "Bloomberg", title: "FSG's minority sale to a Bezos-backed consortium the backdrop to the sporting-director search", time: "3w ago", category: "major" },
];
