...
const LATEST_NEWS = [
  { source: "Anfield Watch", title: "Liverpool in 'pole position' for Kaishu Sano as serious contact is made with the Mainz midfielder's camp", time: "today", category: "major" },
  { source: "The Peoples Person", title: "Reds steal a march on Man United in the race for Sano, with Arsenal also trailing on the £50m Japan star", time: "today", category: "major" },
  ...
  { source: "ESPN", title: "Konate to Real Madrid confirmed: France defender leaves on a free after extension talks collapse", time: "2d ago", category: "major" },
  ...
  { source: "Empire of the Kop", title: "Romano confirms it: Celtic's U16 captain Dara Jikiemi signs a five-year Liverpool path at sixteen", time: "3d ago", category: "fan" },
  { source: "Football365", title: "Chiesa's exit U-turn: the Italian now wants to stay and fight for a starting role under Iraola", time: "3d ago", category: "major" },
];
