...
const PLAYERS = [
  ...
  { id: 8, name: "Conor Bradley", number: 12, position: "DEF", nationality: "🇬🇧 N. Ireland", age: 22, appearances: 16, goals: 0, assists: 2, cleanSheets: 4, xG: 0.8, tacklesPer90: 2.6, passCompletion: 84, progressiveCarries: 5.1, form: 7.3, status: "injured", injuryNote: "Sat Jul 18 — the horizon moves back the right way. After a fortnight in which the knee that gave way at Arsenal in January was spoken of as a 2027 problem, David Lynch reported this week that Bradley is targeting a return shortly after the new campaign begins and is 'not a million miles away,' which he called a nice surprise for some of you. Liverpool will not lean on him and are planning the season without him, as they should with a 22-year-old and a serious knee. But the language around him has changed from lost year to a matter of weeks, and Frimpong has been holding the flank alone", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p492777.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool.com", title: "Istanbul, not Jeddah: Besiktas reported at verbal terms with Mohamed Salah as agent Ramy Abbas denies any club has been agreed", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Official: Dominik Szoboszlai signs a new five-year contract at Anfield running to 2031", time: "today", category: "official" },
  { source: "ESPN", title: "Twenty-four hours to MetLife: Mac Allister set to start in Argentina's midfield three against an unbeaten Spain", time: "today", category: "major" },
  { source: "TeamTalk", title: "'Off limits': PSG harden on Bradley Barcola and price any change of heart at a British-record £127.5m", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Curtis Jones shuts down reported Nottingham Forest agreement with a single raised-eyebrow emoji", time: "today", category: "fan" },
  { source: "Football365", title: "Arsenal framed as top of the Barcola race as reports claim the PSG winger has cooled on an Anfield move", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Conor Bradley 'not a million miles away': David Lynch says the right-back targets a return soon after the season starts", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Szoboszlai's new terms reported in the £200,000-£250,000 band after being voted players' player of the season", time: "1d ago", category: "official" },
  { source: "TeamTalk", title: "Koln growing confident of keeping Said El Mala for another year despite Liverpool and Newcastle interest", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Chicago the base, Nashville the opener: Van Dijk, Isak, Wirtz, Gravenberch and Gakpo expected for the USA tour", time: "1d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Josh Abe called into first-team training as Iraola pulls the U21s into pre-season work", time: "2d ago", category: "fan" },
  { source: "Sports Mole", title: "Nusa gettable at €60m as Leipzig need a major sale, having already kept Liverpool from Yan Diomande", time: "2d ago", category: "fan" },
  { source: "Rush The Kop", title: "Ekitike, Leoni and Jaros still sidelined as Iraola opens pre-season with a thin senior group at Kirkby", time: "3d ago", category: "fan" },
  { source: "This Is Anfield", title: "Van Dijk not for sale at any price as AC Milan redraw their plan around a free transfer in 2027", time: "3d ago", category: "major" },
];
