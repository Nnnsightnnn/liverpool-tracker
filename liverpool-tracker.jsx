...
const LATEST_NEWS = [
  { source: "CaughtOffside", title: "Ben Jacobs: Liverpool ready to sell Wataru Endo in January as Iraola makes his first ruthless call", time: "today", category: "major" },
  { source: "Football365", title: "'Iraola clearly doesn't fancy him' - FSG to sanction January exit for one of Klopp's last signings", time: "today", category: "major" },
  { source: "Empire of the Kop", title: "Liverpool believe they have a 'future world-beater' in Rio Ngumoha and want the deal done inside a month", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "No new injuries as a 25-man squad trains at the AXA, with Van Dijk, Wirtz and Tsimikas back in", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Iraola on Endo: 'in front of him in his position, I have a lot of players'", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Szoboszlai names two Liverpool youngsters who 'deserve to play' after the Tottenham win", time: "today", category: "fan" },
  { source: "beIN Sports", title: "Klopp calls up 44 players across two Germany squads, with Florian Wirtz among the midfielders", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Friday: watch Andoni Iraola's pre-Bournemouth press conference live at 1.30pm", time: "today", category: "official" },
  { source: "Sportskeeda", title: "Endo's contract expires in 2027, making January the last window Liverpool can recover a fee", time: "today", category: "major" },
  { source: "NBC Sports", title: "Bournemouth team news: Araujo out to late November, Kroupi to early November, Milosavljevic first back", time: "today", category: "major" },
  { source: "The Athletic", title: "Ornstein: no Ngumoha agreement as things stand, with Arsenal and Bayern both admirers", time: "1d ago", category: "major" },
  { source: "Squawka", title: "The alternative table: Liverpool concede the fewest expected goals per game in the Premier League", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Genk sporting director on the £30m teenage goalkeeper: 'Never saw that coming'", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Bournemouth return: Iraola faces the club he took into Europe for the first time on Sunday", time: "2d ago", category: "fan" },
];
