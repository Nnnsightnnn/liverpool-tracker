...
const LATEST_NEWS = [
  { source: "Fabrizio Romano", title: "Here we go: Inter agree deal to sign Curtis Jones, €35m package, medical being planned", time: "today", category: "major" },
  { source: "Anfield Index", title: "Liverpool accept Inter's €35m offer for Jones after holding out toward €40m", time: "today", category: "fan" },
  { source: "Sky Sports", title: "PSG soften on Barcola valuation as Liverpool's near-£98m offer moves back into play", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Iraola's Como 90 minutes hint at six Newcastle starters as recovered names fold in", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Newcastle injury blow: Joelinton ruled out of Sunday's opener against Liverpool", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Gakpo now expected to stay and start on the left at St James' Park", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Isak set for a hostile St James' return in red as both clubs remember Keegan", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Gomez targets the August 29 Forest return after being ruled out of Newcastle", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Ekitike pictured using a cane as a festive-period comeback is targeted", time: "2d ago", category: "fan" },
  { source: "FotMob", title: "Elliott weighs Sunderland and Leeds against a World Cup place as Endo nears the exit", time: "2d ago", category: "fan" },
  ...
  { source: "Sky Sports", title: "FSG's minority-stake sale to the Bezos-Bhatia consortium settles into context", time: "6d ago", category: "official" },
