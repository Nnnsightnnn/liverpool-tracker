...
const LATEST_NEWS = [
  { source: "David Ornstein / TeamTalk", title: "Liverpool 'firmly in the driving seat' for Yan Diomandé: an improved second bid around €115m is loading after the €100m rejection, with player buy-in said to have FSG 'in dreamland' and PSG behind", time: "today", category: "major" },
  { source: "ESPN / Sky Sports", title: "Netherlands 5-1 Sweden in Houston: Cody Gakpo scores twice and Crysencio Summerville once as Van Dijk's Dutch set a World Cup-record 14-game unbeaten run, Isak's Sweden routed", time: "today", category: "fan" },
  { source: "This Is Anfield / Read Liverpool", title: "Curtis Jones agrees personal terms with Inter on a five-year deal to 2031, the clubs still apart on a ~€25m-plus-sell-on fee against Liverpool's €30m ask, fresh meeting set for next week", time: "today", category: "major" },
  { source: "live4liverpool / This Is Anfield", title: "Diomandé personal terms 'no issue': Liverpool ready to put £180,000-a-week on the table as Leipzig hold out for a fee nearer €130m", time: "today", category: "fan" },
  { source: "Football365 / Turkish Football", title: "Salah to Fenerbahce: former board member says a framework was agreed before the elections, with re-elected president Aziz Yıldırım now to greenlight a three-year deal worth around €12-13m a season", time: "1d ago", category: "major" },
  { source: "Liverpool.com / Anfield Watch", title: "Van de Ven door looks shut: Tottenham rate the Dutch defender untouchable and Liverpool are 'not actively pursuing', Hughes keeping the centre-back search on Inácio and Ordóñez", time: "1d ago", category: "fan" },
  { source: "Fabrizio Romano / This Is Anfield", title: "Munoz settles in: the €40m (£34.7m) Osasuna winger, the window's first arrival, signed for six years after Liverpool hijacked a near-done Newcastle move", time: "2d ago", category: "official" },
  { source: "ESPN / Sports Mole", title: "Fixtures out: Iraola handed a daunting opener away at Newcastle on Sunday August 23, Liverpool's first season since 2017-18 without Salah and Robertson", time: "2d ago", category: "official" },
  { source: "ClutchPoints / OneFootball", title: "Inácio stays the cleanest centre-back route on a ~£52m clause; Brugge's Ordóñez the value alternative as Hughes works a four-man board", time: "2d ago", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season map: Iraola's first look begins with newly promoted Sunderland at Geodis Park, Nashville, on July 25 before the US tour", time: "3d ago", category: "fan" },
  { source: "Liverpool.com / GiveMeSport", title: "Gakpo stays in demand but the club resist a sale, the Dutchman lingering as a possible Leipzig swap chip even as Liverpool insist they want to add up front", time: "3d ago", category: "fan" },
  { source: "Empire of the Kop / Liverpool FC", title: "Ekitike's long road back: a ruptured Achilles points to a festive-period return at best, the absence that keeps the striker-search file open", time: "4d ago", category: "fan" },
  { source: "This Is Anfield / Anfield Watch", title: "Mac Allister's camp again push back on exit talk, even as Liverpool stay quietly open to a sale near €120m to fund the midfield reshape", time: "5d ago", category: "fan" },
  { source: "GiveMeSport / Managing Madrid", title: "Konaté's free move to Real Madrid sealed, the centre-back vacancy still the spine of Hughes's summer search", time: "1w ago", category: "major" },
];
