...
const PLAYERS = [
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Fri Jun 26 — the finale, then the decision: Salah, who scored and set one up in Sunday's 3-1 of New Zealand, faces Iran in Seattle with Egypt top of Group G and a knockout place on the line. Off the pitch the field narrows: The National now frames Saudi Arabia as the frontrunner, the captain said to have given conditional approval, while Fenerbahce keep a three-year offer framed. A free agent on June 30, the Anfield chapter closed, the final word waits on the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
  { id: 22, name: "Cody Gakpo", number: 18, position: "FWD", nationality: "🇳🇱 Netherlands", age: 25, appearances: 39, goals: 9, assists: 6, cleanSheets: null, xG: 7.1, tacklesPer90: 0.8, passCompletion: 81, progressiveCarries: 2.5, form: 6.8, status: "fit", injuryNote: "Wed Jun 24 — the exit cools: fresh reporting calls a departure 'highly improbable' and stresses Gakpo has not asked to leave, with Liverpool insistent they want to add to the front line rather than thin it despite the lingering Leipzig-swap talk. He started for the Netherlands in the 2-2 with Endo's Japan; a nine-goal forward the rebuild would rather build around than lose", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p243298.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool FC / Football365", title: "Personal terms agreed: Liverpool 'one step' from a record Diomandé deal as Leipzig's ~£128m valuation would beat Isak's £125m PL high", time: "today", category: "major" },
  { source: "This Is Anfield / Empire of the Kop", title: "Right-back hunt heats up: Liverpool 'offered' Atalanta's Marco Palestra as Chelsea move first with a £47m-plus bid he has yet to approve", time: "today", category: "major" },
  { source: "Al Jazeera / The National", title: "Salah meets Iran in Seattle with a knockout place on the line as Saudi Arabia firms as frontrunner over a framed Fenerbahce offer", time: "today", category: "fan" },
  { source: "Football365", title: "Liverpool pull the plug on a separate forward pursuit after the Diomandé agreement, consolidating around the deal closest to done", time: "today", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Iraola's first pre-season confirmed: a US tour against Sunderland, Wrexham and Leeds before an August 23 opener at Newcastle", time: "1d ago", category: "official" },
  { source: "Anfield Watch / ESPN", title: "Camavinga stays on the midfield board: Madrid willing near £52m, but the France international is reported reluctant to leave", time: "1d ago", category: "fan" },
  { source: "The Telegraph / Sky Sports", title: "Jones staying: Liverpool rebuff a second Inter bid worth ~€25m against a £35m valuation and signal no interest in dealing", time: "1d ago", category: "major" },
  { source: "Liverpool.com / Empire of the Kop", title: "Gakpo exit 'highly improbable' despite De Zerbi's Tottenham interest; the nine-goal Dutchman stays firmly in Iraola's plans", time: "2d ago", category: "fan" },
  { source: "NewsNow / TransferFeed", title: "Bartishvili on the radar: Liverpool and Arsenal track the young Georgian as a longer-list contingency", time: "2d ago", category: "fan" },
  { source: "Al Jazeera / ESPN", title: "Konaté switch confirmed: Real Madrid announce the centre-back to 2030 as their third signing, unveiling held until after the World Cup", time: "2d ago", category: "official" },
  { source: "Liverpool.com / Sportingpedia", title: "Mac Allister the sell-to-buy lever: no extension talks open as Liverpool would listen near €120m to fund the reshape", time: "4d ago", category: "fan" },
  { source: "ESPN / This Is Anfield", title: "Victor Munoz hit by a fresh muscle injury, ruled out of Spain's remaining World Cup group games; first sight in red slips to pre-season", time: "4d ago", category: "official" },
  { source: "TeamTalk / ESPN", title: "Nmecha a cheaper midfield contingency: Liverpool and Man Utd ask Dortmund, but his ~£69m clause only opens next summer", time: "5d ago", category: "fan" },
];
