...
const LATEST_NEWS = [
  { source: "Empire of the Kop", title: "Liverpool open official PSG talks and table first Barcola bid worth over £85m", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "Romano: Barcola to Liverpool not imminent 'here we go' as PSG hold near €170m but expected to compromise", time: "today", category: "major" },
  { source: "BBC Sport", title: "Liverpool step up move for Crystal Palace's Marc Guehi with the window closing in", time: "today", category: "major" },
  { source: "Anfield Watch", title: "Iraola confirms World Cup winner Victor Munoz will cut short his break and fly into Liverpool next week", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Liverpool decide against reviving the €100m Yan Diomande deal despite intermediary approach", time: "today", category: "fan" },
  { source: "GiveMeSport", title: "Liverpool make initial contact with AC Milan over Fikayo Tomori as the cheaper centre-back route", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Inter Milan believe they are signing Curtis Jones as the £30m-£35m gap narrows", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Salah nears Trabzonspor agreement on a reported €17m salary, but the deal is not yet signed", time: "1d ago", category: "major" },
  { source: "Sports Mole", title: "Gakpo open to Tottenham move after positive talks as Liverpool insist he is not for sale cheaply", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Pundits urge Liverpool to weigh a Trent Alexander-Arnold reunion after one season at Real Madrid", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Monaco visit Anfield on Sunday for Iraola's first home dugout, a 2.30pm kick-off and a reunion 21 years on", time: "2d ago", category: "official" },
