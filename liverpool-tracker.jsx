...
const PLAYERS = [
  // ── Goalkeepers ───────────────────────────────────────────────────────────
  { id: 1, name: "Alisson Becker", number: 1, position: "GK", nationality: "🇧🇷 Brazil", age: 33, appearances: 32, goals: 0, assists: 0, cleanSheets: 10, xG: 0, tacklesPer90: 0, passCompletion: 82, progressiveCarries: 0.2, form: 6.5, status: "recovering", injuryNote: "Wed May 20 — Liverpool FC official Wed-morning fitness tracker has the Brazilian back in FULL training at Kirkby after stepping up Tuesday; Slot 'hopeful' for the Sun May 24 finale after 11 straight games out. Schira's Thursday line — 'agreed €15m deal' to Juventus on €5m-a-year personal terms — holds into Wed alongside Sky Sports' fresh Lucas Chevalier scouting line. Brentford could be his Anfield send-off if he passes Friday's fitness check", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p116535.png" },
...
const LATEST_NEWS = [
  { source: "ESPN / Sky Sports / VAVEL", title: "BOURNEMOUTH 1-1 MAN CITY (Vitality, last night): Junior Kroupi 39' for the Cherries, Haaland 90+5' for City — the draw confirms Arsenal as champions BUT, critically for Liverpool, leaves Bournemouth on 62 points with one to play and Liverpool's 65-point cushion essentially seals top five before Sunday", time: "today", category: "major" },
  { source: "Football365 / TeamTalk / Yahoo Sports", title: "FSG 'U-turn' confirmed Wed AM: Liverpool now 'discussing' four Slot replacements after Salah outburst 'triggered' a rethink — Graeme Bailey reports 'very serious concerns', Romano holds the line that there's no sack before the Brentford finale but a 'review thereafter'", time: "today", category: "major" },
  { source: "Liverpool.com / This Is Anfield", title: "Conte ENTERS the Slot-replacement frame: Italian's abrupt Napoli exit announced overnight Tuesday, Wed AM wires add him to Iraola, Nagelsmann, Hoeness and Jaissle on FSG's discussed shortlist — Caught Offside says Liverpool 'now have a new candidate'", time: "today", category: "major" },
  { source: "Liverpool FC / Liverpool.com", title: "Pre-Brentford fitness tracker (Wed): Alisson, Isak and Frimpong all back in full training at Kirkby this morning — Slot 'hopeful' on all three for Sun May 24 finale per the club's own update; team news firms at Friday's presser", time: "today", category: "official" },
  { source: "Liverpool.com / Per Second News", title: "Mark Schwarzer on BBC Match of the Day: 'It just shows you things are not right at the club' — Wed AM punditry stacks add the ex-Premier League keeper's verdict to the Gerrard line, with five days to the farewell and FSG still publicly silent", time: "today", category: "fan" },
  { source: "Sky Sports / The Athletic", title: "Liverpool 'most interested' in PSG's Lucas Chevalier as Alisson replacement — 24-year-old 'long monitored' by Liverpool scouts, story moves on Wed alongside Schira's Juventus-Alisson €15m / €5m-a-year personal-terms line", time: "today", category: "major" },
  { source: "Liverpool FC / This Is Anfield / Liverpool.com", title: "UNVEILED YESTERDAY 9am BST: adidas 2026-27 home kit inspired by the iconic 1989-90 title-winning shirt — geometric pattern returns, deep-red shorts and socks, paired with a green 'LFC heritage' goalkeeper kit; on sale via LFC Store", time: "1d ago", category: "official" },
  { source: "SportBible / This Is Anfield", title: "Rooney's Sunday verdict still ringing: 'I'd put Salah on the bench' for the Anfield farewell — the ex-Manchester United captain's line cycled through Tuesday's papers and into Wed's selection-debate columns; Slot still expected to start the Egyptian", time: "2d ago", category: "fan" },
  { source: "Caught Offside / SI / beIN Sports", title: "17 past and present Liverpool players have now liked Salah's anti-Slot post — Konaté, Wirtz and Gakpo joined the original SportBible nine on Monday; SI labels it 'a brutal swipe' that pits players, fans and legends against each other", time: "2d ago", category: "fan" },
  { source: "TNT Sports / This Is Anfield / Tribuna", title: "Steven Gerrard's 'damning' verdict on Slot: 'Identity's gone' — the Liverpool icon's TNT Sports intervention remains the line punditry has coalesced around; consensus on Slot has narrowed sharply across the week", time: "3d ago", category: "major" },
  { source: "Al Jazeera / ITV / Euronews / Liverpool.com", title: "CONFIRMED Sunday: Chelsea appoint Xabi Alonso as new manager on a four-year deal starting July 1 — ex-Real Madrid boss snubs a 'wait for Liverpool' play, ends FSG's most-discussed Plan B and leaves the replacement market suddenly thin", time: "3d ago", category: "major" },
  { source: "Liverpool.com / Goal.com", title: "Salah takes 'another swipe' at Slot in second social-media post — beIN Sports' Sunday-night carry has the Egyptian doubling down on Saturday's bombshell; the manager-vs-talisman frame for Sunday's farewell is hardening by the hour", time: "3d ago", category: "major" },
  { source: "Sky Sports / NBC Sports / ESPN", title: "Aston Villa 4-2 Liverpool: Watkins brace, Rogers and McGinn fire Emery's side to Champions League as Slot's team ripped apart — Van Dijk's two headers (52', 90+) the lone reply on a night that dropped the Reds to 5th", time: "5d ago", category: "major" },
  { source: "Anfield Watch / FootballTransfers", title: "Alisson Becker 'agrees €15m deal' to leave Liverpool — Nicolò Schira pegs the personal terms at €5m a year on a Juventus contract as the Brazilian's Anfield exit firms up after an 11th straight game absent", time: "6d ago", category: "fan" },
