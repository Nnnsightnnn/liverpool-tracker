...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Official: Liverpool sign Lucca Brughmans, the 18-year-old Genk goalkeeper, and loan him straight back until 2027", time: "today", category: "official" },
  { source: "Sports Mole", title: "Reds confirm £30m signing and immediate loan exit of 6ft 7in goalkeeper as the window closes", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Liverpool fail in late deadline-day loan bid for Chelsea defender Malo Gusto", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool reject £30m Nottingham Forest bid for Trey Nyoni and move to open contract talks", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Reds see off late Arsenal and Real Madrid challenge to sign 6ft 7in giant in £30m deal", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Liverpool fail with final desperate push to sign Chelsea defender as Chelsea insist on a permanent sale", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Cody Gakpo holds air-clearing talks with the owners and stays at Anfield", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Federico Chiesa's father shuts down Liverpool exit rumours on deadline night", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Stefan Bajcetic completes permanent transfer to Celta Vigo for £1.3m with a buy-back retained", time: "today", category: "official" },
  { source: "TeamTalk", title: "Liverpool let go of 149-game star as two deadline-day loan exits are confirmed: Elliott and Figueroa", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Every incoming and outgoing deal Liverpool completed on an extremely quiet transfer deadline day", time: "today", category: "fan" },
  { source: "Rousing The Kop", title: "Why Liverpool's non-homegrown quota is not an excuse for failing to make a deadline-day signing", time: "today", category: "fan" },
  { source: "The Athletic", title: "Joe Gomez completes full training and targets an Ipswich return as an unreinforced back line waits", time: "today", category: "major" },
  { source: "Sky Sports", title: "Barcola registered and in line for a debut at Portman Road on Friday", time: "1d ago", category: "official" },
  { source: "ESPN", title: "Liverpool 13th as the market closes, a place and a point below Friday's hosts Ipswich Town", time: "today", category: "major" },
