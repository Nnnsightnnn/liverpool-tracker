...
const LATEST_NEWS = [
  { source: "Sports Mole", title: "Matchday-eve: pointless Fulham at Anfield on Saturday at 3pm, Liverpool chasing a third straight win to climb from sixth", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Gakpo the lone doubt for Fulham: 'I don't know. I hope so, but I don't know,' Iraola says of the adductor", time: "today", category: "fan" },
  { source: "The 4th Official", title: "Predicted XI: Barcola keeps the right, Ngumoha or a rested Munoz covers the left if Gakpo fails a late test", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Fulham team news: Cairney out with the knee; Arbeloa likely to keep his Palace XI, Bobb and King the wide threat", time: "today", category: "major" },
  { source: "ESPN", title: "Isak carries the line into Fulham: three league goals in three, a first Anfield goal in red still owed", time: "today", category: "major" },
  { source: "Opta Analyst", title: "The comeback habit: Liverpool behind first in three of four, and Fulham made 3.13 xG in losing to Palace", time: "today", category: "fan" },
  { source: "Yahoo Sports", title: "Iraola still without a net: Hughes gone to Al-Hilal, no sporting director named three games in", time: "1d ago", category: "major" },
  { source: "Football365", title: "January watch holds: City's £31m Ait-Nouri and Palace's Wharton the winter names Liverpool keep circling", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Ornstein holds the line: a change of ownership 'in the next year or two' after FSG's 38% sale to 1892 Holdings", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Player ratings, revisited: Mac Allister a 9 and man of the match, Araujo an 8 for the backheel assist", time: "2d ago", category: "fan" },
  { source: "Opta Analyst", title: "Two days on: the 2-1 over Atletico, 1.68 xG to 0.81, was the first Liverpool win earned on chances", time: "2d ago", category: "fan" },
  { source: "VAVEL", title: "Anfield record: Fulham winners just twice in 32 league visits, and never yet arriving pointless", time: "2d ago", category: "fan" },
  { source: "Goal", title: "Fulham booed off after a third straight defeat; only twice before have they opened a season with three losses", time: "4d ago", category: "major" },
];
