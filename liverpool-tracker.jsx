...
const LATEST_NEWS = [
  { source: "This Is Anfield", title: "Saturday training update: Kerkez back on the grass, Alisson NOT spotted outdoors at AXA — Woodman primed to keep gloves at Old Trafford", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "LFC predicted XI vs Man United: Winger dilemma, Curtis Jones starts at RB, Wirtz pulls strings with Salah out", time: "today", category: "fan" },
  { source: "Sports Mole", title: "'No Mo and no Alisson' predicted Liverpool XI vs Man United — Woodman keeps the gloves, Frimpong to RW", time: "today", category: "major" },
  { source: "3 Added Minutes", title: "Liverpool predicted line-up vs Man Utd: Slot sweating over Alisson and Kerkez fitness on matchday-1", time: "today", category: "major" },
  ...
  { source: "This Is Anfield", title: "FSG back Arne Slot for third season at Liverpool amid 'harsh' criticism — Champions League spot the explicit lever", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Arne Slot future: Liverpool boss expected to stay at Anfield next season as club close in on Champions League qualification", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Every word Arne Slot said in his pre-Man Utd press conference — Salah, Alisson, injury news and Alexander Isak form", time: "1d ago", category: "major" },
  ...
  { source: "Sky Sports", title: "Mohamed Salah ruled out of Man Utd clash with hamstring injury — club expect Egyptian back before end of season for Anfield farewell", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Liverpool's 'dream' summer transfer window: $108m PSG target arrives, Barcelona battle and Wharton secured", time: "1d ago", category: "major" },
  ...
  { source: "FourFourTwo", title: "Mohamed Salah set to announce next club within days — Egypt national team staff member reveals decision is locked in", time: "2d ago", category: "major" },
  { source: "Empire of the Kop", title: "Romano: Curtis Jones could copy McTominay's Napoli playbook if he leaves Liverpool — Inter Milan circling, 14 months left on deal", time: "3d ago", category: "fan" },
  { source: "This Is Anfield", title: "Liverpool 3-1 Crystal Palace match report: Up to 4th as Isak and Wirtz score in vital top-five push", time: "1w ago", category: "fan" },
];
