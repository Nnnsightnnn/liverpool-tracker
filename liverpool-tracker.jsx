...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Isak's scoring form continues: a 20th-minute opener in Sweden's 2-1 win over Romania", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Szoboszlai and Kerkez play 90 in Hungary's 1-0 defeat to Ukraine; Barcola on late as France win in Turkiye", time: "today", category: "official" },
  { source: "Empire of the Kop", title: "Trey Nyoni believes Iraola 'probably' sees him primarily as a six", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Mamardashvili's Georgia beaten by a 99th-minute Northern Ireland winner; Nyoni plays 90 for England U20s", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Isak and Jacquet shortlisted for September's Premier League Player of the Month", time: "1d ago", category: "official" },
  { source: "CaughtOffside", title: "Manchester United complete surprise raid on Liverpool for 16-year-old Isaac Konde", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Rio Ngumoha reveals the extra tool Iraola has given him to 'destroy defenders'", time: "1d ago", category: "fan" },
  { source: "ESPN", title: "Netherlands 1-1 Germany: Gakpo's stoppage-time volley denies Klopp a winning debut", time: "1d ago", category: "major" },
  { source: "Read Man City", title: "Haaland leads the first Man City players into international action", time: "1d ago", category: "fan" },
  { source: "Anfield Index", title: "Andoni Iraola nominated for Premier League Manager of the Month for September", time: "1d ago", category: "major" },
  { source: "Nehanda Radio", title: "Injury heartbreak for Liverpool youngster Isaac Mabaya as Warriors debut is delayed", time: "2d ago", category: "major" },
  ...
  { source: "This Is Anfield", title: "Alisson left out of Brazil squad for September, a major boost for Liverpool", time: "2w ago", category: "fan" },
];
