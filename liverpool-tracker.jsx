...
const PLAYERS = [
  ...
  { id: 17, name: "Wataru Endo", number: 3, position: "MID", nationality: "🇯🇵 Japan", age: 33, appearances: 14, goals: 0, assists: 1, cleanSheets: null, xG: 0.3, tacklesPer90: 3.1, passCompletion: 87, progressiveCarries: 1.2, form: 6.2, status: "doubtful", injuryNote: "Sat Jul 4 — the comeback broke down: the foot injured at Sunderland in February flared in the May 31 Iceland warm-up, and in mid-June Japan's captain withdrew from the World Cup squad and retired from international football after 73 caps. He reports on July 13 with a point to prove and a likely summer sale to negotiate", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p158983.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "PSG open talks with Leipzig for Yan Diomande after the winger agrees five-year personal terms in Paris", time: "today", category: "major" },
  { source: "TeamTalk", title: "Exclusive: Barcola has made his decision, telling PSG he intends to leave after fresh talks with Liverpool's recruiters", time: "today", category: "major" },
  { source: "Football365", title: "Liverpool officials 'travel to France' over the winger chase, ready to pounce if the Diomande-PSG deal hiccups", time: "today", category: "major" },
  { source: "Football365", title: "Van Dijk 'very close' to Galatasaray after 'positive' agent talks, per reports Liverpool's orbit calls wide of the mark", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "'Going nowhere': Iraola's feelings on Van Dijk made clear as the captain's 35th birthday arrives on Wednesday", time: "today", category: "fan" },
  { source: "Goal", title: "'Yes, I can confirm the talks': Klopp goes public on the DFB approach, with New York talks reported for next week", time: "1d ago", category: "major" },
  { source: "Empire of the Kop", title: "Open to Anfield: Chelsea's Pedro Neto 'would jump at' a Liverpool move as Mendes talks are held", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "From Spain: Liverpool linked with Almeria's 25-goal attacking midfielder Sergio Arribas", time: "1d ago", category: "fan" },
  { source: "Squawka", title: "Argentina open at -275 for Tuesday's noon meeting with Egypt in Atlanta; Messi leads the Golden Boot on seven", time: "today", category: "fan" },
  { source: "Football365", title: "Liverpool prepare a first Tillman bid as reporting splits on Leverkusen's price, from a £25m opener to beyond £43m", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Confirmed: Elphick, Cooper, de la Torre and Webber complete Andoni Iraola's new-look backroom staff", time: "1d ago", category: "official" },
  { source: "DaveOCKOP", title: "Jones and Forest cool further: if the midfielder leaves at all it would be for Inter, Arsenal or Villa, per reports", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Pre-season in view: eight days until Iraola's first Kirkby session, twenty until Sunderland in Nashville", time: "today", category: "fan" },
];
