...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Barcola left out by PSG again as Liverpool grow 'hopeful' of sealing the winger this week", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Liverpool lodge a third bid worth around £68m for Yankuba Minteh as Brighton talks close in", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "Done deal: Calvin Ramsay joins St Mirren on a season-long loan, ending his Anfield career", time: "today", category: "major" },
  { source: "TeamTalk", title: "FSG ready to sanction up to eight Liverpool exits before the September 1 deadline", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Chiesa a doubt for Forest after missing Newcastle with a fitness issue", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Gomez steps up his recovery and is an outside chance to face Forest on Saturday", time: "today", category: "official" },
  { source: "UEFA", title: "Liverpool confirmed in Pot 1 for Thursday's Champions League league-phase draw in Monaco", time: "today", category: "official" },
  { source: "Goal", title: "Iraola eyes a first Anfield win as Forest visit on Saturday for the season's first home night", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "Isak targets a first goal of the Iraola era at Anfield after a hostile Newcastle blank", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Ngumoha set for a new five-year deal as he turns 18 on Saturday, the day Forest visit", time: "1d ago", category: "fan" },
  { source: "BBC Sport", title: "The post-Salah penalty question lingers over Liverpool after Szoboszlai's Newcastle spot-kick", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Newcastle 2-2 Liverpool: Szoboszlai's stoppage-time penalty rescued Iraola's opening day", time: "2d ago", category: "major" },
  { source: "ESPN", title: "Curtis Jones settles at Inter as the last Scouser's €35m San Siro move beds in", time: "3d ago", category: "major" },
