...
const LATEST_NEWS = [
  { source: "Liverpool.com / This Is Anfield", title: "Mohamed Salah's BOMBSHELL Instagram statement slams Slot's 'ponderous' style and calls for return to Klopp's 'heavy metal football' — 'I want to see Liverpool go back to being the team opponents fear' as outgoing No. 11 publicly takes aim at the manager", time: "today", category: "major" },
  { source: "SportBible / JOE / SportsJoe", title: "DRESSING-ROOM REVOLT: Szoboszlai, Robertson, Kerkez, Ekitike, Endo, Leoni, Frimpong and Calvin Ramsay all LIKE Salah's anti-Slot post — Curtis Jones leaves a clapping emoji, then posts his own 'way off standards' statement", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Trent Alexander-Arnold reacts to Salah's 'yet another defeat' post with a 🐐 emoji — ex-No. 66 sends solidarity message from Madrid as the Anfield dressing room publicly aligns with the departing Egyptian", time: "today", category: "major" },
  { source: "SportBible / TalkSPORT", title: "Steven Gerrard offers BLEAK verdict on Salah's Instagram antics — Liverpool icon weighs in on the post that's torn open the FSG-Slot peace and tells Saturday-night audiences 'this isn't the way' to leave the club", time: "today", category: "fan" },
  { source: "Liverpool.com / Per Second News", title: "Slot under fresh siege as 'crumbling Liverpool' narrative dominates Sunday papers — Salah's social-media call for change leaves the manager defending himself on TWO fronts (FSG above, dressing room beside) heading into the Brentford finale", time: "today", category: "major" },
  { source: "Liverpool.com / ESPN", title: "Champions League math, Sunday lunchtime: Liverpool need a Brentford win OR Bournemouth/Chelsea to drop points — Bournemouth host Manchester City this afternoon, the Reds' top-five fate could be decided before they kick on May 24", time: "today", category: "major" },
  { source: "Football365 / Sky Sports", title: "Carragher reignites Slot critique on Sunday Supplement — 'showing signs of a man buckling' becomes 'the dressing room has lost him' as the pundit responds to the Salah-Trent-Jones cascade", time: "today", category: "fan" },
  { source: "Sky Sports / NBC Sports", title: "Aston Villa 4-2 Liverpool: Ollie Watkins brace fires Unai Emery's side to Champions League as Slot's team ripped apart — Rogers 43', Watkins 57' & 73', McGinn for Villa; Van Dijk 52', 90+ for the Reds", time: "2d ago", category: "major" },
  { source: "Liverpool FC / NBC Sports", title: "Slot post-match: 'damaging — three out of four from set pieces' as the manager calls the defeat 'damaging' and again insists 'I have every reason to believe I am the Liverpool manager next season'", time: "2d ago", category: "official" },
  { source: "Goal.com / SI", title: "Liverpool player ratings vs Aston Villa: 'Wretched Reds routed by Watkins & Co. despite best efforts of teenager Rio Ngumoha' — Van Dijk's 8/10 the lone bright spot in a 4-2 defeat that drops Liverpool to 5th", time: "2d ago", category: "major" },
  { source: "ESPN / Sports Mole / SI", title: "Alexander Isak ruled out of Villa Park with a 'minor injury' — Slot at kickoff: 'Indeed, Alex is out — minor injury,' Liverpool 'hopeful' for the Brentford home finale May 24", time: "2d ago", category: "major" },
  { source: "This Is Anfield / RotoWire", title: "Jeremie Frimpong added to the injury list — Joe Gomez stepped in at RB for the Villa Park defeat as Slot's match-day inventory thinned further", time: "2d ago", category: "major" },
  { source: "Liverpool FC", title: "Confirmed Liverpool line-up v Aston Villa — Mamardashvili; Gomez, Konate, Van Dijk, Kerkez; Gravenberch, Mac Allister; Jones, Szoboszlai, Gakpo; Ngumoha as Slot rolled out a 4-2-3-1 with the 17-year-old leading the line", time: "2d ago", category: "official" },
  { source: "Sky Sports / Inside World Football", title: "Xabi Alonso 'frontrunner' for Chelsea manager job — talks 'progress positively' as the ex-Bayer boss weighs the Stamford Bridge offer against waiting for Liverpool, FSG decision to stick with Slot puts him on the spot", time: "3d ago", category: "major" },
  { source: "Anfield Watch / FootballTransfers", title: "Alisson Becker 'agrees €15m deal' to leave Liverpool — Nicolò Schira pegs the personal terms at €5m a year on a Juventus contract as the Brazilian's Anfield exit firms up", time: "3d ago", category: "fan" },
  { source: "Liverpool.com", title: "Ibrahima Konaté contract 'stalemate' with Liverpool — sticking points over signing-on package and agent commissions, Real Madrid still circling as the Frenchman starts at Villa Park", time: "4d ago", category: "major" },
  { source: "ESPN / Anfield Index / Yahoo / RTÉ", title: "'Anything can happen … we'll see' — Joe Gomez breaks silence on his Liverpool future, admits he doesn't know if he'll still be at Anfield next season as he enters the final year of his deal", time: "4d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool 1-1 Chelsea: Boos for Arne Slot at Anfield as Blues end six-game Premier League losing streak — Gravenberch 6', Enzo Fernandez 35'", time: "1w ago", category: "major" },
];
