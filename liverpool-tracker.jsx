...
const PLAYERS = [
  ...
  { id: 10, name: "Giovanni Leoni", number: 33, position: "DEF", nationality: "🇮🇹 Italy", age: 18, appearances: 1, goals: 0, assists: 0, cleanSheets: 0, xG: 0, tacklesPer90: 0, passCompletion: 0, progressiveCarries: 0, form: 0, status: "injured", injuryNote: "Sun Jul 12 — nearing the end of it: ten months on from the ACL tear in September, he is reported to be closing on a comeback and is on site at the AXA with Endo, Bradley and Ekitike, none of whom have resumed outdoor work. Not for Nashville, but for the first time the timeline is being discussed in weeks rather than months", image: "https://r2.thesportsdb.com/images/media/player/cutout/8aws9t1766829004.png" }, /* Leoni - TheSportsDB cutout */
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Michael Edwards resigns as FSG's chief executive of football, a year early, and will not be replaced: Mike Gordon retakes football operations", time: "today", category: "major" },
  { source: "The Athletic", title: "Ornstein: sporting director Richard Hughes expected to join Al-Hilal once the transfer window closes, reuniting with Simon Francis", time: "today", category: "major" },
  { source: "ESPN", title: "Argentina 3-1 Switzerland (aet): Mac Allister heads in Messi's 10th-minute corner, Embolo sent off, England await in Atlanta", time: "today", category: "fan" },
  { source: "TeamTalk", title: "Nottingham Forest 'reach agreement' for Curtis Jones at around £40m, funded by City's £116m for Elliot Anderson", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Palace offer Adam Wharton to Real Madrid at £103m as Liverpool's interest cools: Anfield move now 'extremely unlikely'", time: "today", category: "major" },
  { source: "SportBible", title: "Europe back in play for Salah: Fenerbahce can match Gulf wages and offer UEFA football as the decision nears after Egypt's exit", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Carragher on Edwards' exit: Iraola has 'an impossible task' with no CEO of football and a sporting director halfway out the door", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Iraola's first press conference is 11am tomorrow at the AXA, with senior players reporting back and testing from Tuesday", time: "today", category: "official" },
  { source: "Fabrizio Romano", title: "Barcola exit a 'serious possibility' as the winger declines a new PSG contract, though Paris insist he is not for sale", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Jeremy Jacquet hands Liverpool a pre-season boost, training at the AXA alongside Elliott, Bajcetic and McConnell", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "Giovanni Leoni nearing a comeback ten months after his ACL tear, while Ekitike, Bradley and Endo remain indoors", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "No World Cup players before America: Wirtz, Van Dijk, Gravenberch, Gakpo and Isak due back ahead of Wrexham on July 30", time: "2d ago", category: "official" },
  { source: "Football365", title: "Mainz hold their €50-60m line on Kaishu Sano as Liverpool stay ahead of United and Arsenal for the Japan No. 6", time: "2d ago", category: "major" },
  { source: "Anfield Watch", title: "Monaco's Lamine Camara stays warm with Newcastle in the same room, but the executive who drove the deal has gone", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Three-stop US tour set: Sunderland in Nashville (Jul 25), Wrexham in New York (Jul 30), Leeds in Chicago (Aug 2)", time: "3d ago", category: "official" },
];
