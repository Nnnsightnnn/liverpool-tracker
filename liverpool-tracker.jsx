...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "'I want him to stay': Van Dijk goes public urging Liverpool to keep Gakpo from Manchester City", time: "today", category: "major" },
  { source: "ESPN", title: "Manchester City ready a formal offer worth up to 100m euros for Cody Gakpo before Tuesday's deadline", time: "today", category: "major" },
  { source: "TeamTalk", title: "Ismaila Sarr says yes and becomes the live one: Liverpool weigh a third bid after two Palace rejections", time: "today", category: "major" },
  { source: "Sky Sports", title: "Barcola's £123m move down to a signature as Ligue 1 shuts, No. 29 chosen, announcement to follow", time: "today", category: "major" },
  { source: "Football365", title: "Brighton hold firm at £80m for Minteh while Chelsea's £100m valuation of Neto reads too steep", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Gakpo tempted by the Etihad and City's title race, though no formal transfer request is confirmed", time: "today", category: "fan" },
  { source: "ESPN", title: "Liverpool 13th at the deadline, a place and a point below Friday's hosts Ipswich Town", time: "today", category: "major" },
  { source: "Gulf News", title: "Van Dijk on his own future: 'no deadline' on the decision, focus on the pitch", time: "today", category: "major" },
  ...
  { source: "Sky Sports", title: "Endo made available with Wolves, Fulham and West Ham told; Bajcetic closing on a Celta return", time: "1d ago", category: "major" },
  ...
  { source: "Sky Sports", title: "Liverpool 2-2 Nottingham Forest: Munoz's debut strike rescues a second straight draw at Anfield", time: "2d ago", category: "major" },
  { source: "The Independent", title: "Alex Scott £90m the midfield complication as Liverpool's pursuit looks set to slip to next summer", time: "2d ago", category: "major" },
  { source: "Liverpool.com", title: "'I cannot guarantee anything': Iraola declines to promise Gakpo will still be a Liverpool player", time: "3d ago", category: "fan" },
