...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Iraola on the eve of his Bournemouth return: meet them, hug them, then be ruthless", time: "today", category: "official" },
  { source: "Liverpool.com", title: "'I know their strengths, their weaknesses': Iraola on facing the side he built", time: "today", category: "major" },
  { source: "Sports Mole", title: "Bournemouth team news: Sinisterra a doubt, Adams a rest call after the Sociedad win", time: "today", category: "major" },
  { source: "inkl", title: "Predicted XI: Alisson back, Araujo at right-back, Kerkez trusted at left-back", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Three draws in four, and the Vitality is the last easy date before a cruel October", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Team news: the four out stay four as the squad travels south to Dorset", time: "today", category: "official" },
  { source: "Yahoo Sports", title: "Iraola on the opponent: 'not much has changed, Senesi out, Silva in, a similar player'", time: "today", category: "major" },
  { source: "BBC Sport", title: "Ngumoha reports to England after Sunday, his Liverpool contract still unsigned", time: "1d ago", category: "major" },
  { source: "Sports Illustrated", title: "Three games in, the 'under pressure' framing around Iraola will not go away", time: "1d ago", category: "fan" },
  { source: "beIN Sports", title: "Brentford 3-0 Chelsea sends the Bees third and reshapes Liverpool's run-in", time: "1d ago", category: "major" },
  ...
  { source: "Liverpool.com", title: "Iraola pushing Araujo to learn English so the back four can use his experience", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "No new injuries as a 25-man squad trains at the AXA before the trip to Dorset", time: "2d ago", category: "fan" },
];
