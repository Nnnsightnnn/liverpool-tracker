...
const PLAYERS = [
  ...
  { id: 25, name: "Rio Ngumoha", number: 48, position: "FWD", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 17, appearances: 13, goals: 2, assists: 2, cleanSheets: null, xG: 1.4, tacklesPer90: 0.3, passCompletion: 78, progressiveCarries: 3.5, form: 7.3, status: "fit", injuryNote: "Fri Aug 15 — still holding the berth while Paris is negotiated. Ngumoha keeps the post-Salah right-sided slot by default as the winger board reshapes: Barcola talks have gone club-to-club with Liverpool 'confident', while the cheaper Mbaye option is reported 'off' with Dortmund now ahead. The 17-year-old, youngest goalscorer in the club's history, held the spotlight through the Sunderland and Wrexham wins before the seniors returned, and is reported to have no intention of leaving. Until a senior winger signs, the shirt is his", image: "https://r2.thesportsdb.com/images/media/player/cutout/ay5j761773955893.png" },
...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "FSG sell strategic minority stake to a Bezos and Bhatia-led consortium", time: "today", category: "official" },
  { source: "Bloomberg", title: "Liverpool valued near $7bn as 1892 Holdings buys around a third of the club", time: "today", category: "major" },
  { source: "ESPN", title: "What the Bezos-Bhatia deal means: Bhatia in as vice-chairman, transfer plans unchanged", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "'Deal is on' as Barcola talks go club-to-club, Liverpool confident to deadline day", time: "today", category: "major" },
  { source: "CaughtOffside", title: "Tottenham step up Gakpo pursuit with Liverpool talks now underway", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Gakpo 'agrees Spurs deal': claims of a £60m-plus bid, sources deny agreement", time: "today", category: "fan" },
  { source: "Football365", title: "Mbaye move 'off' over PSG's demands as Dortmund move into pole", time: "1d ago", category: "major" },
  { source: "Liverpool.com", title: "Curtis Jones 'breakthrough' holds as Inter and Liverpool haggle over the figures", time: "1d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Jacquet, Jones and Mac Allister filmed in training before the Como double-header", time: "1d ago", category: "fan" },
  { source: "Liverpool FC", title: "Araujo set for his Anfield bow as Como close the pre-season on Sunday", time: "1d ago", category: "official" },
