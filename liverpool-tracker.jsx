...
const LATEST_NEWS = [
  { source: "Empire of the Kop", title: "Liverpool submit £85m opening bid for Bradley Barcola as club-to-club talks with PSG escalate", time: "today", category: "major" },
  { source: "FootballTransfers", title: "Besiktas issue statement denouncing reporter and denying a Salah contract is agreed, days after his unveiling was briefed for next week", time: "today", category: "major" },
  { source: "TeamTalk", title: "Inter Milan's third bid for Curtis Jones, around €32m, rejected as Liverpool hold out for £35m", time: "today", category: "major" },
  { source: "CaughtOffside", title: "PSG hold firm between £116m and £128m for Barcola as the France winger repeats he wants a bigger role elsewhere", time: "today", category: "major" },
  { source: "Anfield Watch", title: "Adam Wharton confirmed as Liverpool's top midfield target after the Reds turn down the chance to sign Joao Gomes", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Liverpool name initial 31-player squad for the USA tour, including eleven academy players", time: "today", category: "official" },
  { source: "This Is Anfield", title: "Ekitike, Bradley and Leoni fly to the USA for specialist rehab as Jayden Danns stays behind with a hamstring problem", time: "today", category: "fan" },
  { source: "Liverpool.com", title: "Iraola on Curtis Jones: 'For me he is a great, great player and I hope he can continue with us'", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Giovanni Leoni back running on the outdoor pitches at the AXA and closest of the long-term absentees to a return", time: "today", category: "fan" },
  { source: "FootballTransfers", title: "Joao Gomes closes on a £35m move to Aston Villa after Liverpool declined a deal he was willing to sign", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Minteh stays live at around £70m as Liverpool run a two-track approach to the right wing", time: "1d ago", category: "major" },
  { source: "This Is Anfield", title: "Who are Liverpool's 11 academy players on the USA pre-season tour?", time: "1d ago", category: "fan" },
  { source: "Turkiye Today", title: "Besiktas reach verbal agreement with Salah over one year at €10m plus €2m in bonuses, report claims", time: "1d ago", category: "major" },
  ...
  { source: "El Gol Digital", title: "Liverpool confident of a fee below Haissem Hassan's €12m clause at a relegated Real Oviedo, with Celtic circling", time: "3d ago", category: "fan" },
];
