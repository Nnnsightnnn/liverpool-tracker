...
const LATEST_NEWS = [
  { source: "ESPN", title: "Liverpool sign Arthur Melo on loan from Juventus: the deadline-day midfielder the club said would not come", time: "today", category: "official" },
  { source: "TeamTalk", title: "Upamecano signs fresh Bayern terms: Liverpool's two-window centre-back chase ends with nothing", time: "today", category: "major" },
  { source: "The Athletic", title: "Joe Gomez back in full training and targeting an Ipswich return as a thin back line leans on his fitness", time: "today", category: "major" },
  { source: "Sky Sports", title: "Arthur Melo passes medical on Merseyside: €4.5m loan fee, buy option disputed in the reporting", time: "today", category: "major" },
  { source: "Fabrizio Romano", title: "Here we go: Ifeanyi Ndukwe joins Levante on a season-long loan, the Spanish club covering his wage", time: "today", category: "major" },
  { source: "Rousing The Kop", title: "Mamardashvili stays as Alisson's deputy after a summer of loan offers nobody met on terms", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Alex Scott parked, not solved: Arthur's loan buys a year on the £90m midfield target", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Barcola registered and in line for a debut at Portman Road as the window shuts", time: "today", category: "official" },
  { source: "Liverpool.com", title: "Harvey Elliott completes Valencia loan on deadline day: no option to buy before June", time: "today", category: "major" },
  { source: "ESPN", title: "Liverpool 13th as the market empties, a place and a point below Friday's hosts Ipswich Town", time: "today", category: "major" },
  { source: "David Ornstein", title: "Gakpo stays and turns to Friday after Manchester City's £80m was rejected and the pursuit called off", time: "1d ago", category: "major" },
  ...
  { source: "This Is Anfield", title: "Eleven out, a record and a loan in: the final shape of Iraola's summer window", time: "today", category: "fan" },
  { source: "Sky Sports", title: "Liverpool 2-2 Nottingham Forest: Munoz's debut strike rescues a second straight draw at Anfield", time: "3d ago", category: "major" },
