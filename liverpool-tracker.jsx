...
const PLAYERS = [
  ...
  { id: 5, name: "Joe Gomez", number: 2, position: "DEF", nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England", age: 28, appearances: 19, goals: 0, assists: 1, cleanSheets: 5, xG: 0.2, tacklesPer90: 1.3, passCompletion: 88, progressiveCarries: 1.5, form: 5.9, status: "injured", outSince: "2026-07-25", injuryNote: "Sat Sep 5 — still the nearest return, and now the first name the next sporting director inherits. Nothing moved on Saturday: Gomez rejoins team training next week, per Iraola's Thursday timetable, and is likely to miss the Champions League opener against Atletico, with Fulham on the 12th the first realistic matchday and the manager hoping to have him before the September break. Richard Hughes stepped down on Saturday afternoon, so the department that waits for him answers, for now, to Ward, Woodfine and Marques. His absence looked different after Portman Road: Araujo started at right-back, so the position he would restore has two fit names rather than one. When he is back he gives a fourth senior centre-back and a third right-back option in one body; the muscle recovery from the 26 July Sunderland friendly 'has gone normally'", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p171287.png" },
...
const LATEST_NEWS = [
  { source: "Liverpool FC", title: "Liverpool FC statement: Richard Hughes steps down as sporting director, the process to appoint a successor under way", time: "today", category: "official" },
  { source: "Sports Mole", title: "Hughes leaves for Al-Hilal: Ward, Woodfine and Marques shortlisted as Liverpool look inside first for a replacement", time: "today", category: "major" },
  { source: "AFP", title: "Athletic Bilbao 3-0 Atletico Madrid: Williams, Navarro and Sancet inflict Simeone's first defeat four days before Anfield", time: "today", category: "major" },
  { source: "Get Spanish Football News", title: "'Are you really asking this question?': Simeone shuts down Alvarez talk as Atletico's own fans whistle him again", time: "today", category: "fan" },
  { source: "ESPN", title: "Liverpool slip to sixth without playing: Brentford's draw at Sunderland and City's 1-0 over Coventry reshuffle the top", time: "today", category: "major" },
  { source: "Sports Mole", title: "Opta: Gakpo's four goal involvements in three games second only to Salah for a Liverpool opening this century", time: "today", category: "major" },
  { source: "Sky Sports", title: "Hits and misses: Gakpo steals Barcola's thunder, Carragher says the new man 'is going to struggle to get a game'", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Alisson's 138th clean sheet moves him past Elisha Scott into fourth on the club's all-time list", time: "today", category: "official" },
  { source: "Liverpool FC", title: "Isak: 'It's still early, it's game by game', the striker on the quickfire double and the Gakpo connection", time: "today", category: "official" },
  { source: "Get Spanish Football News", title: "Jonathan David left out at Bilbao with a cervical contracture, per COPE; the Juventus loanee a doubt for Anfield", time: "today", category: "fan" },
  { source: "SI", title: "The best and worst signings made by Richard Hughes at Liverpool, ranked", time: "today", category: "fan" },
  { source: "live4liverpool", title: "'There's talk of Liverpool': Lescott hints at interest in free agent Carvajal, six Champions League medals and no window needed", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "Carlsberg Player of the Match: Isak takes the supporters' vote for the first time in a Liverpool shirt", time: "1d ago", category: "official" },
