...
const LATEST_NEWS = [
  { source: "Sky Sports", title: "Liverpool 1-0 Wrexham: Rio Ngumoha's switch to the right seals back-to-back Iraola wins in the Bronx", time: "today", category: "major" },
  { source: "Yahoo Sports", title: "Ngumoha strikes on 75 minutes as a young Liverpool see off Wrexham before 42,000 at Yankee Stadium", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Iraola holds Isak, Wirtz and Gravenberch back again, the trio now in line for the Leeds finale in Chicago", time: "today", category: "major" },
  { source: "Liverpool.com", title: "Five talking points: Nyoni, Ndukwe and Chambers impress as Harvey Elliott spurns a chance", time: "today", category: "fan" },
  { source: "This Is Anfield", title: "Federico Chiesa misses the Wrexham squad through illness, but avoids the injury list", time: "today", category: "fan" },
  { source: "ESPN", title: "Sources: Liverpool lodge an official €120m package for Bradley Barcola as PSG hold near £145m", time: "today", category: "major" },
  { source: "Goal", title: "Besiktas 'step away from the table': the Salah file shelved over image rights and agent commission", time: "today", category: "major" },
  { source: "TeamTalk", title: "Wharton 'eager' to join Iraola's Liverpool as Chelsea lurk and Elliott is floated as a makeweight", time: "today", category: "major" },
  { source: "TeamTalk", title: "Centre-back search drags on: Joel Ordonez back in focus a year after Guehi chose Manchester City", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Josh Abe handed a start as Iraola names another youthful XI in New York", time: "1d ago", category: "fan" },
  { source: "Liverpool.com", title: "Van Dijk set to make his pre-season bow in the Anfield friendly against Monaco on August 9", time: "2d ago", category: "fan" },
  { source: "Yahoo Sports", title: "Joao Gomes closing on Aston Villa after Liverpool declined the Wolves midfielder", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Paul Joyce: the captaincy race narrows to Szoboszlai and Chiesa as Iraola seeks a Van Dijk deputy", time: "2d ago", category: "fan" },
  { source: "Liverpool.com", title: "Jordan Henderson closing on a Chelsea move from Brentford as the 2020 spine scatters further", time: "3d ago", category: "major" },
  { source: "MLB.com", title: "Tour finale: Leeds at Soldier Field on Sunday, then home to Monaco on August 9", time: "today", category: "fan" },
];
