...
const PLAYERS = [
  ...
  // ── Defenders ─────────────────────────────────────────────────────────────
  { id: 3, name: "Virgil van Dijk", number: 4, position: "DEF", nationality: "🇳🇱 Netherlands", age: 34, appearances: 43, goals: 6, assists: 1, cleanSheets: 11, xG: 3.2, tacklesPer90: 1.2, passCompletion: 92, progressiveCarries: 0.8, form: 7.4, status: "fit", injuryNote: "Wed Jul 1 — the fixed point wobbles: Turkish reporting has Galatasaray readying an official offer and one of his agents flying out for talks, the 34-year-old captain said to be open to leaving on a free even with a year left to 2027. Liverpool's line is that they will not sanction a fourth senior exit after Salah, Konaté and Robertson, and mean to add at centre-back rather than lose him. Nothing is agreed; fit and in Netherlands colours at the World Cup, he is suddenly the summer's biggest question rather than its one certainty", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p97032.png" },
  ...
  // ── Forwards ──────────────────────────────────────────────────────────────
  { id: 21, name: "Mohamed Salah", number: 11, position: "FWD", nationality: "🇪🇬 Egypt", age: 33, appearances: 39, goals: 10, assists: 10, cleanSheets: null, xG: 7.0, tacklesPer90: 0.6, passCompletion: 82, progressiveCarries: 3.5, form: 7.0, status: "fit", injuryNote: "Wed Jul 1 — free, and fighting a muscle: Salah's Liverpool contract lapsed yesterday, the era formally over after March's agreement to tear up its final year, his next club still unresolved with Saudi Arabia the warmest pull over a framed Fenerbahce offer. For now the story is fitness: a confirmed hamstring strain from the Iran draw leaves Egypt's captain a doubt for their historic World Cup last-32 tie with Australia in Dallas on Friday. The destination call waits for after the tournament", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p118748.png" },
...
const LATEST_NEWS = [
  { source: "TeamTalk / Football365", title: "Van Dijk's future in doubt: Galatasaray ready an 'official offer' and an agent flies out for talks, but Liverpool insist the captain stays", time: "today", category: "major" },
  { source: "World Soccer Talk / GiveMeSport", title: "Koundé for the right-back hole: Liverpool weigh an ~£80m move for Barcelona's versatile France defender", time: "today", category: "major" },
  { source: "Liverpool.com / TeamTalk", title: "A Tonali hijack, then a cooling: Liverpool linked with gatecrashing Spurs for Newcastle's midfielder before playing it down", time: "today", category: "fan" },
  { source: "TeamTalk / Liverpool.com", title: "FSG move to tie Ngumoha down: exit talk dismissed and a new long-term deal prepared for the teenage winger", time: "today", category: "fan" },
  { source: "The Athletic via Liverpool.com", title: "Barcola 'not for sale', the reporting says, even as Liverpool make fresh contact; he is one of six on the winger wishlist", time: "1d ago", category: "fan" },
  { source: "This Is Anfield", title: "A 'huge boost' on Bouaddi: the No. 6 file warms as fresh talks with the Lille teenager's camp progress, though Lille want €70m", time: "1d ago", category: "fan" },
  { source: "Goal / FIFA", title: "Egypt sweat on Salah for Friday: scans confirm a hamstring strain before the historic last-32 tie with Australia in Dallas", time: "1d ago", category: "major" },
  { source: "kicker", title: "Dortmund put €100m on Nmecha amid Liverpool links, a valuation that reads more as a deterrent than an invitation", time: "2d ago", category: "fan" },
  { source: "Al Jazeera / Sky Sports", title: "Gone for nothing: Salah, Konaté (Real Madrid) and Robertson (Tottenham) free transfers took effect as their deals lapsed June 30", time: "1d ago", category: "official" },
  { source: "ESPN / Anfield Watch", title: "Camavinga available near £52m but reluctant: Madrid willing to sell, the France midfielder said to prefer staying", time: "3d ago", category: "fan" },
  { source: "Football365 / Rousing The Kop", title: "A clause on the clock: Schlotterbeck's €50-60m release window, open to just three clubs, keeps ticking toward mid-July", time: "3d ago", category: "fan" },
  { source: "Liverpool FC / This Is Anfield", title: "Pre-season takes shape: squad reports July 13, with home friendlies vs Monaco (Aug 9) and Como (Aug 16) added to the US tour", time: "4d ago", category: "official" },
  { source: "Football Italia / Romano", title: "Chiesa exit 'on': Inter open near €20m against Liverpool's €30m-plus ask, the Italian to settle his future on the pre-season tour", time: "5d ago", category: "fan" },
];
