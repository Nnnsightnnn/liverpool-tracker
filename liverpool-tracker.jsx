...
const LATEST_NEWS = [
  { source: "Sports Mole", title: "Liverpool vs PSG second leg preview: Slot expected to revert to 4-3-3 as Reds bid to overturn 2-0 deficit at Anfield", time: "today", category: "major" },
  { source: "This Is Anfield", title: "Slot's job safe: FSG 'steadfastly behind' manager despite Xabi Alonso links — conflicting reports on Liverpool future", time: "today", category: "fan" },
  { source: "Football365", title: "Xabi Alonso return to Liverpool now 'a genuine possibility' with Slot 'fully aware' after reportedly offering to resign", time: "today", category: "major" },
  { source: "The Peoples Person", title: "Joao Gomes has made his choice between Man United and Liverpool — Brazilian midfielder picks Anfield", time: "1d ago", category: "major" },
  { source: "CaughtOffside", title: "Tottenham secure verbal agreement with Andy Robertson — move hinges on Spurs avoiding relegation", time: "1d ago", category: "major" },
  { source: "Sky Sports", title: "Liverpool 2-0 Fulham: Ngumoha breaks Sterling's Anfield record as youngest PL scorer, Salah adds second in crucial win", time: "2d ago", category: "major" },
  { source: "ESPN", title: "Slot: 'Special' Rio Ngumoha scored Salah-like goal — Liverpool boss hails 17-year-old's long-term future", time: "2d ago", category: "major" },
  { source: "Liverpool.com", title: "Arne Slot finds winning formula — 5 talking points as Liverpool end three-game losing streak vs Fulham", time: "2d ago", category: "fan" },
  { source: "FootballTransfers", title: "Yan Diomande 'close' to transfer agreement with Liverpool — €100m Leipzig winger to replace Salah", time: "2d ago", category: "major" },
  ...
  { source: "Fox Sports", title: "Liverpool 'optimistic' over Konaté contract extension — France defender eager to resolve future before World Cup", time: "3d ago", category: "official" },
  { source: "CaughtOffside", title: "FSG back Arne Slot to stay as Liverpool manager next season despite fan fury and PSG defeat", time: "3d ago", category: "major" },
  { source: "TeamTalk", title: "Liverpool and Real Madrid working on blockbuster Camavinga–Mac Allister swap deal for summer", time: "4d ago", category: "major" },
  { source: "ESPN", title: "PSG 2-0 Liverpool: Doué and Kvaratskhelia strike as Reds are played off the park in Paris", time: "5d ago", category: "major" },
