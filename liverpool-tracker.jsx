...
const LATEST_NEWS = [
  { source: "Anfield Watch / TeamTalk", title: "Edwards 'done waiting': Liverpool open talks for Real Madrid's Eduardo Camavinga as Los Blancos ready a ~£52m sale to fund Enzo Fernandez", time: "today", category: "major" },
  { source: "Anfield Watch / GiveMeSport", title: "The Camavinga catch: Madrid willing and Mourinho signed off, but the France midfielder is reported keen to stay and fight for his place", time: "today", category: "major" },
  { source: "TeamTalk / Sky Sports", title: "Blockbuster second Diomandé bid to land 'quickly' as Leipzig push past €130m behind a private Schafer-Klopp no-sell understanding", time: "today", category: "major" },
  ...
  { source: "Liverpool.com / Sportingpedia", title: "Mac Allister the sell-to-buy lever: no extension talks open as Liverpool would listen near €120m to fund the reshape", time: "3d ago", category: "fan" },
  { source: "Liverpool.com", title: "Isak and Wirtz give Iraola a World Cup boost as the squad's non-internationals begin warm-weather pre-season work", time: "3d ago", category: "fan" },
  { source: "Empire of the Kop", title: "Gakpo exit 'highly improbable': the nine-goal Dutchman has not asked to leave and stays firmly in Iraola's plans", time: "4d ago", category: "fan" },
];
