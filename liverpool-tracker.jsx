...
const PLAYERS = [
  ...
  { id: 9, name: "Jeremie Frimpong", number: 30, position: "DEF", nationality: "🇳🇱 Netherlands", age: 24, appearances: 32, goals: 1, assists: 4, cleanSheets: 7, xG: 0.9, tacklesPer90: 2.2, passCompletion: 83, progressiveCarries: 3.8, form: 6.9, status: "fit", injuryNote: "Scan on minor hamstring issue came back clear — trained Thursday, available for Merseyside Derby (Apr 19) but will be managed", image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p216094.png" },
...
const LATEST_NEWS = [
  { source: "Caught Offside", title: "Liverpool looking to sign Anthony Gordon — deal gathering pace after Ekitike blow, Newcastle need another big sale", time: "today", category: "fan" },
  { source: "Empire of the Kop", title: "'Definitely…' — David Lynch issues Yan Diomande claim as Liverpool urged to sign multiple wingers this summer", time: "today", category: "fan" },
  { source: "Liverpool FC", title: "'A very special game' — Arne Slot on Merseyside derby, Isak, UCL exit and summer rebuild in pre-match presser", time: "1d ago", category: "official" },
  { source: "Liverpool.com", title: "Arne Slot confirms Liverpool injury blow: Joe Gomez ruled out of Merseyside derby, 6 players now missing", time: "1d ago", category: "major" },
  { source: "Liverpool FC", title: "Slot pre-Merseyside derby presser: Ekitike yet to undergo surgery on Achilles, Isak 'not ready for full 90 minutes'", time: "1d ago", category: "official" },
  { source: "Caught Offside", title: "'Tension' at Liverpool as key board figures split over Arne Slot's future despite public FSG backing", time: "1d ago", category: "fan" },
  { source: "Sky Sports", title: "Liverpool transfer chiefs Richard Hughes and Michael Edwards confirmed to remain in post through summer window", time: "1d ago", category: "major" },
  { source: "TEAMtalk", title: "Arne Slot facing six-game audition to save Liverpool job — top-5 finish required, FSG end-of-season review planned", time: "1d ago", category: "major" },
  { source: "Rousing The Kop", title: "Anthony Gordon: Four reasons why a Liverpool move is finally beginning to look inevitable", time: "2d ago", category: "fan" },
  { source: "Anfield Index", title: "Journalist reveals the 'decisive' factor behind FSG's stance on Arne Slot's future at Liverpool", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "FSG 'intend' to stick with Arne Slot even without Champions League football — four summer signings on planning board", time: "2d ago", category: "fan" },
  { source: "ESPN", title: "Hugo Ekitike ruptures Achilles — ruled out of World Cup with France in devastating 9-month blow for Liverpool", time: "2d ago", category: "major" },
  { source: "Empire of the Kop", title: "FSG 'mesmerised' by Andoni Iraola as potential Arne Slot replacement amid Bournemouth transformation", time: "3d ago", category: "fan" },
  { source: "BBC Sport", title: "Liverpool 0-2 PSG (0-4 agg): Dembélé double ends Reds' Champions League campaign at Anfield", time: "4d ago", category: "major" },
