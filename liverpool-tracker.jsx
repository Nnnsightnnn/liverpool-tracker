...
const LATEST_NEWS = [
  { source: "Yahoo Sports", title: "Manchester City reported guilty on 114 of 115 Premier League financial charges; club to appeal", time: "today", category: "major" },
  { source: "Daily Record", title: "Andy Robertson defends City players over the charges: 'They are never to blame'", time: "today", category: "major" },
  { source: "Liverpool FC", title: "Internationals guide: Ngumoha's England Under-20s meet Munoz's Spain tonight", time: "today", category: "official" },
  { source: "Premier League", title: "Isak and Jacquet on September's Player of the Month shortlist; fan vote closes Monday", time: "1d ago", category: "official" },
  { source: "ESPN", title: "Klopp holds Wirtz back for Germany until Serbia as the drop-him debate rolls on", time: "1d ago", category: "major" },
  { source: "TeamTalk", title: "Alisson's new-deal talks parked until later in the year, with terms to 2027", time: "2d ago", category: "fan" },
  { source: "This Is Anfield", title: "Injury boost: Leoni set to rejoin group training, Chiesa close to the grass", time: "2d ago", category: "fan" },
  { source: "CaughtOffside", title: "Manchester United complete raid on Liverpool's academy for 16-year-old Isaac Konde", time: "2d ago", category: "major" },
  { source: "This Is Anfield", title: "Ngumoha's deal beyond 2028 still unsigned as Arsenal interest is played down", time: "2d ago", category: "fan" },
  { source: "Nehanda Radio", title: "Injury heartbreak for Isaac Mabaya as first Zimbabwe call-up is cut short", time: "3d ago", category: "major" },
  { source: "Liverpool.com", title: "Iraola keeps a dozen first-teamers working at Kirkby through the break", time: "3d ago", category: "official" },
  { source: "BBC Sport", title: "Bournemouth 0-1 Liverpool: Isak's winner sent Iraola into the break unbeaten", time: "6d ago", category: "major" },
  { source: "This Is Anfield", title: "Alisson left out of Brazil's September squad, a boost for Liverpool", time: "2w ago", category: "fan" },
];
