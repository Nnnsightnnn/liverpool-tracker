...
export const PREDICTION_NOTE = {
  level: "Medium",
  reason: "Apr 28, five days out from Old Trafford (A) May 3: NBC Sports, FotMob, Sports Mole and OneFootball still converge on a 4-2-3-1 with Alisson back, Curtis Jones at RB (Slot Apr 27: 'comfort on the ball, like Trent') and Mac Allister + Gravenberch in pivot. The shake-up still defining selection: Salah's 4-week hamstring tear opens the right channel — Frimpong came on for him at 59' Saturday and is the most natural deputy, but Slot may push Szoboszlai wider with Wirtz at the 10. Isak nailed on as the lone fit senior No.9 (Ekitike Achilles, season). Confidence Medium because the post-Salah right-side configuration is still fluid and Woodman could keep gloves if Alisson's fitness test fails.",
  pundit_sources: ["NBC Sports", "FotMob", "Sports Mole", "OneFootball", "Liverpool.com", "This Is Anfield", "Empire of the Kop", "Liverpool FC"],
  agreement_rate: 0.7,
