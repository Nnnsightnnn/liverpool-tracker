...
export const PREDICTION_NOTE = {
  level: "Medium",
  reason: "Sat May 16 (lunchtime refresh) — projected Liverpool XI for the Brentford home finale on Sun May 24, a must-win for Champions League after Friday night's 4-2 Villa Park defeat dropped Liverpool to 5th. Salah is expected to START his Anfield farewell (cameo off the bench at Villa, first action since April 25); Isak's return depends on his 'minor injury' clearing (ESPN / Sports Mole — Slot 'hopeful' at kickoff); Alisson targeted for his first start since March 19 after 11 straight absences; Frimpong projected to return from a 'minor issue.' Wirtz returns from antibiotics. Confidence is MEDIUM because Slot's team news typically only firms up in the Friday/Saturday presser the week of the match — multiple slots (GK, RB, CAM, ST) hinge on fitness updates that haven't yet broken, and the manager himself is under viral fan-petition pressure (SportBible) despite FSG's 'no summer review' stance (Tribuna).",
  pundit_sources: ["Liverpool FC", "Liverpool.com", "This Is Anfield", "Sky Sports", "NBC Sports", "ESPN", "FOX Sports", "Goal.com", "Sports Illustrated", "Al Jazeera", "Per Second News", "RotoWire", "FootballTransfers", "Anfield Watch", "Inside World Football", "Football FanCast", "Caught Offside", "Anfield Index", "Yahoo Sports", "RTÉ", "TeamTalk", "GiveMeSport", "Premier League", "Football365", "Sports Mole", "SportBible", "Tribuna"],
  agreement_rate: 0.7,
  generated_at: "2026-05-16T12:10:00Z",
};
