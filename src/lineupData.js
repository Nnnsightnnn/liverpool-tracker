...
export const FORMATIONS = {
  "4-3-3": {
    ...
    // 4-2-3-1 below. Reviewed Sun Sep 20 (morning), after Andoni Iraola's Friday press
  ...
  "4-2-3-1": {
    ...
    // Aug 29; Newcastle drawn 2-2 away on Aug 23). Reviewed Sun Sep 20 (morning), after the
  ...
  "3-4-3": {
    ...
    // Reviewed Sun Sep 20 (morning), pointed at Bournemouth away today. This remains the
...
// Hand-curated from RESULTS + injuryNote context, reviewed Sun Sep 20 (morning), after Iraola's
...
export const PLAYER_EVIDENCE = {
  ...
  22: "Adductor doubt · late fitness test",    // Gakpo
  ...
  30: "Right flank for today's league XI", // Barcola
...
export const SLOT_CONFIDENCE = {
  ...
  LAM: "Low",       // Gakpo · adductor doubt after missing Saturday's session; Ngumoha ready if he fails a warm-up
...
export const PREDICTION_NOTE = {
  level: "Medium",
  generated_at: "2026-09-20T08:30:00Z",
  reason: "Sun Sep 20, morning, and it is matchday: Bournemouth away at 2pm at the Vitality Stadium, live on Sky Sports Main Event, Andoni Iraola's first return to the club he managed for three years and left in June. Confidence holds at Medium, and the reason it cannot rise this time is a fitness doubt rather than a disagreement between previews. Cody Gakpo did not train on Saturday with soreness in both adductors, and Iraola would not guarantee him, 'I cannot guarantee it', per This Is Anfield, so the left of the front three is a genuine question, with Rio Ngumoha the ready replacement if a morning warm-up goes against him. The eleven below is the Sunday consensus at Sports Illustrated, Yahoo and The Hard Tackle, a 4-2-3-1: Alisson; Araujo, Van Dijk, Jacquet, Kerkez; Szoboszlai, Mac Allister; Barcola, Wirtz, Gakpo; Isak, with Mac Allister the previews' one certainty after a goal and an assist in the cup. Nothing else moved medically: Bradley (knee, ~21 Nov), Ekitike (Achilles, January at the earliest), Leoni (ACL, rejoining group training in the break) and Chiesa (aiming to resume training at the end of September) remain the four out, and Joe Gomez is available and expected on the bench, his half-time withdrawal in the cup having been planned rather than forced. Bournemouth are sixteenth and winless under Marco Rose, the first side in Premier League history to lead each of its opening four fixtures without winning any, and arrive off the first European win in the club's history at Real Sociedad on Thursday.",
};
