...
export const FORMATIONS = {
  "4-3-3": {
    ...
    // agent's demands astronomical; and the Barcola pursuit has cooled, PSG
    // pricing him at £127.5m with Ornstein reporting they will not sell, Minteh
    // and Hassan the deliverable alternatives behind it.
    defaultXI: {
  ...
  "4-2-3-1": {
    ...
    // part; the winger board has cooled at the top, PSG pricing Barcola at
    // £127.5m and reported unwilling to sell after the £85m bid, with Minteh
    // at around £70m and Hassan the deliverable alternatives, El Mala parked at
    // Koln until 2027; Jacquet the only senior CB fit until Van Dijk joins up.
    defaultXI: {
      GK: 1,    // Alisson (started the Brentford finale)
      LB: 7,    // Kerkez (first-pick LB with Robertson gone to Spurs)
      LCB: 3,   // Van Dijk (captain · contracted to 2027)
...
// signing of 17-year-old Samuel Martinez for 2027; the Barcola pursuit cooled as
// PSG priced him at £127.5m with Ornstein reporting they will not sell; Inter's
...
export const PLAYER_EVIDENCE = {
  ...
  10: "ACL · running outdoors, furthest along",  // Leoni
...
// (Refreshed Wed Jul 22: the Barcola pursuit cooled a day after the £85m bid, PSG
// pricing him at £127.5m with Ornstein reporting they do not want to sell. Inter's
...
export const SLOT_CONFIDENCE = {
  ...
  RAM: "Low",    // Salah gone · Barcola priced out at £127.5m, Minteh/Hassan in reserve · Ngumoha holds it by default
...
export const SLOT_RATIONALE = {
  ...
  RAM: "Wed Jul 22 — the slot that defines the summer, and the marquee option has priced itself back out. A day after Liverpool's £85m opening bid, L'Equipe put PSG's valuation of Bradley Barcola at £127.5m and Ornstein reported the champions are not convinced they want to sell at all, to the point of inviting Manchester United to bid instead. The gap, not the willingness, is now the wall. Behind it Yankuba Minteh at around £70m from Brighton has not been withdrawn, and Haissem Hassan sits beneath a €12m clause at a relegated Real Oviedo: two deliverable prices for one shirt, with a Yan Diomande enquiry and a Harvey Elliott makeweight the cheaper hedge. Salah remains a free agent, Besiktas wanting him but calling the agent's demands astronomical. Rio Ngumoha, seventeen, keeps the berth until somebody lands.",
...
export const PREDICTION_NOTE = {
  level: "Low",
  reason: "Wed Jul 22 — the XI below is a squad baseline rather than a matchday prediction, and the gap between it and whatever starts in Nashville on Saturday is currently enormous. In his first pre-season briefing Iraola confirmed the phasing: Isak, Wirtz and Gravenberch rejoin the tour in the coming days, missing the Sunderland opener but available for Wrexham and Leeds, while Alisson, Van Dijk and Gakpo stay in Europe and link up later, Van Dijk's minutes reserved for the Anfield friendlies. Victor Munoz and Alexis Mac Allister, a World Cup winner and a runner-up, miss the tour entirely and are not expected before the Como friendly on August 16. The team that plays Sunderland will therefore be younger and thinner than this one, leaning on the eleven academy players in the party. The winger slot still decides the shape and it cooled today: PSG have priced Barcola at £127.5m and Ornstein reports they do not want to sell, leaving the £85m bid short, with Minteh at around £70m and Hassan under a €12m clause the deliverable alternatives and a Diomande enquiry, Harvey Elliott a possible makeweight, the cheaper hedge. Rio Ngumoha holds the right-sided berth by default. In midfield Adam Wharton stays the priority beyond £100m after the club declined Joao Gomes, while Inter's third bid for Curtis Jones was rejected and Liverpool are drawing up fresh terms. Ekitike (Achilles, to the festive period), Leoni (ACL, running outdoors and furthest advanced), Bradley (knee), plus Endo and Bajcetic all travelled to build fitness and play no part; Frimpong is the only fit senior right-back on the tour."
};
