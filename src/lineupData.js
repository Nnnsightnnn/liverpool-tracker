...
export const PREDICTION_NOTE = {
  level: "Medium",
  reason: "Sat May 30 (post-season refresh) — the 2025-26 season is over (Liverpool 5th, 60 pts, Champions League secured by the May 24 1-1 with Brentford). This is a snapshot of the first-choice XI Liverpool closed the campaign with, not a matchday prediction. This week's headlines: Jeremie Frimpong has been left out of the Netherlands' World Cup squad (Koeman: 'the pattern of this season that he has been injured regularly'), while Van Dijk, Gravenberch and Gakpo all travel. Anthony Gordon has completed a Barcelona medical (~£70m) with Liverpool stepping aside, leaving the attack rebuild narrowed to RB Leipzig's Yan Diomandé (€100m valuation, agency dispute) with Barcola the alternative. Konaté still drifts toward a free exit; Conor Bradley is a pre-season doubt with 'no timeline' on his knee; Robertson's free move to Spurs is done; Salah will name his next club after the World Cup. Next competitive fixture: not until 2026-27 (pre-season friendly vs Sunderland in Nashville, July 25).",
