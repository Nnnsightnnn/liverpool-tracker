...
export const PLAYER_EVIDENCE = {
  ...
  5:  "Muscle · stepped up, outside chance vs Forest", // Gomez
  ...
  26: "Fitness doubt for Saturday's opener",        // Chiesa
...
export const SLOT_RATIONALE = {
  ...
  RAM: "Tue Aug 25 — the slot that defined the summer, and above it the marquee search that quickened this week. Kept against Tottenham's interest, Gakpo answered by dragging Liverpool level at Newcastle in the 55th, the post-Salah berth his on merit rather than by default, with Rio Ngumoha, 18 on Saturday, a rotation option. Above it the Barcola pursuit has turned hopeful: PSG left the France winger out again and Liverpool believe a deal can be done this week, an improved structured offer readied to bridge a fee that had held near £145m, while a third bid worth around £68m has gone to Brighton for Minteh. Until a senior winger signs, Gakpo owns the right, and on this evidence he may keep it regardless.",
  RB:  "Tue Aug 25 — a one-man department, with reinforcements only trickling. Jeremie Frimpong started the 2-2 at Newcastle as the only fit recognised right-back and holds the flank for Saturday: Conor Bradley is still short after January knee surgery, and Joe Gomez, stepped up in his recovery, is only an outside chance for the Forest visit. Ronald Araujo, in on loan with a competitive debut behind him, spells the flank as the in-game cover. Curtis Jones, last season's emergency option there, is an Inter player now, and Calvin Ramsay has gone to St Mirren on loan. Frimpong plays by elimination, and plays on.",
  ST:  "Tue Aug 25 — Alexander Isak walked back into St James' in red on Sunday and found the loudest, coldest welcome of the weekend, no goal, a difficult afternoon, and the late penalty handed to Szoboszlai rather than him. Lined up again with Wirtz and Gravenberch behind him, the £100m striker's injury-wrecked debut year still shadows a front line yet to settle. A first goal of the Iraola era, ideally at Anfield against Forest on Saturday, is the reset the whole attack, and the striker himself, most needs.",
};
...
export const PREDICTION_NOTE = {
  level: "High",
  reason: "Tue Aug 25 — the XI below points at Nottingham Forest at home on Saturday, August 29, Iraola's first competitive night at Anfield, and confidence is high because we have a competitive team sheet to read: the group that drew 2-2 at Newcastle started ten of the eleven shown here, Szoboszlai rescuing a debut point from a stoppage-time penalty and Gakpo taking the equaliser. Expect continuity. The defence stays thin, Gomez now an outside chance after stepping up his recovery, Leoni (ACL, eyeing September) and Bradley (knee) still out, so Frimpong holds the right with Araujo's loan the in-game cover and Jacquet beside Van Dijk; Chiesa is a fresh fitness doubt among the forwards. Isak leads the line seeking a first goal of the era after a hostile, blank afternoon on Tyneside. On the ledger the window has quickened: PSG left Barcola out again and Liverpool are hopeful of a deal this week, a third bid worth around £68m is in for Brighton's Minteh, and Calvin Ramsay has left on loan for St Mirren as up to eight exits are readied. Araujo, a loan arrival, is not yet in the PLAYERS-keyed XI, so Jacquet fills RCB in the graphic. Next up: Nottingham Forest at home, August 29."
};
