...
export const PLAYER_EVIDENCE = {
  ...
  22: "NED v GER tonight \u00b7 Ward's PSV buy",           // Gakpo
...
// Anfield on Sunday 11 October. (Reviewed Thu Sep 24, morning.) The basis has changed in kind: this
...
export const PREDICTION_NOTE = {
  ...
  reason: "Thu Sep 24, morning. The eleven is unchanged and so is the logic: the side that started at Bournemouth is the baseline for Manchester City at Anfield on Sunday 11 October at 4.30pm, a 4-2-3-1 of Alisson; Araujo, Jacquet, Van Dijk, Kerkez; Mac Allister, Szoboszlai; Gakpo, Wirtz, Barcola; Isak. The news that moves this morning moves off the pitch, not on it: the internationals begin tonight, with Van Dijk, Gravenberch, Gakpo and a recalled Frimpong in the Dutch squad that meets Klopp's Germany, so the only real threat to this sheet for the next fortnight is a knock on somebody else's field. Opta's expected-points model still reads City's defence as leakier than their record, which argues for keeping the chance-creator in over Carragher's call to drop Wirtz. Leoni, a year and a day from his ACL, and Chiesa are training-ground stories, not selection ones yet. Confidence stays Medium: seventeen days out, and most of the eleven are away. Bradley and Ekitike remain out.",
};
