...
export const FORMATIONS = {
  "4-3-3": {
    ...
    // 4-2-3-1 below. Reviewed Sat Sep 19 (evening), after Andoni Iraola's Friday press
  ...
  "4-2-3-1": {
    ...
    // Aug 29; Newcastle drawn 2-2 away on Aug 23). Reviewed Sat Sep 19 (evening), after the
  ...
  "3-4-3": {
    ...
    // Reviewed Sat Sep 19 (evening), pointed at Bournemouth away tomorrow. This remains the
...
// Hand-curated from RESULTS + injuryNote context, reviewed Sat Sep 19 (evening), after Iraola's
...
export const PLAYER_EVIDENCE = {
  1:  "Back in goal at the Vitality",         // Alisson
  ...
  28: "Left out by the latest previews", // Munoz
  29: "Booked his own English lessons",       // Araujo
  30: "Right flank for tomorrow's league XI", // Barcola
...
// (Reviewed Sat Sep 19, evening. Saturday added one complication: Last Word on Football's
...
// ─── Per-slot rationale ─────────────────────────────────────────────────────
// The editorial note shown beneath each slot. Refreshed by the daily run. Reviewed Sat Sep 19
...
export const PREDICTION_NOTE = {
  level: "Medium",
  generated_at: "2026-09-19T22:30:00Z",
  reason: "Sat Sep 19, evening, the night before Andoni Iraola's first return to the club he managed for three years and left in June. This draw looks forward to Bournemouth away on Sunday 20 September, 2pm at the Vitality Stadium, live on Sky Sports Main Event, with Michael Oliver refereeing. Confidence holds at Medium, and Saturday is the reason it cannot rise. The eleven below follows the two previews published after Friday's press conference, at Sports Illustrated and Yahoo, which agreed on all of it: Alisson; Araujo, Van Dijk, Jacquet, Kerkez; Szoboszlai, Mac Allister; Barcola, Wirtz, Gakpo; Isak. Last Word on Football, publishing on Saturday lunchtime, disagrees in two places, naming Victor Munoz on the right and Ryan Gravenberch in the pivot ahead of Mac Allister. No new information sits behind that change, no training report and no second press conference, so the XI is held rather than rewritten, and the affected slots keep their lower confidence. Nothing moved medically: Bradley (knee, ~21 Nov), Ekitike (Achilles, January at the earliest), Leoni (ACL, rejoining group training in the break) and Chiesa (aiming to resume training at the end of September) remain the four out, and Joe Gomez is confirmed available, his half-time withdrawal in the cup having been planned rather than forced. The one Liverpool injury of the day was three miles from the first team: Isaac Mabaya, an under-21 right-back, off after five minutes at Kirkby in a 5-1 win over Brighton. Bournemouth are sixteenth and winless in the league under Marco Rose, the first side in Premier League history to lead each of its opening four fixtures without winning any, and Rose confirmed on Friday that everyone came through Thursday's win at Real Sociedad fit.",
};
