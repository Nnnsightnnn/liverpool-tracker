...
// Hand-curated from RESULTS array + injuryNote context as of 2026-04-29.
export const PLAYER_EVIDENCE = {
  ...
  6:  "8/10 vs Palace · Slot Apr 29: 'leaving'",     // Robertson
...
export const PREDICTION_NOTE = {
  level: "Medium",
  reason: "Apr 29, four days out from Old Trafford (A) May 3: NBC Sports, FotMob, Sports Mole and OneFootball still converge on a 4-2-3-1 with Alisson back (targeting his return), Curtis Jones at RB (Slot Apr 27: 'comfort on the ball, like Trent') and Mac Allister + Gravenberch in pivot. Today's Curtis Jones exit story (Romano via EOTK & Rousing, Apr 28-29: Inter Milan eyeing a McTominay-style move) doesn't change selection — he still earned the RB slot — but it sharpens the focus. Salah's 4-week hamstring opens the right channel: Frimpong came on for him at 59' Saturday and is the most natural deputy, though Slot may push Szoboszlai wider with Wirtz at the 10. Isak nailed on as the lone fit senior No.9 (Ekitike Achilles, season). Confidence Medium because the post-Salah right side is still fluid and Woodman could keep gloves if Alisson fails his late fitness test.",
  pundit_sources: ["NBC Sports", "FotMob", "Sports Mole", "OneFootball", "Liverpool.com", "This Is Anfield", "Empire of the Kop", "Rousing The Kop", "Liverpool FC"],
  agreement_rate: 0.7,
  generated_at: "2026-04-29T09:30:00Z",
};
