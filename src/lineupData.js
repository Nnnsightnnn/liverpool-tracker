...
export const PLAYER_EVIDENCE = {
  1:  "Kirkby \u00b7 talks parked, deal to 2027",   // Alisson
  2:  "Georgia \u00b7 Ukraine away Monday",     // Mamardashvili
  3:  "NED \u00b7 Serbia next \u00b7 deal to 2027",       // Van Dijk
  5:  "Stays at Kirkby \u00b7 300th next game",        // Gomez
  7:  "Hungary \u00b7 Belfast on Monday",         // Kerkez
  ...
  11: "POTM shortlist \u00b7 France, Mon",    // Jacquet
  ...
  15: "Hungary \u00b7 Belfast on Monday",   // Szoboszlai
  17: "Kirkby \u00b7 sale sanctioned for January",       // Endo
  18: "GER Serbia 1 Oct \u00b7 drop-him debate",          // Wirtz
  20: "England U20 \u00b7 90 mins v Italy",               // Nyoni
  22: "Scored 90+2 v Germany \u00b7 Serbia next",       // Gakpo
  23: "Scored for Sweden \u00b7 POTM shortlist",       // Isak
  24: "Achilles \u00b7 Inter or Lens, January",      // Ekitike
  25: "England \u00b7 both flanks, deal unsigned",         // Ngumoha
  26: "On the grass by month's end \u00b7 5th fwd",         // Chiesa
  27: "Reserve \u00b7 Matty Wright signs below",       // Woodman
  28: "Spain \u00b7 faces Ngumoha tonight",    // Munoz
...
export const SLOT_CONFIDENCE = {
  ...
  LDM: "Sat Sep 26, morning - ninety minutes of a Hungarian defeat on Friday, and the one midfield position the contract story does not touch. His deal is signed; his partner's is not offered. At the Vitality it was purpose without payoff, two free-kicks narrowly wide, a booking and a withdrawal on eighty-one, and Carragher argued a struggling ten drags him too deep. Nyoni, who volunteered for the six this week, is the young alternative.",    // Szoboszlai · started and was booked; Gravenberch came on for him,    // Szoboszlai · started and was booked; Gravenberch came on for him
  ...
  LAM: "Sat Sep 26, morning - a quarter-hour off the bench in France's 1-0 win in Turkiye, and the quiet around him holds. Barcola took the left at the Vitality against every preview, forced one save from Petrovic with a deflected curler, and was otherwise handled by a thirty-five-year-old on his 431st appearance for the club. A six. Early days, and a 106m-pound forward without a league goal.",       // Barcola · took the left today against every preview; Munoz replaced him on 72
...
export const SLOT_RATIONALE = {
  LB:   "Sat Sep 26, morning - Hungary again on Monday, in Belfast, and the argument over this flank waits for his return. Kerkez went the full ninety at the club that sold him, credited by the BBC for effort rather than quality after being targeted repeatedly over the top. Tsimikas did not leave the bench and is rated no higher. No market until January, and Semenyo attacks this flank when the season resumes at Anfield.",
  LCB:  "Sat Sep 26, morning - the captain takes the Netherlands to Belgrade on Sunday, the Klopp reunion two days behind him after Gakpo rescued a 1-1 draw. His club contract waits on a likely new custodian in Julian Ward, the Netherlands commitment running to Euro 2028 while his Liverpool deal enters a final year with talks not due until 2027. On the pitch nothing is in doubt: every league minute bar the cup night, a seven at Bournemouth, three clean sheets running. Haaland is the first name back.",
  RCB:  "Sat Sep 26, morning - a year to the day since Leoni's knee went, the man who arrived in his absence has made the place his own. Jacquet, twenty-one, won possession six times at Bournemouth per Opta and three of his four duels, took the man-of-the-match award and a first France call-up in the same week, and is the obvious long-term answer beside whoever succeeds Van Dijk. The least complicated thing Liverpool bought in the summer.",
  RB:   "Sat Sep 26, morning - with Uruguay in Seoul on Monday, and the slot the first brief any new recruitment chief will read. AnfieldWatch reports the club is weighing a permanent deal for Araujo, on loan from Barcelona, while Benfica's Banjaqui (50m euros) and Feyenoord's Read, five assists in eight games per Sports Mole, sit on the January list; the Liverpool Echo frames City, whose own week has been consumed by a charges verdict, as a selection call on him. Five straight league starts out of position and three clean sheets say he keeps it for now.",
  ...
  RDM:  "Sat Sep 26, morning - the executive expected back as sporting director helped bring him from Brighton, and the renewal he has not been offered becomes that man's file. Mac Allister said he was very sad not to be offered fresh terms, that there are plenty of options in two years, and that if two is all there is, that is perfect. The Athletic's expected sporting director, Julian Ward, helped sign him in 2023. Seven possession wins at the Vitality, five starts in seven under Iraola, and undroppable on current evidence.",
  LAM:  "Sat Sep 26, morning - France take him to Brussels on Monday, and the quiet around him holds. Barcola took the left at the Vitality against every preview, forced one save from Petrovic with a deflected curler, and was otherwise handled by a thirty-five-year-old on his 431st appearance for the club. A six. The standing caveat travels with him: early days, and a 106m-pound forward without a league goal.",
  CAM:  "Sat Sep 26, morning - the drop-him debate runs on while the player waits on his country. Jamie Carragher called Wirtz's Bournemouth afternoon the poorest he has seen from him in a Liverpool shirt and said he could not start against City, citing Opta's team-low 70.3 per cent passing accuracy, sixteen possessions lost and three chances created. Andoni Iraola disagreed on Sky Sports, granting a slow start but happier with the second half, and Wirtz answered on Instagram. He reports late to Klopp's split Germany squad, in contention for Serbia on 1 October.",
  RAM:  "Sat Sep 26, morning - Julian Ward's first spell brought him from PSV, and the Netherlands he scored for on Thursday go to Belgrade on Sunday. For the club he passed a warm-up on two sore adductors at Bournemouth, switched to the right, and delivered the ball that became Isak's winner, with three chances created per Opta and Squawka putting 57 per cent of Isak's Liverpool league goals down to his deliveries. He has played three positions in five games, which is why this slot is not higher than Medium.",
  ST:   "Sat Sep 26, morning - the only senior nine is Sweden's until Monday, when they play Poland, and the cover behind him is being profiled by the BBC. Isak was close to anonymous for an hour at the Vitality and then did the one thing the position exists for, arriving where the blocked ball fell. Four in five leaves him level with Haaland at the top of the division. Koumas is the entire cover.",
};
...
export const PREDICTION_NOTE = {
  level: "Medium",
  generated_at: "2026-09-26T08:30:00Z",
  reason: "Sat Sep 26, morning. The eleven is unchanged: the side that started at Bournemouth is the baseline for Manchester City at Anfield on Sunday 11 October at 4.30pm, a 4-2-3-1 of Alisson; Araujo, Jacquet, Van Dijk, Kerkez; Mac Allister, Szoboszlai; Gakpo, Wirtz, Barcola; Isak. The break's second week has produced no injury and no selection news, only the weekend's fixtures: Ngumoha faces Munoz tonight, the Dutch play Serbia on Sunday, and most of the squad is in action on Monday. Alisson, left out by Brazil and with contract talks parked until later in the year, trains at Kirkby and arrives rested. The only real threat to this sheet for the next fortnight is an injury on somebody else's field. Confidence stays Medium: fifteen days out, and most of the eleven are away. Bradley and Ekitike remain out.",
};
