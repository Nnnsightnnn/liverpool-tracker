...
export const FORMATIONS = {
  "4-3-3": {
    ...
    // today's Leeds finale; the centre-back hunt turns to Milan's Tomori; Barcola
  ...
  "4-2-3-1": {
    ...
    // World Cup men together for the first time in today's Leeds finale.
    defaultXI: {
      GK: 1,    // Alisson (started the Brentford finale)
      LB: 7,    // Kerkez (first-pick LB with Robertson gone to Spurs)
      LCB: 3,   // Van Dijk (captain · contracted to 2027)
...
export const PLAYER_EVIDENCE = {
  ...
  18: "No. 10 role · plays Leeds today",          // Wirtz
  19: "Building fitness · on the tour",           // Bajcetic
  20: "Impressed on tour · Iraola audition",      // Nyoni
  22: "Not for sale · tried on the left",         // Gakpo
  23: "First minutes vs Leeds today",             // Isak
...
// Jacquet together for the first time in today's Leeds finale. The centre-back hunt
...
export const SLOT_CONFIDENCE = {
  ...
  LAM: "Medium", // Wirtz · injury-hit debut season · No. 10 role, plays the Leeds finale today
...
export const SLOT_RATIONALE = {
  ...
  RCB: "Sun Aug 2 — the succession finally has a live name. With Konaté gone free to Madrid and the summer's shortlist (Inácio, Ordóñez) unresolved, Liverpool have opened contact with AC Milan over Fikayo Tomori, the England defender out of favour at San Siro with a year left; Newcastle have had £12m rejected and Juventus watch. Jacquet, twenty, is the only senior centre-back Iraola can pick until Van Dijk is eased back, so a Premier-League-proven body is now the priority before Newcastle.",
  ...
  RAM: "Sun Aug 2 — the slot that defines the summer, and a way out is opening. PSG have had a £42.7m bid accepted by Monaco for Akliouche and opened talks for Ajax's Mika Godts, two wide signings that could finally free Bradley Barcola, whose ~£103m opening bid was rejected and who Paris still price near €170m, a gap of some £45m. The player has done his part, refusing a new deal, asking for England and waving off Bayern. Below him Rio Ngumoha, seventeen, holds the post-Salah berth by default after his Wrexham winner, with Akliouche now Paris's own signing and Minteh (~£70-80m) the first name in reserve. Until a winger lands, the berth belongs to the academy.",
...
export const PREDICTION_NOTE = {
  level: "Low",
  reason: "Sun Aug 2 — the XI below stays a squad baseline rather than a matchday team. Today's tour finale against Leeds at Chicago's Soldier Field (3pm local, 9pm BST) is where Andoni Iraola finally starts Isak, Wirtz, Gravenberch and the debutant £60m Jeremie Jacquet together for the first time. Liverpool arrive two from two, a 1-0 win over Wrexham following the 4-2 at Sunderland. Off the pitch the centre-back hunt has a name at last, Liverpool in contact with AC Milan over Fikayo Tomori, while PSG accept Monaco's £42.7m bid for Akliouche and open Godts talks, a path that could free Barcola (the ~£103m opening bid rejected, PSG holding near €170m), and Sano leads the midfield race at around £51m. Joe Gomez is out for weeks and misses the Newcastle opener; Van Dijk is eased back through the Anfield friendlies; Ekitike (Achilles) and Bradley (knee) stay months away; Leoni (ACL) runs outdoors and is furthest advanced."
};
