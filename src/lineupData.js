...
export const PLAYER_EVIDENCE = {
  1:  "Kirkby \u00b7 left out by Brazil, rested",   // Alisson
  2:  "Georgia \u00b7 beaten in the 99th minute",     // Mamardashvili
  3:  "NED \u00b7 Serbia next \u00b7 deal to 2027",       // Van Dijk
  5:  "Stays at Kirkby \u00b7 300th next game",        // Gomez
  7:  "Hungary \u00b7 90 mins in 1-0 loss",         // Kerkez
  ...
  11: "POTM shortlist \u00b7 France bench Fri",    // Jacquet
  ...
  15: "Hungary \u00b7 90 mins v Ukraine",   // Szoboszlai
  ...
  28: "Not at Kirkby \u00b7 18 mins last out",    // Munoz
  29: "Loan \u00b7 permanence now the question",   // Araujo
  30: "France \u00b7 15 mins in Turkiye win",          // Barcola
...
// Anfield on Sunday 11 October. (Reviewed Fri Sep 25, evening.) The basis has changed in kind: this
...
export const SLOT_CONFIDENCE = {
  ...
  LAM: "Fri Sep 25, evening - a quarter-hour off the bench in France's 1-0 win in Turkiye, and the quiet around him holds. Barcola took the left at the Vitality against every preview, forced one save from Petrovic with a deflected curler, and was otherwise handled by a thirty-five-year-old on his 431st appearance for the club. A six. Early days, and a 106m-pound forward without a league goal.",       // Barcola · took the left today against every preview; Munoz replaced him on 72
  ...
  ST:  "Fri Sep 25, evening - the only senior nine at the club scored for Sweden on Friday, a twentieth-minute opener in a 2-1 win over Romania, in the week the Premier League shortlisted him for September. He is past the three he managed in fourteen Premier League appearances across all of last season, and only Haaland has more this year. Koumas is the entire cover.",      // Isak · the only senior centre-forward, and four goals in five
};
...
export const PREDICTION_NOTE = {
  level: "Medium",
  generated_at: "2026-09-25T22:30:00Z",
  reason: "Fri Sep 25, evening. The eleven is unchanged: the side that started at Bournemouth is the baseline for Manchester City at Anfield on Sunday 11 October at 4.30pm, a 4-2-3-1 of Alisson; Araujo, Jacquet, Van Dijk, Kerkez; Mac Allister, Szoboszlai; Gakpo, Wirtz, Barcola; Isak. Friday was the break's busiest night and it left the sheet intact: Isak scored for Sweden, Szoboszlai and Kerkez played ninety for Hungary, Barcola fifteen for France, and the club's round-up reported no injuries. Alisson is not away at all, left out by Brazil and training at Kirkby, so the goalkeeper arrives rested. The only real threat to this sheet for the next fortnight is still an injury on somebody else's field. Confidence stays Medium: sixteen days out, and most of the eleven are away. Bradley and Ekitike remain out.",
};
