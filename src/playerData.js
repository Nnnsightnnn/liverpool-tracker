...
export const TRANSFER_TARGETS = {
  generatedAt: "2026-05-28T09:00:00Z",
  summary:
    "Thursday morning, the manager has spoken and the window has its shape. With Salah and Robertson out the door and Slot bracing the support for as many as ten further departures, Edwards's desk now carries two thick files. The incoming sheet is led by Marc Guéhi — Palace's centre-back, contract running, Liverpool's slot open — and the year-two narrative around the £241m Wirtz-and-Isak pair already paid for. Beneath them sit Anthony Gordon, Martín Zubimendi and, on the longer horizon, Porto's Diogo Costa with his €60m release. The outgoing sheet — Gomez, Chiesa, Endo, Tsimikas, Elliott, Ramsay — is the financial choreography that funds the rest.",
  incoming: [
    {
      id: "guehi-2026",
      name: "Marc Guéhi",
      ...
      foot: "Right",
      image: "https://resources.premierleague.com/premierleague/photos/players/110x140/p209036.png",
      ...
      releaseClause: null,
      contractNote: "Final year; Palace bracing for sale.",
      probability: 78,
      heatTier: "hot",
      sources: [
      ...
      rumorNote:
        "Thu May 28 — Palace's England centre-back has been informally counted into Liverpool's 2026-27 backline since February. With Konaté's future unresolved and the Quansah buy-back deferred to 2027, Edwards has the slot and the budget; Palace, with twelve months left on the deal, want a Premier League destination they can live with. Talks have not formally opened — both clubs know what the number is.",
      positionFit: {
        replaces: "Konaté (if sold)",
        competesWith: ["Van Dijk", "Konaté"],
        depthAfter: "Van Dijk · Guéhi · Konaté · Quansah(2027)",
      },
      stats: {
        apps: 36, goals: 1, assists: 0,
        tacklesPer90: 1.9, passCompletion: 87, progressiveCarries: 0.9,
        cleanSheets: 9, xG: 0.4,
      },
    },
    {
      id: "gordon-2026",
      ...
      releaseClause: null,
      contractNote: "Three years left; Newcastle's PSR position softening.",
      probability: 41,
      heatTier: "warm",
      sources: [
        { name: "Fabrizio Romano", tier: "S" },
        { name: "The Athletic",     tier: "A" },
        { name: "TEAMtalk",         tier: "C" },
      ],
      lastUpdated: "2026-05-27",
      rumorNote:
        "Wed May 27 — the Salah replacement file's most persistent name. Gordon, a Liverpudlian, has long been understood to want the move; Newcastle's PSR cushion is thin enough that a €70-85m offer would now have to be heard. Slot prefers an inverted right-side option but would convert him to the left as a working alternative. The conversation, per Romano, is real — but not the first call Edwards intends to make.",
      positionFit: {
        replaces: "Salah (filled the right; Gordon shifts the left)",
        competesWith: ["Díaz", "Gakpo"],
        depthAfter: "Gordon · Díaz · Gakpo · Chiesa(out)",
      },
      stats: {
    ...
    },
    {
      ...
      nationality: "🇪🇸 Spain",
      foot: "Right",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Mart%C3%ADn_Zubimendi.jpg/330px-Mart%C3%ADn_Zubimendi.jpg",
      ...
      wageBand: "B",
      contractExpiry: "2028-06-30",
      releaseClause: { amount: 60, currency: "€m" },
      contractNote: "€60m release clause active all summer.",
      probability: 32,
      heatTier: "cool",
      sources: [
        { name: "The Athletic",  tier: "A" },
        { name: "Marca",         tier: "A" },
        { name: "Football365",   tier: "C" },
      ],
      lastUpdated: "2026-05-26",
      rumorNote:
        "Tue May 26 — the long-running No. 6 file. The release clause makes the price fixed and the decision binary; Liverpool's Endo is on the way out and Mac Allister's situation is unresolved. Arsenal walked away from the same conversation in 2024. Zubimendi's preference remains to stay in San Sebastián but his agents have not closed the door on a final move.",
      positionFit: {
        replaces: "Endo (out)",
        competesWith: ["Mac Allister", "Gravenberch"],
        depthAfter: "Zubimendi · Mac Allister · Gravenberch · Jones(out?)",
      },
      stats: {
        apps: 35, goals: 1, assists: 2,
        tacklesPer90: 2.4, passCompletion: 91, progressiveCarries: 1.8,
    ...
    },
    {
      ...
      foot: "Right",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Portugal_national_football_team_0866_%28Diogo_Costa%29.jpg/330px-Portugal_national_football_team_0866_%28Diogo_Costa%29.jpg",
      currentClub: "Porto",
      ...
      releaseClause: { amount: 60, currency: "€m" },
      contractNote: "€60m release; longer-horizon No. 1 of the future.",
      probability: 24,
      heatTier: "cool",
      sources: [
        { name: "Sky Sports",     tier: "A" },
        { name: "A Bola",         tier: "A" },
        { name: "Crunch Sports",  tier: "C" },
      ],
      lastUpdated: "2026-05-25",
      rumorNote:
        "Mon May 25 — Mamardashvili's loan-out signal points here. With Alisson now framed as staying, Liverpool's long-term goalkeeper plan is openly drawn around the Porto No. 1; the €60m clause is the figure the recruitment team has been keeping a slot for. Not a 2026 move — a 2027 commitment being scoped this summer.",
      positionFit: {
        replaces: "Alisson (long-term)",
        competesWith: ["Alisson", "Mamardashvili"],
        depthAfter: "Alisson · Costa(2027) · Mamardashvili(loan)",
      },
      stats: {
        apps: 38, goals: 0, assists: 0,
        tacklesPer90: 0, passCompletion: 84, progressiveCarries: 0.2,
        cleanSheets: 16, xG: 0,
      },
    },
    {
      ...
      foot: "Right",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/FC_RB_Salzburg_gegen_SK_Austria_Klagenfurt_%282023-05-28%29_38_%28cropped%29.jpg/330px-FC_RB_Salzburg_gegen_SK_Austria_Klagenfurt_%282023-05-28%29_38_%28cropped%29.jpg",
      currentClub: "RB Leipzig",
      currentLeague: "Bundesliga",
      feeMin: 65, feeMax: 80, feeCurrency: "€m",
      marketValue: 70,
      wageBand: "B",
      contractExpiry: "2029-06-30",
      releaseClause: { amount: 65, currency: "€m" },
      contractNote: "€65m release clause — Bundesliga's open secret.",
      probability: 28,
      heatTier: "cool",
      sources: [
        { name: "Sky Sports",     tier: "A" },
      ...
      lastUpdated: "2026-05-26",
      rumorNote:
        "Tue May 26 — the contingency striker if Isak's year-two does not arrive. Šeško's release clause is the cheapest live ticket on the elite-No.9 market; Arsenal and Manchester United are also tracking. Slot's preference is to give the rebuild another window before adding here — but the slot is held open in the modelling.",
      positionFit: {
        replaces: "Isak (depth)",
        competesWith: ["Isak", "Núñez"],
        depthAfter: "Isak · Šeško · Núñez(?)",
      },
      stats: {
        apps: 32, goals: 18, assists: 4,
        tacklesPer90: 0.4, passCompletion: 71, progressiveCarries: 2.1,
        cleanSheets: 0, xG: 17.3,
      },
    },
    {
      id: "wharton-2026",
      ...
      age: 22,
      position: "MID",
      role: "Deep-lying midfielder",
      nationality: "🏴󠁧󠁢󠁥󠁮󠁧󠁿 England",
      foot: "Right",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/1_adam_wharton_2026.jpg/330px-1_adam_wharton_2026.jpg",
      currentClub: "Crystal Palace",
      currentLeague: "Premier League",
      feeMin: 50, feeMax: 60, feeCurrency: "€m",
      marketValue: 55,
      wageBand: "C",
      contractExpiry: "2029-06-30",
      releaseClause: null,
      contractNote: "Three years left; Palace under no pressure.",
      probability: 22,
      heatTier: "cool",
      sources: [
        { name: "The Athletic",  tier: "A" },
      ...
      rumorNote:
        "Sun May 24 — the secondary midfield file. Wharton, the England No. 6 in waiting, ticks Slot's deep-lying brief; Palace's position is that the price starts at €60m and goes up. Liverpool's interest is real but not lead; the Zubimendi conversation has to resolve first.",
      positionFit: {
        replaces: "Endo (out, depth)",
        competesWith: ["Mac Allister", "Gravenberch"],
        depthAfter: "Mac Allister · Wharton · Gravenberch",
      },
      stats: {
        apps: 30, goals: 1, assists: 3,
        tacklesPer90: 2.6, passCompletion: 89, progressiveCarries: 2.4,
        cleanSheets: 0, xG: 1.1,
      },
    },
    {
      id: "olise-2026",
      ...
      nationality: "🇫🇷 France",
      foot: "Left",
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/FC_RB_Salzburg_gegen_FC_Bayern_M%C3%BCnchen_%282026-01-06_Testspiel%29_10.jpg/330px-FC_RB_Salzburg_gegen_FC_Bayern_M%C3%BCnchen_%282026-01-06_Testspiel%29_10.jpg",
      currentClub: "Bayern Munich",
      currentLeague: "Bundesliga",
      feeMin: 90, feeMax: 110, feeCurrency: "€m",
      marketValue: 95,
      wageBand: "A",
      contractExpiry: "2029-06-30",
      releaseClause: null,
      contractNote: "Bayern uninterested in selling; price is the message.",
      probability: 18,
      heatTier: "cool",
      sources: [
        { name: "Fabrizio Romano", tier: "S" },
      ...
      rumorNote:
        "Sat May 23 — the inverted-right-winger fantasy file. Olise's first Bundesliga season has been a hit; Bayern's wage structure is unlikely to be undone by any reasonable Anfield bid. Listed here for completeness — Liverpool's scouts have a folder; the recruitment team does not have an active call.",
      positionFit: {
        replaces: "Salah (right)",
        competesWith: ["Salah's slot", "Wirtz"],
        depthAfter: "Olise · Wirtz · Elliott(out)",
      },
      stats: {
        apps: 31, goals: 14, assists: 11,
        tacklesPer90: 1.0, passCompletion: 81, progressiveCarries: 4.6,
    ...
    },
    {
      ...
      contractExpiry: "2028-06-30",
      releaseClause: null,
      contractNote: "Everton's PSR star; no Merseyside sale, ever.",
      probability: 8,
      heatTier: "dead",
      sources: [
        { name: "The Athletic",  tier: "A" },
      ...
      rumorNote:
        "Wed May 20 — left-footed centre-back, Cumbrian, England future — the profile fits. The destination does not: Everton's board would sell to Real Madrid, Bayern, Paris and Saudi Arabia before they would sell to Anfield. United States Manchester are the more realistic bidder. Listed for the audit trail.",
      positionFit: {
        replaces: "Konaté (left-foot alternative)",
        competesWith: ["Van Dijk", "Konaté", "Guéhi"],
        depthAfter: "Van Dijk · Guéhi · Branthwaite · Konaté",
      },
      stats: {
        apps: 33, goals: 2, assists: 0,
        tacklesPer90: 1.7, passCompletion: 86, progressiveCarries: 1.1,
        cleanSheets: 7, xG: 0.9,
      },
    },
  ],
  outgoing: [
    ...
    },
    {
      ...
      feeAsk: { min: 12, max: 15, currency: "€m" },
      probability: 96,
      heatTier: "done",
      sources: [{ name: "Sky Sports", tier: "A" }, { name: "RTE", tier: "B" }],
      note: "Paperwork only. The Kerkez handover is unambiguous.",
    },
    {
      id: "gomez-out",
      name: "Joe Gomez",
