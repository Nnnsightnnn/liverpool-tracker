...
export const FORM_TRENDS = {
  ...
  played: 4,
  headline:
    "A league position was lost on Monday night without a single new number being added to this board, which is a useful reminder of what it does and does not measure. The four-game Premier League sample is still 6.00 expected goals for and 5.16 against, six scored and four conceded, Opta throughout now that Squawka's gameweek-three table has replaced the Ipswich estimate; Squawka's own figures have not been refreshed past that round, so nothing here moves until Liverpool play again in the league. The reading holds: this is a side overperforming its chances rather than underperforming its luck, six goals from 4.87 expected once the three league cards below are added up, or 4.97 on Squawka's published three-round table, a gap that is the residue of the Ipswich revision rather than a disagreement worth resolving. Only the Fulham afternoon, 1.13 from 14 shots to 0.71 from 10, produced meaningfully more chances than goals. Three of Iraola's four league games have ended level, four straight Anfield draws across two managers. Tuesday's cup tie adds a data point that belongs to neither total: a rotated Liverpool against a Tottenham side that has scored nothing at all from 2.94, with no VAR and penalties waiting if it stays level.",
  diagnosis: [
    {
...
export const SQUAD_LOAD = {
  ...
  returning: [
    ...
    { name: "Cody Gakpo", issue: "Niggles in both adductors, no defined injury", status: "Fit, and the previews disagree on him: leading the line in the morning reads, left out of the evening one", note: "The evening changed the argument rather than his fitness. Where Sports Mole's morning preview had Gakpo as the false nine with Isak rested, Rousing The Kop's post-press-conference XI leaves him out on the grounds that a player thirty minutes into his return from an adductor niggle should not start 72 hours later, and gives the centre-forward role to Lewis Koumas instead. Koumas sits outside this tracker's 26, which is why the pitch view still draws Gakpo there. A goal and three assists in three league games per Opta are back in the pool either way.", source: "Liverpool FC / Sports Mole / Rousing The Kop" },
    ...
    { name: "Wataru Endo", issue: "No injury; unused all season", status: "Expected to start the cup tie at centre-back, alongside Gomez rather than instead of him, per Rousing The Kop", note: "The hedge in the morning's version has gone. Rousing The Kop's post-press-conference XI starts Endo and Gomez together in the middle of a back four, with Van Dijk, Jacquet and Araujo all rested, which is the plainest available statement of how thin the department is: a 33-year-old holding midfielder is the fourth centre-half, and the same preview names the 18-year-old Mor Talla Ndiaye as the alternative behind him. Nought minutes this season, fourth in the midfield queue, left off the European squad.", source: "Rousing The Kop / Liverpool FC" },
  ],
  startersLastMatch: {
  ...
  depthRisk: [
    ...
    { position: "Centre-forward", level: "high", detail: "Isak alone, and rested in every XI published since Iraola spoke, which makes Tuesday the first match of the season he does not start. The cover is the argument: Rousing The Kop's evening preview hands the role to Lewis Koumas, a 20-year-old yet to start a competitive game, rather than to Gakpo, who is only thirty minutes into his own return. Sixteen touches against Fulham, the second fewest for a Liverpool outfielder on record per the BBC; three league goals in four. Ekitike is out until the new year, so this rest is a cup-only luxury." },
