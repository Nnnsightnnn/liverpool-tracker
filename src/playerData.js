...
export const STANDINGS_COMMENTARY = {
  ...
  teams: {
    "Liverpool": "Eighth on six and unbeaten, but now two places further from the Champions League line than on Thursday, because Brentford played and won. Bournemouth away on Sunday is the last soft fixture before the international break and before a run of City, Brentford, Brighton and Arsenal.",
...
export const DISPATCHES = [
  {
    n: "01",
    headline: "An Eighteen-Year-Old Gets The Call, Two Days Before A Contract Meeting.",
    byline: "Liverpool FC / BBC Sport",
    dateline: "Wembley · 18 September",
