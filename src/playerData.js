...
export const NEWS_DIGEST = {
  ...
  keyTopics: [
    ...
    },
    {
      ...
      detail:
        "Sky Sports' Friday May 15 build-up: Liverpool travel to Villa Park tonight (8pm BST kickoff, Sky Sports Main Event) for the penultimate game of the campaign. Liverpool sit 4th on 65 pts from 36, three points clear of 5th-placed Villa (62) and four clear of 6th-placed Chelsea (61). A win confirms Champions League qualification and all-but secures fourth place before the visit of Brentford May 24; a Chelsea slip on the weekend would do the same job. Villa balance a Europa League final five days later.",
      category: "matches",
    },
    {
    ...
    },
    {
      ...
      detail:
        "Reported across ESPN, Anfield Index, Yahoo Sports and RTÉ on Wed May 13 and still echoing through Friday's coverage: 11-year servant Joe Gomez has admitted he doesn't know if he'll still be a Liverpool player next season. 'No. I think anything can happen. I don't know is the honest answer. I've only got a year left so I don't know, but whatever is meant to be will be, I guess … all I can do is be thankful and we'll see.' Gomez turns 29 on the final weekend; 18 league apps this term and now thrust into a confirmed RB start tonight after Frimpong's late withdrawal. Adds to Salah and Robertson on confirmed/likely departures.",
      category: "transfers",
    },
    {
